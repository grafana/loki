...
- Scaleway tutorial on getting started with Loki "[Use Loki to Manage k8s Application Logs][scaleway-loki]".
...
[scaleway-loki]: https://www.scaleway.com/en/docs/use-loki-to-manage-k8s-application-logs/
