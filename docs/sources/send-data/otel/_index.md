...
Loki supports [per tenant]({{< relref "../../configure/overview#limits_config" >}}) OTLP config which lets you change the default mapping of OTLP to Loki format for each tenant.
