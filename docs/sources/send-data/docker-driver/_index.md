...
```bash
docker plugin install grafana/loki-docker-driver:v3.7.0-arm64 --alias loki --grant-all-permissions
```
...
docker plugin upgrade loki grafana/loki-docker-driver:v3.7.0-arm64 --grant-all-permissions
