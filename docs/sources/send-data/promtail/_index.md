...
Promtail can also be configured to receive logs from another Promtail or any Loki client by exposing the [Loki Push API](https://grafana.com/docs/loki/latest/reference/loki-http-api#ingest-logs) with the [loki_push_api](https://grafana.com/docs/loki/latest/reference/loki-http-api#loki_push_api) scrape config.
