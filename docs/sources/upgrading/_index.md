...
There are more examples on the [Storage description page]({{< relref "../storage/index.md" >}}) including the information you need to setup the `storage` section for boltdb-shipper.
...
_Note:_ A "shared ring" as mentioned below refers to using _consul_ or _etcd_ for values in the following config:
