...
If you have a use-case that relies on strict parsing where you expect the parser to throw an error, we suggest you use `| logfmt --strict` to enable strict mode.
