...
Use Promtail's [Docker target](../promtail/configuration.md/#docker) or [Docker service discovery](../promtail/configuration.md/#docker_sd_config) to avoid this issue.
