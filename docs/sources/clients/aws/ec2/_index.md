...
curl -O -L "https://github.com/MarkWang2/loki/releases/download/v1.6.0/promtail-linux-amd64.zip"
...
[final config]: https://github.com/MarkWang2/loki/blob/master/docs/sources/clients/aws/ec2/promtail-ec2-final.yaml
