...
-  **feat(storage): add support for IBM cloud object storage as storage client**: :warning: ADD DESCRIPTION HERE :warning:. [PR #8826](https://github.com/grafana/loki/pull/8826)]