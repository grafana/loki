...
Additionally, you can also access the log line using the [`__line__`]({{< relref "../template_functions#__line__" >}}) function and the timestamp using the [`__timestamp__`]({{< relref "../template_functions#__timestamp__" >}}) function. See [template functions]({{< relref "../template_functions" >}}) to learn about available functions in the template format.
