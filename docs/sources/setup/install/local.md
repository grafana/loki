...
1. In the command line, change directory (`cd` on most systems) to the directory with Loki.
   ...
   For example, if you are using Loki version 3.6.0, you need to use the `https://raw.githubusercontent.com/grafana/loki/v3.7.0/cmd/loki/loki-local-config.yaml` URL to download the configuration file.
