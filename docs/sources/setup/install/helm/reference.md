...
"grafana/loki"
		...
		<tr>
			...
			<td>string</td>
			<td>Overrides the image tag whose default is the chart's appVersion TODO: needed for 3rd target backend functionality revert to null or latest once this behavior is released</td>
			<td><pre lang="json">
null
</pre>
</td>
