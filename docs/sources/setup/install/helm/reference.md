...
{}
		...
		<tr>
			<td>ruler.serviceAccount.annotations</td>
			<td>object</td>
			<td>Annotations for the ruler service account</td>
			<td><pre lang="json">
{}
</pre>
</td>
		...
		<tr>
			<td>ruler.serviceAccount.automountServiceAccountToken</td>
			<td>bool</td>
			<td>Set this toggle to false to opt out of automounting API credentials for the service account</td>
			<td><pre lang="json">
true
		...
		<tr>
			<td>ruler.serviceAccount.imagePullSecrets</td>
			<td>list</td>
			<td>Image pull secrets for the ruler service account</td>
			<td><pre lang="json">
[]
</pre>
</td>
		...
		<tr>
			<td>ruler.serviceAccount.name</td>
			<td>string</td>
			<td>The name of the ServiceAccount to use for the ruler. If not set and create is true, a name is generated by appending "-ruler" to the common ServiceAccount.</td>
			<td><pre lang="json">
null
</pre>
</td>
