...
Simple Scalable Deployment (SSD) mode is being deprecated and will be removed with the Loki 4.0 release. When you upgrade to Loki 3.x, you should choose either monolithic (single-binary) or microservices (distributed) as your [deployment mode](https://grafana.com/docs/loki/<LOKI_VERSION>/get-started/deployment-modes/). You will not be able to run Loki 4.0 in SSD mode.
{{< /admonition >}}
