...
### Helm Chart 6.41.2 - Respect the global registry in the sidecar image

If you prefixed the sidecar container with a private registry (`sidecar.image.repository`), this is no longer necessary as the global registry is used starting with Helm chart 6.41.2. Therefore please use `global.registry` or alternatively, `sidecar.image.registry` for more fine-grained control.
