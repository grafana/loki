---
title: Upgrade Loki 1.x versions
menuTitle: 
description:  Upgrading instructions for Grafana Loki 1.x versions.
weight: 650
---


# Upgrade Loki 1.x versions
...
The following are upgrade instructions for Grafana Loki 1.x versions.
