...
* Review the [Promtail syslog-receiver configuration documentation](/docs/clients/promtail/scraping#syslog-receiver)
...
* Review the [Promtail systemd-journal configuration documentation](/docs/clients/promtail/scraping#journal-scraping-linux-only)
