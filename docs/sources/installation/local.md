...
3. Download the Loki and Promtail .zip files that correspond to your system.
   **Note:** LogCLI or Loki Canary are not required to run Loki. `LogCLI` allows you to run Loki queries in a command line interface. [Loki Canary]({{<relref "../operations/loki-canary">}}) is a tool to audit Loki performance.
