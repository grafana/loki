...
- `buckets_over_time(scalar, unwrapped-range)`: return histogram over time for the specified bucket factor. Refer [buckets_over_time](#buckets-over-time) for syntax.
