...
- [`chunk.go`](https://github.com/grafana/loki/blob/main/pkg/storage/stores/shipper/indexshipper/tsdb/index/chunk.go) defines the chunk metadata and the page markers, including the page size constants.
