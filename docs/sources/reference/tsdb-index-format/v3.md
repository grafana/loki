...
Version 3 is written for periods with schema version `v13`. It is identical to [version 2](https://grafana.com/docs/loki/<LOKI_VERSION>/reference/tsdb-index-version/v2/) except for the chunks part of a series entry, which gains page markers so that readers can skip over chunks that fall outside the queried time range. See [TSDB index format](https://grafana.com/docs/loki/<LOKI_VERSION>/reference/tsdb-index-version/) for the encoding notation used on this page.
...
- [Label indices](https://grafana.com/docs/loki/<LOKI_VERSION>/reference/tsdb-index-version/v2/#label-indices)
- [Postings](https://grafana.com/docs/loki/<LOKI_VERSION>/reference/tsdb-index-version/v2/#postings)
- [Label offset table](https://grafana.com/docs/loki/<LOKI_VERSION>/reference/tsdb-index-version/v2/#label-offset-table)
- [Postings offset table](https://grafana.com/docs/loki/<LOKI_VERSION>/reference/tsdb-index-version/v2/#postings-offset-table)
- [Fingerprint offsets table](https://grafana.com/docs/loki/<LOKI_VERSION>/reference/tsdb-index-version/v2/#fingerprint-offsets-table)
- [TOC](../v2/#toc)
