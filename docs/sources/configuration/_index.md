...
## alibaba_storage_config

The `alibaba_storage_config` configures alibaba oss as a general storage for different data generated by Loki.

```yaml
# Comma separated list of bucket names to evenly distribute chunks over.
# CLI flag: -<prefix>.oss.buckets
...
# Which store to use for the chunks. Either aws, azure, gcp, oss
...
# Configures aibaba oss as the common storage.
[alibaba: <alibaba_storage_config>]  
