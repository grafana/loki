...
1. From the Grafana main menu, click the **Explore** icon (1) to launch the Explore tab. To learn more about Explore, refer the [Explore](/docs/grafana/<GRAFANA-VERSION>/explore/) documentation.
...
1. Click **Code** (3) to work in Code mode in the query editor.
    ...
    Refer to [query examples](https://grafana.com/docs/loki/<LOKI_VERSIO>/query/query_examples/) for more examples.
