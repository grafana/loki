...
| `loki_compactor_delete_processing_fails_total`                | Counter     | Number times the delete phase of compaction has failed.                                                 |
...
| `loki_compactor_oldest_pending_delete_request_age_seconds`    | Counter     | Age of oldest pending delete request in seconds, since they are over their cancellation period.         |
| `loki_compactor_pending_delete_requests_count`                | Counter     | Count of delete requests which are over their cancellation period and have not finished processing yet. |
