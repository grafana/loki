{
  ...
  _config+:: {
    ...
    querier_stateful: if self.using_boltdb_shipper then true else super.querier_stateful,
    ingester_stateful: if self.using_boltdb_shipper then true else super.ingester_stateful,
