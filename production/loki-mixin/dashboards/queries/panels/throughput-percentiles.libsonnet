...

{
  new(component)::
    ...
    lib.panels.timeSeries.bytesRate({
      ...
      description: |||
        The number of bytes processed per second for the %s component.
      ...
      targets: [
        lib.query.prometheus.new(
          datasource=common.variables.metrics_datasource.name,
          expr=shared.queries.queryStats.bytes_processed_rate_p99(component),
          params={
            refId: 'p99',
        ...
        lib.query.prometheus.new(
          datasource=common.variables.metrics_datasource.name,
          expr=shared.queries.queryStats.bytes_processed_rate_p95(component),
          params={
            refId: 'p95',
        ...
        lib.query.prometheus.new(
          datasource=common.variables.metrics_datasource.name,
          expr=shared.queries.queryStats.bytes_processed_rate_p90(component),
          params={
            refId: 'p90',
        ...
        lib.query.prometheus.new(
          datasource=common.variables.metrics_datasource.name,
          expr=shared.queries.queryStats.bytes_processed_rate_p50(component),
          params={
            refId: 'p50',
        ...
        lib.query.prometheus.new(
          datasource=common.variables.metrics_datasource.name,
          expr=shared.queries.queryStats.bytes_processed_rate_average(component),
          params={
            refId: 'avg',
