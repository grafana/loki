...
local queries = import '../shared/queries/main.libsonnet';
...
dashboard.new({
  title: 'Loki / Query / Logs / Query Frontend',
  description: '',
  uid: 'loki-query-logs-query-frontend',
  tags: config.tags + ['query', 'logs', 'query-frontend'],
  from: 'now-1h',
  to: 'now',
  links: links,
  variables: [
