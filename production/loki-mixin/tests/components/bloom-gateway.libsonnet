      ...
      cases: [
        ...
        },
        {
          ...
          test:
            ...
            selector().job('bloom-gateway').build(),
          expected: 'cluster="$cluster", job=~"($namespace)/((loki|enterprise-logs)-)?(bloom-gateway|single-binary)", namespace="$namespace"',
        },
        {
          ...
          test:
            ...
            selector().job('bloom-gateway').build(),
          expected: 'cluster="$cluster", job=~"($namespace)/((loki|enterprise-logs)-)?(bloom-gateway)", namespace="$namespace"',
        },
        {
      ...
      cases: [
        ...
        },
        {
          ...
          test:
            ...
            selector().pod('bloom-gateway').build(),
          expected: 'cluster="$cluster", namespace="$namespace", pod=~"((loki|enterprise-logs)-)?((bloom-gateway|single-binary)-([0-9]+|[a-z0-9]{10}-[a-z0-9]{5}))"',
        },
        {
          ...
          test:
            ...
            selector().pod('bloom-gateway').build(),
          expected: 'cluster="$cluster", namespace="$namespace", pod=~"((loki|enterprise-logs)-)?((bloom-gateway)-([0-9]+|[a-z0-9]{10}-[a-z0-9]{5}))"',
        },
        {
      ...
      cases: [
        ...
        },
        {
          ...
          test:
            ...
            selector().container('bloom-gateway').build(),
          expected: 'cluster="$cluster", container=~"((loki|enterprise-logs)-)?(bloom-gateway|single-binary)", namespace="$namespace"',
        },
        {
          ...
          test:
            ...
            selector().container('bloom-gateway').build(),
          expected: 'cluster="$cluster", container=~"((loki|enterprise-logs)-)?(bloom-gateway)", namespace="$namespace"',
        },
        {
      ...
      cases: [
        ...
        },
        {
          ...
          test:
            ...
            selector().component('bloom-gateway').build(),
          expected: 'cluster="$cluster", component=~"((loki|enterprise-logs)-)?(bloom-gateway|single-binary)", namespace="$namespace"',
        },
        {
          ...
          test:
            ...
            selector().component('bloom-gateway').build(),
          expected: 'cluster="$cluster", component=~"((loki|enterprise-logs)-)?(bloom-gateway)", namespace="$namespace"',
        },
        {
