      ...
      cases: [
        ...
        },
        {
          ...
          test:
            ...
            selector().job('pattern-ingester').build(),
          expected: 'cluster="$cluster", job=~"($namespace)/((loki|enterprise-logs)-)?(pattern-ingester|single-binary)", namespace="$namespace"',
        },
        {
          ...
          test:
            ...
            selector().job('pattern-ingester').build(),
          expected: 'cluster="$cluster", job=~"($namespace)/((loki|enterprise-logs)-)?(pattern-ingester)", namespace="$namespace"',
        },
        {
      ...
      cases: [
        ...
        },
        {
          ...
          test:
            ...
            selector().pod('pattern-ingester').build(),
          expected: 'cluster="$cluster", namespace="$namespace", pod=~"((loki|enterprise-logs)-)?((pattern-ingester|single-binary)-([0-9]+|[a-z0-9]{10}-[a-z0-9]{5}))"',
        },
        {
          ...
          test:
            ...
            selector().pod('pattern-ingester').build(),
          expected: 'cluster="$cluster", namespace="$namespace", pod=~"((loki|enterprise-logs)-)?((pattern-ingester)-([0-9]+|[a-z0-9]{10}-[a-z0-9]{5}))"',
        },
        {
      ...
      cases: [
        ...
        },
        {
          ...
          test:
            ...
            selector().container('pattern-ingester').build(),
          expected: 'cluster="$cluster", container=~"((loki|enterprise-logs)-)?(pattern-ingester|single-binary)", namespace="$namespace"',
        },
        {
          ...
          test:
            ...
            selector().container('pattern-ingester').build(),
          expected: 'cluster="$cluster", container=~"((loki|enterprise-logs)-)?(pattern-ingester)", namespace="$namespace"',
        },
        {
      ...
      cases: [
        ...
        },
        {
          ...
          test:
            ...
            selector().component('pattern-ingester').build(),
          expected: 'cluster="$cluster", component=~"((loki|enterprise-logs)-)?(pattern-ingester|single-binary)", namespace="$namespace"',
        },
        {
          ...
          test:
            ...
            selector().component('pattern-ingester').build(),
          expected: 'cluster="$cluster", component=~"((loki|enterprise-logs)-)?(pattern-ingester)", namespace="$namespace"',
        },
        {
