      ...
      cases: [
        ...
        },
        {
          ...
          actual:
            ...
            selector().job('query-scheduler').build(),
          expected: 'cluster="$cluster", job=~"($namespace)/((loki|enterprise-logs)-)?(query-scheduler|read|single-binary)", namespace="$namespace"',
        },
        {
          ...
          actual:
            ...
            selector().job('query-scheduler').build(),
          expected: 'cluster="$cluster", job=~"($namespace)/((loki|enterprise-logs)-)?(query-scheduler|read)", namespace="$namespace"',
        },
        {
          ...
          actual:
            ...
            selector().job('query-scheduler').build(),
          expected: 'cluster="$cluster", job=~"($namespace)/((loki|enterprise-logs)-)?(query-scheduler|single-binary)", namespace="$namespace"',
        },
        {
          ...
          actual:
            ...
            selector().job('query-scheduler').build(),
          expected: 'cluster="$cluster", job=~"($namespace)/((loki|enterprise-logs)-)?(query-scheduler)", namespace="$namespace"',
        },
      ],
    },
    {
      ...
      cases: [
        ...
        },
        {
          ...
          actual:
            ...
            selector().pod('query-scheduler').build(),
          expected: 'cluster="$cluster", namespace="$namespace", pod=~"((loki|enterprise-logs)-)?((query-scheduler|read|single-binary)-([0-9]+|[a-z0-9]{10}-[a-z0-9]{5}))"',
        },
        {
          ...
          actual:
            ...
            selector().pod('query-scheduler').build(),
          expected: 'cluster="$cluster", namespace="$namespace", pod=~"((loki|enterprise-logs)-)?((query-scheduler|read)-([0-9]+|[a-z0-9]{10}-[a-z0-9]{5}))"',
        },
        {
          ...
          actual:
            ...
            selector().pod('query-scheduler').build(),
          expected: 'cluster="$cluster", namespace="$namespace", pod=~"((loki|enterprise-logs)-)?((query-scheduler|single-binary)-([0-9]+|[a-z0-9]{10}-[a-z0-9]{5}))"',
        },
        {
          ...
          actual:
            ...
            selector().pod('query-scheduler').build(),
          expected: 'cluster="$cluster", namespace="$namespace", pod=~"((loki|enterprise-logs)-)?((query-scheduler)-([0-9]+|[a-z0-9]{10}-[a-z0-9]{5}))"',
        },
      ],
    },
    {
      ...
      cases: [
        ...
        },
        {
          ...
          actual:
            ...
            selector().container('query-scheduler').build(),
          expected: 'cluster="$cluster", container=~"((loki|enterprise-logs)-)?(query-scheduler|read|single-binary)", namespace="$namespace"',
        },
        {
          ...
          actual:
            ...
            selector().container('query-scheduler').build(),
          expected: 'cluster="$cluster", container=~"((loki|enterprise-logs)-)?(query-scheduler|read)", namespace="$namespace"',
        },
        {
          ...
          actual:
            ...
            selector().container('query-scheduler').build(),
          expected: 'cluster="$cluster", container=~"((loki|enterprise-logs)-)?(query-scheduler|single-binary)", namespace="$namespace"',
        },
        {
          ...
          actual:
            ...
            selector().container('query-scheduler').build(),
          expected: 'cluster="$cluster", container=~"((loki|enterprise-logs)-)?(query-scheduler)", namespace="$namespace"',
        },
      ],
    },
    {
      ...
      cases: [
        ...
        },
        {
          ...
          actual:
            ...
            selector().component('query-scheduler').build(),
          expected: 'cluster="$cluster", component=~"((loki|enterprise-logs)-)?(query-scheduler|read|single-binary)", namespace="$namespace"',
        },
        {
          ...
          actual:
            ...
            selector().component('query-scheduler').build(),
          expected: 'cluster="$cluster", component=~"((loki|enterprise-logs)-)?(query-scheduler|read)", namespace="$namespace"',
        },
        {
          ...
          actual:
            ...
            selector().component('query-scheduler').build(),
          expected: 'cluster="$cluster", component=~"((loki|enterprise-logs)-)?(query-scheduler|single-binary)", namespace="$namespace"',
        },
        {
          ...
          actual:
            ...
            selector().component('query-scheduler').build(),
          expected: 'cluster="$cluster", component=~"((loki|enterprise-logs)-)?(query-scheduler)", namespace="$namespace"',
        },
      ],
    },
    {
