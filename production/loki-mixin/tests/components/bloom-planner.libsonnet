      ...
      cases: [
        ...
        },
        {
          ...
          test:
            ...
            selector().job('bloom-planner').build(),
          expected: 'cluster="$cluster", job=~"($namespace)/((loki|enterprise-logs)-)?(bloom-planner|loki|single-binary)", namespace="$namespace"',
        },
        {
          ...
          test:
            ...
            selector().job('bloom-planner').build(),
          expected: 'cluster="$cluster", job=~"($namespace)/((loki|enterprise-logs)-)?(bloom-planner|loki)", namespace="$namespace"',
        },
        {
      ...
      cases: [
        ...
        },
        {
          ...
          test:
            ...
            selector().pod('bloom-planner').build(),
          expected: 'cluster="$cluster", namespace="$namespace", pod=~"((loki|enterprise-logs)-)?((bloom-planner|loki|single-binary)-([0-9]+|[a-z0-9]{10}-[a-z0-9]{5}))"',
        },
        {
          ...
          test:
            ...
            selector().pod('bloom-planner').build(),
          expected: 'cluster="$cluster", namespace="$namespace", pod=~"((loki|enterprise-logs)-)?((bloom-planner|loki)-([0-9]+|[a-z0-9]{10}-[a-z0-9]{5}))"',
        },
        {
      ...
      cases: [
        ...
        },
        {
          ...
          test:
            ...
            selector().container('bloom-planner').build(),
          expected: 'cluster="$cluster", container=~"((loki|enterprise-logs)-)?(bloom-planner|loki|single-binary)", namespace="$namespace"',
        },
        {
          ...
          test:
            ...
            selector().container('bloom-planner').build(),
          expected: 'cluster="$cluster", container=~"((loki|enterprise-logs)-)?(bloom-planner|loki)", namespace="$namespace"',
        },
        {
      ...
      cases: [
        ...
        },
        {
          ...
          test:
            ...
            selector().component('bloom-planner').build(),
          expected: 'cluster="$cluster", component=~"((loki|enterprise-logs)-)?(bloom-planner|loki|single-binary)", namespace="$namespace"',
        },
        {
          ...
          test:
            ...
            selector().component('bloom-planner').build(),
          expected: 'cluster="$cluster", component=~"((loki|enterprise-logs)-)?(bloom-planner|loki)", namespace="$namespace"',
        },
        {
