...
func (s *NoOpStorage) StoreQuerySample(_ context.Context, sample *QuerySample) error {
...
func (s *NoOpStorage) StoreComparisonResult(_ context.Context, result *ComparisonResult) error {
