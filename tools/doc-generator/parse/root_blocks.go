...
var (
	...
	RootBlocks = []RootBlock{
		{
			Name:       "server",
			StructType: []reflect.Type{reflect.TypeFor[server.Config]()},
			Desc:       "Configures the server of the launched module(s).",
		},
		{
			Name:       "distributor",
			StructType: []reflect.Type{reflect.TypeFor[distributor.Config]()},
			Desc:       "Configures the distributor.",
		},
		{
			Name:       "querier",
			StructType: []reflect.Type{reflect.TypeFor[querier.Config]()},
			Desc:       "Configures the querier. Only appropriate when running all modules or just the querier.",
		},
		{
			Name:       "query_scheduler",
			StructType: []reflect.Type{reflect.TypeFor[scheduler.Config]()},
		...
		{
			Name:       "frontend",
			StructType: []reflect.Type{reflect.TypeFor[frontend.Config]()},
			Desc:       "The frontend block configures the Loki query-frontend.",
		},
		{
			Name:       "query_range",
			StructType: []reflect.Type{reflect.TypeFor[queryrange.Config]()},
			Desc:       "The query_range block configures the query splitting and caching in the Loki query-frontend.",
		},
		{
			Name:       "ruler",
			StructType: []reflect.Type{reflect.TypeFor[ruler.Config]()},
			Desc:       "The ruler block configures the Loki ruler.",
		},
		{
			Name:       "ingester_client",
			StructType: []reflect.Type{reflect.TypeFor[ingester_client.Config]()},
		...
		{
			Name:       "ingester",
			StructType: []reflect.Type{reflect.TypeFor[ingester.Config]()},
			Desc:       "The ingester block configures the ingester and how the ingester will register itself to a key value store.",
		},
		{
			Name:       "index_gateway",
			StructType: []reflect.Type{reflect.TypeFor[indexgateway.Config]()},
		...
		{
			Name:       "storage_config",
			StructType: []reflect.Type{reflect.TypeFor[storage.Config]()},
		...
		},
		{
			...
			StructType: []reflect.Type{reflect.TypeFor[storage_config.ChunkStoreConfig]()},
		...
		{
			Name:       "schema_config",
			StructType: []reflect.Type{reflect.TypeFor[storage_config.SchemaConfig]()},
			Desc:       "Configures the chunk index schema and where it is stored.",
		},
		{
			Name:       "compactor",
			StructType: []reflect.Type{reflect.TypeFor[compactor.Config]()},
			Desc:       "The compactor block configures the compactor component, which compacts index shards for performance.",
		},
		{
			Name:       "bloom_gateway",
			StructType: []reflect.Type{reflect.TypeFor[bloomgateway.Config]()},
		...
		{
			Name:       "bloom_build",
			StructType: []reflect.Type{reflect.TypeFor[bloombuild.Config]()},
		...
		{
			Name:       "limits_config",
			StructType: []reflect.Type{reflect.TypeFor[validation.Limits]()},
		...
		{
			Name:       "tracing",
			StructType: []reflect.Type{reflect.TypeFor[tracing.Config]()},
			Desc:       "Configuration for tracing.",
		},
		{
			Name:       "analytics",
			StructType: []reflect.Type{reflect.TypeFor[analytics.Config]()},
			Desc:       "Configuration for analytics.",
		},
		{
			Name:       "profiling",
			StructType: []reflect.Type{reflect.TypeFor[loki.ProfilingConfig]()},
			Desc:       "Configuration for profiling options.",
		},

		{
			Name:       "common",
			StructType: []reflect.Type{reflect.TypeFor[common.Config]()},
...
When a memberlist config with atleast 1 join_members is defined, kvstore of type memberlist is automatically selected for all the components that require a ring unless otherwise specified in the component's configuration section.`,
		...
		},
		{
			...
			StructType: []reflect.Type{reflect.TypeFor[alibaba.OssConfig](), reflect.TypeFor[storage.NamedOssConfig]()},
		...
		},
		{
			...
			StructType: []reflect.Type{reflect.TypeFor[gcp.GCSConfig](), reflect.TypeFor[storage.NamedGCSConfig]()},
		...
		},
		{
			...
			StructType: []reflect.Type{reflect.TypeFor[baidubce.BOSStorageConfig](), reflect.TypeFor[storage.NamedBOSStorageConfig]()},
		...
		},
		{
			...
			StructType: []reflect.Type{reflect.TypeFor[openstack.SwiftConfig](), reflect.TypeFor[storage.NamedSwiftConfig]()},
		...
		},
		{
			...
			StructType: []reflect.Type{reflect.TypeFor[ibmcloud.COSConfig](), reflect.TypeFor[storage.NamedCOSConfig]()},
		...
		},
		{
			...
			StructType: []reflect.Type{reflect.TypeFor[local.FSConfig](), reflect.TypeFor[storage.NamedFSConfig]()},
		...
		},
		{
			...
			StructType: []reflect.Type{reflect.TypeFor[storage.NamedStores]()},
...
Named store from this example can be used by setting object_store to store-1 in period_config.`,
		},
		{
			...
			StructType: []reflect.Type{reflect.TypeFor[push.AttributesConfig]()},
			Desc:       "Define actions for matching OpenTelemetry (OTEL) attributes.",
		},
		{
			Name:       "thanos_object_store_config",
			StructType: []reflect.Type{reflect.TypeFor[bucket.Config]()},
