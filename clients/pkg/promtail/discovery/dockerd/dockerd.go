...
var DefaultDockerSDConfig = SDConfig{
...
func (*SDConfig) Name() string { return "dockerd" }
...
func NewDockerDiscovery(conf *SDConfig, logger log.Logger) (*DockerDiscovery, error) {
	var err error
