...
func (c *Config) RegisterFlagsWithPrefix(prefix string, f *flag.FlagSet) {
	// All of these args are deprecated - instead callers should be loading
	// arguments from the YAML config file, which supports multiple clients and
	// is documented here: https://bit.ly/promtail-yaml-reference
	...
	f.IntVar(&c.BackoffConfig.MaxRetries, prefix+"client.max-retries", MaxRetries, "Maximum number of retries when sending batches (deprecated).")
