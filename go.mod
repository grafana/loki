...
require (
	...
	github.com/weaveworks/common v0.0.0-20220913160921-e98fcdf5519a
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/loki v0.0.0-20220928022443-575c72b474b1
