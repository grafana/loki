...
require (
	...
	github.com/cortexproject/cortex v0.0.0-20190825121948-934998160dbe
...
replace git.apache.org/thrift.git => github.com/apache/thrift v0.0.0-20180924222215-a9235805469b
