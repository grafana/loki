...
const file_google_bigtable_v2_types_proto_rawDesc = "" +
	"\n" +
	"\x1egoogle/bigtable/v2/types.proto\x12\x12google.bigtable.v2\x1a\x1fgoogle/api/field_behavior.proto\"\xb1\x1c\n" +
	"\x04Type\x12?\n" +
	"\n" +
	"bytes_type\x18\x01 \x01(\v2\x1e.google.bigtable.v2.Type.BytesH\x00R\tbytesType\x12B\n" +
	"\vstring_type\x18\x02 \x01(\v2\x1f.google.bigtable.v2.Type.StringH\x00R\n" +
	"stringType\x12?\n" +
	"\n" +
	"int64_type\x18\x05 \x01(\v2\x1e.google.bigtable.v2.Type.Int64H\x00R\tint64Type\x12E\n" +
	"\ffloat32_type\x18\f \x01(\v2 .google.bigtable.v2.Type.Float32H\x00R\vfloat32Type\x12E\n" +
	"\ffloat64_type\x18\t \x01(\v2 .google.bigtable.v2.Type.Float64H\x00R\vfloat64Type\x12<\n" +
	"\tbool_type\x18\b \x01(\v2\x1d.google.bigtable.v2.Type.BoolH\x00R\bboolType\x12K\n" +
	"\x0etimestamp_type\x18\n" +
	" \x01(\v2\".google.bigtable.v2.Type.TimestampH\x00R\rtimestampType\x12<\n" +
	"\tdate_type\x18\v \x01(\v2\x1d.google.bigtable.v2.Type.DateH\x00R\bdateType\x12K\n" +
	"\x0eaggregate_type\x18\x06 \x01(\v2\".google.bigtable.v2.Type.AggregateH\x00R\raggregateType\x12B\n" +
	"\vstruct_type\x18\a \x01(\v2\x1f.google.bigtable.v2.Type.StructH\x00R\n" +
	"structType\x12?\n" +
	"\n" +
	"array_type\x18\x03 \x01(\v2\x1e.google.bigtable.v2.Type.ArrayH\x00R\tarrayType\x129\n" +
	"\bmap_type\x18\x04 \x01(\v2\x1c.google.bigtable.v2.Type.MapH\x00R\amapType\x12?\n" +
	"\n" +
	"proto_type\x18\r \x01(\v2\x1e.google.bigtable.v2.Type.ProtoH\x00R\tprotoType\x12<\n" +
	"\tenum_type\x18\x0e \x01(\v2\x1d.google.bigtable.v2.Type.EnumH\x00R\benumType\x1a\xd0\x01\n" +
	"\x05Bytes\x12C\n" +
	"\bencoding\x18\x01 \x01(\v2'.google.bigtable.v2.Type.Bytes.EncodingR\bencoding\x1a\x81\x01\n" +
	"\bEncoding\x12?\n" +
	"\x03raw\x18\x01 \x01(\v2+.google.bigtable.v2.Type.Bytes.Encoding.RawH\x00R\x03raw\x1a(\n" +
	"\x03Raw\x12!\n" +
	"\fescape_nulls\x18\x01 \x01(\bR\vescapeNullsB\n" +
	"\n" +
	"\bencoding\x1a\xd5\x02\n" +
	"\x06String\x12D\n" +
	"\bencoding\x18\x01 \x01(\v2(.google.bigtable.v2.Type.String.EncodingR\bencoding\x1a\x84\x02\n" +
	"\bEncoding\x12Q\n" +
	"\butf8_raw\x18\x01 \x01(\v20.google.bigtable.v2.Type.String.Encoding.Utf8RawB\x02\x18\x01H\x00R\autf8Raw\x12S\n" +
	"\n" +
	"utf8_bytes\x18\x02 \x01(\v22.google.bigtable.v2.Type.String.Encoding.Utf8BytesH\x00R\tutf8Bytes\x1a\r\n" +
	"\aUtf8Raw:\x02\x18\x01\x1a5\n" +
	"\tUtf8Bytes\x12(\n" +
	"\x10null_escape_char\x18\x01 \x01(\tR\x0enullEscapeCharB\n" +
	"\n" +
	"\bencoding\x1a\x9c\x03\n" +
	"\x05Int64\x12C\n" +
	"\bencoding\x18\x01 \x01(\v2'.google.bigtable.v2.Type.Int64.EncodingR\bencoding\x1a\xcd\x02\n" +
	"\bEncoding\x12b\n" +
	"\x10big_endian_bytes\x18\x01 \x01(\v26.google.bigtable.v2.Type.Int64.Encoding.BigEndianBytesH\x00R\x0ebigEndianBytes\x12h\n" +
	"\x12ordered_code_bytes\x18\x02 \x01(\v28.google.bigtable.v2.Type.Int64.Encoding.OrderedCodeBytesH\x00R\x10orderedCodeBytes\x1aS\n" +
	"\x0eBigEndianBytes\x12A\n" +
	"\n" +
	"bytes_type\x18\x01 \x01(\v2\x1e.google.bigtable.v2.Type.BytesB\x02\x18\x01R\tbytesType\x1a\x12\n" +
	"\x10OrderedCodeBytesB\n" +
	"\n" +
	"\bencoding\x1a\x06\n" +
	"\x04Bool\x1a\t\n" +
	"\aFloat32\x1a\t\n" +
	"\aFloat64\x1a\xc3\x01\n" +
	"\tTimestamp\x12G\n" +
	"\bencoding\x18\x01 \x01(\v2+.google.bigtable.v2.Type.Timestamp.EncodingR\bencoding\x1am\n" +
	"\bEncoding\x12U\n" +
	"\x11unix_micros_int64\x18\x01 \x01(\v2'.google.bigtable.v2.Type.Int64.EncodingH\x00R\x0funixMicrosInt64B\n" +
	"\n" +
	"\bencoding\x1a\x06\n" +
	"\x04Date\x1a\xf0\x04\n" +
	"\x06Struct\x12=\n" +
	"\x06fields\x18\x01 \x03(\v2%.google.bigtable.v2.Type.Struct.FieldR\x06fields\x12D\n" +
	"\bencoding\x18\x02 \x01(\v2(.google.bigtable.v2.Type.Struct.EncodingR\bencoding\x1aT\n" +
	"\x05Field\x12\x1d\n" +
	"\n" +
	"field_name\x18\x01 \x01(\tR\tfieldName\x12,\n" +
	"\x04type\x18\x02 \x01(\v2\x18.google.bigtable.v2.TypeR\x04type\x1a\x8a\x03\n" +
	"\bEncoding\x12R\n" +
	"\tsingleton\x18\x01 \x01(\v22.google.bigtable.v2.Type.Struct.Encoding.SingletonH\x00R\tsingleton\x12b\n" +
	"\x0fdelimited_bytes\x18\x02 \x01(\v27.google.bigtable.v2.Type.Struct.Encoding.DelimitedBytesH\x00R\x0edelimitedBytes\x12i\n" +
	"\x12ordered_code_bytes\x18\x03 \x01(\v29.google.bigtable.v2.Type.Struct.Encoding.OrderedCodeBytesH\x00R\x10orderedCodeBytes\x1a\v\n" +
	"\tSingleton\x1a.\n" +
	...
	"\tenum_name\x18\x02 \x01(\tR\benumName\x1aD\n" +
	"\x05Array\x12;\n" +
	"\felement_type\x18\x01 \x01(\v2\x18.google.bigtable.v2.TypeR\velementType\x1as\n" +
	"\x03Map\x123\n" +
	"\bkey_type\x18\x01 \x01(\v2\x18.google.bigtable.v2.TypeR\akeyType\x127\n" +
	"\n" +
	"value_type\x18\x02 \x01(\v2\x18.google.bigtable.v2.TypeR\tvalueType\x1a\xee\x03\n" +
	"\tAggregate\x127\n" +
	"\n" +
	"input_type\x18\x01 \x01(\v2\x18.google.bigtable.v2.TypeR\tinputType\x12<\n" +
	"\n" +
	"state_type\x18\x02 \x01(\v2\x18.google.bigtable.v2.TypeB\x03\xe0A\x03R\tstateType\x12:\n" +
	"\x03sum\x18\x04 \x01(\v2&.google.bigtable.v2.Type.Aggregate.SumH\x00R\x03sum\x12q\n" +
	"\x12hllpp_unique_count\x18\x05 \x01(\v2A.google.bigtable.v2.Type.Aggregate.HyperLogLogPlusPlusUniqueCountH\x00R\x10hllppUniqueCount\x12:\n" +
	"\x03max\x18\x06 \x01(\v2&.google.bigtable.v2.Type.Aggregate.MaxH\x00R\x03max\x12:\n" +
	"\x03min\x18\a \x01(\v2&.google.bigtable.v2.Type.Aggregate.MinH\x00R\x03min\x1a\x05\n" +
	"\x03Sum\x1a\x05\n" +
	"\x03Max\x1a\x05\n" +
	"\x03Min\x1a \n" +
...
var (
	...
	file_google_bigtable_v2_types_proto_rawDescData []byte
)

func file_google_bigtable_v2_types_proto_rawDescGZIP() []byte {
	file_google_bigtable_v2_types_proto_rawDescOnce.Do(func() {
		file_google_bigtable_v2_types_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_bigtable_v2_types_proto_rawDesc), len(file_google_bigtable_v2_types_proto_rawDesc)))
	})
...
func file_google_bigtable_v2_types_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_bigtable_v2_types_proto_rawDesc), len(file_google_bigtable_v2_types_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   33,
			NumExtensions: 0,
			NumServices:   0,
