...
func (c *bigtableClient) GetClientConfiguration(ctx context.Context, in *GetClientConfigurationRequest, opts ...grpc.CallOption) (*ClientConfiguration, error) {
	...
	err := c.cc.Invoke(ctx, Bigtable_GetClientConfiguration_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bigtableClient) OpenTable(ctx context.Context, opts ...grpc.CallOption) (Bigtable_OpenTableClient, error) {
	stream, err := c.cc.NewStream(ctx, &Bigtable_ServiceDesc.Streams[6], Bigtable_OpenTable_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &bigtableOpenTableClient{stream}
	return x, nil
}
...
type bigtableOpenTableClient struct {
	grpc.ClientStream
}

func (x *bigtableOpenTableClient) Send(m *SessionRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *bigtableOpenTableClient) Recv() (*SessionResponse, error) {
...
func (c *bigtableClient) OpenAuthorizedView(ctx context.Context, opts ...grpc.CallOption) (Bigtable_OpenAuthorizedViewClient, error) {
	stream, err := c.cc.NewStream(ctx, &Bigtable_ServiceDesc.Streams[7], Bigtable_OpenAuthorizedView_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &bigtableOpenAuthorizedViewClient{stream}
	return x, nil
}
...
type bigtableOpenAuthorizedViewClient struct {
	grpc.ClientStream
}

func (x *bigtableOpenAuthorizedViewClient) Send(m *SessionRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *bigtableOpenAuthorizedViewClient) Recv() (*SessionResponse, error) {
	m := new(SessionResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *bigtableClient) OpenMaterializedView(ctx context.Context, opts ...grpc.CallOption) (Bigtable_OpenMaterializedViewClient, error) {
	stream, err := c.cc.NewStream(ctx, &Bigtable_ServiceDesc.Streams[8], Bigtable_OpenMaterializedView_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
	x := &bigtableOpenMaterializedViewClient{stream}
	return x, nil
}
...
type bigtableOpenMaterializedViewClient struct {
	grpc.ClientStream
}

func (x *bigtableOpenMaterializedViewClient) Send(m *SessionRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *bigtableOpenMaterializedViewClient) Recv() (*SessionResponse, error) {
	m := new(SessionResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (UnimplementedBigtableServer) OpenTable(Bigtable_OpenTableServer) error {
	return status.Errorf(codes.Unimplemented, "method OpenTable not implemented")
}
func (UnimplementedBigtableServer) OpenAuthorizedView(Bigtable_OpenAuthorizedViewServer) error {
	return status.Errorf(codes.Unimplemented, "method OpenAuthorizedView not implemented")
}
func (UnimplementedBigtableServer) OpenMaterializedView(Bigtable_OpenMaterializedViewServer) error {
	return status.Errorf(codes.Unimplemented, "method OpenMaterializedView not implemented")
}
...
func _Bigtable_OpenTable_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BigtableServer).OpenTable(&bigtableOpenTableServer{stream})
}
...
type bigtableOpenTableServer struct {
	grpc.ServerStream
}

func (x *bigtableOpenTableServer) Send(m *SessionResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *bigtableOpenTableServer) Recv() (*SessionRequest, error) {
...
func _Bigtable_OpenAuthorizedView_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BigtableServer).OpenAuthorizedView(&bigtableOpenAuthorizedViewServer{stream})
}
...
type bigtableOpenAuthorizedViewServer struct {
	grpc.ServerStream
}

func (x *bigtableOpenAuthorizedViewServer) Send(m *SessionResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *bigtableOpenAuthorizedViewServer) Recv() (*SessionRequest, error) {
	m := new(SessionRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Bigtable_OpenMaterializedView_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BigtableServer).OpenMaterializedView(&bigtableOpenMaterializedViewServer{stream})
}
...
type bigtableOpenMaterializedViewServer struct {
	grpc.ServerStream
}

func (x *bigtableOpenMaterializedViewServer) Send(m *SessionResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *bigtableOpenMaterializedViewServer) Recv() (*SessionRequest, error) {
	m := new(SessionRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
