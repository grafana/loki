...
| `confmap.newExpandedValueSanitizer` | stable | Fixes some types of decoding errors where environment variables are parsed as non-string types but assigned to string fields. | v0.144.0 | v0.154.0 | [Link](https://github.com/open-telemetry/opentelemetry-collector/pull/14413) |
