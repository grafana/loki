...
type filterSelector struct {
	...
	spectralExpression *spectralBoolExpr
}

func (s filterSelector) present() bool {
	return s.expression != nil || s.spectralExpression != nil
}

func (s filterSelector) ToString() string {
	if s.spectralExpression != nil {
		return s.spectralExpression.String()
	}
