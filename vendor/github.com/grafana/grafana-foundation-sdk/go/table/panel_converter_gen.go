...
func PanelConverter(input dashboard.Panel) string {
	...
	if input.Options != nil && input.Options.(*Options).FrameIndex != 0 {

		buffer.WriteString(`FrameIndex(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).FrameIndex)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).ShowHeader != true {

		buffer.WriteString(`ShowHeader(`)
		arg0 := fmt.Sprintf("%#v", input.Options.(*Options).ShowHeader)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).ShowTypeIcons != nil && *input.Options.(*Options).ShowTypeIcons != false {

		buffer.WriteString(`ShowTypeIcons(`)
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.Options.(*Options).ShowTypeIcons))
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).SortBy != nil && len(input.Options.(*Options).SortBy) >= 1 {

		buffer.WriteString(`SortBy(`)
		tmparg0 := []string{}
		for _, arg1 := range input.Options.(*Options).SortBy {
	...
	if input.Options != nil && input.Options.(*Options).Footer != nil {

		buffer.WriteString(`Footer(`)
		arg0 := common.TableFooterOptionsConverter(*input.Options.(*Options).Footer)
		buffer.WriteString(arg0)
	...
	if input.Options != nil && input.Options.(*Options).CellHeight != nil {

		buffer.WriteString(`CellHeight(`)
		arg0 := cog.Dump(*input.Options.(*Options).CellHeight)
		buffer.WriteString(arg0)
	...
	if input.FieldConfig != nil && input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).Width != nil {

		buffer.WriteString(`Width(`)
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.FieldConfig.Defaults.Custom.(*FieldConfig).Width))
		buffer.WriteString(arg0)
	...
	if input.FieldConfig != nil && input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).MinWidth != nil {

		buffer.WriteString(`MinWidth(`)
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.FieldConfig.Defaults.Custom.(*FieldConfig).MinWidth))
		buffer.WriteString(arg0)
	...
	if input.FieldConfig != nil && input.FieldConfig.Defaults.Custom != nil {
		...
		arg0 := cog.Dump(input.FieldConfig.Defaults.Custom.(*FieldConfig).Align)
		buffer.WriteString(arg0)
	...
	if input.FieldConfig != nil && input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).DisplayMode != nil {

		buffer.WriteString(`DisplayMode(`)
		arg0 := cog.Dump(*input.FieldConfig.Defaults.Custom.(*FieldConfig).DisplayMode)
		buffer.WriteString(arg0)
	...
	if input.FieldConfig != nil && input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).CellOptions != nil {

		buffer.WriteString(`CellOptions(`)
		arg0 := cog.Dump(*input.FieldConfig.Defaults.Custom.(*FieldConfig).CellOptions)
		buffer.WriteString(arg0)
	...
	if input.FieldConfig != nil && input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).Hidden != nil {

		buffer.WriteString(`Hidden(`)
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.FieldConfig.Defaults.Custom.(*FieldConfig).Hidden))
		buffer.WriteString(arg0)
	...
	if input.FieldConfig != nil && input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).Inspect != false {

		buffer.WriteString(`Inspect(`)
		arg0 := fmt.Sprintf("%#v", input.FieldConfig.Defaults.Custom.(*FieldConfig).Inspect)
		buffer.WriteString(arg0)
	...
	if input.FieldConfig != nil && input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).Filterable != nil {

		buffer.WriteString(`Filterable(`)
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.FieldConfig.Defaults.Custom.(*FieldConfig).Filterable))
		buffer.WriteString(arg0)
	...
	if input.FieldConfig != nil && input.FieldConfig.Defaults.Custom != nil && input.FieldConfig.Defaults.Custom.(*FieldConfig).HideHeader != nil {

		buffer.WriteString(`HideHeader(`)
		arg0 := fmt.Sprintf("%#v", cog.Unptr(input.FieldConfig.Defaults.Custom.(*FieldConfig).HideHeader))
		buffer.WriteString(arg0)
