...
func (builder *PanelBuilder) Footer(footer cog.Builder[common.TableFooterOptions]) *PanelBuilder {
	...
	if err != nil {
		builder.errors["options.footer"] = err.(cog.BuildErrors)
		return builder
	}
	builder.internal.Options.(*Options).Footer = &footerResource
...
func (builder *PanelBuilder) Width(width float64) *PanelBuilder {
	if builder.internal.FieldConfig == nil {
		builder.internal.FieldConfig = &dashboard.FieldConfigSource{}
	}
	...
	builder.internal.FieldConfig.Defaults.Custom.(*FieldConfig).Width = &width

	return builder
}

func (builder *PanelBuilder) MinWidth(minWidth float64) *PanelBuilder {
	if builder.internal.FieldConfig == nil {
		builder.internal.FieldConfig = &dashboard.FieldConfigSource{}
	}
	if builder.internal.FieldConfig.Defaults.Custom == nil {
	...
	builder.internal.FieldConfig.Defaults.Custom.(*FieldConfig).MinWidth = &minWidth

	return builder
}

func (builder *PanelBuilder) Align(align common.FieldTextAlignment) *PanelBuilder {
	if builder.internal.FieldConfig == nil {
		builder.internal.FieldConfig = &dashboard.FieldConfigSource{}
	}
	if builder.internal.FieldConfig.Defaults.Custom == nil {
	...
	builder.internal.FieldConfig.Defaults.Custom.(*FieldConfig).Align = align

	return builder
}

// This field is deprecated in favor of using cellOptions
func (builder *PanelBuilder) DisplayMode(displayMode common.TableCellDisplayMode) *PanelBuilder {
	if builder.internal.FieldConfig == nil {
		builder.internal.FieldConfig = &dashboard.FieldConfigSource{}
	}
	if builder.internal.FieldConfig.Defaults.Custom == nil {
	...
	builder.internal.FieldConfig.Defaults.Custom.(*FieldConfig).DisplayMode = &displayMode

	return builder
}

func (builder *PanelBuilder) CellOptions(cellOptions common.TableCellOptions) *PanelBuilder {
	if builder.internal.FieldConfig == nil {
		builder.internal.FieldConfig = &dashboard.FieldConfigSource{}
	}
	if builder.internal.FieldConfig.Defaults.Custom == nil {
...
func (builder *PanelBuilder) Hidden(hidden bool) *PanelBuilder {
	if builder.internal.FieldConfig == nil {
		builder.internal.FieldConfig = &dashboard.FieldConfigSource{}
	}
	if builder.internal.FieldConfig.Defaults.Custom == nil {
	...
	builder.internal.FieldConfig.Defaults.Custom.(*FieldConfig).Hidden = &hidden

	return builder
}

func (builder *PanelBuilder) Inspect(inspect bool) *PanelBuilder {
	if builder.internal.FieldConfig == nil {
		builder.internal.FieldConfig = &dashboard.FieldConfigSource{}
	}
	if builder.internal.FieldConfig.Defaults.Custom == nil {
	...
	builder.internal.FieldConfig.Defaults.Custom.(*FieldConfig).Inspect = inspect

	return builder
}

func (builder *PanelBuilder) Filterable(filterable bool) *PanelBuilder {
	if builder.internal.FieldConfig == nil {
		builder.internal.FieldConfig = &dashboard.FieldConfigSource{}
	}
	if builder.internal.FieldConfig.Defaults.Custom == nil {
	...
	builder.internal.FieldConfig.Defaults.Custom.(*FieldConfig).Filterable = &filterable

	return builder
}

// Hides any header for a column, useful for columns that show some static content or buttons.
func (builder *PanelBuilder) HideHeader(hideHeader bool) *PanelBuilder {
	if builder.internal.FieldConfig == nil {
		builder.internal.FieldConfig = &dashboard.FieldConfigSource{}
	}
	if builder.internal.FieldConfig.Defaults.Custom == nil {
	...
	builder.internal.FieldConfig.Defaults.Custom.(*FieldConfig).HideHeader = &hideHeader
