...
var bddNodes = [60]int32{
	-1, 1, -1, 0, 19, 3, 1, 4, 100000013, 2, 5, 100000013, 3, 12, 6, 4, 7, 100000006, 5, 100000004, 8, 6, 100000004, 9, 7, 100000004, 10, 8, 100000004, 11, 9, 100000011, 100000012, 4, 15, 13, 8, 100000006, 14, 10, 100000009, 100000010, 5, 100000005, 16, 8, 100000004, 17, 9, 18, 100000008, 10, 100000007, 100000008, 3, 100000001, 20, 4, 100000002, 100000003}
...
func resolveResult(idx int32, params *EndpointParameters, c *conditionContext) (smithyendpoints.Endpoint, error) {
	...
	case 4:
		uriString := func() string {
			...
			out.WriteString("https://kafka-api.")
	...
	case 5:
		uriString := func() string {
			var out strings.Builder
			out.WriteString("https://kafka-api-fips.")
			out.WriteString(*params.Region)
			out.WriteString(".")
			out.WriteString(c.PartitionResult.DualStackDnsSuffix)
			return out.String()
