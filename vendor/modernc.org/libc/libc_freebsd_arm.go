...
// Xmmap — see libc_freebsd.go. freebsd/arm: the 64-bit off_t spans two argument
// words and needs a PAD word before it for EABI 8-byte alignment (matches
// golang.org/x/sys/unix's freebsd/arm mmap).
