...
func newQueryClient(app *kingpin.Application) client.Client {
	...
	app.Flag("retry-timeout", "How long need to wait between retries. Can also be set using LOKI_CLIENT_RETRY_TIMEOUT env var.").Default("0").Envar("LOKI_CLIENT_RETRY_TIMEOUT").IntVar(&client.RetryTimeout)
