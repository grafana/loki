...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LokiStackNetworkPolicyStatus) DeepCopyInto(out *LokiStackNetworkPolicyStatus) {
	*out = *in
	if in.ObjectStorageAllowedEgressPorts != nil {
		in, out := &in.ObjectStorageAllowedEgressPorts, &out.ObjectStorageAllowedEgressPorts
		*out = make([]int32, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LokiStackNetworkPolicyStatus.
func (in *LokiStackNetworkPolicyStatus) DeepCopy() *LokiStackNetworkPolicyStatus {
	if in == nil {
		return nil
	}
	out := new(LokiStackNetworkPolicyStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *LokiStackStatus) DeepCopyInto(out *LokiStackStatus) {
	*out = *in
	...
	in.Storage.DeepCopyInto(&out.Storage)
	in.NetworkPolicyStatus.DeepCopyInto(&out.NetworkPolicyStatus)
	if in.Conditions != nil {
		in, out := &in.Conditions, &out.Conditions
		*out = make([]metav1.Condition, len(*in))
		for i := range *in {
