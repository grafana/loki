...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ObjectStorageSchemaMap) DeepCopyInto(out *ObjectStorageSchemaMap) {
	{
		in := &in
		*out = make(ObjectStorageSchemaMap, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ObjectStorageSchemaMap.
func (in ObjectStorageSchemaMap) DeepCopy() ObjectStorageSchemaMap {
	if in == nil {
		return nil
	}
	out := new(ObjectStorageSchemaMap)
	in.DeepCopyInto(out)
	return *out
}
