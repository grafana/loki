...
func (in *LokiStackStorageStatus) DeepCopyInto(out *LokiStackStorageStatus) {
	*out = *in
	if in.Schemas != nil {
		...
		*out = make([]StorageSchemaStatus, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ObjectStorageSchemaSpec) DeepCopyInto(out *ObjectStorageSchemaSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ObjectStorageSchemaSpec.
func (in *ObjectStorageSchemaSpec) DeepCopy() *ObjectStorageSchemaSpec {
	if in == nil {
		return nil
	}
	out := new(ObjectStorageSchemaSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ObjectStorageSpec) DeepCopyInto(out *ObjectStorageSpec) {
	*out = *in
	if in.Schemas != nil {
		in, out := &in.Schemas, &out.Schemas
		*out = make([]ObjectStorageSchemaSpec, len(*in))
		copy(*out, *in)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StorageSchemaStatus) DeepCopyInto(out *StorageSchemaStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StorageSchemaStatus.
func (in *StorageSchemaStatus) DeepCopy() *StorageSchemaStatus {
	if in == nil {
		return nil
	}
	out := new(StorageSchemaStatus)
	in.DeepCopyInto(out)
	return out
}
