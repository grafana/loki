...
require (
	...
	github.com/openshift/api v0.0.0-20241001152557-e415140e5d5f // release-4.15
	github.com/openshift/cloud-credential-operator v0.0.0-20240228211631-9adc8f69a48c // release-4.15
	github.com/openshift/library-go v0.0.0-20241001171606-756adf2188fc // release-4.15
