...
require (
	...
	github.com/openshift/api v0.0.0-20240527133614-ba11c1587003 // release-4.15
	github.com/openshift/cloud-credential-operator v0.0.0-20240228211631-9adc8f69a48c // release-4.15
	github.com/openshift/library-go v0.0.0-20240731134552-8211143dfde7 // release-4.15
