...
require (
	...
	github.com/openshift/api v0.0.0-20260824101849-98e1b9eebf85 // release-5.0
	github.com/openshift/cloud-credential-operator v0.0.0-20260812220200-b187feee66f4 // release-4.21
