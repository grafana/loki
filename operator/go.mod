...
require (
	...
	github.com/openshift/api v0.0.0-20240918231400-8f6ded478e8a // release-4.17
	github.com/openshift/cloud-credential-operator v0.0.0-20241022212603-a46630073d20 // release-4.17
