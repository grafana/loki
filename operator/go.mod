...
require (
	...
	github.com/openshift/api v0.0.0-20240924220842-3c700b6cb32b // release-4.15
	github.com/openshift/cloud-credential-operator v0.0.0-20240228211631-9adc8f69a48c // release-4.15
	github.com/openshift/library-go v0.0.0-20240930172803-190f286b06b1 // release-4.15
