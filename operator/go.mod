...
require (
	...
	github.com/grafana/loki/operator/api/loki v0.0.0-20260827121917-dd170be07101
	github.com/grafana/loki/v3 v3.7.6
	github.com/maxbrunsfeld/counterfeiter/v6 v6.12.2
	github.com/openshift/api v0.0.0-20260827103138-252412308277 // release-5.0
	github.com/openshift/cloud-credential-operator v0.0.0-20260812220200-b187feee66f4 // release-5.0
	github.com/openshift/library-go v0.0.0-20260814122159-7b930c0d20a6 // release-5.0
...
require (
	...
	github.com/grafana/loki/pkg/push v0.0.0-20260827121917-dd170be07101 // indirect
...
// Pin etcd to 3.6.x. k8s.io/apiserver v0.37 selects etcd 3.7, which is incompatible
// with grafana/dskit (pulled in via github.com/grafana/loki/v3): dskit's etcd mock
// still uses Cmp.Target/TargetUnion/Result APIs removed in etcd 3.7.
replace (
	go.etcd.io/etcd/api/v3 => go.etcd.io/etcd/api/v3 v3.6.14
	go.etcd.io/etcd/client/pkg/v3 => go.etcd.io/etcd/client/pkg/v3 v3.6.14
	go.etcd.io/etcd/client/v3 => go.etcd.io/etcd/client/v3 v3.6.14
)
