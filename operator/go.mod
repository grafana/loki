...
require (
	...
	github.com/openshift/api v0.0.0-20240918231400-8f6ded478e8a // release-4.15
	github.com/openshift/cloud-credential-operator v0.0.0-20241002171521-e13308408b4d // release-4.15
