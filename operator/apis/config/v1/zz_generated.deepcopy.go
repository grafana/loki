...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ControllerProfiler) DeepCopyInto(out *ControllerProfiler) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ControllerProfiler.
func (in *ControllerProfiler) DeepCopy() *ControllerProfiler {
	if in == nil {
		return nil
	}
	out := new(ControllerProfiler)
	in.DeepCopyInto(out)
	return out
}
