...
func (in *GlobalOTLPSpec) DeepCopyInto(out *GlobalOTLPSpec) {
	*out = *in
	if in.GlobalResourceAttributesAsLabels != nil {
		in, out := &in.GlobalResourceAttributesAsLabels, &out.GlobalResourceAttributesAsLabels
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
...
func (in *OTLPSpec) DeepCopyInto(out *OTLPSpec) {
	*out = *in
	in.RessourceAttributes.DeepCopyInto(&out.RessourceAttributes)
