...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TenantOTLPSpec) DeepCopyInto(out *TenantOTLPSpec) {
	*out = *in
	in.OTLPSpec.DeepCopyInto(&out.OTLPSpec)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TenantOTLPSpec.
func (in *TenantOTLPSpec) DeepCopy() *TenantOTLPSpec {
	if in == nil {
		return nil
	}
	out := new(TenantOTLPSpec)
