...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenshiftLoggingSpec) DeepCopyInto(out *OpenshiftLoggingSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenshiftLoggingSpec.
func (in *OpenshiftLoggingSpec) DeepCopy() *OpenshiftLoggingSpec {
	if in == nil {
		return nil
	}
	out := new(OpenshiftLoggingSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *TenantsSpec) DeepCopyInto(out *TenantsSpec) {
	*out = *in
	...
	if in.OpenshiftLogging != nil {
		in, out := &in.OpenshiftLogging, &out.OpenshiftLogging
		*out = new(OpenshiftLoggingSpec)
		(*in).DeepCopyInto(*out)
	}
}
