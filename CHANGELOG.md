...
## [3.6.10](https://github.com/grafana/loki/compare/v3.6.9...v3.6.10) (2026-04-02)


### ⚠ BREAKING CHANGES

* **operator:** consolidate image build workflows and improve documentation ([#19395](https://github.com/grafana/loki/issues/19395))
* move the Loki UI to a Grafana Plugin ([#19390](https://github.com/grafana/loki/issues/19390))
* **operator:** CI publishing image strategy  ([#19365](https://github.com/grafana/loki/issues/19365))

### Features

* add json parsing stage to v2 engine ([#19240](https://github.com/grafana/loki/issues/19240)) ([aec34ed](https://github.com/grafana/loki/commit/aec34ed30ae72e4cbaff064e65b4a550c932c226))
* add logfmt parse support to the v2 query engine ([#18931](https://github.com/grafana/loki/issues/18931)) ([ccb4549](https://github.com/grafana/loki/commit/ccb4549dddc18ca6255b215fdc67e122077be265))
...
* add p50, p95 and p99 section sizes per tenant ([#19054](https://github.com/grafana/loki/issues/19054)) ([cb3b74a](https://github.com/grafana/loki/commit/cb3b74a45d1d6704162d042f421d701ece502abc))
* add p50, p95 and p99 sections per tenant to stats ([#19044](https://github.com/grafana/loki/issues/19044)) ([d256df4](https://github.com/grafana/loki/commit/d256df481efa2b2a25c058b059f78a20de37abe4))
...
* build multi-tenant data objects ([#19034](https://github.com/grafana/loki/issues/19034)) ([f60f818](https://github.com/grafana/loki/commit/f60f818bdd5f1259a7940e302e8f29a6ad6980c8))
* capture logs drilldown flag in query samples ([#19242](https://github.com/grafana/loki/issues/19242)) ([cb3f2ad](https://github.com/grafana/loki/commit/cb3f2ad5b6e1cd2941f7d55f5ebfddbe1713b5ec))
* Change how analytics proxy works ([#19098](https://github.com/grafana/loki/issues/19098)) ([82d25df](https://github.com/grafana/loki/commit/82d25dfd5a3202f1538d9084a34561bd277ebeaf))
* **compactor-hs:** add a metric to track the number of jobs left to conclude ongoing unit of work ([#19506](https://github.com/grafana/loki/issues/19506)) ([9e0f50c](https://github.com/grafana/loki/commit/9e0f50c3629211ea087c365c5acc833b6ab4e2cf))
* Default ingestion policy mappings merged with per-tenant mappings ([#18926](https://github.com/grafana/loki/issues/18926)) ([3b2498b](https://github.com/grafana/loki/commit/3b2498b89645d09091f3be07380caa864c40e2c0))
* **deletion:** return request ID in response header ([#19444](https://github.com/grafana/loki/issues/19444)) ([6e6e8a9](https://github.com/grafana/loki/commit/6e6e8a97d970bf2fdc4b7ce6d8963c2cc84ac495))
* drilldown config endpoint ([#19028](https://github.com/grafana/loki/issues/19028)) ([52b5d95](https://github.com/grafana/loki/commit/52b5d95ed13748139b0c559cf4aa657176839680))
* **engine:** More aggregations for the new query engine ([#19350](https://github.com/grafana/loki/issues/19350)) ([1474ede](https://github.com/grafana/loki/commit/1474ede675f78c2f57139520c3b9a4bcb0da6071))
* **engine:** Prefetch inputs of Merge pipeline concurrently ([#19039](https://github.com/grafana/loki/issues/19039)) ([f50c87f](https://github.com/grafana/loki/commit/f50c87fce298da7e2aa0412a6c37761bbc33925a))
* **fluentd:** Add 'compress gzip' setting to fluentd plugin ([#18995](https://github.com/grafana/loki/issues/18995)) ([1cda925](https://github.com/grafana/loki/commit/1cda92572a66d726b1b75a1649b4627dc654d86a))
* **goldfish:** improve query performance with indexes and paritions ([#19023](https://github.com/grafana/loki/issues/19023)) ([89509de](https://github.com/grafana/loki/commit/89509dee9a429390682aa22d59c59eca58c3a2cf))
* **helm:** Add `startupProbe` to memcached ([#19166](https://github.com/grafana/loki/issues/19166)) ([f799e9b](https://github.com/grafana/loki/commit/f799e9b4c63d15cc428e72c58801056b77d8a382))
* **helm:** Add `startupProbe` to memcached exporter ([#19165](https://github.com/grafana/loki/issues/19165)) ([901e574](https://github.com/grafana/loki/commit/901e574b605525ae569bcaccbdc6201f67407478))
* **helm:** add configurable livenessProbe to single binary StatefulSet ([#19072](https://github.com/grafana/loki/issues/19072)) ([18b8995](https://github.com/grafana/loki/commit/18b8995a3239dce86258ad54964ef58550cfa131))
* **helm:** add dnsconfig to all missing resources ([#18903](https://github.com/grafana/loki/issues/18903)) ([ed68531](https://github.com/grafana/loki/commit/ed68531da58b92dd188c1ce3f237ebc23b011e7f))
* **helm:** Add health probes to gateway component ([#18545](https://github.com/grafana/loki/issues/18545)) ([82aa322](https://github.com/grafana/loki/commit/82aa322db55b1e4806a20a149babbcec17d705e9))
* **helm:** Add health probes to loki in backend ([#18548](https://github.com/grafana/loki/issues/18548)) ([10441c8](https://github.com/grafana/loki/commit/10441c899f658592296b8acfb6f8a74f95a4edf3))
* **helm:** add more specificity to affinity and topology spread constraints ([#17404](https://github.com/grafana/loki/issues/17404)) ([#19061](https://github.com/grafana/loki/issues/19061)) ([0819e48](https://github.com/grafana/loki/commit/0819e48b6be59341160ed691343dbc681ab009ec))
* **helm:** add namespaceOverride ([#18707](https://github.com/grafana/loki/issues/18707)) ([5ca4dca](https://github.com/grafana/loki/commit/5ca4dca1fd0cbb4361bf4400288f18dd29e8c528))
* **helm:** add replicas to loki-canary deployment ([#19095](https://github.com/grafana/loki/issues/19095)) ([c9d7d76](https://github.com/grafana/loki/commit/c9d7d76e449b88630f2af9f8585860d7bb66598d))
* **helm:** add support for custom alert rule annotations ([#19193](https://github.com/grafana/loki/issues/19193)) ([2df5197](https://github.com/grafana/loki/commit/2df5197bfbbee71c424776b28f829d71696325c9))
* **helm:** allow configuring service types ([#18708](https://github.com/grafana/loki/issues/18708)) ([2e52f8f](https://github.com/grafana/loki/commit/2e52f8fea18a239b210e16c77f3439f13af6fb56))
* **helm:** Allow enabling user namespaces ([#18661](https://github.com/grafana/loki/issues/18661)) ([d0b39e5](https://github.com/grafana/loki/commit/d0b39e5c201a4c553567e7e62eeaa6929853c943))
* **helm:** allow extraObjects as dict ([#13252](https://github.com/grafana/loki/issues/13252)) ([6a953bb](https://github.com/grafana/loki/commit/6a953bb4924308302b4171cf0586fed2574c19bd))
* **helm:** Make access modes for persistence on all PVCs and StatefulSets editable ([#13474](https://github.com/grafana/loki/issues/13474)) ([0b449ab](https://github.com/grafana/loki/commit/0b449ab3232c8948af3fcb62b615babb85491fda))
* **helm:** Only delete PVC on statefulset deletion, not scaling ([#19097](https://github.com/grafana/loki/issues/19097)) ([0cead58](https://github.com/grafana/loki/commit/0cead58025032591e332b720fd9d642242cc4de6))
* **helm:** use named ports for memcached services targetports ([#18990](https://github.com/grafana/loki/issues/18990)) ([6a5be7e](https://github.com/grafana/loki/commit/6a5be7ea7fe52acc3a6201aa0757ed71d68136e1))
* implement `unwrap` as a projection ([#19409](https://github.com/grafana/loki/issues/19409)) ([3ce6fa2](https://github.com/grafana/loki/commit/3ce6fa29467953e4da44f71d84599f6735e94675))
* implement volume-based pattern filtering ([#18838](https://github.com/grafana/loki/issues/18838)) ([71e2e01](https://github.com/grafana/loki/commit/71e2e01ee233428ee717a7ea1cc8495199b56c3d))
* **logcli:** add --log.level parameter ([#19136](https://github.com/grafana/loki/issues/19136)) ([77c18d9](https://github.com/grafana/loki/commit/77c18d9670c7ee85a1137d89f2d2e27d782ca2db))
* **loki-mixin:** allow disabling thanos dashboard and fix dashboard's file name ([#18749](https://github.com/grafana/loki/issues/18749)) ([cadc824](https://github.com/grafana/loki/commit/cadc8240153597608b59821047345064981d1019))
* move the Loki UI to a Grafana Plugin ([#19390](https://github.com/grafana/loki/issues/19390)) ([3a1e5ad](https://github.com/grafana/loki/commit/3a1e5ad5f1d506cb2c42a4873884b0a4db9b0094))
...
* per policy overridable stream limits ([#18994](https://github.com/grafana/loki/issues/18994)) ([af257fd](https://github.com/grafana/loki/commit/af257fd058a17b355b48bfe4d6423ce4feba0397))
* prepare Loki 3.6 ([ab8e800](https://github.com/grafana/loki/commit/ab8e8007d9cb42bd8552139569a8e055a73b80b6))
* print the tenant in the dump and stats sub-commands ([#19033](https://github.com/grafana/loki/issues/19033)) ([1475762](https://github.com/grafana/loki/commit/147576299452b06a9e464c395b228854e14552a6))
* **querytee:** Add workflow_dispatch for querytee-images workflow ([#19541](https://github.com/grafana/loki/issues/19541)) ([4216f68](https://github.com/grafana/loki/commit/4216f68447339b05769946e1a9da0ba4889e27d2))
* remove tenant topic tee ([#19082](https://github.com/grafana/loki/issues/19082)) ([a03e86c](https://github.com/grafana/loki/commit/a03e86c858e648922f1ff0e8984d57a98b8e6ec8))
* **single-binary:** delete statefulset if volumeClaimTemplates changes ([#19217](https://github.com/grafana/loki/issues/19217)) ([da4240d](https://github.com/grafana/loki/commit/da4240d1b2e8e5a81c38a5b984f416c012744159))
...
* add single-binary component to ingress NetworkPolicy ([#19229](https://github.com/grafana/loki/issues/19229)) ([1a7b489](https://github.com/grafana/loki/commit/1a7b4891156c7643cd1886e052c7c3769d030687))
* Add special case handling for comparing empty and nil values ([#19348](https://github.com/grafana/loki/issues/19348)) ([af6983e](https://github.com/grafana/loki/commit/af6983e9de19682da197d33f3459ab736fdf307b))
...
* apply global otlp config to tenant config only when it is updated in the overrides ([#19213](https://github.com/grafana/loki/issues/19213)) ([8057c5c](https://github.com/grafana/loki/commit/8057c5c424fdc3c2c3b3bcd7475705db7807dea5))
* backoff cannot be canceled via ctx ([#19041](https://github.com/grafana/loki/issues/19041)) ([3bab0ff](https://github.com/grafana/loki/commit/3bab0ff5fea686e96980555b066e8619a34318bc))
...
* **build:** remove busybox from dockerfile ([#19502](https://github.com/grafana/loki/issues/19502)) ([f2ba692](https://github.com/grafana/loki/commit/f2ba692f7659b684fb39cf0a89c66678e33ec9bd))
* **build:** rpm signature config ([#19476](https://github.com/grafana/loki/issues/19476)) ([352c046](https://github.com/grafana/loki/commit/352c046094ace0956808747e589b5961883d2bbe))
* bump go toolchain to 1.24.6 ([#19449](https://github.com/grafana/loki/issues/19449)) ([becdf9b](https://github.com/grafana/loki/commit/becdf9bcd04d45f50c9fcc06e0aff19457287ff4))
...
* correctly register allowed log level fields ([d8c4997](https://github.com/grafana/loki/commit/d8c49971205c9a5f65c86a8518cd1785ce8f54af))
* deadlock when shutting down dataobj-consumers ([#18932](https://github.com/grafana/loki/issues/18932)) ([d8b22bf](https://github.com/grafana/loki/commit/d8b22bfef8107ca983c0e6a2ed38173a2f00434b))
...
* **deps:** patch mapstructure dependency to remove CVE ([#19447](https://github.com/grafana/loki/issues/19447)) ([e34530e](https://github.com/grafana/loki/commit/e34530eefd898c7fc29ae3b286383e1d062f16ec))
...
* **deps:** update dependency @hookform/resolvers to v5.2.2 (main) ([#19276](https://github.com/grafana/loki/issues/19276)) ([2c02eaf](https://github.com/grafana/loki/commit/2c02eaf07b741ddb097be429c153a64c140cce4e))
* **deps:** update dependency @tanstack/react-query to v5.85.5 (main) ([#18962](https://github.com/grafana/loki/issues/18962)) ([0465150](https://github.com/grafana/loki/commit/04651509aa50959bc7e4cde7d363bb1414369302))
* **deps:** update dependency @tanstack/react-query-devtools to v5.85.5 (main) ([#18963](https://github.com/grafana/loki/issues/18963)) ([f42d584](https://github.com/grafana/loki/commit/f42d5849a82845aff809a71ba5f5b8c1a3d0897e))
* **deps:** update dependency lucide-react to ^0.541.0 (main) ([#18983](https://github.com/grafana/loki/issues/18983)) ([da3d3c0](https://github.com/grafana/loki/commit/da3d3c0cfa504bd5bd7163aefdf2446ee3703aeb))
* **deps:** update dependency lucide-react to ^0.542.0 (main) ([#19017](https://github.com/grafana/loki/issues/19017)) ([1583ce4](https://github.com/grafana/loki/commit/1583ce4061241ef8db4275b1adea22da663b90bc))
* **deps:** update dependency lucide-react to ^0.544.0 (main) ([#19310](https://github.com/grafana/loki/issues/19310)) ([f744d38](https://github.com/grafana/loki/commit/f744d3848c1983898b74d737c51544c52380329f))
* **deps:** update dependency react-datepicker to v8.7.0 (main) ([#18984](https://github.com/grafana/loki/issues/18984)) ([cebc392](https://github.com/grafana/loki/commit/cebc39236965d0c41b90bfa52487284da31f80c5))
* **deps:** update dependency react-router-dom to v7.8.1 (main) ([#18964](https://github.com/grafana/loki/issues/18964)) ([6b7f284](https://github.com/grafana/loki/commit/6b7f284304abdc373c0c388928c308a01e80112e))
* **deps:** update dependency react-router-dom to v7.8.2 (main) ([#18971](https://github.com/grafana/loki/issues/18971)) ([d090601](https://github.com/grafana/loki/commit/d0906012b1f04cf1134271d7a2443b08193e9ddb))
* **deps:** update dependency zod to v4 (main) ([#18392](https://github.com/grafana/loki/issues/18392)) ([6f45a17](https://github.com/grafana/loki/commit/6f45a17b683e10ec1360c8f8ca19315b6dfac9ab))
* **deps:** update module cloud.google.com/go/bigtable to v1.40.0 (main) ([#19311](https://github.com/grafana/loki/issues/19311)) ([93e2a33](https://github.com/grafana/loki/commit/93e2a33b1f9451157eb60243e21c925249f0d693))
* **deps:** update module cloud.google.com/go/bigtable to v1.40.1 (main) ([#19337](https://github.com/grafana/loki/issues/19337)) ([e27e476](https://github.com/grafana/loki/commit/e27e476cf0a63bc879e7242507b6196205eb058c))
* **deps:** update module cloud.google.com/go/storage to v1.56.1 (main) ([#18965](https://github.com/grafana/loki/issues/18965)) ([ed2d732](https://github.com/grafana/loki/commit/ed2d732871c019e0ed42267acbef06188b61db42))
* **deps:** update module cloud.google.com/go/storage to v1.57.0 (main) ([#19312](https://github.com/grafana/loki/issues/19312)) ([819c9c1](https://github.com/grafana/loki/commit/819c9c147658680b2d92ef1a020523b5f8935bb5))
* **deps:** update module github.com/aws/aws-sdk-go-v2/credentials to v1.18.15 (main) ([#19338](https://github.com/grafana/loki/issues/19338)) ([8b8d7de](https://github.com/grafana/loki/commit/8b8d7def78049d8cb2021da05ebdbd07acc3183a))
* **deps:** update module github.com/aws/aws-sdk-go-v2/credentials to v1.18.16 (main) ([#19352](https://github.com/grafana/loki/issues/19352)) ([9d44db8](https://github.com/grafana/loki/commit/9d44db8d6c990d7e11fdf1a17b6fc79b84f904a1))
* **deps:** update module github.com/aws/aws-sdk-go-v2/service/dynamodb to v1.50.5 (main) ([#19340](https://github.com/grafana/loki/issues/19340)) ([afce820](https://github.com/grafana/loki/commit/afce82071693bb3a90612209decc7afd85227b03))
* **deps:** update module github.com/aws/aws-sdk-go-v2/service/dynamodb to v1.51.0 (main) ([#19388](https://github.com/grafana/loki/issues/19388)) ([ba5f308](https://github.com/grafana/loki/commit/ba5f308b672aefa7003b18d5a56dac696d5f9908))
* **deps:** update module github.com/baidubce/bce-sdk-go to v0.9.241 (main) ([#18972](https://github.com/grafana/loki/issues/18972)) ([e64154c](https://github.com/grafana/loki/commit/e64154ca9e664a805289895ef39a37c3127423bd))
* **deps:** update module github.com/baidubce/bce-sdk-go to v0.9.245 (main) ([#19278](https://github.com/grafana/loki/issues/19278)) ([295d660](https://github.com/grafana/loki/commit/295d6604f519fcb90ded0d83e537a355b4cdf8c2))
...
* **deps:** update module github.com/charmbracelet/bubbletea to v1.3.10 (main) ([#19279](https://github.com/grafana/loki/issues/19279)) ([789da59](https://github.com/grafana/loki/commit/789da595ca42bd2ce7727a07ae60d5705174805d))
* **deps:** update module github.com/docker/docker to v28.4.0+incompatible (main) ([#19314](https://github.com/grafana/loki/issues/19314)) ([7407527](https://github.com/grafana/loki/commit/7407527408064ec4425fb3478838f6fcefd6ad9e))
* **deps:** update module github.com/docker/docker to v28.5.0+incompatible (main) ([#19414](https://github.com/grafana/loki/issues/19414)) ([cfd7b12](https://github.com/grafana/loki/commit/cfd7b129a0741584741119f1a3528fb7edde70fc))
* **deps:** update module github.com/fsouza/fake-gcs-server to v1.52.3 (main) ([#18999](https://github.com/grafana/loki/issues/18999)) ([2f02275](https://github.com/grafana/loki/commit/2f022754af6283036cafce4f9f5de80d835cc4f3))
* **deps:** update module github.com/go-logfmt/logfmt to v0.6.1 (main) ([#19412](https://github.com/grafana/loki/issues/19412)) ([7f3d419](https://github.com/grafana/loki/commit/7f3d41930ae7e475256e43f85587b6e57dec2bed))
* **deps:** update module github.com/grafana/loki/v3 to v3.5.5 (main) ([#18444](https://github.com/grafana/loki/issues/18444)) ([d54b6d8](https://github.com/grafana/loki/commit/d54b6d8647ae8fecfad7b1f76b33b64e65f85988))
* **deps:** update module github.com/ibm/ibm-cos-sdk-go to v1.12.3 (main) ([#19281](https://github.com/grafana/loki/issues/19281)) ([3308ba5](https://github.com/grafana/loki/commit/3308ba57e8e01c96af62e0cfe344720d135e5ce5))
* **deps:** update module github.com/ibm/sarama to v1.46.0 (main) ([#19002](https://github.com/grafana/loki/issues/19002)) ([b106390](https://github.com/grafana/loki/commit/b10639054a46740e9a4b801b684377b074c9932d))
* **deps:** update module github.com/ibm/sarama to v1.46.1 (main) ([#19282](https://github.com/grafana/loki/issues/19282)) ([7335181](https://github.com/grafana/loki/commit/73351817016225402955e5465aa5dd6fbb599afc))
* **deps:** update module github.com/oschwald/geoip2-golang to v1.13.0 (main) ([#18354](https://github.com/grafana/loki/issues/18354)) ([7508db8](https://github.com/grafana/loki/commit/7508db8b43db00c02e697be1a0c54403c03ac830))
* **deps:** update module github.com/pressly/goose/v3 to v3.25.0 (main) ([#19004](https://github.com/grafana/loki/issues/19004)) ([f078dc8](https://github.com/grafana/loki/commit/f078dc84369150e21f3e9e36cfc20f4879de3560))
* **deps:** update module github.com/pressly/goose/v3 to v3.26.0 (main) ([#19417](https://github.com/grafana/loki/issues/19417)) ([b2a5c08](https://github.com/grafana/loki/commit/b2a5c08d7079dcf7e569c0e5434b679c31fa635f))
* **deps:** update module github.com/redis/go-redis/v9 to v9.12.1 (main) ([#18218](https://github.com/grafana/loki/issues/18218)) ([cc16946](https://github.com/grafana/loki/commit/cc1694665b7f68a1e1f171042844b462d6d2e5a4))
* **deps:** update module github.com/shirou/gopsutil/v4 to v4.25.8 (main) ([#19284](https://github.com/grafana/loki/issues/19284)) ([a31a86c](https://github.com/grafana/loki/commit/a31a86c4dc951e765fed50f1a4163dff7a133532))
* **deps:** update module github.com/shirou/gopsutil/v4 to v4.25.9 (main) ([#19366](https://github.com/grafana/loki/issues/19366)) ([9f1c1a5](https://github.com/grafana/loki/commit/9f1c1a54b059c88c0d94e04eb6e14fbb5ef052aa))
* **deps:** update module github.com/sony/gobreaker/v2 to v2.2.0 (main) ([#18987](https://github.com/grafana/loki/issues/18987)) ([bed8a22](https://github.com/grafana/loki/commit/bed8a22cf8b1e8aba2b056f41850829eefbe8414))
* **deps:** update module github.com/sony/gobreaker/v2 to v2.2.1 (main) ([#19285](https://github.com/grafana/loki/issues/19285)) ([1112aef](https://github.com/grafana/loki/commit/1112aef808780262cfc80eb3d87f5483045fd531))
* **deps:** update module github.com/sony/gobreaker/v2 to v2.3.0 (main) ([#19418](https://github.com/grafana/loki/issues/19418)) ([f84a673](https://github.com/grafana/loki/commit/f84a673d9146c386f89080e29bc94aa1c7d99af1))
* **deps:** update module github.com/spf13/afero to v1.15.0 (main) ([#19317](https://github.com/grafana/loki/issues/19317)) ([8854ac1](https://github.com/grafana/loki/commit/8854ac1e3035561a8622fa7b1363c5d19d0ac400))
* **deps:** update module github.com/stretchr/testify to v1.11.0 (main) ([#18993](https://github.com/grafana/loki/issues/18993)) ([5d8948e](https://github.com/grafana/loki/commit/5d8948e1a645e010958e0dad1daf1f79571e7d12))
* **deps:** update module github.com/stretchr/testify to v1.11.1 (main) ([#19042](https://github.com/grafana/loki/issues/19042)) ([014ec14](https://github.com/grafana/loki/commit/014ec14fc2661a9b8d96213286cc002ea3691575))
* **deps:** update module github.com/twmb/franz-go to v1.19.5 (main) ([#18039](https://github.com/grafana/loki/issues/18039)) ([91a236a](https://github.com/grafana/loki/commit/91a236a2f528f71a696acd56ee880411beeae547))
* **deps:** update module github.com/twmb/franz-go/pkg/kadm to v1.16.1 (main) ([#18733](https://github.com/grafana/loki/issues/18733)) ([4cf65d5](https://github.com/grafana/loki/commit/4cf65d5491d1d61bab5821f425bda24f438f6219))
* **deps:** update module github.com/workiva/go-datastructures to v1.1.6 (main) ([#19287](https://github.com/grafana/loki/issues/19287)) ([1704434](https://github.com/grafana/loki/commit/1704434e2c5175e30f2414c89c31213a064575c4))
* **deps:** update module go.etcd.io/bbolt to v1.4.3 (main) ([#18973](https://github.com/grafana/loki/issues/18973)) ([362239c](https://github.com/grafana/loki/commit/362239c9adf6448a9f124a74eaeab3b5a3a4f729))
* **deps:** update module go.opentelemetry.io/collector/pdata to v1.39.0 (main) ([#19010](https://github.com/grafana/loki/issues/19010)) ([b33b2d6](https://github.com/grafana/loki/commit/b33b2d6af5fb954e86af4a0c00c533b2b7c7ce22))
* **deps:** update module go.opentelemetry.io/collector/pdata to v1.42.0 (main) ([#19323](https://github.com/grafana/loki/issues/19323)) ([568cdf1](https://github.com/grafana/loki/commit/568cdf1272e54b85ea946e6cb7df2c949d8c3650))
* **deps:** update module go.opentelemetry.io/collector/pdata to v1.43.0 (main) ([#19419](https://github.com/grafana/loki/issues/19419)) ([3e415ac](https://github.com/grafana/loki/commit/3e415aca3d904fa6fa3cbedfdc7a2bdfd7fb6d41))
* **deps:** update module go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc to v0.63.0 (main) ([#18455](https://github.com/grafana/loki/issues/18455)) ([5605b2d](https://github.com/grafana/loki/commit/5605b2d49bbf2da287939784429d786b5e9284c8))
* **deps:** update module go.opentelemetry.io/contrib/instrumentation/net/http/httptrace/otelhttptrace to v0.63.0 (main) ([#19324](https://github.com/grafana/loki/issues/19324)) ([6270613](https://github.com/grafana/loki/commit/627061348a3286280bd54b28154bc4c638eca084))
* **deps:** update module go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp to v0.63.0 (main) ([#19327](https://github.com/grafana/loki/issues/19327)) ([8519187](https://github.com/grafana/loki/commit/85191873f255b98f5ebc877962332d3e5904eaec))
...
* **deps:** update module golang.org/x/net to v0.45.0 (main) ([#19420](https://github.com/grafana/loki/issues/19420)) ([1e8c50c](https://github.com/grafana/loki/commit/1e8c50ca62fde21d20f62cc41a7d5a262b77b9a7))
* **deps:** update module golang.org/x/oauth2 to v0.31.0 (main) ([#19329](https://github.com/grafana/loki/issues/19329)) ([eaac4ae](https://github.com/grafana/loki/commit/eaac4aed0117168632321ea9e8df74e15109a5ef))
* **deps:** update module golang.org/x/time to v0.13.0 (main) ([#19330](https://github.com/grafana/loki/issues/19330)) ([de928b1](https://github.com/grafana/loki/commit/de928b19dd44c8c6e472c99c1432b5dac86fc415))
* **deps:** update module google.golang.org/api to v0.248.0 (main) ([#18988](https://github.com/grafana/loki/issues/18988)) ([269b3f3](https://github.com/grafana/loki/commit/269b3f3fb58223d7cb757332dd646aa8ee45ebfe))
* **deps:** update module google.golang.org/api to v0.250.0 (main) ([#19331](https://github.com/grafana/loki/issues/19331)) ([a0489e3](https://github.com/grafana/loki/commit/a0489e3e21ee19e161a1df31063d97b6cb58e42f))
* **deps:** update module google.golang.org/api to v0.251.0 (main) ([#19368](https://github.com/grafana/loki/issues/19368)) ([e09cdf6](https://github.com/grafana/loki/commit/e09cdf6adfc78088c86c78a7b8e13dd7eb07bd9b))
* **deps:** update module google.golang.org/api to v0.252.0 (main) ([#19421](https://github.com/grafana/loki/issues/19421)) ([af3e999](https://github.com/grafana/loki/commit/af3e9994966d0ec9899191cdfe40d1eb93b8676a))
* **deps:** update module google.golang.org/grpc to v1.75.0 (main) ([#18989](https://github.com/grafana/loki/issues/18989)) ([332df2b](https://github.com/grafana/loki/commit/332df2b2000039dfc0903df454fef93b47de165d))
* **deps:** update module google.golang.org/grpc to v1.75.1 (main) ([#19288](https://github.com/grafana/loki/issues/19288)) ([4e2c090](https://github.com/grafana/loki/commit/4e2c090c9460bdd5791f07dd40409e6025fe6631))
...
* **deps:** update module google.golang.org/protobuf to v1.36.10 (main) ([#19376](https://github.com/grafana/loki/issues/19376)) ([c9f2666](https://github.com/grafana/loki/commit/c9f266694a100471b329d6fac6a8c5020279f1c1))
* **deps:** update module google.golang.org/protobuf to v1.36.9 (main) ([#19289](https://github.com/grafana/loki/issues/19289)) ([fd073bc](https://github.com/grafana/loki/commit/fd073bc6a1b0bb2f842a4091a1736d84e3f1c03d))
...
* don't need to open section to read tenant ([#19053](https://github.com/grafana/loki/issues/19053)) ([598cab7](https://github.com/grafana/loki/commit/598cab79e5f1f697fa8ce0731700bf91c2cd02fe))
* downgrade UI's @swc/core dep back to v1.13.5 ([#19345](https://github.com/grafana/loki/issues/19345)) ([134c5af](https://github.com/grafana/loki/commit/134c5af50efe63652cdfaaa2d1542e52fcccf521))
* extended detected level for debug and critical level ([#18370](https://github.com/grafana/loki/issues/18370)) ([2b01a31](https://github.com/grafana/loki/commit/2b01a310d83f96fbb5128bd0a0405470be7788f5))
* fix context canceled stops reader from cleaning up ([#19210](https://github.com/grafana/loki/issues/19210)) ([acb8b89](https://github.com/grafana/loki/commit/acb8b89a2fd6141bbef253bc216b62778c5bb964))
* fix possible data loss in dataobj-consumers ([#19060](https://github.com/grafana/loki/issues/19060)) ([44aba62](https://github.com/grafana/loki/commit/44aba6224376e5985f8ade5c0f1c4c5323db51b3))
* Fix push stats calculation ([#19319](https://github.com/grafana/loki/issues/19319)) ([a6d4935](https://github.com/grafana/loki/commit/a6d4935c8827721757dd0c953a615fa24c208662))
...
* **helm:** Add init container configuration for backend, bloom builder, distributor, query-frontend, query-scheduler, read, write. ([#18709](https://github.com/grafana/loki/issues/18709)) ([95ced86](https://github.com/grafana/loki/commit/95ced86f69c508d98b8e3e633234b82645a372ee))
* **helm:** admin-api should only be deployed in microservice mode ([#13655](https://github.com/grafana/loki/issues/13655)) ([51d710f](https://github.com/grafana/loki/commit/51d710f1560ee9de1decc7133e596d7774e0971e))
* **helm:** avoid double zonal ingester scrapping by not scrapping headless svc ([#19000](https://github.com/grafana/loki/issues/19000)) ([350d46c](https://github.com/grafana/loki/commit/350d46c34fd22777eb960fceb015185d910a060b))
* **helm:** Do not strip whitespace in target definitions for querier and read deployments ([#19464](https://github.com/grafana/loki/issues/19464)) ([7c309fb](https://github.com/grafana/loki/commit/7c309fb9122ab442abf1261d797ea9372c38a3e7))
* **helm:** explicitly set registry for k8s-sidecar image ([#19233](https://github.com/grafana/loki/issues/19233)) ([e0c07c4](https://github.com/grafana/loki/commit/e0c07c495281832f555f7dbe7e89205dc510fb7b))
* **helm:** Remove flaky enterprise test ([#19362](https://github.com/grafana/loki/issues/19362)) ([a1c9512](https://github.com/grafana/loki/commit/a1c951214c14e43c49c914c6c76b5e43a34f36a1))
* **helm:** Roll back change to Thanos ruler storage ([#18907](https://github.com/grafana/loki/issues/18907)) ([43dfc97](https://github.com/grafana/loki/commit/43dfc9740e8ea357758cbbd6accb6c8f8ea0c358))
* **helm:** un-deprecate several features in `monitoring` block ([#19012](https://github.com/grafana/loki/issues/19012)) ([3272ca7](https://github.com/grafana/loki/commit/3272ca71976984d74ab900462516a27000c308d1))
* **helm:** Update querier, read, and single binary target definitions for UI enablement ([#19461](https://github.com/grafana/loki/issues/19461)) ([087430e](https://github.com/grafana/loki/commit/087430e64de9c41e1a7815435ec2269c5f5428fd))
* **helm:** use gateway container port as nginx server port ([#18774](https://github.com/grafana/loki/issues/18774)) ([84f7b8d](https://github.com/grafana/loki/commit/84f7b8d8d03067e8fd65afdadf2152774f09e896))
* **helm:** Use strings in stead of integers for ports in CiliumNetworkPolicies ([#19252](https://github.com/grafana/loki/issues/19252)) ([3f41d14](https://github.com/grafana/loki/commit/3f41d1441d66d0665fe0fc7277507d2fdac0380e))
...
* **logger:** correct log level verbosity in rule evaluation ([#19519](https://github.com/grafana/loki/issues/19519)) ([37ad381](https://github.com/grafana/loki/commit/37ad3814b56d5b6056570aabf4ac528bb4de92a5))
* Metastore timerange filter ([#19171](https://github.com/grafana/loki/issues/19171)) ([dfb60dc](https://github.com/grafana/loki/commit/dfb60dcaf094dc5fc2c74be2b2e3827ed3de1db1))
* **networkpolicy:** use UDP/53 for DNS egress instead of named port ([#19073](https://github.com/grafana/loki/issues/19073)) ([4cbbc4f](https://github.com/grafana/loki/commit/4cbbc4f3bcba7905234804b025f197675d13d630))
* nil error returned when client closed ([#19068](https://github.com/grafana/loki/issues/19068)) ([5809c47](https://github.com/grafana/loki/commit/5809c4739bab34602924e6c463fcb6dc12cbcabf))
...
* panic in stats.go ([#19032](https://github.com/grafana/loki/issues/19032)) ([aebac6f](https://github.com/grafana/loki/commit/aebac6f49d23f0c083a3ed731edfd304f249dee2))
* panic while applying storage updates when a whole chunk is deleted by line filters ([#19262](https://github.com/grafana/loki/issues/19262)) ([cbcfbca](https://github.com/grafana/loki/commit/cbcfbca443b8c08e0a5a5e1eb425f4ae18e04d34))
* records discarded if one fetch returns error ([#19069](https://github.com/grafana/loki/issues/19069)) ([90ac000](https://github.com/grafana/loki/commit/90ac000ce652dc609229fac9d24cf9219149fe6b))
* remove UI from docker build ([#19425](https://github.com/grafana/loki/issues/19425)) ([48f5ade](https://github.com/grafana/loki/commit/48f5ade0e54a637a50d962eda66b87caa4a31e9a))
* silly mistake, this is why we have tests ([461fed7](https://github.com/grafana/loki/commit/461fed751ae5127998668cbf1f47fabffe74f654))
* Stop applying limits pushdown under a filter ([#19154](https://github.com/grafana/loki/issues/19154)) ([b7f14f9](https://github.com/grafana/loki/commit/b7f14f95543f982d0b12bc62fec824f3de5381e7))
* update ckit ([#18997](https://github.com/grafana/loki/issues/18997)) ([a00e159](https://github.com/grafana/loki/commit/a00e159c927b427e154f9e6436d2cb8f4eaefe8d))
* update kfake to fix tests and revert go-redis ([#18958](https://github.com/grafana/loki/issues/18958)) ([adda28c](https://github.com/grafana/loki/commit/adda28c7300d9f03de929ff9adc7e461df806894))
* update loki-helm-test image tag to latest commit ([#19227](https://github.com/grafana/loki/issues/19227)) ([6298e44](https://github.com/grafana/loki/commit/6298e44b01a03386b02f2a3aad06c18f04e76a24))
* use cooperative active sticky load balancer ([#19160](https://github.com/grafana/loki/issues/19160)) ([3535ae4](https://github.com/grafana/loki/commit/3535ae4ae12f239d2cb9c9a28616f598feaa2963))
* Use default config when building s3 client (backport k277) ([#19559](https://github.com/grafana/loki/issues/19559)) ([9d7a2f5](https://github.com/grafana/loki/commit/9d7a2f5e84bdba68679cb1c4107261cfce807b25))


### Performance Improvements

* **engine:** reuse existing array in genericFunction.Evaluate ([#19235](https://github.com/grafana/loki/issues/19235)) ([24e968c](https://github.com/grafana/loki/commit/24e968cfcb731f380319cb67f26edee887221472))
* Reduce allocations for JSON and logfmt parser ([#18637](https://github.com/grafana/loki/issues/18637)) ([adb27ff](https://github.com/grafana/loki/commit/adb27ff177c6e0561d2e5da562852b235cb00956))


### Code Refactoring

* **operator:** CI publishing image strategy  ([#19365](https://github.com/grafana/loki/issues/19365)) ([ee8c776](https://github.com/grafana/loki/commit/ee8c776a27b3cb5db5da679cbe09c2a9bd68f93d))
...
* add delete commands to logcli ([#18375](https://github.com/grafana/loki/issues/18375)) ([f38950a](https://github.com/grafana/loki/commit/f38950a02b4e26d7e694d107f8b41e121555a1b1))
* add ReasonFailed ([#18055](https://github.com/grafana/loki/issues/18055)) ([b15d85d](https://github.com/grafana/loki/commit/b15d85da9b1448490c6d17cbc71bb907761c4bc5))
* add traceId support to goldfish ([#18681](https://github.com/grafana/loki/issues/18681)) ([2f0dc74](https://github.com/grafana/loki/commit/2f0dc74309048193ce88ce054fafb95458fb203d))
* add traceId to Goldfish UI ([#18726](https://github.com/grafana/loki/issues/18726)) ([4fabb8d](https://github.com/grafana/loki/commit/4fabb8d632834e2e11911724ce7a86fdd9959b65))
...
* filter tenant limits endpoint by allowlist ([#18521](https://github.com/grafana/loki/issues/18521)) ([73de7b5](https://github.com/grafana/loki/commit/73de7b5378f7bc9f629933ba2c7cd20fbf9a0b3a))
* Goldfish UI ([#17983](https://github.com/grafana/loki/issues/17983)) ([462acb5](https://github.com/grafana/loki/commit/462acb52bbe11f47ee6c9e40401fc3fc4bd374df))
...
* **helm:** add FOLDER_ANNOTATATION logic for sidecar container in loki helm chart, making multi-tenant alerting easier ([#13289](https://github.com/grafana/loki/issues/13289)) ([833fcbc](https://github.com/grafana/loki/commit/833fcbce39fe956a7e006ea6618fbbd8d7ccfaa8))
...
* improve dataobj-inspect command ([#18618](https://github.com/grafana/loki/issues/18618)) ([238e0b7](https://github.com/grafana/loki/commit/238e0b781817f33540c36c71087f6eeefca50838))
* Initial index-builder implementation ([#18297](https://github.com/grafana/loki/issues/18297)) ([1f0edcd](https://github.com/grafana/loki/commit/1f0edcd4ac77907aebdb8732284062205357da8d))
* log ingestion policy when log_push_request is set ([#18712](https://github.com/grafana/loki/issues/18712)) ([0ec787f](https://github.com/grafana/loki/commit/0ec787f22a04620727ca4dc3fac762da2498c3e0))
* Mark truncated log lines with identifier ([#18262](https://github.com/grafana/loki/issues/18262)) ([0ee8e76](https://github.com/grafana/loki/commit/0ee8e76ba28065e2eb03c6908146522700ed6aa7))
* return metric query partial results for drilldown ([#18286](https://github.com/grafana/loki/issues/18286)) ([c0c2265](https://github.com/grafana/loki/commit/c0c22652838af2080345cdef5d5967a5cbdb1bd5))
* return ReasonFailed from ingest-limits frontend ([#18123](https://github.com/grafana/loki/issues/18123)) ([c42ccc3](https://github.com/grafana/loki/commit/c42ccc3248f5fc0ffdc7355fbceed4f1db68c75d))
...
* **deps:** update module golang.org/x/crypto to v0.41.0 (main) ([#18767](https://github.com/grafana/loki/issues/18767)) ([c395888](https://github.com/grafana/loki/commit/c395888a5f9657855480b07d05f7ec57902a7722))
...
* detect "Information" log level as "info" ([#18195](https://github.com/grafana/loki/issues/18195)) ([82263d3](https://github.com/grafana/loki/commit/82263d383a0ac6efac50c681f00d26cb2848d367))
* do not try to merge the already consolidated delete requests while listing them ([#18544](https://github.com/grafana/loki/issues/18544)) ([8054076](https://github.com/grafana/loki/commit/8054076873f925a539119e46422a4129766b9541))
...
* ensure to return delete requests only for the requested tanent ([#18589](https://github.com/grafana/loki/issues/18589)) ([cdb190b](https://github.com/grafana/loki/commit/cdb190be96eeed8087c9692726abae01ce6e7208))
* ensure we do not add duplicate structured metadata from stream labels and extracted map ([#18523](https://github.com/grafana/loki/issues/18523)) ([db72d63](https://github.com/grafana/loki/commit/db72d63211c2cc5208d207b5795d5109b74c16ca))
* Fix empty streamIDs in multi-section index objects ([#18556](https://github.com/grafana/loki/issues/18556)) ([41d93f8](https://github.com/grafana/loki/commit/41d93f8a866125fb28d76f235095762c10c3ccbb))
* Fix handling of duplicate delete requests ([#18460](https://github.com/grafana/loki/issues/18460)) ([255fce2](https://github.com/grafana/loki/commit/255fce20d813fc0b39758b6dbf51b23b987f0609))
* Fix nil pointer dereference in Volume method of the composite store ([#18064](https://github.com/grafana/loki/issues/18064)) ([fc7c018](https://github.com/grafana/loki/commit/fc7c0189c063d59d8933159faa9ab8f3e9df7f06))
...
* Handle WAL corruption properly on startup ([#18175](https://github.com/grafana/loki/issues/18175)) ([1954f67](https://github.com/grafana/loki/commit/1954f67a50ca0dc40e77c49e2c6cc74014e5998a))
...
* limit volume and frequency of persisted patterns ([#18362](https://github.com/grafana/loki/issues/18362)) ([c690827](https://github.com/grafana/loki/commit/c690827c6a655ada93806237d81643025ab53494))
...
* Loki chart fails to render proper YAML when add more than one ex… ([#12911](https://github.com/grafana/loki/issues/12911)) ([cf12656](https://github.com/grafana/loki/commit/cf12656a148cee6a605c19c45b8c27e4050f2ece))
* make helm use grpc for compactor address ([#17454](https://github.com/grafana/loki/issues/17454)) ([90003f6](https://github.com/grafana/loki/commit/90003f6d9b9c90249d360aa0648ed197aef1a2cd))
* **memberlist:** allow resolution of advertise address from v6 interf… ([#18250](https://github.com/grafana/loki/issues/18250)) ([8594d1c](https://github.com/grafana/loki/commit/8594d1ca282a9378091c122a2aa31d4b3af3f817))
...
* pattern persistence feature flag ([#18285](https://github.com/grafana/loki/issues/18285)) ([a206324](https://github.com/grafana/loki/commit/a206324ae3640d5f7615c2115fb3272256e95c6d))
* **pattern:** Fix feature flag for enabling pattern persistence ([#18216](https://github.com/grafana/loki/issues/18216)) ([c167800](https://github.com/grafana/loki/commit/c167800b3f6e7edd7b3f06a9105245c98b7391dd))
* register goldfish flags ([#18728](https://github.com/grafana/loki/issues/18728)) ([e06fea9](https://github.com/grafana/loki/commit/e06fea953852ed276c9bd2175326335cad7a62f6))
* Remove duplicated metric from Kafka producer ([#18614](https://github.com/grafana/loki/issues/18614)) ([a67a460](https://github.com/grafana/loki/commit/a67a460e9d7db43a793b180f2e73584fbe2497bb))
...
* routing for goldfish to work with nginx ([#18578](https://github.com/grafana/loki/issues/18578)) ([2e728ce](https://github.com/grafana/loki/commit/2e728ce7ba1def6d286d431b5d69be1a872d26bd))
* Row reader with no stream ID predicates ([#18368](https://github.com/grafana/loki/issues/18368)) ([f66781d](https://github.com/grafana/loki/commit/f66781d426df57157f73d383dee234b989d0e69a))
* Update dskit to fix linux/arm build ([#18715](https://github.com/grafana/loki/issues/18715)) ([f39fc1e](https://github.com/grafana/loki/commit/f39fc1e6e623bc88bf4d5d8e2e0c2ca039f5967f))
* while validating logql expression, detect and validate expression in label_replace ([#18470](https://github.com/grafana/loki/issues/18470)) ([d379de5](https://github.com/grafana/loki/commit/d379de501f93be62cb0f72948794276e817d2599))
...
* Use map for InPredicate when reading dataobj ([#18325](https://github.com/grafana/loki/issues/18325)) ([a238816](https://github.com/grafana/loki/commit/a2388167513c801074a7ebfecbf2b111f9e030db))
