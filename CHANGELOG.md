...
* [9352](https://github.com/grafana/loki/pull/9352) **Zlepper**: Promtail: Support pulling Kubernetes logs directly from API, rather than requiring host mounted volumes.
