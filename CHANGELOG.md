...
## [3.9.0](https://github.com/grafana/loki/compare/v3.8.0...v3.9.0) (2026-07-30)


### ⚠ BREAKING CHANGES

* Remove deprecated `per_tenant_override_config` and `per_tenant_override_period` ([#22856](https://github.com/grafana/loki/issues/22856))
* **ruler:** Always wipe the remote-write WAL on startup ([#22509](https://github.com/grafana/loki/issues/22509))
* **storage:** Use Thanos storage clients by default ([#22676](https://github.com/grafana/loki/issues/22676))
* Remove targets for Simple Scalable Deployment (SSD) ([#21481](https://github.com/grafana/loki/issues/21481))
* Remove deprecated `/api/prom` API endpoints ([#21569](https://github.com/grafana/loki/issues/21569))

### Features

* Add a minimum number of shuffle shard size in index gateway client ([#22573](https://github.com/grafana/loki/issues/22573)) ([7d69c1c](https://github.com/grafana/loki/commit/7d69c1ccb3fa8ce86d610fe6c8aea3fe6be61bfa))
* Add circuit breaker to drop traffic ([#23157](https://github.com/grafana/loki/issues/23157)) ([f9ed564](https://github.com/grafana/loki/commit/f9ed564e867d7624078a213fcc86eb917b01cb9a))
* Add label based access control LBAC ([#21266](https://github.com/grafana/loki/issues/21266)) ([976379a](https://github.com/grafana/loki/commit/976379a2d99962e1f55c35e4332b4b4de17ad35e))
* Add limit for max inflight bytes ([#23188](https://github.com/grafana/loki/issues/23188)) ([7a5c93d](https://github.com/grafana/loki/commit/7a5c93d9590b55a4dbcffd55ddfd90c562cce50c))
* Add X-Loki-Backfill-Day header to label backfilled streams ([#22628](https://github.com/grafana/loki/issues/22628)) ([bb93c60](https://github.com/grafana/loki/commit/bb93c6005cf2f40ddd64734e3d4db8e02e29c874))
* **alibaba oss:** Alibaba oss ecs ram role ([#21989](https://github.com/grafana/loki/issues/21989)) ([5555ff9](https://github.com/grafana/loki/commit/5555ff970ebef795cde19c0a8698b2ea796a3700))
* Allow overriding rate limits per ingestion policy ([#22435](https://github.com/grafana/loki/issues/22435)) ([bd7c05d](https://github.com/grafana/loki/commit/bd7c05dd0846bf580a2749567dd13dc6312f86d9))
* **auth:** Add no_auth_tenant config option for single-tenant mode ([#21819](https://github.com/grafana/loki/issues/21819)) ([7923fe1](https://github.com/grafana/loki/commit/7923fe121c5bde4953c88fa4ce9c02232bf4a672))
* **compaction:** Build index over compacted log objects in LogMerge ([#23214](https://github.com/grafana/loki/issues/23214)) ([eb93257](https://github.com/grafana/loki/commit/eb93257eb02e51988c865af0d8ca959d209cc506))
* **compaction:** Implement merge for log objects ([#23117](https://github.com/grafana/loki/issues/23117)) ([b88aca5](https://github.com/grafana/loki/commit/b88aca5d943de0b20be3f1b4ef36a813c68c44e3))
* **compaction:** Log object compaction - contract changes ([#23065](https://github.com/grafana/loki/issues/23065)) ([d821f2b](https://github.com/grafana/loki/commit/d821f2b68bf1bb79bc137a83b3965fa0857b90fb))
* **compaction:** Observability for log compaction ([#23122](https://github.com/grafana/loki/issues/23122)) ([aa5e221](https://github.com/grafana/loki/commit/aa5e221aa4d54fb5126e121e5f85d918270e1953))
* **compaction:** Track dataobj compaction artifacts via arrow record results ([#23364](https://github.com/grafana/loki/issues/23364)) ([47f6607](https://github.com/grafana/loki/commit/47f6607b21e76e0181e429552bf9409a06ef931c))
* **compactor:** Add new `increase_generation_numbers` endpoint ([#22443](https://github.com/grafana/loki/issues/22443)) ([4649720](https://github.com/grafana/loki/commit/4649720ee5dcd295d5d5ae01a7dca7276b94e90f))
* **compactor:** Read new postings section type ([#22143](https://github.com/grafana/loki/issues/22143)) ([6102d52](https://github.com/grafana/loki/commit/6102d521a270ce8c41f6d4959d94704ccccdc012))
* **compactor:** Reuse logsobj builder metrics ([#22138](https://github.com/grafana/loki/issues/22138)) ([bd6316d](https://github.com/grafana/loki/commit/bd6316d9ac9abe3243f9f1dfd8531415f585a756))
* **dataobj-compactor:** Add compaction dry-run flag with audit logging ([#22308](https://github.com/grafana/loki/issues/22308)) ([0b12196](https://github.com/grafana/loki/commit/0b12196743499f4fa0166e6da70437be116c4ee7))
* **dataobj-compactor:** Compactor coordinator/planner main loop ([#21973](https://github.com/grafana/loki/issues/21973)) ([5790955](https://github.com/grafana/loki/commit/5790955aba2ad3c46f4f49329778b499d196f23f))
* **dataobj-compactor:** Index compaction metrics ([#22087](https://github.com/grafana/loki/issues/22087)) ([89ea0d4](https://github.com/grafana/loki/commit/89ea0d47eea7ea482a3c0a4c2aead7a4b68c399c))
* **dataobj-compactor:** IndexMerge executor over postings + stats sections ([#22233](https://github.com/grafana/loki/issues/22233)) ([030dd44](https://github.com/grafana/loki/commit/030dd4418dd820dd0f00ba540b62053f40805f9d))
* **dataobj-compactor:** Log compaction planning and scheduling ([#23125](https://github.com/grafana/loki/issues/23125)) ([6034cdc](https://github.com/grafana/loki/commit/6034cdc53331607925c976c2efd4af755a3de3e4))
* **dataobj-compactor:** Log merge executor planning ([#23201](https://github.com/grafana/loki/issues/23201)) ([03cf02a](https://github.com/grafana/loki/commit/03cf02a95dd1cb499a4ecb48c98785c33c67e8fc))
* **dataobj/explorer:** Decode indexpointers rows in inspect endpoint ([#22276](https://github.com/grafana/loki/issues/22276)) ([fe7529a](https://github.com/grafana/loki/commit/fe7529addb51363033ce4b523b1e8bce6dbdadca))
* **dataobj/postings,stats:** Add merge builders and row decoders ([#22229](https://github.com/grafana/loki/issues/22229)) ([03cd800](https://github.com/grafana/loki/commit/03cd8002cf7e6d3a05364840a372cad4aef4bab3))
* **dataobj:** Add bloom and regex pushdown predicates to dataset scans ([#22551](https://github.com/grafana/loki/issues/22551)) ([fa9c6f4](https://github.com/grafana/loki/commit/fa9c6f47a961fcbbdd8786f307a5e8a35fa77b98))
* **dataobj:** Add postings Scanner with pushed-down selection ([#22582](https://github.com/grafana/loki/issues/22582)) ([71a5792](https://github.com/grafana/loki/commit/71a57923982e561a8e07766f837f5599d7b80784))
* **dataobj:** Record index sizes (file + uncompressed logs) in the ToC ([#23331](https://github.com/grafana/loki/issues/23331)) ([0172979](https://github.com/grafana/loki/commit/0172979d1a8695c8d1582df3daf6cbb23feeb1df))
* **dataobj:** Schedule LogMerge via per-tenant IndexMerge/LogMerge flip-flop ([#23316](https://github.com/grafana/loki/issues/23316)) ([c70cfc5](https://github.com/grafana/loki/commit/c70cfc5473c5e5a3bc03f16acb5b1894b52be7c9))
* **dataobj:** Split per-tenant compaction into index and log toggles ([#23371](https://github.com/grafana/loki/issues/23371)) ([7a34f30](https://github.com/grafana/loki/commit/7a34f30bc734c200540cf40e0ab6b6d6050d4493))
* **distributor:** Generalize backfill day to opaque shard and disable Loki time sharding for backfill ([#23248](https://github.com/grafana/loki/issues/23248)) ([d083dcd](https://github.com/grafana/loki/commit/d083dcd47b4d547d71a7d88fd9209b9096d45683))
* **engine/physicalpb:** Add IndexMerge node marshalling ([#22231](https://github.com/grafana/loki/issues/22231)) ([b3e9265](https://github.com/grafana/loki/commit/b3e9265b6c5ddab4e3e3bce43ffefe97da73e3b3))
* **engine:** Name the unimplemented feature when the v2 engine falls back ([#22365](https://github.com/grafana/loki/issues/22365)) ([9967e80](https://github.com/grafana/loki/commit/9967e80372fe08734476bedfab1b37415f4a6837))
* **index-gateway-client:** Add TeeGatewayClient ([#22810](https://github.com/grafana/loki/issues/22810)) ([12459ee](https://github.com/grafana/loki/commit/12459eee6c8b587e2faa0a7c58edfa105c360cbb))
* **index-gateway:** Add `/sync-indexes` endpoint for on-demand index sync ([#22637](https://github.com/grafana/loki/issues/22637)) ([cc1f4f4](https://github.com/grafana/loki/commit/cc1f4f461ad7cbec21007b35c50a44a9c94499e9))
* **ingester:** Add /flush/tenant endpoint to flush a tenant and ship its index ([#22499](https://github.com/grafana/loki/issues/22499)) ([5da6fee](https://github.com/grafana/loki/commit/5da6fee8fada644df3a82920d386ec694f0670df))
* **ingester:** Set chunk IngestedAt at flush for backfilled streams ([#22812](https://github.com/grafana/loki/issues/22812)) ([ba89e12](https://github.com/grafana/loki/commit/ba89e1224d24354981e46bfdf7a966104cb25e13))
* **kafka:** Reject partial produces when the buffer is full ([#22417](https://github.com/grafana/loki/issues/22417)) ([1be4ce7](https://github.com/grafana/loki/commit/1be4ce7bbc9defd5089152e03d1536e010cb7d47))
* **logql:** Add per-tenant query bytes counter metric ([#23382](https://github.com/grafana/loki/issues/23382)) ([3fd2d13](https://github.com/grafana/loki/commit/3fd2d1317cfef6abd81becd68f2df1e2e81aed7f))
* **metastore:** Add postings metrics ([#22946](https://github.com/grafana/loki/issues/22946)) ([35d5a2a](https://github.com/grafana/loki/commit/35d5a2a5d6f66fd5a206e843a7145e169dff8c73))
* **metastore:** Add read-path metrics and locality stats for postings index ([#22493](https://github.com/grafana/loki/issues/22493)) ([667368f](https://github.com/grafana/loki/commit/667368f43bcda78b454b2e24791b3d2ab8edf1a4))
* **metastore:** Drive stream selection through the postings Scanner ([#22583](https://github.com/grafana/loki/issues/22583)) ([e3b83f0](https://github.com/grafana/loki/commit/e3b83f00f0458a3f29d7b06f170f09a5f6e47a74))
* **metastore:** Enable range stats for postings section columns ([#23185](https://github.com/grafana/loki/issues/23185)) ([0e298b6](https://github.com/grafana/loki/commit/0e298b6be6239bca67305632eb187c4b182d3128))
* **metastore:** Open postings sections concurrently ([#23187](https://github.com/grafana/loki/issues/23187)) ([5a871e4](https://github.com/grafana/loki/commit/5a871e44ebbfc4d263cfc41c3dbd6c12ba850990))
...
* **otlp:** Adds a reporter to view attributes expanded to structured metadata [k317] ([#23655](https://github.com/grafana/loki/issues/23655)) ([5eed1a7](https://github.com/grafana/loki/commit/5eed1a74ed39d739dc1a796a1f2995a0a7315add))
* **postings:** Add postings data locality to xcap ([#23070](https://github.com/grafana/loki/issues/23070)) ([5de9bad](https://github.com/grafana/loki/commit/5de9bad34043b922a61f1ea2f22e94f2427fd32b))
* **querylimits:** Allow TSDB sharding strategy overrides ([#22332](https://github.com/grafana/loki/issues/22332)) ([a0f24ce](https://github.com/grafana/loki/commit/a0f24cede91479f941af728454c109e44af605c2))
* Rendezvous shuffle sharding algorithm for data objects with opt in configuration ([#22167](https://github.com/grafana/loki/issues/22167)) ([60db1ba](https://github.com/grafana/loki/commit/60db1ba4938bf623c166680f80a0be0b412ae607))
* **retention:** Use chunk IngestedAt for retention decisions ([#22819](https://github.com/grafana/loki/issues/22819)) ([e16efe7](https://github.com/grafana/loki/commit/e16efe7f94254f57f85246fd35db7533f35c1b5b))
* **ruler:** Always wipe the remote-write WAL on startup ([#22509](https://github.com/grafana/loki/issues/22509)) ([636c007](https://github.com/grafana/loki/commit/636c0072c2736773ce0cc9c8be9844472b631cbb))
* Support per-policy stream sharding overrides ([#22451](https://github.com/grafana/loki/issues/22451)) ([8ee465e](https://github.com/grafana/loki/commit/8ee465ee2e92877ee485b04b60149dca6821c1b8))
* **tools:** Adds a CLI for measuring postings and logs locality ([#23103](https://github.com/grafana/loki/issues/23103)) ([61f1bb4](https://github.com/grafana/loki/commit/61f1bb460166cc597217503415ec36abc78fa871))
* **tsdb:** Add FormatV4 reader and writer foundation ([#22370](https://github.com/grafana/loki/issues/22370)) ([3b7142e](https://github.com/grafana/loki/commit/3b7142e69a41c4a7b0e4d7d8de8bb43a1646ea4e))


### Bug Fixes

* Advertise sticky balancers for dataobj index builders ([#23304](https://github.com/grafana/loki/issues/23304)) ([f01b591](https://github.com/grafana/loki/commit/f01b59111bb412b06fdec93150a92b70f9c7f6f2))
* **bloomshipper:** Prevent index-gateway panic on shutdown ([#22321](https://github.com/grafana/loki/issues/22321)) ([4d17f02](https://github.com/grafana/loki/commit/4d17f02cdba29aa21e636a7803fd25799d67b647))
* **ci:** Log into dockerhub for patch release PRs ([#22527](https://github.com/grafana/loki/issues/22527)) ([00d5e95](https://github.com/grafana/loki/commit/00d5e9534a7f6cad1b38247fdeb8705cb84ebc60))
* **ci:** Use newer backport action ([#22456](https://github.com/grafana/loki/issues/22456)) ([94aef6a](https://github.com/grafana/loki/commit/94aef6ad31abfe9625cc59b96cdf1ec44d9a25d5))
* Clean shutdown support for dataobj-index-builder ([#23301](https://github.com/grafana/loki/issues/23301)) ([35e1b9a](https://github.com/grafana/loki/commit/35e1b9aa62c24f0be7e509459a78f42cca3ef4b6))
* **compaction:** Correct source bucket and metrics for log-compaction path ([#23215](https://github.com/grafana/loki/issues/23215)) ([a49819d](https://github.com/grafana/loki/commit/a49819dd2bf64b60b233e7a51a28df5122d49e2b))
* **compaction:** Improve memory utilization for index compaction workers ([#23251](https://github.com/grafana/loki/issues/23251)) ([3554f41](https://github.com/grafana/loki/commit/3554f41c35c4c9c7c17cb30ed30a036052cf017d))
* **compaction:** Stop using the default sort_schema in index compaction ([#23285](https://github.com/grafana/loki/issues/23285)) ([65cf44a](https://github.com/grafana/loki/commit/65cf44ae831b0cc47f9d6a0d86e86a4ed9d9bce5))
* **compaction:** Store fully-qualified sort schema in stats sections ([#23308](https://github.com/grafana/loki/issues/23308)) ([da1efe2](https://github.com/grafana/loki/commit/da1efe2a0151a08f58bef9fb306bf57cccf49de2))
* **compaction:** Upload logs objects to correct path ([#23359](https://github.com/grafana/loki/issues/23359)) ([925c8c7](https://github.com/grafana/loki/commit/925c8c7c7c6feface41c5bef12c74f05c05e8c84))
* **compactor:** Dataobj compaction metrics registration and restrictive-S3 IndexMerge probe ([#22367](https://github.com/grafana/loki/issues/22367)) ([ac76b40](https://github.com/grafana/loki/commit/ac76b402773c77bec17545c1297e786933d3e0ab))
* **compactor:** Fix delete request when using Thanos objstore client with filesystem backend ([#22809](https://github.com/grafana/loki/issues/22809)) ([eae43e1](https://github.com/grafana/loki/commit/eae43e10e9320c79d5e879e11aada5b7ada6eb44))
* **compactor:** Skip retention scans for zero retention ([#21756](https://github.com/grafana/loki/issues/21756)) ([233e939](https://github.com/grafana/loki/commit/233e939282a6273a1b31eb001a7b65169aa3ebb8))
* **dataobj-compaction:** Filter index sections by tenant in IndexMerge ([#22450](https://github.com/grafana/loki/issues/22450)) ([6c3c537](https://github.com/grafana/loki/commit/6c3c537ccd9fbf998db3659c411dd0ad4ad6ad93))
* **dataobj-compaction:** Plan index compaction from section runs 🤖🤖🤖 ([#23408](https://github.com/grafana/loki/issues/23408)) ([e1f7cde](https://github.com/grafana/loki/commit/e1f7cde220dfa1e3cc8ee29826cfff1fd227f06c))
* **dataobj-compaction:** Revert treating touching section bounds as one run 🤖🤖🤖 ([#23386](https://github.com/grafana/loki/issues/23386)) ([3c90d59](https://github.com/grafana/loki/commit/3c90d59774c2ff46067fa189a00a629c84e38781))
* **dataobj-compaction:** Split postings sections by size ([#22442](https://github.com/grafana/loki/issues/22442)) ([3830706](https://github.com/grafana/loki/commit/38307065cff24d3331e9adccd4547d7e1914bfdb))
* **dataobj-compaction:** Treat touching section bounds as one run 🤖🤖🤖 ([#23366](https://github.com/grafana/loki/issues/23366)) ([8da68d8](https://github.com/grafana/loki/commit/8da68d840320da4b9aac7211adc7d55632b8df22))
* **dataobj-stats:** Tie-break section sort on object path and section index ([#22469](https://github.com/grafana/loki/issues/22469)) ([e4b27ef](https://github.com/grafana/loki/commit/e4b27ef5a72901062e41478a7746925759ed8b43))
* **dataobj-tee:** Fix problem with hotspots when rateBytes=0 ([#22641](https://github.com/grafana/loki/issues/22641)) ([33b30c8](https://github.com/grafana/loki/commit/33b30c883ad3de81c4831c2fa9bf7f3244d43471))
* **dataobj:** Handle constant predicates in logs predicate ordering ([#22160](https://github.com/grafana/loki/issues/22160)) ([5c0197c](https://github.com/grafana/loki/commit/5c0197c4f3805e741be6a79b3a66431be4743c49))
* **dataobj:** Skip unrecognized columns when iterating sections ([#23378](https://github.com/grafana/loki/issues/23378)) ([5901575](https://github.com/grafana/loki/commit/5901575c8a9a4efa0b27582fbe750a4d67f40dd3))
* **dataobj:** Source index ToC time range from postings sections and enable page pruning on kind ([#22468](https://github.com/grafana/loki/issues/22468)) ([eecfe8a](https://github.com/grafana/loki/commit/eecfe8a42c441a6dad7c40309183117bb6282204))
* De-flake several flaky unit and integration tests ([#23295](https://github.com/grafana/loki/issues/23295)) ([562a762](https://github.com/grafana/loki/commit/562a762ab1d07985edc561920d74e792f4a6aab9))
* **deps:** Bump golang.org/x/text to v0.39.0 (GO-2026-5970) ([#23404](https://github.com/grafana/loki/issues/23404)) ([4d5cacc](https://github.com/grafana/loki/commit/4d5cacccbef2d5a6d37636d26090d9ebc919593f))
* **deps:** Update charm.land/bubbletea/v2 to v2.0.7 (main) ([#22275](https://github.com/grafana/loki/issues/22275)) ([41e912e](https://github.com/grafana/loki/commit/41e912e873c3b3f684bef4d0f03577b551e59194))
* **deps:** Update charm.land/lipgloss/v2 to v2.0.4 (main) ([#22418](https://github.com/grafana/loki/issues/22418)) ([c35c9bb](https://github.com/grafana/loki/commit/c35c9bb78ae881b4eba5a48125adac27ed499448))
* **deps:** Update github.com/alecthomas/chroma/v2 to v2.26.1 (main) ([#21734](https://github.com/grafana/loki/issues/21734)) ([f87fa8f](https://github.com/grafana/loki/commit/f87fa8f3865931f3bfcf63f29ce58c1bdaa83610))
* **deps:** Update github.com/alicebob/miniredis/v2 to v2.38.0 (main) ([#21922](https://github.com/grafana/loki/issues/21922)) ([914a0cf](https://github.com/grafana/loki/commit/914a0cfe9c700a35a777e777b59fa4a83e9c6da4))
* **deps:** Update github.com/aws/aws-sdk-go-v2/config to v1.32.24 (main) ([#22131](https://github.com/grafana/loki/issues/22131)) ([e147c5c](https://github.com/grafana/loki/commit/e147c5c9b7b3ba6ce2154da3213397f2b1dfb59e))
* **deps:** Update github.com/aws/aws-sdk-go-v2/config to v1.32.25 (main) ([#22409](https://github.com/grafana/loki/issues/22409)) ([faaedd9](https://github.com/grafana/loki/commit/faaedd914bf7868b52e445b063c59c146b4f66d5))
* **deps:** Update github.com/aws/aws-sdk-go-v2/service/s3 to v1.103.3 (main) ([#21707](https://github.com/grafana/loki/issues/21707)) ([8181286](https://github.com/grafana/loki/commit/8181286a452e291b3f8817200007be5f7fb21f91))
* **deps:** Update github.com/aws/smithy-go to v1.27.2 (main) ([#22119](https://github.com/grafana/loki/issues/22119)) ([fe5c45a](https://github.com/grafana/loki/commit/fe5c45a21c3ac4f8dee944f9fe9b4290f138fe57))
* **deps:** Update github.com/Azure/azure-sdk-for-go/sdk/storage/azblob to v1.8.0 (main) ([#22454](https://github.com/grafana/loki/issues/22454)) ([4ab8713](https://github.com/grafana/loki/commit/4ab87131fd6563fc0d517465a245a9e42bf750ee))
* **deps:** Update github.com/buger/jsonparser to v1.2.0 (main) ([#21746](https://github.com/grafana/loki/issues/21746)) ([d092355](https://github.com/grafana/loki/commit/d09235599f1a334d7ba83c9c94255156df24370d))
* **deps:** Update github.com/fluent/fluent-bit-go digest to 71a89c3 (main) ([#22525](https://github.com/grafana/loki/issues/22525)) ([0d1879b](https://github.com/grafana/loki/commit/0d1879bde55e2e9a20c348f31bf54b12df33c8cf))
* **deps:** Update github.com/go-sql-driver/mysql to v1.10.0 (main) ([#21747](https://github.com/grafana/loki/issues/21747)) ([8e18d58](https://github.com/grafana/loki/commit/8e18d580e4c374130b8144be236ce660a5ea7d30))
* **deps:** Update github.com/IBM/go-sdk-core/v5 to v5.21.4 (main) ([#22140](https://github.com/grafana/loki/issues/22140)) ([5e13146](https://github.com/grafana/loki/commit/5e13146c400e561b7facbd9e7be706e8629a1a9e))
* **deps:** Update github.com/IBM/ibm-cos-sdk-go to v1.14.1 (main) ([#22405](https://github.com/grafana/loki/issues/22405)) ([cee9fa7](https://github.com/grafana/loki/commit/cee9fa77e308ef7ced185a145c912424ac2b0770))
* **deps:** Update github.com/joncrlsn/dque digest to 7723fd1 (main) ([#22531](https://github.com/grafana/loki/issues/22531)) ([51de701](https://github.com/grafana/loki/commit/51de7015ec5615a310d86b17810bd091b7869b24))
* **deps:** Update github.com/klauspost/compress to v1.18.6 (main) ([#21757](https://github.com/grafana/loki/issues/21757)) ([b291720](https://github.com/grafana/loki/commit/b291720ffeddce6de9077351fa6e4f3fcc1cf6d5))
* **deps:** Update github.com/minio/minio-go/v7 to v7.2.0 (main) ([#22107](https://github.com/grafana/loki/issues/22107)) ([e7a7787](https://github.com/grafana/loki/commit/e7a778710ad078697625432d1e7c6df5b39ca8a8))
* **deps:** Update github.com/mitchellh/mapstructure digest to 8508981 (main) ([#22532](https://github.com/grafana/loki/issues/22532)) ([314ac92](https://github.com/grafana/loki/commit/314ac920b1a693e68645fb1ae06d4051a8d51ef2))
* **deps:** Update github.com/pierrec/lz4/v4 to v4.1.27 (main) ([#22228](https://github.com/grafana/loki/issues/22228)) ([5f32480](https://github.com/grafana/loki/commit/5f324806a88fef462b2d926b6e1d32297f2bbaa8))
* **deps:** Update github.com/pressly/goose/v3 to v3.27.1 (main) ([#21718](https://github.com/grafana/loki/issues/21718)) ([6e47a42](https://github.com/grafana/loki/commit/6e47a42c30a4af812f33cab6c11e0368a75b3121))
* **deps:** Update github.com/prometheus/common to v0.68.1 (main) ([#22134](https://github.com/grafana/loki/issues/22134)) ([e932184](https://github.com/grafana/loki/commit/e932184ce5e85ffa7e224e086e367808375ddf14))
* **deps:** Update github.com/redis/go-redis/v9 to v9.20.0 (main) ([#21743](https://github.com/grafana/loki/issues/21743)) ([ae077ab](https://github.com/grafana/loki/commit/ae077ab19635730daab135896bbed1e3c0c74627))
* **deps:** Update github.com/redis/go-redis/v9 to v9.20.1 (main) ([#22412](https://github.com/grafana/loki/issues/22412)) ([46744df](https://github.com/grafana/loki/commit/46744df9e77832b7561f56931a717d43f0e072bc))
* **deps:** Update github.com/shirou/gopsutil/v4 to v4.26.5 (main) ([#21748](https://github.com/grafana/loki/issues/21748)) ([b37806c](https://github.com/grafana/loki/commit/b37806cedc039401c97f0938ea4d706a73ed65de))
* **deps:** Update github.com/thanos-io/objstore digest to fb6fd3a (main) ([#22533](https://github.com/grafana/loki/issues/22533)) ([d703874](https://github.com/grafana/loki/commit/d703874e23d16757df9fb5fad3fa8ec78bb69d29))
* **deps:** Update github.com/twmb/franz-go to v1.21.3 (main) ([#21695](https://github.com/grafana/loki/issues/21695)) ([f89f9a7](https://github.com/grafana/loki/commit/f89f9a7ebc7cfa992dbe697fc68a157f99e15ba3))
* **deps:** Update github.com/twmb/franz-go/pkg/kadm to v1.18.0 (main) ([#21696](https://github.com/grafana/loki/issues/21696)) ([95f0aba](https://github.com/grafana/loki/commit/95f0abab08387659a57d00e09ac8b520ac3a10d0))
* **deps:** Update go.opentelemetry.io/collector/pdata to v1.60.0 (main) ([#21744](https://github.com/grafana/loki/issues/21744)) ([f9dd4a6](https://github.com/grafana/loki/commit/f9dd4a6341f8f445030bba7be162c3f75503d333))
* **deps:** Update go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc to v0.69.0 (main) ([#22125](https://github.com/grafana/loki/issues/22125)) ([6b05d50](https://github.com/grafana/loki/commit/6b05d50a34f7193a05aec60d558ac5880128df95))
* **deps:** Update go.opentelemetry.io/contrib/instrumentation/net/http/httptrace/otelhttptrace to v0.69.0 (main) ([#22126](https://github.com/grafana/loki/issues/22126)) ([693fb72](https://github.com/grafana/loki/commit/693fb72266678838dfbfc1968aa594babed52781))
* **deps:** Update go4.org/netipx digest to fdeea32 (main) ([#22543](https://github.com/grafana/loki/issues/22543)) ([d1111f8](https://github.com/grafana/loki/commit/d1111f88bd27f779ff8a243281d476b3fc31f222))
* **deps:** Update golang.org/x/net to v0.56.0 (main) ([#22399](https://github.com/grafana/loki/issues/22399)) ([b879f11](https://github.com/grafana/loki/commit/b879f11db56198cc5a93c22c75a803dfb14fdc45))
* **deps:** Update golang.org/x/tools to v0.46.0 (main) ([#22414](https://github.com/grafana/loki/issues/22414)) ([7d90ee3](https://github.com/grafana/loki/commit/7d90ee3ab52149424a3e871d6f70e0dda4113b24))
* **deps:** Update google.golang.org/api to v0.284.0 (main) ([#21753](https://github.com/grafana/loki/issues/21753)) ([472233e](https://github.com/grafana/loki/commit/472233e872f21eb595e23ad335cca6d09658e212))
* **deps:** Update google.golang.org/genproto/googleapis/rpc digest to b703f56 (main) ([#22653](https://github.com/grafana/loki/issues/22653)) ([1e44839](https://github.com/grafana/loki/commit/1e44839381e186e076681cc420a7face532d3bf8))
...
* **deps:** Update k8s.io/apimachinery to v0.36.1 (main) ([#21708](https://github.com/grafana/loki/issues/21708)) ([102f0fd](https://github.com/grafana/loki/commit/102f0fd38c6b06acd9095e7cc6a8907bdeee8aaa))
* **deps:** Update k8s.io/apimachinery to v0.36.2 (main) ([#22419](https://github.com/grafana/loki/issues/22419)) ([6b590ea](https://github.com/grafana/loki/commit/6b590ea6f42b58ec86ff119d00c34b66a19cdf73))
* **deps:** Update k8s.io/utils digest to be93311 (main) ([#22544](https://github.com/grafana/loki/issues/22544)) ([e0d53e1](https://github.com/grafana/loki/commit/e0d53e18eb0dae82edf3bc7dea7081eced4bea04))
* **deps:** Update module cloud.google.com/go/storage to v1.62.3 (main) ([#22290](https://github.com/grafana/loki/issues/22290)) ([4627dc4](https://github.com/grafana/loki/commit/4627dc40cc6f1fcba08f5f25bba03e3c06cfd6ef))
* **deps:** Update module cloud.google.com/go/storage to v1.63.0 (main) ([#22762](https://github.com/grafana/loki/issues/22762)) ([9ec549c](https://github.com/grafana/loki/commit/9ec549c640a7be24f12face6fdaa6cbcb7ac510e))
* **deps:** Update module github.com/alecthomas/chroma/v2 to v2.27.0 (main) ([#22480](https://github.com/grafana/loki/issues/22480)) ([6c09e06](https://github.com/grafana/loki/commit/6c09e0618d73295d9b40d8f02d14d246d872b72f))
* **deps:** Update module github.com/aws/aws-sdk-go-v2 to v1.41.9 (main) ([#22130](https://github.com/grafana/loki/issues/22130)) ([25acf05](https://github.com/grafana/loki/commit/25acf0526f5b7f3f68f3db4d234d52e0f6ed4b8c))
* **deps:** Update module github.com/aws/aws-sdk-go-v2/service/s3 to v1.104.0 (main) ([#22475](https://github.com/grafana/loki/issues/22475)) ([bf11a28](https://github.com/grafana/loki/commit/bf11a28f39d6d796972b56fc03207550c1f622c5))
* **deps:** Update module github.com/aws/smithy-go to v1.27.3 (main) ([#22796](https://github.com/grafana/loki/issues/22796)) ([c909d5b](https://github.com/grafana/loki/commit/c909d5b85c36dda67dd6f650d437ca6b7deee8a4))
* **deps:** Update module github.com/Azure/azure-sdk-for-go/sdk/azcore to v1.22.0 (main) ([#22293](https://github.com/grafana/loki/issues/22293)) ([a312ffb](https://github.com/grafana/loki/commit/a312ffbf3dc0d61486e04fb2df703b244bfa1393))
* **deps:** Update module github.com/Azure/azure-sdk-for-go/sdk/azidentity to v1.14.0 (main) ([#22465](https://github.com/grafana/loki/issues/22465)) ([98c8eff](https://github.com/grafana/loki/commit/98c8eff161d10fbb85c74a4e7197ddc7abcd7313))
* **deps:** Update module github.com/baidubce/bce-sdk-go to v0.9.266 (main) ([#21754](https://github.com/grafana/loki/issues/21754)) ([79e31d3](https://github.com/grafana/loki/commit/79e31d343818dc0e1d1c6dc5c4dfcd1f93e84625))
* **deps:** Update module github.com/baidubce/bce-sdk-go to v0.9.270 (main) ([#22484](https://github.com/grafana/loki/issues/22484)) ([4baa88f](https://github.com/grafana/loki/commit/4baa88fd4bd86660691662b19239d390409a4ff6))
* **deps:** Update module github.com/IBM/go-sdk-core/v5 to v5.22.1 (main) ([#22507](https://github.com/grafana/loki/issues/22507)) ([e3e6fa2](https://github.com/grafana/loki/commit/e3e6fa298c10774a327c661eafd06a3d9b0e0c8f))
* **deps:** Update module github.com/minio/minio-go/v7 to v7.2.1 (main) ([#22773](https://github.com/grafana/loki/issues/22773)) ([963f23f](https://github.com/grafana/loki/commit/963f23fd77291b60a4ac0e26bfe4edbda3e36578))
* **deps:** Update module github.com/moby/moby/v2 to v2.0.0-beta.16 (main) ([#22289](https://github.com/grafana/loki/issues/22289)) ([2fd13cb](https://github.com/grafana/loki/commit/2fd13cbc84c5ce969c4710513e5c76babf2fdbed))
* **deps:** Update module github.com/prometheus/common to v0.69.0 (main) ([#22482](https://github.com/grafana/loki/issues/22482)) ([db1c24e](https://github.com/grafana/loki/commit/db1c24e62ff4374d0fddd849036a99757a13c488))
* **deps:** Update module github.com/redis/go-redis/v9 to v9.21.0 (main) ([#22679](https://github.com/grafana/loki/issues/22679)) ([ccd0944](https://github.com/grafana/loki/commit/ccd0944d4fdf6f00a8057e64310e6b0d6ee96774))
* **deps:** Update module github.com/twmb/franz-go/plugin/kotel to v1.7.0 (main) ([#22745](https://github.com/grafana/loki/issues/22745)) ([ae71211](https://github.com/grafana/loki/commit/ae71211e559c54f270d3b96ba15228af0fe1f8c0))
* **deps:** Update module go.etcd.io/bbolt to v1.5.0 (main) ([#22489](https://github.com/grafana/loki/issues/22489)) ([5d85505](https://github.com/grafana/loki/commit/5d8550571565d6af6d1090cb7940d289fbefd0cd))
* **deps:** Update module go.opentelemetry.io/collector/pdata to v1.61.0 (main) ([#22682](https://github.com/grafana/loki/issues/22682)) ([b72bbb8](https://github.com/grafana/loki/commit/b72bbb83f5b77cb0f647dabceca63fa21778a04d))
* **deps:** Update module golang.org/x/sync to v0.21.0 (main) ([#22300](https://github.com/grafana/loki/issues/22300)) ([20bb4e2](https://github.com/grafana/loki/commit/20bb4e2dd15980160206448cfbd2cf8d21ef10d1))
* **deps:** Update module golang.org/x/tools to v0.47.0 (main) ([#22746](https://github.com/grafana/loki/issues/22746)) ([9a8268d](https://github.com/grafana/loki/commit/9a8268d3effdd088f5c45ba05abfcdcc95962486))
* **deps:** Update module google.golang.org/api to v0.286.0 (main) ([#22476](https://github.com/grafana/loki/issues/22476)) ([f601c1e](https://github.com/grafana/loki/commit/f601c1e1c0d40fe826d649443bf995e04b793d67))
* **distributor:** Make max_line_size_truncate truncation observable ([#22105](https://github.com/grafana/loki/issues/22105)) ([233073f](https://github.com/grafana/loki/commit/233073f09c902441a82773d5f07e5984bf17dcd5))
* **engine/v2:** Push line_format & label_format field refs to upstream parsers ([#23113](https://github.com/grafana/loki/issues/23113)) ([8f6b40e](https://github.com/grafana/loki/commit/8f6b40e87db504818b01e11738fc01b2b4add7e6))
* **engine/workflow:** Surface failed-task errors before results EOF ([#22232](https://github.com/grafana/loki/issues/22232)) ([beb732c](https://github.com/grafana/loki/commit/beb732c3c5b453353543aca5c3547ba334ebf7af))
* **engine:** Close task streams when workers disconnect 🤖🤖🤖 ([#23275](https://github.com/grafana/loki/issues/23275)) ([1874ebb](https://github.com/grafana/loki/commit/1874ebb86291a148a3a9f3abd173d1d96eb157e1))
* **engine:** Handle scheduler and worker connection drops correctly ([#22389](https://github.com/grafana/loki/issues/22389)) ([f2f3b92](https://github.com/grafana/loki/commit/f2f3b922e9eac120066905fe251d7d5b505ccc36))
* **engine:** Propagate errors from marshalExpressions ([#22346](https://github.com/grafana/loki/issues/22346)) ([703df7d](https://github.com/grafana/loki/commit/703df7df91ae4bcaab495012769ed1052da53564))
* **engine:** Return errors instead of panicking in executor pipelines ([#23291](https://github.com/grafana/loki/issues/23291)) ([46398d6](https://github.com/grafana/loki/commit/46398d68c324b40a306469cba0052c4b4571f3c0))
* Exclude debug routes from distributor panel on operational dashb… ([#23377](https://github.com/grafana/loki/issues/23377)) ([97e2f53](https://github.com/grafana/loki/commit/97e2f531dda57ce32d69de133ee66a25869634a8))
* Fix for ruler concurrent map iteration ([#22636](https://github.com/grafana/loki/issues/22636)) ([b85ca73](https://github.com/grafana/loki/commit/b85ca7349491dc90ec7d49f32dd544d79c2213bf))
* Function signatures which otherwise is failing lint ([#23447](https://github.com/grafana/loki/issues/23447)) ([7d470b1](https://github.com/grafana/loki/commit/7d470b18e26bb10462338e0bdb9892613adf7595))
* **goldfish:** Fix migration typo ([#22272](https://github.com/grafana/loki/issues/22272)) ([bd4eab2](https://github.com/grafana/loki/commit/bd4eab223cbe3a7d4d4eb467c43e5c687b006780))
* Including rangeInterval into query lookback and length checks ([#22500](https://github.com/grafana/loki/issues/22500)) ([1c3bb31](https://github.com/grafana/loki/commit/1c3bb31d65eab430ff544d12c1b0cb79083f6578))
* **index-gateway:** Correctness fixes for broken indexSet handling + configurable download timeout ([#23356](https://github.com/grafana/loki/issues/23356)) ([6907cbc](https://github.com/grafana/loki/commit/6907cbc2b8ad8109b28580d37177ea41e8198226))
* **index-gateway:** Register IndexGatewayInterceptors before Server ([#22771](https://github.com/grafana/loki/issues/22771)) ([b77a4ae](https://github.com/grafana/loki/commit/b77a4aee152648c4943adbde58f2fa6b9989acdb))
* **log tailer:** Fix occasional duplicate entries ([#23300](https://github.com/grafana/loki/issues/23300)) ([985771d](https://github.com/grafana/loki/commit/985771d678ef18acee9273a1781bf702c2c0c11a))
* **logcli:** Prevent panic and incorrect result when listing label values from a local file ([#22432](https://github.com/grafana/loki/issues/22432)) ([546186d](https://github.com/grafana/loki/commit/546186d1222f85f64a5b595eece66cfe05c5a2e6))
* **logging:** Stabilize storage layer log messages ([#21955](https://github.com/grafana/loki/issues/21955)) ([8dfe7e7](https://github.com/grafana/loki/commit/8dfe7e75e84b698c059c793bf1e9e378bc532c7f))
* **logql:** Match IPv6 addresses at the end of a line in ip filters ([#22470](https://github.com/grafana/loki/issues/22470)) ([199ea51](https://github.com/grafana/loki/commit/199ea5168249b13258f9987203a68d80c4186062))
* **metastore:** Recognize non-equality label filters as stream labels ([#23202](https://github.com/grafana/loki/issues/23202)) ([649969e](https://github.com/grafana/loki/commit/649969e0489070cfaa789d5896b35dacece9a4b8))
...
* **otlp:** Skip empty values when discovering service_name from resource attributes ([#21913](https://github.com/grafana/loki/issues/21913)) ([98b31b6](https://github.com/grafana/loki/commit/98b31b64a9a856e4260d7e37282a5f0c4bdba331))
* ProduceSync hangs until context canceled if len(records) == 0 ([#22901](https://github.com/grafana/loki/issues/22901)) ([ab6a81e](https://github.com/grafana/loki/commit/ab6a81eca03aa46534819fef1bfd113c4bd12a1c))
* **querier/tail:** Stop leaking goroutines on websocket teardown races ([#22073](https://github.com/grafana/loki/issues/22073)) ([7fd7241](https://github.com/grafana/loki/commit/7fd7241c8724e71808ebe86474ba5b1e13d437cc))
* **querier:** Classify wrapped LogQL query errors as 400 instead of 500 ([#22393](https://github.com/grafana/loki/issues/22393)) ([f14a3a6](https://github.com/grafana/loki/commit/f14a3a68484b9c3e53c600cdd23e1d9ed9449263))
* **queryrange:** Preserve sketch in MergeLabels ([#23326](https://github.com/grafana/loki/issues/23326)) ([9680cb3](https://github.com/grafana/loki/commit/9680cb38e8393e49963a42b38d5342860c414b50))
* Request source key for collision-renamed labels in metric queries ([#22141](https://github.com/grafana/loki/issues/22141)) ([77b271f](https://github.com/grafana/loki/commit/77b271f9c9f24ea573f6ae3c2c3d9d70b47e1af5))
* Reset shared calculator scratchpad on abort ([#23305](https://github.com/grafana/loki/issues/23305)) ([d9ed9d5](https://github.com/grafana/loki/commit/d9ed9d5801ec79ea07d9e0f4687522725c4a6585))
* Return unknonwn level when severity_text contains unrecognized values ([#22373](https://github.com/grafana/loki/issues/22373)) ([28e27ef](https://github.com/grafana/loki/commit/28e27ef49c7672ed4704c34f504bd6be790bc919))
* Revert to returning arbitrary values in detected_level and add tests ([#22844](https://github.com/grafana/loki/issues/22844)) ([1670cd8](https://github.com/grafana/loki/commit/1670cd83799ae7f39f1cc048fde139274139a117))
* **ruler:** Allow partial per-tenant remote_write config overrides ([#23186](https://github.com/grafana/loki/issues/23186)) ([7136cb1](https://github.com/grafana/loki/commit/7136cb17563cee98af57a94dd90997f178a338ad))
* **ruler:** Apply common.path_prefix to ruler WAL directory default ([#21823](https://github.com/grafana/loki/issues/21823)) ([fbf98eb](https://github.com/grafana/loki/commit/fbf98eb42291cd09cf019956a1812e35dbbadbbf))
* **ruler:** Populate RulerStorage from `common.filesystem` config ([#22791](https://github.com/grafana/loki/issues/22791)) ([0ccfbc5](https://github.com/grafana/loki/commit/0ccfbc570e02f34decaf9a76945b47e1421c7fe6))
* **ruler:** Prevent rule evaluation deadlock when jitter query hashin… ([#22413](https://github.com/grafana/loki/issues/22413)) ([df37677](https://github.com/grafana/loki/commit/df376776f6242a62aa7e70a33c98e9db7f02fa2f))
* **security/CRITICAL/clients/cmd/fluentd/docker:** Update dependency fluentd to v1.19.3 [SECURITY] (main) ([#22689](https://github.com/grafana/loki/issues/22689)) ([3d2126a](https://github.com/grafana/loki/commit/3d2126aedfb768bbbd399da24fcb630aacec22ee))
* **security/HIGH/:** Update module github.com/apache/thrift to v0.24.0 [SECURITY] (main) ([#23280](https://github.com/grafana/loki/issues/23280)) ([6affe8b](https://github.com/grafana/loki/commit/6affe8ba021b810bd98255f609b4ca75a97e2096))
* **security/HIGH/:** Update module github.com/containerd/containerd/v2 to v2.2.4 [SECURITY] (main) ([#22168](https://github.com/grafana/loki/issues/22168)) ([940a542](https://github.com/grafana/loki/commit/940a5429594a023ea8cd46c6388048d3d4f81e10))
* **security/UNKNOWN/cmd/dataobj-inspect:** Update module golang.org/x/sys to v0.44.0 [SECURITY] (main) ([#22177](https://github.com/grafana/loki/issues/22177)) ([08b028f](https://github.com/grafana/loki/commit/08b028f9d3841379e792943000a86d94db7624f1))
* **security/UNKNOWN/cmd/dataobj-inspect:** Update security cmd/dataobj-inspect github.com/go-jose/go-jose/v4 to v4.1.4 [SECURITY] (main) ([#22170](https://github.com/grafana/loki/issues/22170)) ([a8e33f1](https://github.com/grafana/loki/commit/a8e33f1e554790d58934a9d32f07436e725f5da1))
* **security/UNKNOWN/cmd/dataobj-inspect:** Update security cmd/dataobj-inspect golang.org/x/crypto to v0.52.0 [SECURITY] (main) ([#22175](https://github.com/grafana/loki/issues/22175)) ([064f86d](https://github.com/grafana/loki/commit/064f86def40fca597d475aeda52521a3810ba1d5))
* **security/UNKNOWN/cmd/dataobj-inspect:** Update security cmd/dataobj-inspect golang.org/x/net to v0.55.0 [SECURITY] (main) ([#22176](https://github.com/grafana/loki/issues/22176)) ([d32c677](https://github.com/grafana/loki/commit/d32c677251137fc05aa47bd5b942c3e651ee0fac))
* **security/UNKNOWN/cmd/dataobj-inspect:** Update security cmd/dataobj-inspect google.golang.org/grpc to v1.79.3 [SECURITY] (main) ([#22171](https://github.com/grafana/loki/issues/22171)) ([a3236f5](https://github.com/grafana/loki/commit/a3236f546b9da7339f058f23a8792277ea10420c))
* **security/UNKNOWN/pkg/push:** Update module golang.org/x/net to v0.55.0 [SECURITY] (main) ([#22182](https://github.com/grafana/loki/issues/22182)) ([d887836](https://github.com/grafana/loki/commit/d887836f9b75b189e97be94358d6f045f781a0f0))
* **security/UNKNOWN/pkg/push:** Update module golang.org/x/sys to v0.44.0 [SECURITY] (main) ([#22183](https://github.com/grafana/loki/issues/22183)) ([9598b56](https://github.com/grafana/loki/commit/9598b5693261f958368a3b971a77f1f316e664b6))
* **security/UNKNOWN/:** Update module github.com/containerd/containerd/v2 to v2.2.5 [SECURITY] (main) ([#22477](https://github.com/grafana/loki/issues/22477)) ([3840d87](https://github.com/grafana/loki/commit/3840d87b44503545843bc5db596215389f583abd))
* **storage:** Fix index filename issue with legacy S3 client and `chunk_delimiter: "-"` ([#22670](https://github.com/grafana/loki/issues/22670)) ([961d673](https://github.com/grafana/loki/commit/961d6736ad5ec41f1ac42ab4e1b6f247c829095c))
* **toc:** Dataobj index builder stuck on bound check ([#22954](https://github.com/grafana/loki/issues/22954)) ([92eb7c8](https://github.com/grafana/loki/commit/92eb7c8a97cb4ce9d59ceaa94fa343893fb4a36b))
* Update objstore to include fix for GCS Exists ([#23380](https://github.com/grafana/loki/issues/23380)) ([4a3278c](https://github.com/grafana/loki/commit/4a3278cce7fedd0ac623aa53bb1b39e3b228ca0c))
* Use consistent time units on operational dashboard ([#22155](https://github.com/grafana/loki/issues/22155)) ([684599a](https://github.com/grafana/loki/commit/684599a63b18f236e715ff6a9495c31125f7bee2))
* **v1-engine:** Handling of absent-as-empty semantics for key="" filters in bloom filters ([#22495](https://github.com/grafana/loki/issues/22495)) ([a5e1dd7](https://github.com/grafana/loki/commit/a5e1dd794e55836ffdbd6117f7afc9511104348b))
* **v1-engine:** Revert "fix(v1-engine): Shard mapper inflating outer sum over non-additive range aggregations" ([#22925](https://github.com/grafana/loki/issues/22925)) ([3de9d46](https://github.com/grafana/loki/commit/3de9d464aba7081469ffcc30c584aaf2ca061428))
* **v1-engine:** Shard mapper inflating outer sum over non-additive range aggregations ([#22396](https://github.com/grafana/loki/issues/22396)) ([37e6e0b](https://github.com/grafana/loki/commit/37e6e0bef7d3c8f45f7eac92d8590e864b110470))
* **v1-engine:** Shard mapper inflating outer sum over non-additive range aggregations ([#22955](https://github.com/grafana/loki/issues/22955)) ([19db1ca](https://github.com/grafana/loki/commit/19db1ca9a0fe79d751fcfa414011d20094b43b0e))
* **v2-engine:** Dedup projections by (name, type) so builtin fields survive collision with parsed field ([#22907](https://github.com/grafana/loki/issues/22907)) ([b5b36c7](https://github.com/grafana/loki/commit/b5b36c782905229c46b36b94a2787edcbe6f97dd))
* **v2-engine:** Make label_format and line_format input lookups category-aware to skip NULL same-short-name shadows and match v1 ([#22770](https://github.com/grafana/loki/issues/22770)) ([3b74cce](https://github.com/grafana/loki/commit/3b74ccebe09a9352033d02c95394053d17d6b505))
* **v2-engine:** Match v1 logfmt non-strict behavior (silently swallow parse errors) ([#22902](https://github.com/grafana/loki/issues/22902)) ([10fb976](https://github.com/grafana/loki/commit/10fb9764958d81277c9558fed3b6e11b43afc879))
* **v2-engine:** Place label_format outputs in Parsed category and remove pre-existing same-name labels to match v1 ([#22624](https://github.com/grafana/loki/issues/22624)) ([8c7eef3](https://github.com/grafana/loki/commit/8c7eef3ec6c816558d9806023a00af9a105d4026))
* **v2-engine:** Preserve empty-valued _extracted parsed labels across chained ColumnCompat passes to match v1 ([#22578](https://github.com/grafana/loki/issues/22578)) ([147b3ae](https://github.com/grafana/loki/commit/147b3aef423418c2317ed6ecbd96b6bb794eba58))
* **v2-engine:** Preserve explicit empty values from line_format/label_format through mergeColumns to match v1 ([#22428](https://github.com/grafana/loki/issues/22428)) ([3430739](https://github.com/grafana/loki/commit/34307396fff982f499bf886c1fb90654dd97100f))
* **v2-engine:** Preserve unwrap label when outer aggregation groups by it ([#23332](https://github.com/grafana/loki/issues/23332)) ([d0822bc](https://github.com/grafana/loki/commit/d0822bcc3c355d886d07920023cedd7f53408898))
* **v2-engine:** Push regexp parser source column to scan projections ([#22804](https://github.com/grafana/loki/issues/22804)) ([0226c8e](https://github.com/grafana/loki/commit/0226c8e8c928861cd948f7c8baf976bcfcba341b))
* **v2-engine:** Renaming of label using label_format in v2 must drop all label types except builtin/generated ones ([#22375](https://github.com/grafana/loki/issues/22375)) ([f01d09f](https://github.com/grafana/loki/commit/f01d09f68ef11f44f03d528600452e4b2d5b55b2))
* **v2-engine:** Render null/missing parsed labels as "" in line_format and label_format to match v1 ([#22342](https://github.com/grafana/loki/issues/22342)) ([2d1986e](https://github.com/grafana/loki/commit/2d1986edc704eb7acd5f1abe12ac4076aa01de00))
* **v2-engine:** Stop double-underscoring nested keys with digit start in json parser ([#23325](https://github.com/grafana/loki/issues/23325)) ([714d4d2](https://github.com/grafana/loki/commit/714d4d2589062613290a4505ecadfc187f0509dd))
* **v2-engine:** Treat absent column as empty string in scan-layer predicate pushdown to match v1 LogQL semantics ([#22448](https://github.com/grafana/loki/issues/22448)) ([304cda5](https://github.com/grafana/loki/commit/304cda505286c1a03d77262ead291fe7f78b8f80))
* **v2-engine:** Treat null string column entries as empty string in label/line filters to match v1 LogQL semantics ([#22298](https://github.com/grafana/loki/issues/22298)) ([5b3883d](https://github.com/grafana/loki/commit/5b3883d672c732702fe74d57ff27df1dc5c5ff52))
* **v2-engine:** Wrap results cache inside step-align so cache sees aligned bounds ([#22852](https://github.com/grafana/loki/issues/22852)) ([9059ea3](https://github.com/grafana/loki/commit/9059ea39a820479515da425edb33c3c9d3bbc994))
* **version:** Copy build info to Prometheus common library ([#22343](https://github.com/grafana/loki/issues/22343)) ([43ab4aa](https://github.com/grafana/loki/commit/43ab4aac8ba688660ee85cf1b5f72ae2f5ea733e))
* YAML decode failures in recent versions of go-yaml ([#22871](https://github.com/grafana/loki/issues/22871)) ([a92b05c](https://github.com/grafana/loki/commit/a92b05c51626880bf96f83901bcf39f6e405d77d))


### Performance Improvements

* **dataobj:** Speed up index compaction (O(1) stats size, trim postings bitmaps) ([#23274](https://github.com/grafana/loki/issues/23274)) ([f3388e0](https://github.com/grafana/loki/commit/f3388e0f742e69f9a91a65d05bd624f51479a401))
* **engine:** Short-circuit DataObjScan when logs predicate is unsatisfiable ([#22162](https://github.com/grafana/loki/issues/22162)) ([a7adf30](https://github.com/grafana/loki/commit/a7adf30edb7b6a594fca8cec6c4932051eab0ab0))
* **logql:** Cap series accumulation at the max_query_series limit ([#23123](https://github.com/grafana/loki/issues/23123)) ([871ed63](https://github.com/grafana/loki/commit/871ed636ff60f31668167bcaada6f3bc68fba3ea))
* Optimise rendezvous shuffle sharding algorithm ([#22269](https://github.com/grafana/loki/issues/22269)) ([69822a3](https://github.com/grafana/loki/commit/69822a387c960307f0876584fcede24628fb07fa))
* **querier:** Avoid expensive shuffle sharding when shardSize=0 ([#22912](https://github.com/grafana/loki/issues/22912)) ([f8aad8a](https://github.com/grafana/loki/commit/f8aad8a0b34799eecbfdc619aa0b35cc54a1d0e9))


### Reverts

* **compactor:** Revert read new postings section type ([#22143](https://github.com/grafana/loki/issues/22143)) ([#22786](https://github.com/grafana/loki/issues/22786)) ([2a25ec3](https://github.com/grafana/loki/commit/2a25ec3624158e036f0ac2fc0cb05cf9404c273b))
* Remove deprecated `/api/prom` API endpoints ([#21569](https://github.com/grafana/loki/issues/21569)) ([#22466](https://github.com/grafana/loki/issues/22466)) ([5b4cd23](https://github.com/grafana/loki/commit/5b4cd2305353b13ebb7a50e60acb6184bcb1f7ec))


### Miscellaneous Chores

* Remove deprecated `/api/prom` API endpoints ([#21569](https://github.com/grafana/loki/issues/21569)) ([8d82d85](https://github.com/grafana/loki/commit/8d82d8560f7b780151c319d6faf945915ae885d4))
* Remove deprecated `per_tenant_override_config` and `per_tenant_override_period` ([#22856](https://github.com/grafana/loki/issues/22856)) ([4cdf19f](https://github.com/grafana/loki/commit/4cdf19f56f26d0af4f469f55d1db7968fd62bac8))
* Remove targets for Simple Scalable Deployment (SSD) ([#21481](https://github.com/grafana/loki/issues/21481)) ([4245b4a](https://github.com/grafana/loki/commit/4245b4a0aacb045f6c8a3535dd1e5f61f5ada78d))
* **storage:** Use Thanos storage clients by default ([#22676](https://github.com/grafana/loki/issues/22676)) ([22d470e](https://github.com/grafana/loki/commit/22d470eb6ca9ac681da67e9253d154f02c707f98))

## [3.8.0](https://github.com/grafana/loki/compare/v3.7.1...v3.8.0) (2026-06-08)


### ⚠ BREAKING CHANGES

* Remove support for BigTable/GCP storage backend ([#21502](https://github.com/grafana/loki/issues/21502))
* Remove deprecated Cassandra storage backend ([#21574](https://github.com/grafana/loki/issues/21574))
* Remove deprecated DynamoDB storage backend ([#21601](https://github.com/grafana/loki/issues/21601))
* Remove deprecated gRPC storage backend ([#21638](https://github.com/grafana/loki/issues/21638))
* Remove deprecated BoltDB storage backend for indexes ([#21637](https://github.com/grafana/loki/issues/21637))
* **ksonnet:** Remove boltdb-shipper specific flags from lib ([#21656](https://github.com/grafana/loki/issues/21656))
* Remove deprecated `loki_log_messages_total` metric ([#21764](https://github.com/grafana/loki/issues/21764))
* Rename metric `loki_log_flushes` ([#21765](https://github.com/grafana/loki/issues/21765))
* Remove deprecated `allow_deletes` configuration option ([#21808](https://github.com/grafana/loki/issues/21808))
* Remove deprecated per-tenant setting `unordered_writes` ([#21835](https://github.com/grafana/loki/issues/21835))
* Remove deprecated BoltDB Shipper storage backend ([#21678](https://github.com/grafana/loki/issues/21678))
* Remove deprecated write dedupe cache ([#22056](https://github.com/grafana/loki/issues/22056))
* Remove index read cache and index cache validity settings ([#22066](https://github.com/grafana/loki/issues/22066))
...
* Add limit on max buffered bytes in pattern-tee ([#21855](https://github.com/grafana/loki/issues/21855)) ([8c6c2ab](https://github.com/grafana/loki/commit/8c6c2ab5802e9eb30eabc32e5ddac010817bbcd5))
* add metric loki_distributor_dataobj_tee_estimate_rate_bytes ([#21441](https://github.com/grafana/loki/issues/21441)) ([cae9486](https://github.com/grafana/loki/commit/cae948659ad267bf202d520f5a31cbe10941fe0f))
* add per-phase histogram metrics to engine worker pipeline ([#21547](https://github.com/grafana/loki/issues/21547)) ([c0a243b](https://github.com/grafana/loki/commit/c0a243b2a12222aa8cfc6b56a8e951db12356a91))
* add stats and postings index sections with encoding abstraction ([#21442](https://github.com/grafana/loki/issues/21442)) ([8553815](https://github.com/grafana/loki/commit/8553815420d48ab2b60ae6dce96aaf250222b337))
* add time sharded estimate ([#21463](https://github.com/grafana/loki/issues/21463)) ([47e1e81](https://github.com/grafana/loki/commit/47e1e81f4e3ba05332243de2e66d1ec1fa2a7e07))
* Avoid executing tasks for which we have cached empty results ([#21437](https://github.com/grafana/loki/issues/21437)) ([fb6abe5](https://github.com/grafana/loki/commit/fb6abe5d08b625f562098689ad095a943aaa70b3))
* Batch cache fetches in schedulers during task pruning ([#21548](https://github.com/grafana/loki/issues/21548)) ([f367374](https://github.com/grafana/loki/commit/f3673747f61bd015f52cc11d72d5514c5436951a))
* **ci:** Include linux/riscv64 Loki build in releases ([#21597](https://github.com/grafana/loki/issues/21597)) ([76e65d7](https://github.com/grafana/loki/commit/76e65d7f1a7530917039721618782a5e250a7220))
* clamp pointerscans to index start/end timeranges ([#21534](https://github.com/grafana/loki/issues/21534)) ([2e0a70d](https://github.com/grafana/loki/commit/2e0a70dfca8c2975b7f054aa7f69031ab7d8b074))
* **compactor:** Reuse logsobj builder metrics ([#22138](https://github.com/grafana/loki/issues/22138)) ([bd6316d](https://github.com/grafana/loki/commit/bd6316d9ac9abe3243f9f1dfd8531415f585a756))
* **dataobj-compactor:** Add CompactionMerge physical-plan node ([#21844](https://github.com/grafana/loki/issues/21844)) ([12c419b](https://github.com/grafana/loki/commit/12c419b65df1f1c16187281a83381bcf71c0b7b2))
* **dataobj-compactor:** Add compactor target skeleton, no-op coordinator stub ([#21818](https://github.com/grafana/loki/issues/21818)) ([4cd2cf1](https://github.com/grafana/loki/commit/4cd2cf16bdd1c4d39f839b21a293704de3178f31))
* **dataobj-compactor:** Add dataobj-compactor-worker target scaffold ([#21873](https://github.com/grafana/loki/issues/21873)) ([3a3245b](https://github.com/grafana/loki/commit/3a3245ba995c462bda8476a88791296cc04b1623))
* **dataobj-compactor:** Calculate compaction runs/jobs ([#21845](https://github.com/grafana/loki/issues/21845)) ([3dd8056](https://github.com/grafana/loki/commit/3dd8056722fe243002d75fab716ea7911dc1a3fd))
* **dataobj-compactor:** Compactor coordinator/planner main loop ([#21973](https://github.com/grafana/loki/issues/21973)) ([5790955](https://github.com/grafana/loki/commit/5790955aba2ad3c46f4f49329778b499d196f23f))
* **dataobj-compactor:** IndexMerge executor over postings + stats sections ([#22233](https://github.com/grafana/loki/issues/22233)) ([030dd44](https://github.com/grafana/loki/commit/030dd4418dd820dd0f00ba540b62053f40805f9d))
...
* **dataobj/postings,stats:** Add merge builders and row decoders ([#22229](https://github.com/grafana/loki/issues/22229)) ([03cd800](https://github.com/grafana/loki/commit/03cd8002cf7e6d3a05364840a372cad4aef4bab3))
* **dataobj:** Add sort_schema config and feature flag ([#21460](https://github.com/grafana/loki/issues/21460)) ([30549ac](https://github.com/grafana/loki/commit/30549ac587879a22f60353497953151b88539152))
* **dataobj:** Implement sort schema ([#21557](https://github.com/grafana/loki/issues/21557)) ([a2c4884](https://github.com/grafana/loki/commit/a2c48847a4e39a45369b307c2a1af968d90a757f))
* **dataobj:** Reduce postings indexing allocations via observe/aggregate pattern ([#21610](https://github.com/grafana/loki/issues/21610)) ([96a0574](https://github.com/grafana/loki/commit/96a0574783f99cbc30bfd27eb72cd272a2f39210))
* default loki-mixin dashboards to TSDB ([#18732](https://github.com/grafana/loki/issues/18732)) ([d5fa6f7](https://github.com/grafana/loki/commit/d5fa6f7f9162c9d600d6aa85a84d3099e1fb1a5b))
* **distributor:** Add produce latency histogram to dataobj-tee ([#22068](https://github.com/grafana/loki/issues/22068)) ([047870d](https://github.com/grafana/loki/commit/047870de78a8bbe1cff12bf7cc3e36abccc91ab9))
* **engine/physicalpb:** Add IndexMerge node marshalling ([#22231](https://github.com/grafana/loki/issues/22231)) ([b3e9265](https://github.com/grafana/loki/commit/b3e9265b6c5ddab4e3e3bce43ffefe97da73e3b3))
* **engine/workflow:** Add dormant taskTypeCompaction admission lane ([#21813](https://github.com/grafana/loki/issues/21813)) ([4e9a034](https://github.com/grafana/loki/commit/4e9a034ef8f76df1807fac1fdbe2b3903ddc7f67))
...
* handle context cancelation in memcached batching ([#21625](https://github.com/grafana/loki/issues/21625)) ([abc30f5](https://github.com/grafana/loki/commit/abc30f56f04c739803f1b064fa827689efcb4d0f))
* **helm:** Update charts for GEL ([#21590](https://github.com/grafana/loki/issues/21590)) ([733fb71](https://github.com/grafana/loki/commit/733fb71202d774d86951376b0e83055edd04bd02))
* Improve index builder performance by not holding the lock during the whole `Calculate` ([#21632](https://github.com/grafana/loki/issues/21632)) ([08820d7](https://github.com/grafana/loki/commit/08820d7fa3d4d0be89c52423579230a1f027cc37))
* Introduce max-age option for index-builder ([#21294](https://github.com/grafana/loki/issues/21294)) ([4772bfc](https://github.com/grafana/loki/commit/4772bfc8f3d0379cb4d8a805c1fb2bc808f2ae7f))
* **logql:** Report estimated_query_bytes from index-stats lookups ([#21796](https://github.com/grafana/loki/issues/21796)) ([35ca2f6](https://github.com/grafana/loki/commit/35ca2f67a6c430f1c5471710bacd1282c14f3f0b))
* **lokitool:** Rename `rules lint` to `rules format` ([#21671](https://github.com/grafana/loki/issues/21671)) ([01f2177](https://github.com/grafana/loki/commit/01f21773d74e3be4dbb0c87258e3f7ceafa48ade))
* **metastore:** Add TableOfContentsWriter.ReplaceIndexPointers method ([#21932](https://github.com/grafana/loki/issues/21932)) ([10fc249](https://github.com/grafana/loki/commit/10fc249ce860c460034076ad96fc412ceabb97b4))
* more accurate counts of max_inflight_bytes ([#21611](https://github.com/grafana/loki/issues/21611)) ([4965669](https://github.com/grafana/loki/commit/4965669222c9f954ee4d64511fc8caf80e2a2265))
* On-disk serialization for postings and stats index sections ([#21591](https://github.com/grafana/loki/issues/21591)) ([deff86d](https://github.com/grafana/loki/commit/deff86de61298988c9b0ba5f6900c56924c7eddf))
...
* **query engine:** Add workflow optimizer to clamp predicates on scan nodes ([#21327](https://github.com/grafana/loki/issues/21327)) ([4e187b1](https://github.com/grafana/loki/commit/4e187b13dc6f2df9ee7f0f8f3c65e89b7419981b))
* **query engine:** Implement line_format and label_format with new engine ([#20123](https://github.com/grafana/loki/issues/20123)) ([7be7c9d](https://github.com/grafana/loki/commit/7be7c9d594a1d9535095d5e6c294f1bb6e678f02))
* **querytee:** route v2-unsupported request types directly to v1 in SplittingHandler ([#21450](https://github.com/grafana/loki/issues/21450)) ([4515b4b](https://github.com/grafana/loki/commit/4515b4b65c651250d248daf55226cc1e41f6fa26))
...
* Remove task_pruning_cache_fetch_batch_size in favor of existing memcached batching ([#21593](https://github.com/grafana/loki/issues/21593)) ([24ca0e4](https://github.com/grafana/loki/commit/24ca0e4a2f72c87e07309b033ab8ff4b9c1902a4))
* Resolve cached tasks in parent task ([#21558](https://github.com/grafana/loki/issues/21558)) ([904c963](https://github.com/grafana/loki/commit/904c963d17d7fbd050b42050ec82970c53d56934))
* return caching stats in new engine ([#21369](https://github.com/grafana/loki/issues/21369)) ([c32b57f](https://github.com/grafana/loki/commit/c32b57f36b5cc4ba09107c53cf7bb809dc4a6f43))
* Use `AppendOrdered` strategy to avoid sorting and merging stripes ([#21395](https://github.com/grafana/loki/issues/21395)) ([bd7530f](https://github.com/grafana/loki/commit/bd7530f322a62cb0df6d3d9291740d125fe71189))
* use query logger on metastore workflow ([#21511](https://github.com/grafana/loki/issues/21511)) ([b68de56](https://github.com/grafana/loki/commit/b68de5609279685d4ce6fcac84197b641373442c))
...
* Write all Kafka records at once ([#21542](https://github.com/grafana/loki/issues/21542)) ([fe7f43b](https://github.com/grafana/loki/commit/fe7f43b7f36d8f90931a3bfd35fadc83e1c23d5f))


### Bug Fixes

* allow S3 test to pass regardless of AWS config ([#21499](https://github.com/grafana/loki/issues/21499)) ([5fda167](https://github.com/grafana/loki/commit/5fda16703b9ad430a017b826b2552b02c465c2ca))
...
* **canary:** Default streamvalue to "push" when -push=true ([#21715](https://github.com/grafana/loki/issues/21715)) ([e6d39c8](https://github.com/grafana/loki/commit/e6d39c8888a3fbf87757ccbc8b5b15bad7f2b99e))
* **ci:** Align querytee weekly manifest image name with build output ([#22057](https://github.com/grafana/loki/issues/22057)) ([710ea5b](https://github.com/grafana/loki/commit/710ea5be285c815ac29ab09c0c2ecd1d880ca1f9))
...
* **columnar:** Copy label values to avoid retaining memory ([#21594](https://github.com/grafana/loki/issues/21594)) ([8ca16c4](https://github.com/grafana/loki/commit/8ca16c4e3037d8e16ba9c351f41aebcca9c9a27c))
* **columnar:** Don't release Arrow records ([#21670](https://github.com/grafana/loki/issues/21670)) ([9cdc29f](https://github.com/grafana/loki/commit/9cdc29fb993fcf7b700d2435550be7be09996cfb))
* **columnar:** Fix two race conditions in pkg/engine ([#21674](https://github.com/grafana/loki/issues/21674)) ([4850f1b](https://github.com/grafana/loki/commit/4850f1be4cc11256a19d5a7f42fd1ab1483b72d7))
...
* correct Makefile issues ([#21654](https://github.com/grafana/loki/issues/21654)) ([6f6e86a](https://github.com/grafana/loki/commit/6f6e86a461b28eaf0a8c24ade1babc1c3d1b41f3))
* **dataobj:** Handle constant predicates in logs predicate ordering ([#22160](https://github.com/grafana/loki/issues/22160)) ([5c0197c](https://github.com/grafana/loki/commit/5c0197c4f3805e741be6a79b3a66431be4743c49))
* **deployment:** Use conventional `combined` log format for NGINX access logs in loki-gateway ([#18870](https://github.com/grafana/loki/issues/18870)) ([f1cd475](https://github.com/grafana/loki/commit/f1cd4755a4af431acfdce6a433fdc63c90d64c18))
* **deps:** Revert "Update module google.golang.org/grpc to v1.81.0 (main)" ([#21850](https://github.com/grafana/loki/issues/21850)) ([336bf15](https://github.com/grafana/loki/commit/336bf15695adc92790dc3d7eb09160f773628163))
...
* **deps:** Update grafana/objstore module ([#21784](https://github.com/grafana/loki/issues/21784)) ([1017c95](https://github.com/grafana/loki/commit/1017c952aa59d463b1c04ad19de4ed8cb3080c0e))
...
* **deps:** update module charm.land/bubbletea/v2 to v2.0.5 (main) ([#21585](https://github.com/grafana/loki/issues/21585)) ([9ead25b](https://github.com/grafana/loki/commit/9ead25ba8717bc6165ddb58ce89fabb4de7a8786))
* **deps:** update module charm.land/bubbletea/v2 to v2.0.6 (main) ([#21616](https://github.com/grafana/loki/issues/21616)) ([ac49d83](https://github.com/grafana/loki/commit/ac49d8321e968014b983053a3f3db3fcdba36f34))
* **deps:** update module charm.land/lipgloss/v2 to v2.0.3 (main) ([#21587](https://github.com/grafana/loki/issues/21587)) ([573f5fe](https://github.com/grafana/loki/commit/573f5fe9bba44e7cd2dd25c356d74441a7c97bb3))
* **deps:** update module cloud.google.com/go/bigtable to v1.45.0 (main) ([#21383](https://github.com/grafana/loki/issues/21383)) ([62ecd74](https://github.com/grafana/loki/commit/62ecd745e56d3b5eea5c0cfc4cb2cd43fa82f78c))
...
* **deps:** update module cloud.google.com/go/storage to v1.62.1 (main) ([#21493](https://github.com/grafana/loki/issues/21493)) ([289cf2b](https://github.com/grafana/loki/commit/289cf2b4d5909c837ec4f3a4478caa0618577b11))
* **deps:** Update module cloud.google.com/go/storage to v1.62.2 (main) ([#22036](https://github.com/grafana/loki/issues/22036)) ([25fb325](https://github.com/grafana/loki/commit/25fb325e177d3faae516682ab53a7aa9700af7de))
* **deps:** Update module github.com/apache/arrow-go/v18 to v18.6.0 (main) ([#21727](https://github.com/grafana/loki/issues/21727)) ([11cbac6](https://github.com/grafana/loki/commit/11cbac68f39f4e637dba12e82656e1974cc82c87))
* **deps:** update module github.com/apache/cassandra-gocql-driver/v2 to v2.1.0 (main) ([#21377](https://github.com/grafana/loki/issues/21377)) ([e5e7e48](https://github.com/grafana/loki/commit/e5e7e48a1a030df5e71e48a98f29645067a500e1))
* **deps:** Update module github.com/aws/aws-sdk-go-v2 to v1.41.9 (main) ([#22130](https://github.com/grafana/loki/issues/22130)) ([25acf05](https://github.com/grafana/loki/commit/25acf0526f5b7f3f68f3db4d234d52e0f6ed4b8c))
* **deps:** update module github.com/aws/aws-sdk-go-v2/config to v1.32.14 (main) ([#21315](https://github.com/grafana/loki/issues/21315)) ([cbf0444](https://github.com/grafana/loki/commit/cbf0444ee7fb319d20b5b9137fb1006c3bfaf73a))
* **deps:** Update module github.com/aws/aws-sdk-go-v2/config to v1.32.16 (main) ([#21618](https://github.com/grafana/loki/issues/21618)) ([b14e5b2](https://github.com/grafana/loki/commit/b14e5b29af73d1f910cd6fee009b1f04e89867ca))
* **deps:** Update module github.com/aws/aws-sdk-go-v2/config to v1.32.17 (main) ([#21751](https://github.com/grafana/loki/issues/21751)) ([b729126](https://github.com/grafana/loki/commit/b729126e389d2c89fbb726713e83e291f1240926))
* **deps:** Update module github.com/aws/aws-sdk-go-v2/config to v1.32.18 (main) ([#22037](https://github.com/grafana/loki/issues/22037)) ([059b569](https://github.com/grafana/loki/commit/059b569a221234c47fc17ea3327be726f58bcb73))
* **deps:** update module github.com/aws/aws-sdk-go-v2/credentials to v1.19.15 (main) ([#21634](https://github.com/grafana/loki/issues/21634)) ([19f8688](https://github.com/grafana/loki/commit/19f8688c9de6e49d85e79662d0937567561e2b09))
* **deps:** update module github.com/aws/aws-sdk-go-v2/service/dynamodb to v1.57.1 (main) ([#21235](https://github.com/grafana/loki/issues/21235)) ([dc15bfb](https://github.com/grafana/loki/commit/dc15bfb715a44d6c40750a51b3f4b5b412501d00))
...
* **deps:** update module github.com/aws/aws-sdk-go-v2/service/s3 to v1.99.1 (main) ([#21521](https://github.com/grafana/loki/issues/21521)) ([13e2a5a](https://github.com/grafana/loki/commit/13e2a5a72503c322b9977297a733d89a0a123921))
* **deps:** update module github.com/aws/smithy-go to v1.24.3 (main) ([#21416](https://github.com/grafana/loki/issues/21416)) ([5ec9b00](https://github.com/grafana/loki/commit/5ec9b0077c549337cbc4358652e770075b968cbf))
* **deps:** update module github.com/aws/smithy-go to v1.25.0 (main) ([#21613](https://github.com/grafana/loki/issues/21613)) ([88690fe](https://github.com/grafana/loki/commit/88690fe30a2e770dd222192216f62f371ee2d630))
* **deps:** Update module github.com/Azure/azure-sdk-for-go/sdk/storage/azblob to v1.7.0 (main) ([#22040](https://github.com/grafana/loki/issues/22040)) ([18612c0](https://github.com/grafana/loki/commit/18612c0c4b73599b8075fa5d0c797dbad43210b0))
...
* **deps:** update module github.com/baidubce/bce-sdk-go to v0.9.264 (main) ([#21513](https://github.com/grafana/loki/issues/21513)) ([ad2a80e](https://github.com/grafana/loki/commit/ad2a80e9144a2926742cedf9b2e603317b608a94))
* **deps:** update module github.com/baidubce/bce-sdk-go to v0.9.265 (main) ([#21629](https://github.com/grafana/loki/issues/21629)) ([eb67f6d](https://github.com/grafana/loki/commit/eb67f6dcc58a991e67bfcaf92857d582e9145f47))
* **deps:** update module github.com/coder/quartz to v0.3.1 (main) ([#21529](https://github.com/grafana/loki/issues/21529)) ([c7455ae](https://github.com/grafana/loki/commit/c7455ae253251ee126c6202e728c60470f554910))
...
* **deps:** update module github.com/grafana/loki/pkg/push to v0.4.0 (main) ([#21640](https://github.com/grafana/loki/issues/21640)) ([0a0078d](https://github.com/grafana/loki/commit/0a0078d8dd96114b426477e0978d13792eba6781))
...
* **deps:** Update module github.com/minio/minio-go/v7 to v7.1.0 (main) ([#21729](https://github.com/grafana/loki/issues/21729)) ([ddb4ee3](https://github.com/grafana/loki/commit/ddb4ee34a4a3f3e35611461eac7d54e761c68d0d))
* **deps:** Update module github.com/oschwald/geoip2-golang/v2 to v2.2.0 (main) ([#22041](https://github.com/grafana/loki/issues/22041)) ([9217cd2](https://github.com/grafana/loki/commit/9217cd25ba3cf58d4ffea30fcf1e11338812a0f0))
* **deps:** Update module github.com/parquet-go/parquet-go to v0.30.1 (main) ([#22042](https://github.com/grafana/loki/issues/22042)) ([93fb125](https://github.com/grafana/loki/commit/93fb125b91b0214d1d6f05d98f4fa1919dcbd95e))
...
* **deps:** update module github.com/tjhop/slog-gokit to v0.2.0 (main) ([#21565](https://github.com/grafana/loki/issues/21565)) ([5ff0204](https://github.com/grafana/loki/commit/5ff0204484062806d459ba849e38ff8d7491eaa4))
* **deps:** update module github.com/twmb/franz-go/pkg/kmsg to v1.13.1 (main) ([#21446](https://github.com/grafana/loki/issues/21446)) ([c9417c4](https://github.com/grafana/loki/commit/c9417c47e375ec4287351efda31939e74d697f36))
...
* **deps:** update module go.opentelemetry.io/collector/pdata to v1.55.0 (main) ([#21392](https://github.com/grafana/loki/issues/21392)) ([afebbf7](https://github.com/grafana/loki/commit/afebbf7ecc4d8dac5b83046b8388dee0934a6c85))
* **deps:** update module go.opentelemetry.io/collector/pdata to v1.56.0 (main) ([#21572](https://github.com/grafana/loki/issues/21572)) ([8fa464e](https://github.com/grafana/loki/commit/8fa464ebfd771f1000a8a0407a9c33728a2db69b))
...
* **deps:** update module go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc to v0.68.0 (main) ([#21505](https://github.com/grafana/loki/issues/21505)) ([8f24087](https://github.com/grafana/loki/commit/8f24087b617a5095e858ab4c0d80881986bebaed))
* **deps:** update module go.opentelemetry.io/contrib/instrumentation/net/http/httptrace/otelhttptrace to v0.68.0 (main) ([#21506](https://github.com/grafana/loki/issues/21506)) ([c21805a](https://github.com/grafana/loki/commit/c21805aca27d288b70942d11d6ab9b93159e503a))
* **deps:** update module go.opentelemetry.io/otel to v1.43.0 (main) ([#21418](https://github.com/grafana/loki/issues/21418)) ([148ec88](https://github.com/grafana/loki/commit/148ec8823f0ef66ca10b9e6b0dacb2e94ec467f1))
* **deps:** update module go.opentelemetry.io/otel/sdk to v1.43.0 (main) ([#21419](https://github.com/grafana/loki/issues/21419)) ([e4c0bf6](https://github.com/grafana/loki/commit/e4c0bf66a9bc4ce8cc958c129ad0051aff03caa9))
* **deps:** update module go.opentelemetry.io/otel/trace to v1.43.0 (main) ([#21420](https://github.com/grafana/loki/issues/21420)) ([08e2dac](https://github.com/grafana/loki/commit/08e2dac88b9223a49c93aef856052bf2561c1012))
* **deps:** Update module go.opentelemetry.io/otel/trace to v1.44.0 (main) ([#22118](https://github.com/grafana/loki/issues/22118)) ([dd603f4](https://github.com/grafana/loki/commit/dd603f45398e5c5f2072b57535e81ef05efea218))
* **deps:** update module golang.org/x/tools to v0.44.0 (main) ([#21532](https://github.com/grafana/loki/issues/21532)) ([7e6feef](https://github.com/grafana/loki/commit/7e6feef92d7a25703f3ae40a884bd44e71bf1f54))
...
* **deps:** update module google.golang.org/api to v0.274.0 (main) ([#21408](https://github.com/grafana/loki/issues/21408)) ([a90a776](https://github.com/grafana/loki/commit/a90a776d6f03159f47f1325055c2884649f453c3))
* **deps:** update module google.golang.org/api to v0.275.0 (main) ([#21514](https://github.com/grafana/loki/issues/21514)) ([8b3b432](https://github.com/grafana/loki/commit/8b3b432c0cd1699f235f33b14cc7e183ab2cb86c))
* **deps:** update module google.golang.org/api to v0.276.0 (main) ([#21606](https://github.com/grafana/loki/issues/21606)) ([8d0ef72](https://github.com/grafana/loki/commit/8d0ef724d8ed148a87dd08f8fa26a4ed1dd87a17))
...
* **deps:** update module google.golang.org/grpc to v1.80.0 (main) ([#21409](https://github.com/grafana/loki/issues/21409)) ([7adda86](https://github.com/grafana/loki/commit/7adda86dad9eee117989e09e4ce66ba891848f04))
* **deps:** Update module google.golang.org/grpc to v1.81.0 (main) ([#21782](https://github.com/grafana/loki/issues/21782)) ([9194af8](https://github.com/grafana/loki/commit/9194af8ffc3e7f75e58c7b501c45aad82fbe76e3))
* **deps:** update module k8s.io/apimachinery to v0.35.4 (main) ([#21600](https://github.com/grafana/loki/issues/21600)) ([b663ffb](https://github.com/grafana/loki/commit/b663ffba595793bced65728c25607d610ae4bade))
* **distributor:** Keep stream sharding enabled with empty overrides ([#21829](https://github.com/grafana/loki/issues/21829)) ([164bc0b](https://github.com/grafana/loki/commit/164bc0bd14a74c341dd85db13d627e650ee0c9a0))
* **distributor:** Make max_line_size_truncate truncation observable ([#22105](https://github.com/grafana/loki/issues/22105)) ([233073f](https://github.com/grafana/loki/commit/233073f09c902441a82773d5f07e5984bf17dcd5))
* do not spawn workers if ingesters are disabled ([#21539](https://github.com/grafana/loki/issues/21539)) ([0f29990](https://github.com/grafana/loki/commit/0f299902d4bbbbfb26db5fa893925d2f33156b0e))
* Don't drain in Kafka mode ([#21716](https://github.com/grafana/loki/issues/21716)) ([c405d54](https://github.com/grafana/loki/commit/c405d54f72cf61544e2b4b3285a8bf7f9d1ec974))
* **engine/workflow:** Surface failed-task errors before results EOF ([#22232](https://github.com/grafana/loki/issues/22232)) ([beb732c](https://github.com/grafana/loki/commit/beb732c3c5b453353543aca5c3547ba334ebf7af))
* **engine:** Revert "chore: Enable unwrap of batching pipeline ([#21795](https://github.com/grafana/loki/issues/21795))" ([#21856](https://github.com/grafana/loki/issues/21856)) ([fef3db0](https://github.com/grafana/loki/commit/fef3db05f1aeb00793b3002a54086b72a5df54db))
...
* Fix MatchNotRegexp misbehaving with the new query engine ([#21544](https://github.com/grafana/loki/issues/21544)) ([bb55364](https://github.com/grafana/loki/commit/bb55364a780a652ea3c8ab0d8bb79a0e39b58962))
...
* Flush reason counter not initialized to 0, breaks PromQL functions ([#21772](https://github.com/grafana/loki/issues/21772)) ([61b377d](https://github.com/grafana/loki/commit/61b377db509bebdb67f00a2db8212cc69d95b47b))
* **goldfish:** Fix migration typo ([#22272](https://github.com/grafana/loki/issues/22272)) ([bd4eab2](https://github.com/grafana/loki/commit/bd4eab223cbe3a7d4d4eb467c43e5c687b006780))
* **goldfish:** Use queryUsedV2Engine stat instead of warning message ([#21803](https://github.com/grafana/loki/issues/21803)) ([fd87f9e](https://github.com/grafana/loki/commit/fd87f9e6858cfca82515d7ab4c061e2b0e590512))
* grouping by non-existent label in v2 query engine ([#21430](https://github.com/grafana/loki/issues/21430)) ([e74e2a2](https://github.com/grafana/loki/commit/e74e2a20c5604b1f8bbee02149f9ec2d05c0ecd0))
* handle `INIT` from frontend in running scheduler which is not in `shouldRun` state ([#19866](https://github.com/grafana/loki/issues/19866)) ([6f81a0c](https://github.com/grafana/loki/commit/6f81a0cab51801676001cea0f1c499ebface2875))
* **helm:** Use correct `access_key_id` mapping in `alibabacloud`  storage helper template ([#21827](https://github.com/grafana/loki/issues/21827)) ([ea99cb8](https://github.com/grafana/loki/commit/ea99cb85233b6ffdc541c73ba6fc7c9a7e82ecc3))
* **ibmcloud:** prevent IsObjectNotFoundErr from crashing ([#20668](https://github.com/grafana/loki/issues/20668)) ([dce323d](https://github.com/grafana/loki/commit/dce323d95e6292cf342af010b9d9b92ee4d48429))
* Incorrect bounds check in tryReserveBufferedBytes ([#21867](https://github.com/grafana/loki/issues/21867)) ([501d19d](https://github.com/grafana/loki/commit/501d19df605a62833af5cc2d8b05699aada3e866))
* Incorrect impl of ProduceSync ([#21702](https://github.com/grafana/loki/issues/21702)) ([9a9ba8d](https://github.com/grafana/loki/commit/9a9ba8d05b0a7191d0fc5221f1ff84cdb4445f19))
...
* **logfmt:** use debug logging instead of error similar to what json plugin does ([#20885](https://github.com/grafana/loki/issues/20885)) ([c10cc90](https://github.com/grafana/loki/commit/c10cc902432894c73b8718199a37cd5ab97c5169))
* **logging:** Stabilize ring watcher log messages ([#21953](https://github.com/grafana/loki/issues/21953)) ([98d43a2](https://github.com/grafana/loki/commit/98d43a23c142e9039ed3db0b51ef40ffe0087693))
* **logging:** Stabilize storage layer log messages ([#21955](https://github.com/grafana/loki/issues/21955)) ([8dfe7e7](https://github.com/grafana/loki/commit/8dfe7e75e84b698c059c793bf1e9e378bc532c7f))
* **logql:** Decode unpadded base64 template values ([#21828](https://github.com/grafana/loki/issues/21828)) ([8c1bc07](https://github.com/grafana/loki/commit/8c1bc07b67f8f03f3b7a40f76ac3bb7752d344da))
* **logql:** Fix nil pointer dereference caused by data race during query blocking ([#21726](https://github.com/grafana/loki/issues/21726)) ([ed28b61](https://github.com/grafana/loki/commit/ed28b614938a4b69663f94f29ff8dac66845086a))
* **loki-canary:** Apply -labels and -query-append to metric and tail queries ([#21672](https://github.com/grafana/loki/issues/21672)) ([940117d](https://github.com/grafana/loki/commit/940117de0138d521c7d978d3de950e40f709ee9b))
* **lokitool:** correct rule-files help text for rules lint ([#21592](https://github.com/grafana/loki/issues/21592)) ([5f896b3](https://github.com/grafana/loki/commit/5f896b3f4ecd2caae8bfb2d3b04d3b66850f86ae))
...
* **mixin:** Fix regex pattern for compactor job matcher ([#22004](https://github.com/grafana/loki/issues/22004)) ([4fa6c79](https://github.com/grafana/loki/commit/4fa6c793b1e77424f04cdd3a9dc2d9d7a9a3ed07))
...
* Partial acceptance of records in ProduceSync ([#21781](https://github.com/grafana/loki/issues/21781)) ([5f0e699](https://github.com/grafana/loki/commit/5f0e69966ced877ba75152045618906d04cc2a96))
...
* **querier/tail:** Stop leaking goroutines on websocket teardown races ([#22073](https://github.com/grafana/loki/issues/22073)) ([7fd7241](https://github.com/grafana/loki/commit/7fd7241c8724e71808ebe86474ba5b1e13d437cc))
* **querier:** Add HTTP headers to volume response ([#21598](https://github.com/grafana/loki/issues/21598)) ([e10b92f](https://github.com/grafana/loki/commit/e10b92f584998d0055e5eab19b15c0fc65d35aea))
* **query-engine:** Fix different error messages ending up in different streams ([#21552](https://github.com/grafana/loki/issues/21552)) ([f4f4bce](https://github.com/grafana/loki/commit/f4f4bce1de324118e67278135051ddb450a9a8b5))
* **querytee:** Fix TestProxyEndpoint_QuerySplitting clock-drift bug ([#21779](https://github.com/grafana/loki/issues/21779)) ([da5a172](https://github.com/grafana/loki/commit/da5a17276294a8982989c6bb7f546cdfb8c13255))
* remove all unrelated AWS env vars from storage test ([#21533](https://github.com/grafana/loki/issues/21533)) ([98ab633](https://github.com/grafana/loki/commit/98ab63323d88090eab2fd301491bdb2568728aa3))
* Request source key for collision-renamed labels in metric queries ([#22141](https://github.com/grafana/loki/issues/22141)) ([77b271f](https://github.com/grafana/loki/commit/77b271f9c9f24ea573f6ae3c2c3d9d70b47e1af5))
* restore pipe '|' as a word boundary in level detection ([#21428](https://github.com/grafana/loki/issues/21428)) ([234da0c](https://github.com/grafana/loki/commit/234da0c2b8998a192b82f2b5487698f4eb352bc6))
* restore single quote as word boundary in level detection ([#21429](https://github.com/grafana/loki/issues/21429)) ([7a6870c](https://github.com/grafana/loki/commit/7a6870c3075e83f1833f58f278b8ddd3ac8d0bcb))
* return error for query parameter integer overflow ([#21389](https://github.com/grafana/loki/issues/21389)) ([928fec3](https://github.com/grafana/loki/commit/928fec3dfe8065af56c6452d772d8f2b035365ba))
* Revert "fix(deps): update module github.com/grafana/loki/pkg/push to v0.4.0 (main)" ([#21666](https://github.com/grafana/loki/issues/21666)) ([f5d391e](https://github.com/grafana/loki/commit/f5d391e2ad02ad1a61c834788267f92a8297acbf))
* **ruler:** Fix broken structured logging for insight logs ([#21728](https://github.com/grafana/loki/issues/21728)) ([5fb2f48](https://github.com/grafana/loki/commit/5fb2f48fed3fea39abc37d4a6bc49f0d8d82d6fe))
* **ruler:** Skip dotfiles when listing local rule files ([#21519](https://github.com/grafana/loki/issues/21519)) ([99c0b02](https://github.com/grafana/loki/commit/99c0b02499f14d503c5033351836295ab800c60a))
* **storage:** attach SHA-256 checksum on PutObject for Object Lock buckets ([#21649](https://github.com/grafana/loki/issues/21649)) ([c83d748](https://github.com/grafana/loki/commit/c83d748936d85bd91d3e1f45cd22891c324da2a6))
* **storage:** Pre-compute SHA-256 to avoid aws-chunked on PutObject ([#22003](https://github.com/grafana/loki/issues/22003)) ([0a278d6](https://github.com/grafana/loki/commit/0a278d6b03d2c8fd00173fd03fbc2de54a248f0d))
* **storage:** Remove partial destination file when download fails ([#21974](https://github.com/grafana/loki/issues/21974)) ([3daba4f](https://github.com/grafana/loki/commit/3daba4ff01918f08adf3bc8cac950305c3d800b6))
* **storage:** Respect AZURE_AUTHORITY_HOST environment variable in servicePrincipalTokenFromFederatedToken ([#21554](https://github.com/grafana/loki/issues/21554)) ([e923183](https://github.com/grafana/loki/commit/e92318328b7271a383d9b487e37d6d20105745c2))
* **storage:** Use correct protocol and suffix from Azure connection string for SAS URLs ([#21555](https://github.com/grafana/loki/issues/21555)) ([e98653f](https://github.com/grafana/loki/commit/e98653ff93682d501887c66e01d4217aa95bcd2e))
* the "empty ring" error in quick-start guide for docker-compose.yaml ([#18006](https://github.com/grafana/loki/issues/18006)) ([6c4807e](https://github.com/grafana/loki/commit/6c4807eccee79557f935abfe8491790096ff47ae))
* **tsdb:** delete empty streams from builder map in ToIndexFile ([#21312](https://github.com/grafana/loki/issues/21312)) ([744b04f](https://github.com/grafana/loki/commit/744b04f072d40340dccad20abcf4655574f9aafa))
* **tsdb:** Do not try to ship TSDBs that cannot be opened upon start ([#21769](https://github.com/grafana/loki/issues/21769)) ([d4ce29a](https://github.com/grafana/loki/commit/d4ce29aa77840b785b68b0f0a1093d7c3e1bfe0e))
* Use consistent time units on operational dashboard ([#22155](https://github.com/grafana/loki/issues/22155)) ([684599a](https://github.com/grafana/loki/commit/684599a63b18f236e715ff6a9495c31125f7bee2))
* Use KafkaWriter in dataobj-tee ([#21732](https://github.com/grafana/loki/issues/21732)) ([d8f4d0f](https://github.com/grafana/loki/commit/d8f4d0f6668928184dd4aa993a7481101b0ea169))
...
* Use prometheus summary for high watermark metric ([#21906](https://github.com/grafana/loki/issues/21906)) ([5deb669](https://github.com/grafana/loki/commit/5deb6695d954412a4e0533105939beacc57b2b57))
* Wire up default gRPC client config to ruler's query-frontend clients ([#21549](https://github.com/grafana/loki/issues/21549)) ([43d0784](https://github.com/grafana/loki/commit/43d07847dba4aba1456cc4880398b287fb61bddf))
...
* **blooms:** return full slice to pool after use ([#20981](https://github.com/grafana/loki/issues/20981)) ([9d9c7af](https://github.com/grafana/loki/commit/9d9c7af431be52cbfb38658b98f59e650d975689))
* **engine:** Short-circuit DataObjScan when logs predicate is unsatisfiable ([#22162](https://github.com/grafana/loki/issues/22162)) ([a7adf30](https://github.com/grafana/loki/commit/a7adf30edb7b6a594fca8cec6c4932051eab0ab0))
...
* support shuffle shard by tenant to increase cache hits ([#21357](https://github.com/grafana/loki/issues/21357)) ([787276e](https://github.com/grafana/loki/commit/787276eeaeb2b51bfcdda9cb5a9dff791787dd2a))
* **tsdb:** Add defer closure missed from [#20970](https://github.com/grafana/loki/issues/20970) ([#20978](https://github.com/grafana/loki/issues/20978)) ([e9d724c](https://github.com/grafana/loki/commit/e9d724cb57de27f01d6c0886c92c209aa477ad2e))


### Miscellaneous Chores

* **ksonnet:** Remove boltdb-shipper specific flags from lib ([#21656](https://github.com/grafana/loki/issues/21656)) ([6446e91](https://github.com/grafana/loki/commit/6446e91fcb55b716e1e088c44db471164ccce4f1))
* Remove deprecated `allow_deletes` configuration option ([#21808](https://github.com/grafana/loki/issues/21808)) ([eb17156](https://github.com/grafana/loki/commit/eb171564479b1a19fb7d03efbe087b8aa4a26d9e))
* Remove deprecated `loki_log_messages_total` metric ([#21764](https://github.com/grafana/loki/issues/21764)) ([5046245](https://github.com/grafana/loki/commit/50462454bf56d365296fb71f37f35d8064ae5fb0))
* Remove deprecated BoltDB Shipper storage backend ([#21678](https://github.com/grafana/loki/issues/21678)) ([ba9864c](https://github.com/grafana/loki/commit/ba9864c3d566e91b31b1ed8f3f43695192323de6))
* Remove deprecated BoltDB storage backend for indexes ([#21637](https://github.com/grafana/loki/issues/21637)) ([7bd0ca3](https://github.com/grafana/loki/commit/7bd0ca337cc08cacbf8127e8ebf97176130403e3))
* Remove deprecated Cassandra storage backend ([#21574](https://github.com/grafana/loki/issues/21574)) ([7c64707](https://github.com/grafana/loki/commit/7c6470707ab889d2a1f1f7a95b587b7d0783d755))
* Remove deprecated DynamoDB storage backend ([#21601](https://github.com/grafana/loki/issues/21601)) ([67bf1e6](https://github.com/grafana/loki/commit/67bf1e61c40353366036e4206c8aeb0ddf816f10))
* Remove deprecated gRPC storage backend ([#21638](https://github.com/grafana/loki/issues/21638)) ([5291b3f](https://github.com/grafana/loki/commit/5291b3f6796dbc57ce528f52f07204ff34305536))
* Remove deprecated per-tenant setting `unordered_writes` ([#21835](https://github.com/grafana/loki/issues/21835)) ([352c7fc](https://github.com/grafana/loki/commit/352c7fca241ec3080e215f57831479382bc97aff))
* Remove deprecated write dedupe cache ([#22056](https://github.com/grafana/loki/issues/22056)) ([cc02f60](https://github.com/grafana/loki/commit/cc02f60337417675a3da41c978699f7661b6fb51))
* Remove index read cache and index cache validity settings ([#22066](https://github.com/grafana/loki/issues/22066)) ([f3f662c](https://github.com/grafana/loki/commit/f3f662c1a0c1b8c4581890cdc1a5f542796a8d3f))
* Remove support for BigTable/GCP storage backend ([#21502](https://github.com/grafana/loki/issues/21502)) ([1846a8f](https://github.com/grafana/loki/commit/1846a8fff45e37b2db721f3303b5df37c61d3921))
* Rename metric `loki_log_flushes` ([#21765](https://github.com/grafana/loki/issues/21765)) ([67b213e](https://github.com/grafana/loki/commit/67b213eae7d74f8442219df187da129da7d9301f))
...
* Upgrade go to 1.25.8 ([#21116](https://github.com/grafana/loki/issues/21116)) ([3b305e3](https://github.com/grafana/loki/commit/3b305e3fe11a23c02ba34eb0382e06d5df0e3e07))
...
* **deps:** Update go version to 1.24.11 ([#20200](https://github.com/grafana/loki/issues/20200)) ([79d8922](https://github.com/grafana/loki/commit/79d8922b9c4df8a89efe72afb25daabd90dadf2c))
...
## [3.4.6](https://github.com/grafana/loki/compare/v3.4.5...v3.4.6) (2025-09-09)

### Bug Fixes

* **release-3.4.x:** upgrade go minor version ([#19137](https://github.com/grafana/loki/issues/19137)) ([2b7b94f](https://github.com/grafana/loki/commit/2b7b94ffbfe4b5434aff6a9bd8cdd69c440650ac))
...
* upgrade go and alpine versions ([#19703](https://github.com/grafana/loki/issues/19703)) ([be0ac95](https://github.com/grafana/loki/commit/be0ac95a27769b782758d6ad41ba6c0037773696))
...
This release updates a few dependencies to bring in various security patches (see [CHANGELOG](https://github.com/grafana/loki/blob/release-2.8.x/CHANGELOG.md) for specifics).
