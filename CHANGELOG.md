...
* [11499](https://github.com/grafana/loki/pull/11284) **jmichalek132** Config: Adds `-query-frontend.log-query-request-headers` to enable logging of request headers in query logs.
