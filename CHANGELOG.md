...
## [3.9.0](https://github.com/grafana/loki/compare/v3.8.0...v3.9.0) (2026-09-23)


### ⚠ BREAKING CHANGES

* Remove deprecated ruler_remote_write_* per-tenant limits ([#22941](https://github.com/grafana/loki/issues/22941))
* **frontend:** Default frontend.encoding to protobuf ([#23985](https://github.com/grafana/loki/issues/23985))

### Features

* Add a gauge for the max inflight bytes limit ([#24209](https://github.com/grafana/loki/issues/24209)) ([110923a](https://github.com/grafana/loki/commit/110923ad753346ba7961e9409ff647b8fbe42b6f))
* Add flag to ignore missing chunks during deletion of logs with line filter ([#24204](https://github.com/grafana/loki/issues/24204)) ([22b28a7](https://github.com/grafana/loki/commit/22b28a7002fb89a1dabb29cf050221589e93ed2d))
* Add per tenant max push size override ([#24194](https://github.com/grafana/loki/issues/24194)) ([443c975](https://github.com/grafana/loki/commit/443c975ad3238130bd8974850388b3a1b59ba0b6))
* Add q param to /config for scoped field access ([#24230](https://github.com/grafana/loki/issues/24230)) ([b645ac3](https://github.com/grafana/loki/commit/b645ac3ca2e92fbd6c415228b6851e59a6199fd3))
* Add support for sharding nested streams by rate and time ([#24476](https://github.com/grafana/loki/issues/24476)) ([a832813](https://github.com/grafana/loki/commit/a83281353cf6ce192be30d0d935b53f675a79f66))
* Align loki_querier_worker_inflight_queries metric betweek Frontend v1 and v2 ([#23452](https://github.com/grafana/loki/issues/23452)) ([48444ab](https://github.com/grafana/loki/commit/48444abc873268e14ae587df2f583a3bae51d149))
* **canary:** Implement support for path prefixes ([#24534](https://github.com/grafana/loki/issues/24534)) ([a8b5c92](https://github.com/grafana/loki/commit/a8b5c9207a6fbed8d2ffd523db7d9e600592b896))
* Collapse max request body size and decompressed size ([#24076](https://github.com/grafana/loki/issues/24076)) ([3dc5a8e](https://github.com/grafana/loki/commit/3dc5a8e97e012a5aeb3cc216a15f250c8a380827))
* **compaction:** Merge unique label sets to one global ID during compaction ([#24107](https://github.com/grafana/loki/issues/24107)) ([48e7ae3](https://github.com/grafana/loki/commit/48e7ae39b0976d722e1ab793e70b75b2ad9907f0))
* **dataobj:** Add metadata cache mechanism for data object opens ([#24553](https://github.com/grafana/loki/issues/24553)) ([174912b](https://github.com/grafana/loki/commit/174912bb8fe408c77b111541d151ee63c383c311))
* **dataobj:** Back off idle compaction workers to spare object storage ([#23372](https://github.com/grafana/loki/issues/23372)) ([1c57d2c](https://github.com/grafana/loki/commit/1c57d2c542c17e58cf1447e85fb9e543040e7502))
* **dataobj:** Enable lazy downloading of pages in batches when reading dataobj ([#24041](https://github.com/grafana/loki/issues/24041)) ([bf703b0](https://github.com/grafana/loki/commit/bf703b09246981c094d27a8ade4f3cd79a3e1f84))
* **dataobj:** Filter streams by shard bucket range ([#24594](https://github.com/grafana/loki/issues/24594)) ([8522c1a](https://github.com/grafana/loki/commit/8522c1aed5f8542ea1bafafa73f62855f33a93d5))
* **dataobj:** Match stream IDs in the streams row reader ([#24592](https://github.com/grafana/loki/issues/24592)) ([98def97](https://github.com/grafana/loki/commit/98def974c6af342ed6f5a7cef0b017ee1cffacbe))
* **dataobj:** Persist shard bucket in index objects ([#24010](https://github.com/grafana/loki/issues/24010)) ([3b9130a](https://github.com/grafana/loki/commit/3b9130a6c06eda26dd307aae8cc2c932919dba86))
* **dataobj:** Project columns in the logs row reader ([#24585](https://github.com/grafana/loki/issues/24585)) ([51a4cb1](https://github.com/grafana/loki/commit/51a4cb1279544b75fcfe634f620c0de974a72361))
* **dataobj:** Write min/max shard buckets to index files ([#24225](https://github.com/grafana/loki/issues/24225)) ([8b80648](https://github.com/grafana/loki/commit/8b806487034c36de949b89c000696681a89143d6))
* **indexgateway:** Add admission control to bound concurrent requests ([#23932](https://github.com/grafana/loki/issues/23932)) ([d8e1eaa](https://github.com/grafana/loki/commit/d8e1eaa505365aafe217a6aa336f8da7b60216b4))
* **iter:** Add stream-first sample iterator merge ([#24539](https://github.com/grafana/loki/issues/24539)) ([77a72aa](https://github.com/grafana/loki/commit/77a72aab4844443146da148667e4ce5d293db26d))
* **kafka:** Kafka decoders support both formats ([#24244](https://github.com/grafana/loki/issues/24244)) ([52c7d20](https://github.com/grafana/loki/commit/52c7d20c86a0883a3cde6c0f33e3ef35e459e45d))
* **kafka:** Kafka encoder for InternalPushRequest proto ([#24412](https://github.com/grafana/loki/issues/24412)) ([fd9742a](https://github.com/grafana/loki/commit/fd9742ab49f2d9542b35960ffade7e06324eeced))
* **logcli:** Return errors from library and handle fatal in CLI ([#18778](https://github.com/grafana/loki/issues/18778)) ([68171cf](https://github.com/grafana/loki/commit/68171cf4beca58112b7838bb3966f0113073b9b7))
* **logline:** Split Logline filters into k gap-cut envelopes ([#24475](https://github.com/grafana/loki/issues/24475)) ([8853153](https://github.com/grafana/loki/commit/885315321317cf1df17634d391c075b59a56b724))
* **logql:** Add approx_count_distinct syntax and extractor ([#24112](https://github.com/grafana/loki/issues/24112)) ([e70b294](https://github.com/grafana/loki/commit/e70b294853fa470d838a8e1a24020e0348d19dc3))
* **logql:** Evaluate approx_count_distinct with HyperLogLog ([#24114](https://github.com/grafana/loki/issues/24114)) ([21d9d6b](https://github.com/grafana/loki/commit/21d9d6b2ace16ed92bc20d45fc316de41b2a6d32))
* **logql:** Evaluate CountDistinctSketchExpr as mergeable HLL sketches ([#24196](https://github.com/grafana/loki/issues/24196)) ([79c7a7d](https://github.com/grafana/loki/commit/79c7a7d8f562b8e93c902a7710777be175948c44))
* **logql:** Shard and transport approx_count_distinct sketches ([#24120](https://github.com/grafana/loki/issues/24120)) ([3969791](https://github.com/grafana/loki/commit/3969791f0453ca3fd742b7fc8264371316a2ef4c))
* Move logline hintprovider and logline/v3 to Loki ([#24440](https://github.com/grafana/loki/issues/24440)) ([9c24b8d](https://github.com/grafana/loki/commit/9c24b8d73cb0526592fc9c7b0f0344d33df9d8ca))
* Move logline query-frontend and limits to Loki ([#24455](https://github.com/grafana/loki/issues/24455)) ([f25906d](https://github.com/grafana/loki/commit/f25906d67209ee3aac0b540363736c95f6c7b6b0))
* Move some logline packages to Loki ([#24435](https://github.com/grafana/loki/issues/24435)) ([d769a31](https://github.com/grafana/loki/commit/d769a31fb0ebd3ef5114fc52ad92ffaf7c09abcf))
...
* **storage:** Add custom TLS CA certificate support for Azure Blob Storage connections ([#23062](https://github.com/grafana/loki/issues/23062)) ([3a68a80](https://github.com/grafana/loki/commit/3a68a801d8cba0ba26d751d7a51f1f2165733ea6))
* **storage:** Add stream-first sample order to the chunk store ([#24562](https://github.com/grafana/loki/issues/24562)) ([8eb103b](https://github.com/grafana/loki/commit/8eb103be23127b60929c2fa805fed94f1189fa11))
* Support more kafka producer options ([#24402](https://github.com/grafana/loki/issues/24402)) ([bd2cc6f](https://github.com/grafana/loki/commit/bd2cc6f325415df774b09c825782fa16f9c2240b))
* **validation:** Add inherit_limits flag to per-policy override limits ([#23751](https://github.com/grafana/loki/issues/23751)) ([bcc85b0](https://github.com/grafana/loki/commit/bcc85b063751705abf33ad3633b98f338726da5c))


### Bug Fixes

* Add meaningful chunk fetch loss metrics ([#23925](https://github.com/grafana/loki/issues/23925)) ([b76910e](https://github.com/grafana/loki/commit/b76910eb9734fcc3b34a875af71dfc6ce934cb14))
* Analytics stats_test to allow for repeated test runs ([#24501](https://github.com/grafana/loki/issues/24501)) ([8b55f0e](https://github.com/grafana/loki/commit/8b55f0ecdba9dcdf4829a8a7e1079ebee66fe483))
...
* **compactor:** Skip completed jobs during timeout retries ([#24267](https://github.com/grafana/loki/issues/24267)) ([32c67fe](https://github.com/grafana/loki/commit/32c67febea3dec952f37014fefc33cc8270d38ed))
* Data race in cached client ([#24205](https://github.com/grafana/loki/issues/24205)) ([f8dc184](https://github.com/grafana/loki/commit/f8dc1846299f3e65eabf72e4d02818e1e91959d3))
* Data race protection for filterer ([#24184](https://github.com/grafana/loki/issues/24184)) ([49b4327](https://github.com/grafana/loki/commit/49b432739c5c37a78d7474d65ca1c0e57fff889d))
* **dataobj-compaction:** Honor per-task section selection in LogMerge executor ([#23413](https://github.com/grafana/loki/issues/23413)) ([79edb1d](https://github.com/grafana/loki/commit/79edb1dfdd29eb26e787bef77718b7e880e8028b))
* **dataobj-compaction:** Open one section per Run during log-merge ([#24566](https://github.com/grafana/loki/issues/24566)) ([f7b6fd4](https://github.com/grafana/loki/commit/f7b6fd43edcb15fc1b19d3e6289d6389bd3ce0f4))
* **dataobj:** Initialize both statuses of the metastore write counter ([#24637](https://github.com/grafana/loki/issues/24637)) ([e16547d](https://github.com/grafana/loki/commit/e16547dd5cb101005ec01472498b0f4ca6310f67))
* **dataobj:** Keep zero and empty values when decoding logs rows ([#24579](https://github.com/grafana/loki/issues/24579)) ([f711dea](https://github.com/grafana/loki/commit/f711deabda61f46acc1261c8e7233974ffd3ce06))
* **dataobj:** Stop panicking on a negated constant predicate ([#24631](https://github.com/grafana/loki/issues/24631)) ([5bcbcc1](https://github.com/grafana/loki/commit/5bcbcc13092e58d42d19272deab16fdf6a421eb7))
* Delete counter label values before running tests ([#24502](https://github.com/grafana/loki/issues/24502)) ([bad7e54](https://github.com/grafana/loki/commit/bad7e54e9dbc2bfae98a299c1c292f0ee5145158))
* **deletion:** Keep symbol positions stable when rewriting a chunk ([#24434](https://github.com/grafana/loki/issues/24434)) ([5d7c70a](https://github.com/grafana/loki/commit/5d7c70a9c6cc7f3c651f3d1f9510e6557ced40d6))
* **deletion:** Validate delete request queries like read path queries ([#24228](https://github.com/grafana/loki/issues/24228)) ([7e24de1](https://github.com/grafana/loki/commit/7e24de1d0eddf4b5ae965ccf639c892e48e8cd1a))
* **deps:** Pin azure-sdk-for-go/sdk/storage/azblob to v1.8.0 [k325] ([#24701](https://github.com/grafana/loki/issues/24701)) ([61f4a6a](https://github.com/grafana/loki/commit/61f4a6aceec79e14b6e98c1de2aecfdb906758cb))
* **deps:** Update github.com/fluent/fluent-bit-go digest to ee23069 (main) ([#24246](https://github.com/grafana/loki/issues/24246)) ([d7fa17c](https://github.com/grafana/loki/commit/d7fa17c1c821022655e65311efb5f8ed6a75e4a1))
* **deps:** Update github.com/grafana/dskit digest to 4a836a7 (main) ([#23961](https://github.com/grafana/loki/issues/23961)) ([fca7448](https://github.com/grafana/loki/commit/fca74480bce6727b2d55cf611b7fc3493b3b5439))
...
* **deps:** Update github.com/prometheus/client_golang/exp digest to 3f5d680 (main) ([#24527](https://github.com/grafana/loki/issues/24527)) ([d72f0d4](https://github.com/grafana/loki/commit/d72f0d415a770dc7d1f3a637e92831288ce0bedb))
* **deps:** Update github.com/prometheus/client_golang/exp digest to 89c60c0 (main) ([#24170](https://github.com/grafana/loki/issues/24170)) ([576e13b](https://github.com/grafana/loki/commit/576e13bfb1d28b5a1c7348246e7dd5e3dab814d4))
* **deps:** Update github.com/prometheus/client_golang/exp digest to 9775124 (main) ([#24371](https://github.com/grafana/loki/issues/24371)) ([eb4cff6](https://github.com/grafana/loki/commit/eb4cff618fa12c0eafdbcbaaf11326c006e1ac4c))
* **deps:** Update github.com/prometheus/client_golang/exp digest to d2f148b (main) ([#24576](https://github.com/grafana/loki/issues/24576)) ([faea9d6](https://github.com/grafana/loki/commit/faea9d61f3c9323c89f3d04ab5320b9842133f86))
* **deps:** Update github.com/thanos-io/objstore digest to 44aca71 (main) ([#24481](https://github.com/grafana/loki/issues/24481)) ([bbb94ec](https://github.com/grafana/loki/commit/bbb94eca79f3f48e765b2339f8e2ca8e4ec73f51))
* **deps:** Update github.com/thanos-io/objstore digest to 4b0f367 (main) ([#24313](https://github.com/grafana/loki/issues/24313)) ([7744e58](https://github.com/grafana/loki/commit/7744e589be944dfad32789fdce65734daf240e21))
* **deps:** Update github.com/thanos-io/objstore digest to e42d91c (main) ([#24099](https://github.com/grafana/loki/issues/24099)) ([c327ef6](https://github.com/grafana/loki/commit/c327ef66943fde6ef180c1daf0e167310aab713e))
* **deps:** Update go4.org/netipx digest to 3075585 (main) ([#24217](https://github.com/grafana/loki/issues/24217)) ([9ae5dc6](https://github.com/grafana/loki/commit/9ae5dc68251be3cb45bdff81284dfab1cb3f9a47))
* **deps:** Update google.golang.org/genproto/googleapis/rpc digest to 08b0e42 (main) ([#24160](https://github.com/grafana/loki/issues/24160)) ([65e30f8](https://github.com/grafana/loki/commit/65e30f8488e8a5ea2013c6881675f8103a8f6bc7))
* **deps:** Update google.golang.org/genproto/googleapis/rpc digest to 18b4a75 (main) ([#24344](https://github.com/grafana/loki/issues/24344)) ([9c4574a](https://github.com/grafana/loki/commit/9c4574a2903a4761e523752c1be0c1882ff1c49b))
* **deps:** Update google.golang.org/genproto/googleapis/rpc digest to d0f1323 (main) ([#24407](https://github.com/grafana/loki/issues/24407)) ([e0f7be5](https://github.com/grafana/loki/commit/e0f7be550e6711a46727a0e27c0b43214d3f370e))
* **deps:** Update google.golang.org/genproto/googleapis/rpc digest to da73d73 (main) ([#24265](https://github.com/grafana/loki/issues/24265)) ([5311851](https://github.com/grafana/loki/commit/531185116942b9cb3e322b23e8048adb86077271))
...
* **deps:** Update google.golang.org/genproto/googleapis/rpc digest to f8649dd (main) ([#24488](https://github.com/grafana/loki/issues/24488)) ([78dc95d](https://github.com/grafana/loki/commit/78dc95d2aed9b5d985c569dc64a461c07734be77))
* **deps:** Update module charm.land/bubbles/v2 to v2.2.0 (main) ([#24178](https://github.com/grafana/loki/issues/24178)) ([84102f2](https://github.com/grafana/loki/commit/84102f286df1c1610cce1ba1055fa823b39bb15d))
* **deps:** Update module charm.land/bubbles/v2 to v2.2.1 (main) ([#24227](https://github.com/grafana/loki/issues/24227)) ([1dfc384](https://github.com/grafana/loki/commit/1dfc384ae7fff8879c4837dcade60febf6d7a8d1))
* **deps:** Update module charm.land/bubbletea/v2 to v2.0.9 (main) ([#24163](https://github.com/grafana/loki/issues/24163)) ([ff81c81](https://github.com/grafana/loki/commit/ff81c81af87a0aa5dc88674268339a7a49c42730))
...
* **deps:** Update module cloud.google.com/go/storage to v1.65.0 (main) ([#24156](https://github.com/grafana/loki/issues/24156)) ([c5b0568](https://github.com/grafana/loki/commit/c5b05685a15b8dc64ad43f946a50bf8ae2d32022))
* **deps:** Update module cloud.google.com/go/storage to v1.66.0 (main) ([#24288](https://github.com/grafana/loki/issues/24288)) ([f6aca6e](https://github.com/grafana/loki/commit/f6aca6eab1a6156d1498c96f36d4eeb0fe002a89))
* **deps:** Update module cloud.google.com/go/storage to v1.67.0 (main) ([#24387](https://github.com/grafana/loki/issues/24387)) ([ba999ad](https://github.com/grafana/loki/commit/ba999ad73723652254763fe1f6c2fe3e9771d38b))
* **deps:** Update module cloud.google.com/go/storage to v1.67.1 (main) ([#24489](https://github.com/grafana/loki/issues/24489)) ([f707e22](https://github.com/grafana/loki/commit/f707e22e20b3449f1e94eb178720af2891509bc2))
* **deps:** Update module github.com/alicebob/miniredis/v2 to v2.39.0 (main) ([#24373](https://github.com/grafana/loki/issues/24373)) ([0ecec4e](https://github.com/grafana/loki/commit/0ecec4eacf30cc2ea3e21048d8ea5f45e4c829e3))
* **deps:** Update module github.com/aliyun/credentials-go to v1.4.13 (main) ([#24132](https://github.com/grafana/loki/issues/24132)) ([3a600ca](https://github.com/grafana/loki/commit/3a600ca127e8358c24c69d876d71ded7dc7ffd59))
* **deps:** Update module github.com/aws/smithy-go to v1.27.10 (main) ([#24247](https://github.com/grafana/loki/issues/24247)) ([c5e609f](https://github.com/grafana/loki/commit/c5e609fda4df3ae0bad6725c67af9ef29bccd0d6))
* **deps:** Update module github.com/aws/smithy-go to v1.27.8 (main) ([#24020](https://github.com/grafana/loki/issues/24020)) ([9a2e6e1](https://github.com/grafana/loki/commit/9a2e6e1119243579bde48ad1b42d38c1ec41c7b5))
* **deps:** Update module github.com/aws/smithy-go to v1.27.9 (main) ([#24189](https://github.com/grafana/loki/issues/24189)) ([219fd98](https://github.com/grafana/loki/commit/219fd98da710f4caf27f669562cb79b55ced4e86))
* **deps:** Update module github.com/aws/smithy-go to v1.28.0 (main) ([#24276](https://github.com/grafana/loki/issues/24276)) ([dc6f648](https://github.com/grafana/loki/commit/dc6f648224aab37e7c4ad048a5ba92d22ac2de8b))
* **deps:** Update module github.com/aws/smithy-go to v1.28.1 (main) ([#24289](https://github.com/grafana/loki/issues/24289)) ([2ee7e91](https://github.com/grafana/loki/commit/2ee7e9151b10b674a14674a4cd4c853df0871eeb))
* **deps:** Update module github.com/axiomhq/hyperloglog to v0.3.0 (main) ([#24629](https://github.com/grafana/loki/issues/24629)) ([f2dbd94](https://github.com/grafana/loki/commit/f2dbd94d2b54d7ed8748d57b2d49b7d41d9bfb1c))
...
* **deps:** Update module github.com/Azure/azure-sdk-for-go/sdk/azidentity to v1.14.1 (main) ([#24307](https://github.com/grafana/loki/issues/24307)) ([e041ae5](https://github.com/grafana/loki/commit/e041ae5e608b2f1472e434dd8023854ea82338a3))
* **deps:** Update module github.com/Azure/azure-sdk-for-go/sdk/storage/azblob to v1.8.1 (main) ([#24517](https://github.com/grafana/loki/issues/24517)) ([650999c](https://github.com/grafana/loki/commit/650999c81a44e8f459c918e6639ec8e647717477))
* **deps:** Update module github.com/Azure/azure-sdk-for-go/sdk/storage/azblob to v1.8.1 (main) ([#24552](https://github.com/grafana/loki/issues/24552)) ([76f834f](https://github.com/grafana/loki/commit/76f834fe7376f25f170e35d6869c3a536a0289f9))
* **deps:** Update module github.com/baidubce/bce-sdk-go to v0.9.274 (main) ([#24096](https://github.com/grafana/loki/issues/24096)) ([6626b0d](https://github.com/grafana/loki/commit/6626b0d316eb1eb2baa95ed15bf082f050aed9f6))
* **deps:** Update module github.com/baidubce/bce-sdk-go to v0.9.275 (main) ([#24312](https://github.com/grafana/loki/issues/24312)) ([c5cf0c5](https://github.com/grafana/loki/commit/c5cf0c5bad28990ce168efdcb974e592a7a42001))
* **deps:** Update module github.com/baidubce/bce-sdk-go to v0.9.276 (main) ([#24577](https://github.com/grafana/loki/issues/24577)) ([50f4505](https://github.com/grafana/loki/commit/50f450592a842e15749a0640eb79a783c7c1c7e6))
* **deps:** Update module github.com/go-sql-driver/mysql to v1.10.1 (main) ([#24372](https://github.com/grafana/loki/issues/24372)) ([6722fe2](https://github.com/grafana/loki/commit/6722fe29e6fdd4dfc712ab173fc9e2852d661642))
* **deps:** Update module github.com/grpc-ecosystem/go-grpc-middleware/v2 to v2.3.4 (main) ([#24308](https://github.com/grafana/loki/issues/24308)) ([5e14a3b](https://github.com/grafana/loki/commit/5e14a3bf32b20e85198ab3d359f5f44f91a9772e))
* **deps:** Update module github.com/IBM/go-sdk-core/v5 to v5.23.3 (main) ([#24338](https://github.com/grafana/loki/issues/24338)) ([35faeab](https://github.com/grafana/loki/commit/35faeab666d7b2f0fade2a1c2722cf4201a91a63))
* **deps:** Update module github.com/IBM/ibm-cos-sdk-go to v1.15.0 (main) ([#23792](https://github.com/grafana/loki/issues/23792)) ([cad4bd9](https://github.com/grafana/loki/commit/cad4bd965e208f26cff03bf45ce510fe8c285381))
* **deps:** Update module github.com/IBM/ibm-cos-sdk-go to v1.15.1 (main) ([#24115](https://github.com/grafana/loki/issues/24115)) ([46cae1e](https://github.com/grafana/loki/commit/46cae1e41349ee806fa32e616ea6882e042d147f))
* **deps:** Update module github.com/minio/minio-go/v7 to v7.3.0 (main) ([#24060](https://github.com/grafana/loki/issues/24060)) ([cddca74](https://github.com/grafana/loki/commit/cddca74bdc85b4ab5f42f12b61d3f7b7908edf67))
* **deps:** Update module github.com/moby/moby/v2 to v2.0.0-beta.23 (main) ([#24392](https://github.com/grafana/loki/issues/24392)) ([0c84fdd](https://github.com/grafana/loki/commit/0c84fdd88889ae6e546725e4fc06696decf3406a))
* **deps:** Update module github.com/oschwald/geoip2-golang/v2 to v2.4.0 (main) ([#24483](https://github.com/grafana/loki/issues/24483)) ([9c026c6](https://github.com/grafana/loki/commit/9c026c61a5b388e5721f40884d6396521189960d))
...
* **deps:** Update module github.com/pierrec/lz4/v4 to v4.1.29 (main) ([#24138](https://github.com/grafana/loki/issues/24138)) ([e5f2c94](https://github.com/grafana/loki/commit/e5f2c9483da91b895d75e684c6241283281b4c70))
* **deps:** Update module github.com/pressly/goose/v3 to v3.28.0 (main) ([#24370](https://github.com/grafana/loki/issues/24370)) ([9ef7077](https://github.com/grafana/loki/commit/9ef7077b59f8e8d512ee3ec5a635d21ff232978f))
* **deps:** Update module github.com/prometheus/client_model to v0.6.3 (main) ([#24339](https://github.com/grafana/loki/issues/24339)) ([768e429](https://github.com/grafana/loki/commit/768e429ffe0f418a69eabaa43dcef59826ad734d))
* **deps:** Update module github.com/prometheus/sigv4 to v0.5.0 (main) ([#24341](https://github.com/grafana/loki/issues/24341)) ([5ab6dda](https://github.com/grafana/loki/commit/5ab6dda1ca4c376fe7870e1bac0d1e9d2122c071))
* **deps:** Update module github.com/redis/go-redis/v9 to v9.22.0 (main) ([#23806](https://github.com/grafana/loki/issues/23806)) ([c2e072c](https://github.com/grafana/loki/commit/c2e072cd6566dbb7030e4b937eb77a41f7b1ccdb))
* **deps:** Update module github.com/shirou/gopsutil/v4 to v4.26.8 (main) ([#24319](https://github.com/grafana/loki/issues/24319)) ([83883e4](https://github.com/grafana/loki/commit/83883e43d147ba18ae2a7d084c9d875965ebcf7e))
* **deps:** Update module github.com/sirupsen/logrus to v1.10.0 (main) ([#24000](https://github.com/grafana/loki/issues/24000)) ([ad4c0f3](https://github.com/grafana/loki/commit/ad4c0f342ef0ef206649d392925c366656777f8b))
* **deps:** Update module github.com/sirupsen/logrus to v1.10.1 (main) ([#24153](https://github.com/grafana/loki/issues/24153)) ([bb432d8](https://github.com/grafana/loki/commit/bb432d8cf73c86eb4f7948feeb26cb9ee82e4faa))
* **deps:** Update module github.com/sirupsen/logrus to v1.10.2 (main) ([#24260](https://github.com/grafana/loki/issues/24260)) ([50d801f](https://github.com/grafana/loki/commit/50d801f81fa81688cb1d0b29a2362eef2ac3e4b4))
* **deps:** Update module github.com/stretchr/testify to v1.12.0 (main) ([#24005](https://github.com/grafana/loki/issues/24005)) ([b665634](https://github.com/grafana/loki/commit/b665634c3f9cf8a1232038bac963d06b50b9c7e4))
* **deps:** Update module github.com/stretchr/testify to v1.12.1 (main) ([#24100](https://github.com/grafana/loki/issues/24100)) ([57311f9](https://github.com/grafana/loki/commit/57311f9639c1b9cb9a28d5d74bf4e9e66e1937e7))
* **deps:** Update module github.com/twmb/franz-go/plugin/kotel to v1.7.1 (main) ([#24572](https://github.com/grafana/loki/issues/24572)) ([edbcf13](https://github.com/grafana/loki/commit/edbcf1378e7982e3b42773809eba4fa49707118f))
* **deps:** Update module go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc to v0.71.0 (main) ([#24287](https://github.com/grafana/loki/issues/24287)) ([1fe8371](https://github.com/grafana/loki/commit/1fe837142f2c16ee11802f7cba2498d93a18e81b))
* **deps:** Update module go.opentelemetry.io/contrib/instrumentation/net/http/httptrace/otelhttptrace to v0.71.0 (main) ([#24291](https://github.com/grafana/loki/issues/24291)) ([a279a94](https://github.com/grafana/loki/commit/a279a9489c7a24e18766745efdceea92f445be46))
* **deps:** Update module go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp to v0.71.0 (main) ([#24293](https://github.com/grafana/loki/issues/24293)) ([3401069](https://github.com/grafana/loki/commit/34010698dc5b9341893cfe5913f4de374e5b0dc7))
* **deps:** Update module golang.org/x/crypto to v0.57.0 (main) ([#24509](https://github.com/grafana/loki/issues/24509)) ([08bc8d5](https://github.com/grafana/loki/commit/08bc8d53f86b397692969c803dfea16f8f2188f5))
* **deps:** Update module golang.org/x/sync to v0.23.0 (main) ([#24419](https://github.com/grafana/loki/issues/24419)) ([7be1f1e](https://github.com/grafana/loki/commit/7be1f1e4c5ae0860afcdac459e388827d3da3ed0))
* **deps:** Update module golang.org/x/time to v0.16.0 (main) ([#24420](https://github.com/grafana/loki/issues/24420)) ([c43df95](https://github.com/grafana/loki/commit/c43df953af38bee78ee7592a787125897762ed74))
...
* **deps:** Update module google.golang.org/api to v0.294.0 (main) ([#24294](https://github.com/grafana/loki/issues/24294)) ([e72272d](https://github.com/grafana/loki/commit/e72272d6742f96b4ef05f3ff7a57eec8446b9e89))
* **deps:** Update module google.golang.org/api to v0.296.0 (main) ([#24315](https://github.com/grafana/loki/issues/24315)) ([3527f7c](https://github.com/grafana/loki/commit/3527f7cca8faa3a184fe521fb8233296ea261d7b))
* **deps:** Update module google.golang.org/api to v0.297.0 (main) ([#24369](https://github.com/grafana/loki/issues/24369)) ([af0a089](https://github.com/grafana/loki/commit/af0a089bc08956ff2714ecdac5bdbced254ab0f1))
* **deps:** Update module google.golang.org/api to v0.298.0 (main) ([#24599](https://github.com/grafana/loki/issues/24599)) ([673b4db](https://github.com/grafana/loki/commit/673b4dbd8be6e5aeb3ddae7c15a7b26389ad8138))
* **deps:** Update module google.golang.org/grpc to v1.83.1 (main) ([#24152](https://github.com/grafana/loki/issues/24152)) ([fac504e](https://github.com/grafana/loki/commit/fac504ec026ff6a0c00cc148b1780b7f60bcb91b))
* **deps:** Update module google.golang.org/grpc to v1.83.2 (main) ([#24254](https://github.com/grafana/loki/issues/24254)) ([5e82b49](https://github.com/grafana/loki/commit/5e82b4977b59f51580e2361b27a8958fd9c24651))
* **deps:** Update module k8s.io/apimachinery to v0.36.4 (main) ([#24169](https://github.com/grafana/loki/issues/24169)) ([52bd220](https://github.com/grafana/loki/commit/52bd2200f791d8bcdb3026355af6961e7427cf55))
* **engine:** Drop removed BuilderConfig fields from LogMerge tests ([#24544](https://github.com/grafana/loki/issues/24544)) ([1c85d07](https://github.com/grafana/loki/commit/1c85d0705a6fd6536a5abd488af2da06217d840e))
...
* **indexgateway:** Limit in flight requests to index gateways from client ([#24422](https://github.com/grafana/loki/issues/24422)) ([e6c188c](https://github.com/grafana/loki/commit/e6c188c8c2e2cd178baab52790acea5adc64d393))
* Instead of deleting every WAL in given range period, delete only the ones related to this TSDB head [k325] ([#24702](https://github.com/grafana/loki/issues/24702)) ([fffea45](https://github.com/grafana/loki/commit/fffea454e6ce3ea70e630af6327909d1a0d966eb))
* **iter:** Fix error handling and resource leaks in chained sample and entry iterators ([#23921](https://github.com/grafana/loki/issues/23921)) ([a0b56b8](https://github.com/grafana/loki/commit/a0b56b8aae72eb899bb9a9d193a015a133da378b))
* **iter:** Harden SampleIterator Err() and Close() contract ([#24563](https://github.com/grafana/loki/issues/24563)) ([a6d4ad0](https://github.com/grafana/loki/commit/a6d4ad07c521a37d38cb13a5cce76510c06e9121))
* **kafka:** Reset every field of the reused stream before decoding a record ([#24207](https://github.com/grafana/loki/issues/24207)) ([71725d4](https://github.com/grafana/loki/commit/71725d45e4d0edcf848f0733a9ada5d32c9fce95))
* **kafka:** Use incremental AlterBrokerConfigs  ([#24466](https://github.com/grafana/loki/issues/24466)) ([41795fe](https://github.com/grafana/loki/commit/41795feb6befa552caa31ff610887dd355de836b))
* **kafka:** Use incremental AlterBrokerConfigs  ([#24466](https://github.com/grafana/loki/issues/24466)) ([#24469](https://github.com/grafana/loki/issues/24469)) ([27a3678](https://github.com/grafana/loki/commit/27a36786ca6535d051ea8cde87bd396df079578d))
* **logql:** Allow PB/PiB byte-size literals in queries ([#24030](https://github.com/grafana/loki/issues/24030)) ([40b45b7](https://github.com/grafana/loki/commit/40b45b70163a1c93919df1afd1156b5792c95263))
* **logql:** Avoid data race in sharded avg_over_time grouping ([#23942](https://github.com/grafana/loki/issues/23942)) ([668c7ef](https://github.com/grafana/loki/commit/668c7ef290e0422fb9fb3ee596f450eec123ba40))
* **logql:** Fix ip() line filter matching inside "or" chains ([#23940](https://github.com/grafana/loki/issues/23940)) ([47c500e](https://github.com/grafana/loki/commit/47c500e548ef0dfb02023f311d30569941b0e9f8))
* **logql:** Interpolate sharded quantile_over_time to match the exact aggregator ([#24212](https://github.com/grafana/loki/issues/24212)) ([2ecc312](https://github.com/grafana/loki/commit/2ecc312c67cc06ef4ab29d1d40b13e62d8a798f0))
* **logql:** Keep line filters after decolorize in pipeline order ([#24551](https://github.com/grafana/loki/issues/24551)) ([fb0e902](https://github.com/grafana/loki/commit/fb0e9024659467a3dd7d13715b2b6af67d0770b2))
* **logql:** Point approx_topk shard error at the real flag ([#24234](https://github.com/grafana/loki/issues/24234)) ([c1b990d](https://github.com/grafana/loki/commit/c1b990d337406e5d35f144583837deed3df5ceb1))
* **logql:** Reject converting comparisons against __error__ and __error_details__ ([#24213](https://github.com/grafana/loki/issues/24213)) ([a659858](https://github.com/grafana/loki/commit/a659858df2a9fd36ba54c47b46cb74a77273bb3d))
* **logql:** Reuse a sharded first/last_over_time() candidate across overlapping steps ([#23903](https://github.com/grafana/loki/issues/23903)) ([49ad1d1](https://github.com/grafana/loki/commit/49ad1d156cf285024da58bf4c239546af4f7c988))
* **logql:** Skip empty-pattern blocker warns on misses ([#23897](https://github.com/grafana/loki/issues/23897)) ([795a288](https://github.com/grafana/loki/commit/795a288ff8494e7df62e864e57eddaac3e22725e))
* **logql:** Stop double-counting nested IndexStats ranges ([#24011](https://github.com/grafana/loki/issues/24011)) ([cc9205c](https://github.com/grafana/loki/commit/cc9205cf71baa59681f3a188dfc86a458fa42ccd))
* **logql:** Validate numeric label filter literals ([#24039](https://github.com/grafana/loki/issues/24039)) ([fda1869](https://github.com/grafana/loki/commit/fda186914dcd192d650cca8b7c8f516cf84685a8))
* **logql:** Wrap count min sketch errors with operator name ([#24157](https://github.com/grafana/loki/issues/24157)) ([2cf658c](https://github.com/grafana/loki/commit/2cf658c358302d8cc143e686f0ce416b304b8ff7))
* Mistake in deleted-config.yaml ([#24193](https://github.com/grafana/loki/issues/24193)) ([baa6265](https://github.com/grafana/loki/commit/baa626514ab96d0c1e5fea6cc675e95b283b435a))
...
* **otlp:** close zstd decoder to prevent goroutine leak ([#24356](https://github.com/grafana/loki/issues/24356)) ([fc848e0](https://github.com/grafana/loki/commit/fc848e0c7bfc0116c9baee8779e18e47442204b1))
* Pool exhaustion deadlock in Bloom tests ([#24495](https://github.com/grafana/loki/issues/24495)) ([0c40f07](https://github.com/grafana/loki/commit/0c40f078055d303a212a3c818afb3996530a27e2))
* Port binding flake in integration tests ([#24540](https://github.com/grafana/loki/issues/24540)) ([422eee2](https://github.com/grafana/loki/commit/422eee2b0d29504c890c0469ad978d2b7fbd4d99))
* Propagate response encoding flags to queriers when frontend.encoding is protobuf ([#24262](https://github.com/grafana/loki/issues/24262)) ([01c8d7f](https://github.com/grafana/loki/commit/01c8d7f6fce5beb5e559b2484eee42b8c7143953))
* **querier:** Stop reporting a cancelled tail teardown as an error ([#24464](https://github.com/grafana/loki/issues/24464)) ([60a7201](https://github.com/grafana/loki/commit/60a720153cdb72d94c10b03b4e75afd2d48810d9))
* **querysharding:** Allow sharding across schema period boundaries  ([#24318](https://github.com/grafana/loki/issues/24318)) ([2cc3799](https://github.com/grafana/loki/commit/2cc37992c60f359b8b3be60c9ddf1775b5ad9388))
* Recognise thanos/minio S3 throttling errors as retryable ([#23454](https://github.com/grafana/loki/issues/23454)) ([e377eb1](https://github.com/grafana/loki/commit/e377eb1b7bcfa3a34eb3d0ad7cf93dcaeb8a6fe3))
* **retry:** Multi error containing client errors should not be retried ([#23974](https://github.com/grafana/loki/issues/23974)) ([594b3c5](https://github.com/grafana/loki/commit/594b3c5733523245c1fc97d5a7c0c75f847f5c0b))
* **ruler:** Trim whitespace surrounding rule expressions ([#24467](https://github.com/grafana/loki/issues/24467)) ([9ae4557](https://github.com/grafana/loki/commit/9ae4557676f660b5da04a4e61d836841e32c4034))
...
* **security/HIGH/pkg/push:** Update module google.golang.org/grpc to v1.83.1 [SECURITY] (main) ([#24327](https://github.com/grafana/loki/issues/24327)) ([ad3ddd2](https://github.com/grafana/loki/commit/ad3ddd27268babbf37f17c9da6b4b48aeaef91f3))
* **security/HIGH/pkg/push:** Update module google.golang.org/grpc to v1.83.2 [SECURITY] (main) ([#24428](https://github.com/grafana/loki/issues/24428)) ([b2a0230](https://github.com/grafana/loki/commit/b2a02304a0c1ea548817167ff32ffe3a074b9e5f))
...
* **security/UNKNOWN/:** Update module golang.org/x/crypto to v0.56.0 [SECURITY] (main) ([#24333](https://github.com/grafana/loki/issues/24333)) ([5dd8ce9](https://github.com/grafana/loki/commit/5dd8ce95fce351e3c8415b46afa44ef7c71cda32))
...
* **storage/aws:** Clarify that s3.insecure only disables HTTPS, not TLS verification ([#24549](https://github.com/grafana/loki/issues/24549)) ([11b7c8c](https://github.com/grafana/loki/commit/11b7c8c839f44835307575aec6e5089a954c11b1))
* **tsdb:** Persist chunk IngestedAt in the head WAL ([#24493](https://github.com/grafana/loki/issues/24493)) ([d305006](https://github.com/grafana/loki/commit/d3050064194a75bee3775d516701795a965322a5))


### Performance Improvements

* Hold on to less memory by trimming results down to request limit ([#24198](https://github.com/grafana/loki/issues/24198)) ([8c1864a](https://github.com/grafana/loki/commit/8c1864aa8ed94baa814126457abe3d0d6483dd95))
* **indexgateway:** Only calculate chunk groups if we're going to return them ([#24113](https://github.com/grafana/loki/issues/24113)) ([7325deb](https://github.com/grafana/loki/commit/7325debe9c665f8725a94458107aa0c279738589))
* **logql:** Add constant-label fast path for sample extraction ([#24368](https://github.com/grafana/loki/issues/24368)) ([eb837b0](https://github.com/grafana/loki/commit/eb837b0fe0f0f15d12d446d5a87f3186f27fea8e))
...
* **frontend:** Default frontend.encoding to protobuf ([#23985](https://github.com/grafana/loki/issues/23985)) ([0d84135](https://github.com/grafana/loki/commit/0d84135ccc297676d5ab13a008469397ec0982ad))
* Remove deprecated ruler_remote_write_* per-tenant limits ([#22941](https://github.com/grafana/loki/issues/22941)) ([59aa7d4](https://github.com/grafana/loki/commit/59aa7d41afd01a9179bfc26bf651a665992c5320))
