...
* [5662](https://github.com/grafana/loki/pull/5662) **ssncferreira** Improve performance of instant queries by splitting range into multiple subqueries that are executed in parallel.
