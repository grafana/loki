...
* [9994](https://github.com/grafana/loki/pull/9994) **chaudum**: Smooth out the flush operations over the period of the flush interval to prevent spikes in chunk flush operations.
