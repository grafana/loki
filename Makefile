.DEFAULT_GOAL := all
.PHONY: all images check-generated-files logcli loki loki-debug promtail promtail-debug loki-canary entserver-sample entclient-sample lint test clean yacc protos touch-protobuf-sources touch-protos format
