...
func (cfg *Config) RegisterFlags(f *flag.FlagSet) {
	...
	f.StringVar(&cfg.Config.HTTPTLSConfig.CipherSuites, "internal-server.http-tls-cipher-suites", "", "HTTP TLS Cipher Suites.")
	f.StringVar(&cfg.Config.HTTPTLSConfig.MinVersion, "internal-server.http-tls-min-version", "", "HTTP TLS Min Version.")
