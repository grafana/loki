...
func NewMarker(workingDirectory string, expiration ExpirationChecker, markTimeout time.Duration, chunkClient client.Client, ignoreMissingChunks bool, r prometheus.Registerer) (*Marker, error) {
	return &Marker{
