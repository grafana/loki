...
type CachedDeletes struct {
	Key            string           `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	AddedAtTS      int64            `protobuf:"varint,2,opt,name=addedAtTS,proto3" json:"addedAtTS,omitempty"`
	CacheGen       string           `protobuf:"bytes,3,opt,name=cacheGen,proto3" json:"cacheGen,omitempty"`
	DeleteRequests []*DeleteRequest `protobuf:"bytes,4,rep,name=deleteRequests,proto3" json:"deleteRequests,omitempty"`
}

func (m *CachedDeletes) Reset()      { *m = CachedDeletes{} }
func (*CachedDeletes) ProtoMessage() {}
func (*CachedDeletes) Descriptor() ([]byte, []int) {
	return fileDescriptor_24a5f361c0f660df, []int{5}
}
func (m *CachedDeletes) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CachedDeletes) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CachedDeletes.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CachedDeletes) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CachedDeletes.Merge(m, src)
}
func (m *CachedDeletes) XXX_Size() int {
	return m.Size()
}
func (m *CachedDeletes) XXX_DiscardUnknown() {
	xxx_messageInfo_CachedDeletes.DiscardUnknown(m)
}

var xxx_messageInfo_CachedDeletes proto.InternalMessageInfo

func (m *CachedDeletes) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *CachedDeletes) GetAddedAtTS() int64 {
	if m != nil {
		return m.AddedAtTS
	}
	return 0
...
func (m *CachedDeletes) GetCacheGen() string {
	if m != nil {
		return m.CacheGen
	}
	return ""
...
func (m *CachedDeletes) GetDeleteRequests() []*DeleteRequest {
	if m != nil {
		return m.DeleteRequests
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*CachedDeletes)(nil), "grpc.CachedDeletes")
}
...
var fileDescriptor_24a5f361c0f660df = []byte{
	...
	,
}
...
func (this *CachedDeletes) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CachedDeletes)
	if !ok {
		that2, ok := that.(CachedDeletes)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.AddedAtTS != that1.AddedAtTS {
		return false
	}
	if this.CacheGen != that1.CacheGen {
		return false
	}
	if len(this.DeleteRequests) != len(that1.DeleteRequests) {
		return false
...
func (this *CachedDeletes) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&grpc.CachedDeletes{")
	s = append(s, "Key: "+fmt.Sprintf("%#v", this.Key)+",\n")
	s = append(s, "AddedAtTS: "+fmt.Sprintf("%#v", this.AddedAtTS)+",\n")
	s = append(s, "CacheGen: "+fmt.Sprintf("%#v", this.CacheGen)+",\n")
	if this.DeleteRequests != nil {
		s = append(s, "DeleteRequests: "+fmt.Sprintf("%#v", this.DeleteRequests)+",\n")
	}
	s = append(s, "}")
...
func (m *CachedDeletes) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CachedDeletes) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CachedDeletes) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.CacheGen) > 0 {
		i -= len(m.CacheGen)
		copy(dAtA[i:], m.CacheGen)
		i = encodeVarintGrpc(dAtA, i, uint64(len(m.CacheGen)))
		i--
		dAtA[i] = 0x1a
	}
	if m.AddedAtTS != 0 {
		i = encodeVarintGrpc(dAtA, i, uint64(m.AddedAtTS))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Key) > 0 {
...
func (m *CachedDeletes) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.AddedAtTS != 0 {
		n += 1 + sovGrpc(uint64(m.AddedAtTS))
	}
	l = len(m.CacheGen)
	if l > 0 {
		n += 1 + l + sovGrpc(uint64(l))
...
func (this *CachedDeletes) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForDeleteRequests := "[]*DeleteRequest{"
	...
	repeatedStringForDeleteRequests += "}"
	s := strings.Join([]string{`&CachedDeletes{`,
		`Key:` + fmt.Sprintf("%v", this.Key) + `,`,
		`AddedAtTS:` + fmt.Sprintf("%v", this.AddedAtTS) + `,`,
		`CacheGen:` + fmt.Sprintf("%v", this.CacheGen) + `,`,
		`DeleteRequests:` + repeatedStringForDeleteRequests + `,`,
		`}`,
	}, "")
	return s
...
func (m *CachedDeletes) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CachedDeletes: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CachedDeletes: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field AddedAtTS", wireType)
			}
			m.AddedAtTS = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AddedAtTS |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CacheGen", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CacheGen = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeleteRequests", wireType)
