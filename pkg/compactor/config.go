...
func (cfg *Config) RegisterFlags(f *flag.FlagSet) {
	...
	f.BoolVar(&cfg.DataObjDeletionEnabled, "compactor.dataobj-deletion-enabled", false, "Enable dataobj deletion processing. When enabled, the compactor will create tombstone markers for delete requests on dataobject tables.")
