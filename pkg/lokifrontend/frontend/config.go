...
func InitFrontend(cfg CombinedFrontendConfig, ring ring.ReadRing, natsCfg loki_nats.Config, limits v1.Limits, grpcListenPort int, log log.Logger, reg prometheus.Registerer) (http.RoundTripper, *v1.Frontend, *v2.Frontend, error) {
	switch {
	...
	default:
		...
		fr, err := v1.New(cfg.FrontendV1, natsCfg, limits, log, reg)
		if err != nil {
