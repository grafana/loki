...
type Region struct {
	...
	// DroppedRegions is the count of descendant regions that were dropped due to filtering.
	DroppedRegions uint32 `protobuf:"varint,10,opt,name=dropped_regions,json=droppedRegions,proto3" json:"dropped_regions,omitempty"`
}
...
func (m *Region) GetDroppedRegions() uint32 {
	if m != nil {
		return m.DroppedRegions
	}
	return 0
}
...
var fileDescriptor_cfc78bf5da060d84 = []byte{
	...
	,
}
...
func (this *Region) Equal(that interface{}) bool {
	...
	if this.DroppedRegions != that1.DroppedRegions {
		return false
	}
	return true
}
...
func (this *Region) GoString() string {
	...
	s = append(s, "DroppedRegions: "+fmt.Sprintf("%#v", this.DroppedRegions)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Region) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.DroppedRegions != 0 {
		i = encodeVarintXcap(dAtA, i, uint64(m.DroppedRegions))
		i--
		dAtA[i] = 0x50
	}
	if m.Status != nil {
...
func (m *Region) Size() (n int) {
	...
	if m.DroppedRegions != 0 {
		n += 1 + sovXcap(uint64(m.DroppedRegions))
	}
	return n
}
...
func (this *Region) String() string {
	...
	s := strings.Join([]string{`&Region{`,
		...
		`DroppedRegions:` + fmt.Sprintf("%v", this.DroppedRegions) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Region) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DroppedRegions", wireType)
			}
			m.DroppedRegions = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DroppedRegions |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
