...
type Limits struct {
	...
	StructuredMetadata bool `yaml:"structured_metadata,omitempty" json:"structured_metadata,omitempty" doc:"description=Allow user to send structured metadata (non-indexed labels) in push payload."`
}
...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.BoolVar(&l.StructuredMetadata, "validation.structured-metadata", false, "Allow user to send structured metadata (non-indexed labels) in push payload.")
}
...
func (o *Overrides) StructuredMetadata(userID string) bool {
	return o.getOverridesForUser(userID).StructuredMetadata
}
