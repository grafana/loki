...
type Limits struct {
	...
	BloomTaskTargetChunkSize   flagext.ByteSize `yaml:"bloom_task_target_chunk_size" json:"bloom_task_target_chunk_size" category:"experimental"`
...
func (l *Limits) RegisterFlags(f *flag.FlagSet) {
	...
	f.StringVar(&l.BloomPlanningStrategy, "bloom-build.planning-strategy", "split_keyspace_by_factor", "Experimental. Bloom planning strategy to use in bloom creation. Can be one of: 'split_keyspace_by_factor', 'split_by_chunk_size'")
	...
	_ = l.BloomTaskTargetChunkSize.Set(defaultBloomTaskTargetChunkSize)
	f.Var(&l.BloomTaskTargetChunkSize, "bloom-build.target-chunk-size", "Experimental. Target chunk size in bytes for bloom tasks. Default is 100GB.")
...
func (o *Overrides) BloomTaskTargetChunkSizeBytes(userID string) uint64 {
	return uint64(o.getOverridesForUser(userID).BloomTaskTargetChunkSize)
}
