...
func IsAssignedKey(ringClient ring.ReadRing, lifecycler *ring.BasicLifecycler, key string, bufDescs []ring.InstanceDesc, bufHosts []string, bufZones []string) bool {
