...
func InitLogger(cfg *server.Config, reg prometheus.Registerer, buffered bool, sync bool) {
	...
	cfg.Log = dslog.GoKit(log.With(l, "caller", log.Caller(4)))
}
...
func newPrometheusLogger(l dslog.Level, format dslog.Format, reg prometheus.Registerer, buffered bool, sync bool) log.Logger {
