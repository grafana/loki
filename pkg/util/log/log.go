...
func InitLogger(logFormat string, logLevel dslog.Level, reg prometheus.Registerer, buffered bool, sync bool) log.Logger {
	logger := newPrometheusLogger(logLevel, logFormat, reg, buffered, sync)
