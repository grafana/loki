...
// actually costs on the wire and in memory, as opposed to charging every entry that
// references a set for the whole set, the way an expanded push would have measured it.
