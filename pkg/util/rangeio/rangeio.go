...
var (
	statInputRangesCount     = xcap.NewStatisticInt64("input.ranges.count", xcap.AggregationTypeSum)
	statInputRangesSize      = xcap.NewStatisticInt64("input.ranges.bytes", xcap.AggregationTypeSum)
	statOptimizedRangesCount = xcap.NewStatisticInt64("optimized.ranges.count", xcap.AggregationTypeSum)
	statOptimizedRangesSize  = xcap.NewStatisticInt64("optimized.ranges.bytes", xcap.AggregationTypeSum)
