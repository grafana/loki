...
//
// v4 is currently an exact clone of the v3 algorithm. It exists as a separate
// version so that extraction can diverge from v3 without invalidating v3
// indexes already on disk: extraction is part of the index-version contract, so
// a v3 index must always be queried with the v3 extractor. Never modify this in
// a way that breaks already-written v4 indexes.
