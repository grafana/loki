...
var streamsFixtureV4 = []*logproto.Stream{
	{
		Labels: "{foo=\"glop\"}",
		Entries: []logproto.Entry{
			{
...
var storeFixtureV4 = newMockChunkStore(chunkenc.ChunkFormatV4, chunkenc.UnorderedWithStructuredMetadataHeadBlockFmt, streamsFixtureV4)
