...
func (v9Entries) GetLabelWriteEntries(bucket Bucket, metricName string, lbls labels.Labels, chunkID string) ([]Entry, error) {
...
func (s v10Entries) GetLabelWriteEntries(bucket Bucket, metricName string, lbls labels.Labels, chunkID string) ([]Entry, error) {
	seriesID := labelsSeriesID(lbls)
...
func (s v11Entries) GetLabelWriteEntries(bucket Bucket, metricName string, lbls labels.Labels, chunkID string) ([]Entry, error) {
	seriesID := labelsSeriesID(lbls)
