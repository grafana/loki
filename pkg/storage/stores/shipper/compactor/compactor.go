...
func (cfg *Config) RegisterFlags(f *flag.FlagSet) {
	...
	f.StringVar(&cfg.DeletionMode, "boltdb.shipper.compactor.deletion-mode", "v1", fmt.Sprintf("(Experimental) Deletion mode. Can be one of %v", strings.Join(deletion.AllModes(), "|")))
