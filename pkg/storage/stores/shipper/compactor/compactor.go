...
func (cfg *Config) RegisterFlags(f *flag.FlagSet) {
	...
	f.StringVar(&cfg.DeletionMode, "boltdb.shipper.compactor.deletion-mode", "filter-and-delete", fmt.Sprintf("Deletion mode. Can be one of %v", strings.Join(deletion.AllModes(), "|")))
