...
func createChunk(t testing.TB, chunkFormat byte, userID string, lbs labels.Labels, from model.Time, through model.Time) chunk.Chunk {
	t.Helper()
	const (
	...
	chunkEnc := chunkenc.NewMemChunk(chunkFormat, chunkenc.EncSnappy, chunkenc.UnorderedWithNonIndexedLabelsHeadBlockFmt, blockSize, targetSize)
