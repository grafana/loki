...
// This type allows calling those operations with an unpooled file handle,
...
// Get returns a pooled file handle if available or opens a new one when there
// are no pooled handles available. If this pool has been stopped, an error is
// returned.
...
// the file handle if there is not. If this pool has been stopped, the file
