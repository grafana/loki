...
type IndexReader interface {
	...
	Series(ref storage.SeriesRef, from int64, through int64, builder *labels.ScratchBuilder, chks *[]index.ChunkMeta) (uint64, error)

	// ChunkStats returns the stats for the chunks in the given series.
	ChunkStats(ref storage.SeriesRef, from, through int64, builder *labels.ScratchBuilder) (uint64, index.ChunkStats, error)
