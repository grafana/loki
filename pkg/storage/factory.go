...
func (cfg *Config) RegisterFlags(f *flag.FlagSet) {
	...
	f.IntVar(&cfg.MaxParallelismTableOps, "store.max-parallelism-table-ops", 50, "Maximum number of concurrence used for each table operation. We recommend 2*CPUs available")
