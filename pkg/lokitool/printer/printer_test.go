...
func TestPrintRuleSet(t *testing.T) {
	giveRules := map[string][]rulefmt.RuleGroup{
		"test-namespace-1": {
			rulefmt.RuleGroup{Name: "test-rulegroup-a"},
			rulefmt.RuleGroup{Name: "test-rulegroup-b"},
		},
		"test-namespace-2": {
			rulefmt.RuleGroup{Name: "test-rulegroup-c"},
			rulefmt.RuleGroup{Name: "test-rulegroup-d"},
		},
	}
