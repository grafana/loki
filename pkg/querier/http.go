...
func (q *QuerierAPI) StructuredMetadataHandler(ctx context.Context, req *logproto.StructuredMetadataKeysRequest) (*logproto.StructuredMetadataKeysResponse, error) {
