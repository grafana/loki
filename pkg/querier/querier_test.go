...
func TestQuerier_containsAllIDTypes(t *testing.T) {
	for _, tc := range []struct {
		...
		},
		{
			...
			values:   []string{"57808f62-f117-4a22-84a0-bc3282c7f1061", "5076e837-cd8d-4dd7-95ff-fecb087dccf6", "2e2a6554-1744-4399-b89a-88ae79c27096", "d3c31248-ec0c-4bc4-b11c-8fb1cfb42e62"},
			expected: false,
		},
		{
