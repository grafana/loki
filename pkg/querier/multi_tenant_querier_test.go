...
func TestMultiTenantQuerierSeries(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			orgID: "1|2",
			expectedSeries: []logproto.SeriesIdentifier{
				{Labels: logproto.NewSeriesEntries("a", "1", "b", "2", "__tenant_id__", "1")},
				{Labels: logproto.NewSeriesEntries("a", "1", "b", "3", "__tenant_id__", "1")},
				{Labels: logproto.NewSeriesEntries("a", "1", "b", "4", "__tenant_id__", "1")},
				{Labels: logproto.NewSeriesEntries("a", "1", "b", "5", "__tenant_id__", "1")},
				{Labels: logproto.NewSeriesEntries("a", "1", "b", "2", "__tenant_id__", "2")},
				{Labels: logproto.NewSeriesEntries("a", "1", "b", "3", "__tenant_id__", "2")},
				{Labels: logproto.NewSeriesEntries("a", "1", "b", "4", "__tenant_id__", "2")},
				{Labels: logproto.NewSeriesEntries("a", "1", "b", "5", "__tenant_id__", "2")},
			},
		},
		{
			...
			expectedSeries: []logproto.SeriesIdentifier{
				...
				{Labels: logproto.NewSeriesEntries("a", "1", "b", "4", "__tenant_id__", "2")},
				{Labels: logproto.NewSeriesEntries("a", "1", "b", "5", "__tenant_id__", "2")},
				{Labels: logproto.NewSeriesEntries("a", "1", "b", "2", "__tenant_id__", "3")},
				{Labels: logproto.NewSeriesEntries("a", "1", "b", "3", "__tenant_id__", "3")},
				{Labels: logproto.NewSeriesEntries("a", "1", "b", "4", "__tenant_id__", "3")},
				{Labels: logproto.NewSeriesEntries("a", "1", "b", "5", "__tenant_id__", "3")},
			},
		},
		{
