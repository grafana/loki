...
type LokiSketch struct {
	Topks      []*Topk                                                                                              `protobuf:"bytes,1,rep,name=topks,proto3" json:"topks,omitempty"`
	Statistics stats.Result                                                                                         `protobuf:"bytes,2,opt,name=statistics,proto3" json:"statistics"`
	Headers    []github_com_grafana_loki_pkg_querier_queryrange_queryrangebase_definitions.PrometheusResponseHeader `protobuf:"bytes,9,rep,name=Headers,proto3,customtype=github.com/grafana/loki/pkg/querier/queryrange/queryrangebase/definitions.PrometheusResponseHeader" json:"-"`
}
...
func (m *LokiSketch) GetTopks() []*Topk {
	if m != nil {
		return m.Topks
	}
	return nil
...
func (m *LokiSketch) GetStatistics() stats.Result {
	if m != nil {
		return m.Statistics
	}
	return stats.Result{}
...
type Topk struct {
	...
	Sk        []uint32 `protobuf:"varint,4,rep,packed,name=sk,proto3" json:"sk,omitempty"`
	RowCounts []uint32 `protobuf:"varint,5,rep,packed,name=rowCounts,proto3" json:"rowCounts,omitempty"`
}
...
func (m *Topk) GetRowCounts() []uint32 {
	if m != nil {
		return m.RowCounts
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Topk)(nil), "queryrange.Topk")
}
...
var fileDescriptor_51b9d53b40d11902 = []byte{
	...
	,
}
...
func (this *LokiSketch) Equal(that interface{}) bool {
	...
	if len(this.Topks) != len(that1.Topks) {
		return false
	}
	for i := range this.Topks {
		if !this.Topks[i].Equal(that1.Topks[i]) {
			return false
		}
	}
	if !this.Statistics.Equal(&that1.Statistics) {
...
func (this *LokiSketch) GoString() string {
	...
	if this.Topks != nil {
		s = append(s, "Topks: "+fmt.Sprintf("%#v", this.Topks)+",\n")
	}
	s = append(s, "Statistics: "+strings.Replace(this.Statistics.GoString(), `&`, ``, 1)+",\n")
	s = append(s, "Headers: "+fmt.Sprintf("%#v", this.Headers)+",\n")
	s = append(s, "}")
...
func (m *LokiSketch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x12
	if len(m.Topks) > 0 {
		for iNdEx := len(m.Topks) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Topks[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (this *LokiSketch) String() string {
	...
	repeatedStringForTopks := "[]*Topk{"
	for _, f := range this.Topks {
		repeatedStringForTopks += strings.Replace(f.String(), "Topk", "Topk", 1) + ","
	}
	repeatedStringForTopks += "}"
	s := strings.Join([]string{`&LokiSketch{`,
		`Topks:` + repeatedStringForTopks + `,`,
		`Statistics:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.Statistics), "Result", "stats.Result", 1), `&`, ``, 1) + `,`,
		`Headers:` + fmt.Sprintf("%v", this.Headers) + `,`,
		`}`,
	}, "")
...
func (m *LokiSketch) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Topks = append(m.Topks, &Topk{})
			if err := m.Topks[len(m.Topks)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
