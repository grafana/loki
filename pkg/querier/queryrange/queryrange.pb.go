...
import (
	...
	_ "github.com/grafana/loki/pkg/storage/stores/boltdbshipper/indexgateway/indexgatewaypb"
	github_com_grafana_loki_pkg_storage_stores_boltdbshipper_indexgateway_indexgatewaypb "github.com/grafana/loki/pkg/storage/stores/boltdbshipper/indexgateway/indexgatewaypb"
	io "io"
	math "math"
	math_bits "math/bits"
	reflect "reflect"
...
type IndexStatsResponse struct {
	Response *github_com_grafana_loki_pkg_storage_stores_boltdbshipper_indexgateway_indexgatewaypb.IndexStatsResponse `protobuf:"bytes,1,opt,name=response,proto3,customtype=github.com/grafana/loki/pkg/storage/stores/boltdbshipper/indexgateway/indexgatewaypb.IndexStatsResponse" json:"response,omitempty"`
...
var fileDescriptor_51b9d53b40d11902 = []byte{
	...
	,
}
...
func (m *IndexStatsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Response == nil {
				m.Response = &github_com_grafana_loki_pkg_storage_stores_boltdbshipper_indexgateway_indexgatewaypb.IndexStatsResponse{}
			}
			if err := m.Response.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
