...
import (
	...
	_ "github.com/grafana/loki/v3/v3/pkg/querier/queryrange/queryrangebase/definitions"
	github_com_grafana_loki_pkg_querier_queryrange_queryrangebase_definitions "github.com/grafana/loki/v3/v3/pkg/querier/queryrange/queryrangebase/definitions"
	io "io"
	math "math"
	math_bits "math/bits"
	reflect "reflect"
...
type QueryResponse_DetectedLabels struct {
	DetectedLabels *DetectedLabelsResponse `protobuf:"bytes,12,opt,name=detectedLabels,proto3,oneof"`
}
...
type QueryRequest_DetectedLabels struct {
	DetectedLabels *logproto.DetectedLabelsRequest `protobuf:"bytes,10,opt,name=detectedLabels,proto3,oneof"`
}
...
var fileDescriptor_51b9d53b40d11902 = []byte{
	...
	,
}
