...
type QueryResquest struct {
	// Types that are valid to be assigned to Request:
	//
	//	*QueryResquest_Series
	//	*QueryResquest_Labels
	//	*QueryResquest_Stats
	//	*QueryResquest_Instant
	//	*QueryResquest_Streams
	//	*QueryResquest_Volume
	Request isQueryResquest_Request `protobuf_oneof:"request"`
}

func (m *QueryResquest) Reset()      { *m = QueryResquest{} }
func (*QueryResquest) ProtoMessage() {}
func (*QueryResquest) Descriptor() ([]byte, []int) {
	return fileDescriptor_51b9d53b40d11902, []int{15}
}
func (m *QueryResquest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryResquest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryResquest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryResquest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryResquest.Merge(m, src)
}
func (m *QueryResquest) XXX_Size() int {
	return m.Size()
}
func (m *QueryResquest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryResquest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryResquest proto.InternalMessageInfo

type isQueryResquest_Request interface {
	isQueryResquest_Request()
	Equal(interface{}) bool
	MarshalTo([]byte) (int, error)
	Size() int
}

type QueryResquest_Series struct {
	Series *LokiSeriesRequest `protobuf:"bytes,1,opt,name=series,proto3,oneof"`
}
type QueryResquest_Labels struct {
	Labels *LokiLabelNamesRequest `protobuf:"bytes,2,opt,name=labels,proto3,oneof"`
}
type QueryResquest_Stats struct {
	Stats *logproto.IndexStatsRequest `protobuf:"bytes,3,opt,name=stats,proto3,oneof"`
}
type QueryResquest_Instant struct {
	Instant *LokiInstantRequest `protobuf:"bytes,4,opt,name=instant,proto3,oneof"`
}
type QueryResquest_Streams struct {
	Streams *LokiRequest `protobuf:"bytes,5,opt,name=streams,proto3,oneof"`
}
type QueryResquest_Volume struct {
	Volume *logproto.VolumeRequest `protobuf:"bytes,6,opt,name=volume,proto3,oneof"`
}

func (*QueryResquest_Series) isQueryResquest_Request()  {}
func (*QueryResquest_Labels) isQueryResquest_Request()  {}
func (*QueryResquest_Stats) isQueryResquest_Request()   {}
func (*QueryResquest_Instant) isQueryResquest_Request() {}
func (*QueryResquest_Streams) isQueryResquest_Request() {}
func (*QueryResquest_Volume) isQueryResquest_Request()  {}

func (m *QueryResquest) GetRequest() isQueryResquest_Request {
	if m != nil {
		return m.Request
	}
	return nil
...
func (m *QueryResquest) GetSeries() *LokiSeriesRequest {
	if x, ok := m.GetRequest().(*QueryResquest_Series); ok {
		return x.Series
	}
	return nil
}

func (m *QueryResquest) GetLabels() *LokiLabelNamesRequest {
	if x, ok := m.GetRequest().(*QueryResquest_Labels); ok {
		return x.Labels
	}
	return nil
}

func (m *QueryResquest) GetStats() *logproto.IndexStatsRequest {
	if x, ok := m.GetRequest().(*QueryResquest_Stats); ok {
		return x.Stats
	}
	return nil
}

func (m *QueryResquest) GetInstant() *LokiInstantRequest {
	if x, ok := m.GetRequest().(*QueryResquest_Instant); ok {
		return x.Instant
	}
	return nil
}

func (m *QueryResquest) GetStreams() *LokiRequest {
	if x, ok := m.GetRequest().(*QueryResquest_Streams); ok {
		return x.Streams
	}
	return nil
}

func (m *QueryResquest) GetVolume() *logproto.VolumeRequest {
	if x, ok := m.GetRequest().(*QueryResquest_Volume); ok {
		return x.Volume
	}
	return nil
}
...
// XXX_OneofWrappers is for the internal use of the proto package.
func (*QueryResquest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*QueryResquest_Series)(nil),
		(*QueryResquest_Labels)(nil),
		(*QueryResquest_Stats)(nil),
		(*QueryResquest_Instant)(nil),
		(*QueryResquest_Streams)(nil),
		(*QueryResquest_Volume)(nil),
	}
}
...
func init() {
	...
	proto.RegisterType((*QueryResquest)(nil), "queryrange.QueryResquest")
}
...
var fileDescriptor_51b9d53b40d11902 = []byte{
	...
	,
}
...
func (this *QueryResquest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*QueryResquest)
	if !ok {
		that2, ok := that.(QueryResquest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *QueryResquest_Series) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*QueryResquest_Series)
	if !ok {
		that2, ok := that.(QueryResquest_Series)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *QueryResquest_Labels) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*QueryResquest_Labels)
	if !ok {
		that2, ok := that.(QueryResquest_Labels)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *QueryResquest_Stats) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*QueryResquest_Stats)
	if !ok {
		that2, ok := that.(QueryResquest_Stats)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *QueryResquest_Instant) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*QueryResquest_Instant)
	if !ok {
		that2, ok := that.(QueryResquest_Instant)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *QueryResquest_Streams) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*QueryResquest_Streams)
	if !ok {
		that2, ok := that.(QueryResquest_Streams)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *QueryResquest_Volume) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*QueryResquest_Volume)
	if !ok {
		that2, ok := that.(QueryResquest_Volume)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *QueryResquest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 10)
	s = append(s, "&queryrange.QueryResquest{")
	if this.Request != nil {
...
func (this *QueryResquest_Series) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&queryrange.QueryResquest_Series{` +
		`Series:` + fmt.Sprintf("%#v", this.Series) + `}`}, ", ")
	return s
}
func (this *QueryResquest_Labels) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&queryrange.QueryResquest_Labels{` +
		`Labels:` + fmt.Sprintf("%#v", this.Labels) + `}`}, ", ")
	return s
}
func (this *QueryResquest_Stats) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&queryrange.QueryResquest_Stats{` +
		`Stats:` + fmt.Sprintf("%#v", this.Stats) + `}`}, ", ")
	return s
}
func (this *QueryResquest_Instant) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&queryrange.QueryResquest_Instant{` +
		`Instant:` + fmt.Sprintf("%#v", this.Instant) + `}`}, ", ")
	return s
}
func (this *QueryResquest_Streams) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&queryrange.QueryResquest_Streams{` +
		`Streams:` + fmt.Sprintf("%#v", this.Streams) + `}`}, ", ")
	return s
}
func (this *QueryResquest_Volume) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&queryrange.QueryResquest_Volume{` +
		`Volume:` + fmt.Sprintf("%#v", this.Volume) + `}`}, ", ")
	return s
}
...
func (m *QueryResquest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryResquest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryResquest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryResquest_Series) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *QueryResquest_Series) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Series != nil {
		{
			size, err := m.Series.MarshalToSizedBuffer(dAtA[:i])
...
func (m *QueryResquest_Labels) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *QueryResquest_Labels) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Labels != nil {
		{
			size, err := m.Labels.MarshalToSizedBuffer(dAtA[:i])
...
func (m *QueryResquest_Stats) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *QueryResquest_Stats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Stats != nil {
		{
			size, err := m.Stats.MarshalToSizedBuffer(dAtA[:i])
...
func (m *QueryResquest_Instant) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *QueryResquest_Instant) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Instant != nil {
		{
...
func (m *QueryResquest_Streams) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *QueryResquest_Streams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Streams != nil {
		{
			size, err := m.Streams.MarshalToSizedBuffer(dAtA[:i])
...
func (m *QueryResquest_Volume) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *QueryResquest_Volume) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Volume != nil {
		{
			size, err := m.Volume.MarshalToSizedBuffer(dAtA[:i])
...
func (m *QueryResquest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryResquest_Series) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryResquest_Labels) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryResquest_Stats) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryResquest_Instant) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryResquest_Streams) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryResquest_Volume) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *QueryResquest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&QueryResquest{`,
		`Request:` + fmt.Sprintf("%v", this.Request) + `,`,
		`}`,
	}, "")
	return s
}
func (this *QueryResquest_Series) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&QueryResquest_Series{`,
		`Series:` + strings.Replace(fmt.Sprintf("%v", this.Series), "LokiSeriesRequest", "LokiSeriesRequest", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *QueryResquest_Labels) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&QueryResquest_Labels{`,
		`Labels:` + strings.Replace(fmt.Sprintf("%v", this.Labels), "LokiLabelNamesRequest", "LokiLabelNamesRequest", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *QueryResquest_Stats) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&QueryResquest_Stats{`,
		`Stats:` + strings.Replace(fmt.Sprintf("%v", this.Stats), "IndexStatsRequest", "logproto.IndexStatsRequest", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *QueryResquest_Instant) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&QueryResquest_Instant{`,
		`Instant:` + strings.Replace(fmt.Sprintf("%v", this.Instant), "LokiInstantRequest", "LokiInstantRequest", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *QueryResquest_Streams) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&QueryResquest_Streams{`,
		`Streams:` + strings.Replace(fmt.Sprintf("%v", this.Streams), "LokiRequest", "LokiRequest", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *QueryResquest_Volume) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&QueryResquest_Volume{`,
...
func (m *QueryResquest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryResquest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryResquest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Request = &QueryResquest_Series{v}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Labels", wireType)
			...
			m.Request = &QueryResquest_Labels{v}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Stats", wireType)
			...
			m.Request = &QueryResquest_Stats{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
			...
			m.Request = &QueryResquest_Instant{v}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Streams", wireType)
			...
			m.Request = &QueryResquest_Streams{v}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Volume", wireType)
			...
			m.Request = &QueryResquest_Volume{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipQueryrange(dAtA[iNdEx:])
