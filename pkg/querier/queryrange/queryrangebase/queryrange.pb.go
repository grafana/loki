...
type SampleStream struct {
	...
	Samples          []logproto.LegacySample                             `protobuf:"bytes,2,rep,name=samples,proto3" json:"values,omitempty"`
	Histogramsamples []logproto.HistogramSample                          `protobuf:"bytes,3,rep,name=histogramsamples,proto3" json:"histogramvalues,omitempty"`
}
...
func (m *SampleStream) GetHistogramsamples() []logproto.HistogramSample {
	if m != nil {
...
var fileDescriptor_4cc6a0c1d6b614c4 = []byte{
	...
	,
}
...
func (this *SampleStream) Equal(that interface{}) bool {
	...
	if len(this.Histogramsamples) != len(that1.Histogramsamples) {
		return false
	}
	for i := range this.Histogramsamples {
		if !this.Histogramsamples[i].Equal(&that1.Histogramsamples[i]) {
			return false
		}
	}
	return true
...
func (this *SampleStream) GoString() string {
	...
	if this.Histogramsamples != nil {
		vs := make([]*logproto.HistogramSample, len(this.Histogramsamples))
		for i := range vs {
			vs[i] = &this.Histogramsamples[i]
		}
		s = append(s, "Histogramsamples: "+fmt.Sprintf("%#v", vs)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *SampleStream) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.Histogramsamples) > 0 {
		for iNdEx := len(m.Histogramsamples) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.Histogramsamples[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *SampleStream) Size() (n int) {
	...
	if len(m.Histogramsamples) > 0 {
		for _, e := range m.Histogramsamples {
			l = e.Size()
			n += 1 + l + sovQueryrange(uint64(l))
		}
	}
...
func (this *SampleStream) String() string {
	...
	repeatedStringForHistogramsamples := "[]HistogramSample{"
	for _, f := range this.Histogramsamples {
		repeatedStringForHistogramsamples += fmt.Sprintf("%v", f) + ","
	}
	repeatedStringForHistogramsamples += "}"
	s := strings.Join([]string{`&SampleStream{`,
		`Labels:` + fmt.Sprintf("%v", this.Labels) + `,`,
		`Samples:` + repeatedStringForSamples + `,`,
		`Histogramsamples:` + repeatedStringForHistogramsamples + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *SampleStream) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Histogramsamples = append(m.Histogramsamples, logproto.HistogramSample{})
			if err := m.Histogramsamples[len(m.Histogramsamples)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
