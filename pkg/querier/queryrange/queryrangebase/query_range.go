...
func (q *PrometheusResponse) EncodeJSON(_ bool, _ io.Writer, _ httpreq.EncodingFlags) error {
	return fmt.Errorf("PrometheusResponse does not support JSON encoding")
}
