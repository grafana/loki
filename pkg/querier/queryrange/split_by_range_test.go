...
func Test_RangeVectorSplit(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			...
			subQueries: []queryrangebase.RequestResponse{
				subQueryRequestResponse(`bytes_over_time({app="foo"}[1m])`, 1),
				subQueryRequestResponse(`bytes_over_time({app="foo"}[1m] offset 1m0s)`, 2),
				subQueryRequestResponse(`bytes_over_time({app="foo"}[1m] offset 2m0s)`, 3),
			},
		...
		},
		{
			...
			subQueries: []queryrangebase.RequestResponse{
				...
				subQueryRequestResponse(`bytes_over_time({app="foo"}[1m] offset 2m0s)`, 30),
			},
		...
		},
		{
			...
			subQueries: []queryrangebase.RequestResponse{
				subQueryRequestResponse(`count_over_time({app="foo"}[1m])`, 1),
				subQueryRequestResponse(`count_over_time({app="foo"}[1m] offset 1m0s)`, 1),
				subQueryRequestResponse(`count_over_time({app="foo"}[1m] offset 2m0s)`, 1),
			},
		...
		},
		{
			...
			subQueries: []queryrangebase.RequestResponse{
				...
				subQueryRequestResponse(`count_over_time({app="foo"}[1m] offset 2m0s)`, 0),
			},
