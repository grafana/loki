...
type OTLPConfig struct {
	...
	ConversionStrategy  string                   `yaml:"conversion_strategy,omitempty" category:"experimental" doc:"default=dots_to_underscores|description=Experimental. Conversion strategy to use for OTLP logs. It can be one of [dots_to_underscores (default) or no_conversion]. dots_to_underscores will convert dots in attribute names to underscores, while no_conversion will keep the original attribute names with dots."`
}
...
func (c *OTLPConfig) Validate() error {
	...
	if c.ConversionStrategy != DotsToUnderscores && c.ConversionStrategy != NoConversion {
