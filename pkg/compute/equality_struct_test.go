...
func TestEquals_Struct(t *testing.T) {
	...
	left := columnartest.Struct(t, &alloc,
		columnartest.Field("x", columnar.KindInt64, int64(1), int64(2), int64(3)),
		columnartest.Field("y", columnar.KindUTF8, "a", "b", "c"),
	)
	right := columnartest.Struct(t, &alloc,
		columnartest.Field("x", columnar.KindInt64, int64(1), int64(99), int64(3)),
		columnartest.Field("y", columnar.KindUTF8, "a", "b", "z"),
	)
...
func TestNotEquals_Struct(t *testing.T) {
	...
	right := columnartest.Struct(t, &alloc,
		columnartest.Field("x", columnar.KindInt64, int64(1), int64(99)),
	)

	actual, err := compute.NotEquals(&alloc, left, right, memory.Bitmap{})
	require.NoError(t, err)

	expect := columnartest.Array(t, columnar.KindBool, &alloc, false, true)
	columnartest.RequireDatumsEqual(t, expect, actual, memory.Bitmap{})
}
...
func TestEquals_Struct_WithNulls(t *testing.T) {
	...
	left := columnartest.StructWithValidity(t, &alloc, []bool{true, false},
		columnartest.Field("x", columnar.KindInt64, int64(1), int64(0)),
	)
	right := columnartest.Struct(t, &alloc,
		columnartest.Field("x", columnar.KindInt64, int64(1), int64(0)),
	)
	...
	expect := columnartest.Array(t, columnar.KindBool, &alloc, true, nil)
	columnartest.RequireDatumsEqual(t, expect, actual, memory.Bitmap{})
}
...
func TestEquals_Struct_WithFieldNulls(t *testing.T) {
	...
	left := columnartest.Struct(t, &alloc,
		columnartest.Field("x", columnar.KindInt64, int64(1), nil),
	)
	right := columnartest.Struct(t, &alloc,
		columnartest.Field("x", columnar.KindInt64, int64(1), int64(2)),
	)
...
func TestEquals_Struct_NameMismatch(t *testing.T) {
	...
	left := columnartest.Struct(t, &alloc,
		columnartest.Field("x", columnar.KindInt64, int64(1)),
		columnartest.Field("y", columnar.KindInt64, int64(2)),
	)
	right := columnartest.Struct(t, &alloc,
		columnartest.Field("x", columnar.KindInt64, int64(1)),
		columnartest.Field("z", columnar.KindInt64, int64(2)),
	)
...
func TestNotEquals_Struct_WithFieldNulls(t *testing.T) {
	...
	expect := columnartest.Array(t, columnar.KindBool, &alloc, false, nil)
	columnartest.RequireDatumsEqual(t, expect, actual, memory.Bitmap{})
}
