...
func TestFilter_Struct(t *testing.T) {
	...
	columnartest.RequireArraysEqual(t,
		columnartest.Array(t, columnar.KindInt64, &alloc, int64(1), int64(3)),
		rs.Field(0), memory.Bitmap{},
	)
	columnartest.RequireArraysEqual(t,
		columnartest.Array(t, columnar.KindUTF8, &alloc, "a", "c"),
...
func TestFilter_Struct_WithValidity(t *testing.T) {
	...
	input := columnar.NewStruct(schema, []columnar.Array{
		columnartest.Array(t, columnar.KindInt64, &alloc, int64(1), int64(0), int64(3)),
	}, 3, validity)
