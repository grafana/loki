...
type SinkRoutingStrategy int32

const (
	SINK_ROUTING_STRATEGY_INVALID    SinkRoutingStrategy = 0
	SINK_ROUTING_STRATEGY_BROADCAST  SinkRoutingStrategy = 1
	SINK_ROUTING_STRATEGY_LABEL_HASH SinkRoutingStrategy = 2
	SINK_ROUTING_STRATEGY_TIME_SHARD SinkRoutingStrategy = 3
)

var SinkRoutingStrategy_name = map[int32]string{
	0: "SINK_ROUTING_STRATEGY_INVALID",
	1: "SINK_ROUTING_STRATEGY_BROADCAST",
	2: "SINK_ROUTING_STRATEGY_LABEL_HASH",
	3: "SINK_ROUTING_STRATEGY_TIME_SHARD",
}

var SinkRoutingStrategy_value = map[string]int32{
	"SINK_ROUTING_STRATEGY_INVALID":    0,
	"SINK_ROUTING_STRATEGY_BROADCAST":  1,
	"SINK_ROUTING_STRATEGY_LABEL_HASH": 2,
	"SINK_ROUTING_STRATEGY_TIME_SHARD": 3,
}

func (SinkRoutingStrategy) EnumDescriptor() ([]byte, []int) {
...
type SinkRouting struct {
	Strategy SinkRoutingStrategy `protobuf:"varint,1,opt,name=strategy,proto3,enum=loki.wire.SinkRoutingStrategy" json:"strategy,omitempty"`
	// Grouping specifies the columns to use for label-based sharding.
	// Only used when strategy is SINK_ROUTING_STRATEGY_LABEL_HASH.
	Grouping *physicalpb.Grouping `protobuf:"bytes,2,opt,name=grouping,proto3" json:"grouping,omitempty"`
	// TimeRanges specifies the time range for each shard.
	// Only used when strategy is SINK_ROUTING_STRATEGY_TIME_SHARD.
	// The order matches the order of sinks: time_ranges[i] corresponds to sinks[i].
	TimeRanges []*physicalpb.TimeRange `protobuf:"bytes,3,rep,name=time_ranges,json=timeRanges,proto3" json:"time_ranges,omitempty"`
}

func (m *SinkRouting) Reset()      { *m = SinkRouting{} }
func (*SinkRouting) ProtoMessage() {}
func (*SinkRouting) Descriptor() ([]byte, []int) {
	return fileDescriptor_9956cb67d4b0d2a4, []int{16}
}
func (m *SinkRouting) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SinkRouting) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SinkRouting.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SinkRouting) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SinkRouting.Merge(m, src)
}
func (m *SinkRouting) XXX_Size() int {
	return m.Size()
}
func (m *SinkRouting) XXX_DiscardUnknown() {
	xxx_messageInfo_SinkRouting.DiscardUnknown(m)
}

var xxx_messageInfo_SinkRouting proto.InternalMessageInfo

func (m *SinkRouting) GetStrategy() SinkRoutingStrategy {
	if m != nil {
		return m.Strategy
	}
	return SINK_ROUTING_STRATEGY_INVALID
}

func (m *SinkRouting) GetGrouping() *physicalpb.Grouping {
	if m != nil {
		return m.Grouping
	}
	return nil
...
func (m *SinkRouting) GetTimeRanges() []*physicalpb.TimeRange {
	if m != nil {
		return m.TimeRanges
	}
	return nil
...
type Task struct {
	...
	SinkRouting *SinkRouting `protobuf:"bytes,8,opt,name=sink_routing,json=sinkRouting,proto3" json:"sink_routing,omitempty"`
}
...
func (m *Task) GetSinkRouting() *SinkRouting {
	if m != nil {
		return m.SinkRouting
	}
	return nil
}
...
func (*ContributingTimeRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_9956cb67d4b0d2a4, []int{22}
}
...
func (*TaskError) Descriptor() ([]byte, []int) {
	return fileDescriptor_9956cb67d4b0d2a4, []int{23}
}
...
func init() {
	...
	proto.RegisterEnum("loki.wire.SinkRoutingStrategy", SinkRoutingStrategy_name, SinkRoutingStrategy_value)
	...
	proto.RegisterType((*SinkRouting)(nil), "loki.wire.SinkRouting")
...
var fileDescriptor_9956cb67d4b0d2a4 = []byte{
	...
	,
}
...
func (x SinkRoutingStrategy) String() string {
	s, ok := SinkRoutingStrategy_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (this *SinkRouting) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*SinkRouting)
	if !ok {
		that2, ok := that.(SinkRouting)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *Task) Equal(that interface{}) bool {
	...
	if !this.SinkRouting.Equal(that1.SinkRouting) {
		return false
	}
	return true
}
...
func (this *SinkRouting) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&wirepb.SinkRouting{")
	...
	if this.TimeRanges != nil {
		s = append(s, "TimeRanges: "+fmt.Sprintf("%#v", this.TimeRanges)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *Task) GoString() string {
	...
	if this.SinkRouting != nil {
		s = append(s, "SinkRouting: "+fmt.Sprintf("%#v", this.SinkRouting)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *SinkRouting) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SinkRouting) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SinkRouting) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Strategy != 0 {
		i = encodeVarintWirepb(dAtA, i, uint64(m.Strategy))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Task) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.SinkRouting != nil {
		{
			size, err := m.SinkRouting.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *ContributingTimeRange) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n35, err35 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.Timestamp, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.Timestamp):])
	if err35 != nil {
		return 0, err35
	}
	i -= n35
	i = encodeVarintWirepb(dAtA, i, uint64(n35))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
...
func (m *SinkRouting) Size() (n int) {
	...
	_ = l
	if m.Strategy != 0 {
		n += 1 + sovWirepb(uint64(m.Strategy))
	}
	if m.Grouping != nil {
		l = m.Grouping.Size()
		n += 1 + l + sovWirepb(uint64(l))
...
func (this *SinkRouting) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForTimeRanges := "[]*TimeRange{"
	for _, f := range this.TimeRanges {
		repeatedStringForTimeRanges += strings.Replace(fmt.Sprintf("%v", f), "TimeRange", "physicalpb.TimeRange", 1) + ","
	}
	repeatedStringForTimeRanges += "}"
	s := strings.Join([]string{`&SinkRouting{`,
		`Strategy:` + fmt.Sprintf("%v", this.Strategy) + `,`,
		`Grouping:` + strings.Replace(fmt.Sprintf("%v", this.Grouping), "Grouping", "physicalpb.Grouping", 1) + `,`,
...
func (this *Task) String() string {
	...
	s := strings.Join([]string{`&Task{`,
		...
		`SinkRouting:` + strings.Replace(this.SinkRouting.String(), "SinkRouting", "SinkRouting", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *SinkRouting) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SinkRouting: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SinkRouting: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Strategy |= SinkRoutingStrategy(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			if m.Grouping == nil {
				m.Grouping = &physicalpb.Grouping{}
			}
		...
		case 3:
			...
			m.TimeRanges = append(m.TimeRanges, &physicalpb.TimeRange{})
...
func (m *Task) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SinkRouting", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.SinkRouting == nil {
				m.SinkRouting = &SinkRouting{}
			}
			if err := m.SinkRouting.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
