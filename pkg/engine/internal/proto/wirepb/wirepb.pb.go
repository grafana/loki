...
type TaskAssignMessage struct {
	...
	// TraceContextCarrier holds OpenTelemetry trace context.
	TraceContextCarrier map[string]string `protobuf:"bytes,3,rep,name=trace_context_carrier,json=traceContextCarrier,proto3" json:"trace_context_carrier,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *TaskAssignMessage) GetTraceContextCarrier() map[string]string {
	if m != nil {
		return m.TraceContextCarrier
	}
	return nil
}
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "loki.wire.TaskAssignMessage.TraceContextCarrierEntry")
...
var fileDescriptor_9956cb67d4b0d2a4 = []byte{
	...
	,
}
...
func (this *TaskAssignMessage) Equal(that interface{}) bool {
	...
	if len(this.TraceContextCarrier) != len(that1.TraceContextCarrier) {
		return false
	}
	for i := range this.TraceContextCarrier {
		if this.TraceContextCarrier[i] != that1.TraceContextCarrier[i] {
			return false
		}
	}
	return true
...
func (this *TaskAssignMessage) GoString() string {
	...
	keysForTraceContextCarrier := make([]string, 0, len(this.TraceContextCarrier))
	for k, _ := range this.TraceContextCarrier {
		keysForTraceContextCarrier = append(keysForTraceContextCarrier, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForTraceContextCarrier)
	mapStringForTraceContextCarrier := "map[string]string{"
	for _, k := range keysForTraceContextCarrier {
		mapStringForTraceContextCarrier += fmt.Sprintf("%#v: %#v,", k, this.TraceContextCarrier[k])
	}
	mapStringForTraceContextCarrier += "}"
	if this.TraceContextCarrier != nil {
		s = append(s, "TraceContextCarrier: "+mapStringForTraceContextCarrier+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *TaskAssignMessage) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.TraceContextCarrier) > 0 {
		for k := range m.TraceContextCarrier {
			v := m.TraceContextCarrier[k]
			baseI := i
			i -= len(v)
			copy(dAtA[i:], v)
			i = encodeVarintWirepb(dAtA, i, uint64(len(v)))
			i--
			dAtA[i] = 0x12
			i -= len(k)
			copy(dAtA[i:], k)
...
func (m *TaskAssignMessage) Size() (n int) {
	...
	if len(m.TraceContextCarrier) > 0 {
		for k, v := range m.TraceContextCarrier {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovWirepb(uint64(len(k))) + 1 + len(v) + sovWirepb(uint64(len(v)))
			n += mapEntrySize + 1 + sovWirepb(uint64(mapEntrySize))
		}
	}
	return n
...
func (this *TaskAssignMessage) String() string {
	...
	s := strings.Join([]string{`&TaskAssignMessage{`,
		...
		`TraceContextCarrier:` + mapStringForTraceContextCarrier + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *TaskAssignMessage) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TraceContextCarrier", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TraceContextCarrier == nil {
				m.TraceContextCarrier = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
			...
			m.TraceContextCarrier[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipWirepb(dAtA[iNdEx:])
