...
// GroupingMode represents the way on interpretation of the list of columns for grouping.
type GroupingMode int32

const (
	GROUPING_MODE_INVALID                    GroupingMode = 0
	GROUPING_MODE_GROUPING_BY_EMPTY_SET      GroupingMode = 1
	GROUPING_MODE_GROUPING_BY_LABEL_SET      GroupingMode = 2
	GROUPING_MODE_GROUPING_WITHOUT_EMPTY_SET GroupingMode = 3
	GROUPING_MODE_GROUPING_WITHOUT_LABEL_SET GroupingMode = 4
)

var GroupingMode_name = map[int32]string{
	0: "GROUPING_MODE_INVALID",
	1: "GROUPING_MODE_GROUPING_BY_EMPTY_SET",
	2: "GROUPING_MODE_GROUPING_BY_LABEL_SET",
	3: "GROUPING_MODE_GROUPING_WITHOUT_EMPTY_SET",
	4: "GROUPING_MODE_GROUPING_WITHOUT_LABEL_SET",
}

var GroupingMode_value = map[string]int32{
	"GROUPING_MODE_INVALID":                    0,
	"GROUPING_MODE_GROUPING_BY_EMPTY_SET":      1,
	"GROUPING_MODE_GROUPING_BY_LABEL_SET":      2,
	"GROUPING_MODE_GROUPING_WITHOUT_EMPTY_SET": 3,
	"GROUPING_MODE_GROUPING_WITHOUT_LABEL_SET": 4,
}
...
type AggregateRange struct {
	...
	Grouping  *Grouping        `protobuf:"bytes,1,opt,name=grouping,proto3" json:"grouping,omitempty"`
...
type Grouping struct {
	...
	Mode    GroupingMode                     `protobuf:"varint,2,opt,name=mode,proto3,enum=loki.physical.GroupingMode" json:"mode,omitempty"`
}
...
func (m *Grouping) GetMode() GroupingMode {
	if m != nil {
		return m.Mode
	}
	return GROUPING_MODE_INVALID
}
...
type AggregateVector struct {
	...
	Operation AggregateVectorOp `protobuf:"varint,3,opt,name=operation,proto3,enum=loki.physical.AggregateVectorOp" json:"operation,omitempty"`
}
...
func init() {
	proto.RegisterEnum("loki.physical.GroupingMode", GroupingMode_name, GroupingMode_value)
...
var fileDescriptor_d1fdbb44b95b211f = []byte{
	...
	,
}

func (x GroupingMode) String() string {
	s, ok := GroupingMode_name[int32(x)]
	if ok {
		return s
	}
...
func (m *Grouping) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Mode != 0 {
		i = encodeVarintPhysicalpb(dAtA, i, uint64(m.Mode))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Columns) > 0 {
...
func (m *Grouping) Size() (n int) {
	...
	if m.Mode != 0 {
		n += 1 + sovPhysicalpb(uint64(m.Mode))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Mode |= GroupingMode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
