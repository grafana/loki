...
type AggregateRange struct {
	...
	// execution path.
	Columnar bool `protobuf:"varint,9,opt,name=columnar,proto3" json:"columnar,omitempty"`
}
...
func (m *AggregateRange) GetColumnar() bool {
	if m != nil {
		return m.Columnar
	}
	return false
...
type AggregateVector struct {
	...
	// Columnar indicates that this node should use the columnar (batch)
	// execution path.
	Columnar bool `protobuf:"varint,5,opt,name=columnar,proto3" json:"columnar,omitempty"`
}
...
func (m *AggregateVector) GetColumnar() bool {
	if m != nil {
		return m.Columnar
	}
	return false
...
var fileDescriptor_d1fdbb44b95b211f = []byte{
	...
	,
}
...
func (this *AggregateRange) Equal(that interface{}) bool {
	...
	if this.Columnar != that1.Columnar {
		return false
	}
	return true
}
...
func (this *AggregateRange) GoString() string {
	...
	s = append(s, "Columnar: "+fmt.Sprintf("%#v", this.Columnar)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *PointersScan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i -= n34
	i = encodeVarintPhysicalpb(dAtA, i, uint64(n34))
	i--
	dAtA[i] = 0x2a
...
func (this *AggregateRange) String() string {
	...
	s := strings.Join([]string{`&AggregateRange{`,
		...
		`Columnar:` + fmt.Sprintf("%v", this.Columnar) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *AggregateRange) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Columnar", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
