...
type Node_IndexConsolidate struct {
	IndexConsolidate *IndexConsolidate `protobuf:"bytes,17,opt,name=index_consolidate,json=indexConsolidate,proto3,oneof"`
}
...
func (*Node_IndexConsolidate) isNode_Kind() {}
...
func (m *Node) GetIndexConsolidate() *IndexConsolidate {
	if x, ok := m.GetKind().(*Node_IndexConsolidate); ok {
		return x.IndexConsolidate
	}
	return nil
}
...
// IndexConsolidate is a workflow-final compaction task that builds one
// covering index from N compacted log objects, performs the single primary-ToC
// swap, and deletes the workflow marker. Emitted only by the
// dataobj-compactor coordinator (future PR A11).
type IndexConsolidate struct {
	// Tenant scope. All paths below belong to this tenant.
	Tenant string `protobuf:"bytes,1,opt,name=tenant,proto3" json:"tenant,omitempty"`
	// Start of the ToC window for this compaction cycle, in nanoseconds since
	// the Unix epoch.
	TocWindowStart int64 `protobuf:"varint,2,opt,name=toc_window_start,json=tocWindowStart,proto3" json:"toc_window_start,omitempty"`
	// Deterministic output paths of all Phase-1 CompactionMerge tasks.
	CompactedLogObjectPaths []string `protobuf:"bytes,3,rep,name=compacted_log_object_paths,json=compactedLogObjectPaths,proto3" json:"compacted_log_object_paths,omitempty"`
	// Source index paths to be removed from the primary ToC during the swap.
	...
	// Deterministic destination for the consolidated covering index.
	...
	// Workflow marker to delete on success.
	MarkerPath string `protobuf:"bytes,6,opt,name=marker_path,json=markerPath,proto3" json:"marker_path,omitempty"`
	// Per-task execution deadline.
	TaskTtl time.Duration `protobuf:"bytes,7,opt,name=task_ttl,json=taskTtl,proto3,stdduration" json:"task_ttl"`
}

func (m *IndexConsolidate) Reset()      { *m = IndexConsolidate{} }
func (*IndexConsolidate) ProtoMessage() {}
func (*IndexConsolidate) Descriptor() ([]byte, []int) {
	return fileDescriptor_d1fdbb44b95b211f, []int{22}
}
func (m *IndexConsolidate) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IndexConsolidate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_IndexConsolidate.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *IndexConsolidate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IndexConsolidate.Merge(m, src)
}
func (m *IndexConsolidate) XXX_Size() int {
	return m.Size()
}
func (m *IndexConsolidate) XXX_DiscardUnknown() {
	xxx_messageInfo_IndexConsolidate.DiscardUnknown(m)
}

var xxx_messageInfo_IndexConsolidate proto.InternalMessageInfo

func (m *IndexConsolidate) GetTenant() string {
	if m != nil {
		return m.Tenant
	}
	return ""
...
func (m *IndexConsolidate) GetTocWindowStart() int64 {
	if m != nil {
		return m.TocWindowStart
	}
	return 0
}

func (m *IndexConsolidate) GetCompactedLogObjectPaths() []string {
	if m != nil {
		return m.CompactedLogObjectPaths
	}
	return nil
}

func (m *IndexConsolidate) GetSourceIndexPaths() []string {
	if m != nil {
...
func (m *IndexConsolidate) GetOutputIndexPath() string {
	if m != nil {
...
func (m *IndexConsolidate) GetMarkerPath() string {
	if m != nil {
		return m.MarkerPath
	}
	return ""
...
func (m *IndexConsolidate) GetTaskTtl() time.Duration {
	if m != nil {
		return m.TaskTtl
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*IndexConsolidate)(nil), "loki.physical.IndexConsolidate")
}
...
var fileDescriptor_d1fdbb44b95b211f = []byte{
	...
	,
}
...
func (this *Node_IndexConsolidate) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Node_IndexConsolidate)
	if !ok {
		that2, ok := that.(Node_IndexConsolidate)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.IndexConsolidate.Equal(that1.IndexConsolidate) {
		return false
	}
	return true
}
...
func (this *IndexConsolidate) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*IndexConsolidate)
	if !ok {
		that2, ok := that.(IndexConsolidate)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.TocWindowStart != that1.TocWindowStart {
		return false
	}
	if len(this.CompactedLogObjectPaths) != len(that1.CompactedLogObjectPaths) {
		return false
	}
	for i := range this.CompactedLogObjectPaths {
		if this.CompactedLogObjectPaths[i] != that1.CompactedLogObjectPaths[i] {
			return false
		}
	}
	...
	if this.MarkerPath != that1.MarkerPath {
		return false
	}
	if this.TaskTtl != that1.TaskTtl {
		return false
	}
	return true
}
...
func (this *Node_IndexConsolidate) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&physicalpb.Node_IndexConsolidate{` +
		`IndexConsolidate:` + fmt.Sprintf("%#v", this.IndexConsolidate) + `}`}, ", ")
	return s
}
...
func (this *IndexConsolidate) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 11)
	s = append(s, "&physicalpb.IndexConsolidate{")
	s = append(s, "Tenant: "+fmt.Sprintf("%#v", this.Tenant)+",\n")
	s = append(s, "TocWindowStart: "+fmt.Sprintf("%#v", this.TocWindowStart)+",\n")
	s = append(s, "CompactedLogObjectPaths: "+fmt.Sprintf("%#v", this.CompactedLogObjectPaths)+",\n")
	...
	s = append(s, "MarkerPath: "+fmt.Sprintf("%#v", this.MarkerPath)+",\n")
	s = append(s, "TaskTtl: "+fmt.Sprintf("%#v", this.TaskTtl)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Node_IndexConsolidate) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *Node_IndexConsolidate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.IndexConsolidate != nil {
		{
			size, err := m.IndexConsolidate.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *AggregateRange) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n22, err22 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.Range, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.Range):])
	if err22 != nil {
		return 0, err22
	}
	i -= n22
	...
	i--
	dAtA[i] = 0x32
	n23, err23 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.Step, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.Step):])
	if err23 != nil {
		return 0, err23
	}
	i -= n23
	...
	i--
	dAtA[i] = 0x2a
	n24, err24 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.End, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.End):])
	if err24 != nil {
		return 0, err24
	}
	i -= n24
...
func (m *DataObjScan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.StreamIds) > 0 {
		dAtA29 := make([]byte, len(m.StreamIds)*10)
		var j28 int
		...
		i = encodeVarintPhysicalpb(dAtA, i, uint64(j28))
		i--
		dAtA[i] = 0x1a
	}
	if m.Section != 0 {
...
func (m *TimeRange) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i -= n30
	i = encodeVarintPhysicalpb(dAtA, i, uint64(n30))
	i--
	dAtA[i] = 0x12
	...
	i -= n31
	i = encodeVarintPhysicalpb(dAtA, i, uint64(n31))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
...
func (m *ColumnCompat) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Collisions) > 0 {
		dAtA33 := make([]byte, len(m.Collisions)*10)
		var j32 int
		...
		i = encodeVarintPhysicalpb(dAtA, i, uint64(j32))
		i--
		dAtA[i] = 0x1a
	}
	if m.Destination != 0 {
...
func (m *PointersScan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i -= n37
	i = encodeVarintPhysicalpb(dAtA, i, uint64(n37))
	i--
	dAtA[i] = 0x2a
	...
	i -= n38
	i = encodeVarintPhysicalpb(dAtA, i, uint64(n38))
	i--
	dAtA[i] = 0x22
	if len(m.Predicates) > 0 {
		for iNdEx := len(m.Predicates) - 1; iNdEx >= 0; iNdEx-- {
...
func (m *IndexConsolidate) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *IndexConsolidate) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IndexConsolidate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	n40, err40 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.TaskTtl, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.TaskTtl):])
	if err40 != nil {
		return 0, err40
	}
	i -= n40
	...
	i--
	dAtA[i] = 0x3a
	if len(m.MarkerPath) > 0 {
		i -= len(m.MarkerPath)
		copy(dAtA[i:], m.MarkerPath)
		i = encodeVarintPhysicalpb(dAtA, i, uint64(len(m.MarkerPath)))
		i--
		dAtA[i] = 0x32
	}
	...
	if len(m.CompactedLogObjectPaths) > 0 {
		for iNdEx := len(m.CompactedLogObjectPaths) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.CompactedLogObjectPaths[iNdEx])
			copy(dAtA[i:], m.CompactedLogObjectPaths[iNdEx])
			i = encodeVarintPhysicalpb(dAtA, i, uint64(len(m.CompactedLogObjectPaths[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
	if m.TocWindowStart != 0 {
		i = encodeVarintPhysicalpb(dAtA, i, uint64(m.TocWindowStart))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Tenant) > 0 {
...
func (m *Node_IndexConsolidate) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *IndexConsolidate) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.TocWindowStart != 0 {
		n += 1 + sovPhysicalpb(uint64(m.TocWindowStart))
	}
	if len(m.CompactedLogObjectPaths) > 0 {
		for _, s := range m.CompactedLogObjectPaths {
			l = len(s)
			n += 1 + l + sovPhysicalpb(uint64(l))
		}
	}
	...
	l = github_com_gogo_protobuf_types.SizeOfStdDuration(m.TaskTtl)
	n += 1 + l + sovPhysicalpb(uint64(l))
	return n
}
...
func (this *Node_IndexConsolidate) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Node_IndexConsolidate{`,
		`IndexConsolidate:` + strings.Replace(fmt.Sprintf("%v", this.IndexConsolidate), "IndexConsolidate", "IndexConsolidate", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *IndexConsolidate) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&IndexConsolidate{`,
		`Tenant:` + fmt.Sprintf("%v", this.Tenant) + `,`,
		`TocWindowStart:` + fmt.Sprintf("%v", this.TocWindowStart) + `,`,
		`CompactedLogObjectPaths:` + fmt.Sprintf("%v", this.CompactedLogObjectPaths) + `,`,
		`SourceIndexPaths:` + fmt.Sprintf("%v", this.SourceIndexPaths) + `,`,
		`OutputIndexPath:` + fmt.Sprintf("%v", this.OutputIndexPath) + `,`,
		`MarkerPath:` + fmt.Sprintf("%v", this.MarkerPath) + `,`,
		`TaskTtl:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.TaskTtl), "Duration", "durationpb.Duration", 1), `&`, ``, 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Node) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IndexConsolidate", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Kind = &Node_IndexConsolidate{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPhysicalpb(dAtA[iNdEx:])
...
func (m *IndexConsolidate) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IndexConsolidate: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IndexConsolidate: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TocWindowStart", wireType)
			}
			m.TocWindowStart = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TocWindowStart |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CompactedLogObjectPaths", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CompactedLogObjectPaths = append(m.CompactedLogObjectPaths, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MarkerPath", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MarkerPath = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TaskTtl", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := github_com_gogo_protobuf_types.StdDurationUnmarshal(&m.TaskTtl, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
