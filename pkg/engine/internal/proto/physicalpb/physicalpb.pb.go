...
type Node struct {
	...
	//	*Node_Batching
	//	*Node_Cache
	//	*Node_TableOfContentsConsolidate
...
type Node_TableOfContentsConsolidate struct {
	TableOfContentsConsolidate *TableOfContentsConsolidate `protobuf:"bytes,17,opt,name=table_of_contents_consolidate,json=tableOfContentsConsolidate,proto3,oneof"`
}
...
func (*Node_TableOfContentsConsolidate) isNode_Kind() {}
...
func (m *Node) GetTableOfContentsConsolidate() *TableOfContentsConsolidate {
	if x, ok := m.GetKind().(*Node_TableOfContentsConsolidate); ok {
		return x.TableOfContentsConsolidate
	}
	return nil
}
...
func (*Node) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*Node_Batching)(nil),
		(*Node_Cache)(nil),
		(*Node_TableOfContentsConsolidate)(nil),
	}
}
...
// TableOfContentsConsolidate is the dataobj-compactor v1.0 Phase-2 task.
// Sole responsibility: a single primary-ToC ReplaceIndexPointers swap that
// removes the indexes being consolidated and adds the merged indexes produced
// by Phase-1 IndexMerge tasks. No index build, no object uploads, no marker
// handling. Emitted only by the dataobj-compactor coordinator.
type TableOfContentsConsolidate struct {
	...
	// Existing ToC entries to remove (the indexes being consolidated).
	RemoveIndexPaths []string `protobuf:"bytes,3,rep,name=remove_index_paths,json=removeIndexPaths,proto3" json:"remove_index_paths,omitempty"`
	// New ToC entries to add (the merged indexes produced by Phase-1
	// IndexMerge tasks).
	AddIndexPaths []string `protobuf:"bytes,4,rep,name=add_index_paths,json=addIndexPaths,proto3" json:"add_index_paths,omitempty"`
	// Per-task execution deadline. Sourced from
	// table_of_contents_consolidate_task_ttl.
	TaskTtl time.Duration `protobuf:"bytes,5,opt,name=task_ttl,json=taskTtl,proto3,stdduration" json:"task_ttl"`
}

func (m *TableOfContentsConsolidate) Reset()      { *m = TableOfContentsConsolidate{} }
func (*TableOfContentsConsolidate) ProtoMessage() {}
func (*TableOfContentsConsolidate) Descriptor() ([]byte, []int) {
	return fileDescriptor_d1fdbb44b95b211f, []int{22}
}
func (m *TableOfContentsConsolidate) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TableOfContentsConsolidate) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TableOfContentsConsolidate.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TableOfContentsConsolidate) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TableOfContentsConsolidate.Merge(m, src)
}
func (m *TableOfContentsConsolidate) XXX_Size() int {
	return m.Size()
}
func (m *TableOfContentsConsolidate) XXX_DiscardUnknown() {
	xxx_messageInfo_TableOfContentsConsolidate.DiscardUnknown(m)
}

var xxx_messageInfo_TableOfContentsConsolidate proto.InternalMessageInfo

func (m *TableOfContentsConsolidate) GetTenant() string {
	if m != nil {
		return m.Tenant
	}
	return ""
...
func (m *TableOfContentsConsolidate) GetTocWindowStart() int64 {
	if m != nil {
...
func (m *TableOfContentsConsolidate) GetRemoveIndexPaths() []string {
	if m != nil {
		return m.RemoveIndexPaths
	}
	return nil
}

func (m *TableOfContentsConsolidate) GetAddIndexPaths() []string {
	if m != nil {
		return m.AddIndexPaths
	}
	return nil
}

func (m *TableOfContentsConsolidate) GetTaskTtl() time.Duration {
	if m != nil {
		return m.TaskTtl
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*TableOfContentsConsolidate)(nil), "loki.physical.TableOfContentsConsolidate")
}
...
var fileDescriptor_d1fdbb44b95b211f = []byte{
	...
	,
}
...
func (this *Node_TableOfContentsConsolidate) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Node_TableOfContentsConsolidate)
	if !ok {
		that2, ok := that.(Node_TableOfContentsConsolidate)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.TableOfContentsConsolidate.Equal(that1.TableOfContentsConsolidate) {
		return false
	}
	return true
}
...
func (this *TableOfContentsConsolidate) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TableOfContentsConsolidate)
	if !ok {
		that2, ok := that.(TableOfContentsConsolidate)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if len(this.RemoveIndexPaths) != len(that1.RemoveIndexPaths) {
		return false
	}
	for i := range this.RemoveIndexPaths {
		if this.RemoveIndexPaths[i] != that1.RemoveIndexPaths[i] {
			return false
		}
	}
	if len(this.AddIndexPaths) != len(that1.AddIndexPaths) {
		return false
	}
	for i := range this.AddIndexPaths {
		if this.AddIndexPaths[i] != that1.AddIndexPaths[i] {
			return false
		}
	}
...
func (this *Node_TableOfContentsConsolidate) GoString() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&physicalpb.Node_TableOfContentsConsolidate{` +
		`TableOfContentsConsolidate:` + fmt.Sprintf("%#v", this.TableOfContentsConsolidate) + `}`}, ", ")
	return s
}
...
func (this *TableOfContentsConsolidate) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 9)
	s = append(s, "&physicalpb.TableOfContentsConsolidate{")
	s = append(s, "Tenant: "+fmt.Sprintf("%#v", this.Tenant)+",\n")
	s = append(s, "TocWindowStart: "+fmt.Sprintf("%#v", this.TocWindowStart)+",\n")
	s = append(s, "RemoveIndexPaths: "+fmt.Sprintf("%#v", this.RemoveIndexPaths)+",\n")
	s = append(s, "AddIndexPaths: "+fmt.Sprintf("%#v", this.AddIndexPaths)+",\n")
...
func (m *Node_TableOfContentsConsolidate) MarshalTo(dAtA []byte) (int, error) {
	return m.MarshalToSizedBuffer(dAtA[:m.Size()])
}

func (m *Node_TableOfContentsConsolidate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.TableOfContentsConsolidate != nil {
		{
			size, err := m.TableOfContentsConsolidate.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *TableOfContentsConsolidate) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TableOfContentsConsolidate) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TableOfContentsConsolidate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	i--
	dAtA[i] = 0x2a
	if len(m.AddIndexPaths) > 0 {
		for iNdEx := len(m.AddIndexPaths) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.AddIndexPaths[iNdEx])
			copy(dAtA[i:], m.AddIndexPaths[iNdEx])
			i = encodeVarintPhysicalpb(dAtA, i, uint64(len(m.AddIndexPaths[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
	if len(m.RemoveIndexPaths) > 0 {
		for iNdEx := len(m.RemoveIndexPaths) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.RemoveIndexPaths[iNdEx])
			copy(dAtA[i:], m.RemoveIndexPaths[iNdEx])
			i = encodeVarintPhysicalpb(dAtA, i, uint64(len(m.RemoveIndexPaths[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *Node_TableOfContentsConsolidate) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.TableOfContentsConsolidate != nil {
		l = m.TableOfContentsConsolidate.Size()
		n += 2 + l + sovPhysicalpb(uint64(l))
	}
	return n
}
...
func (m *TableOfContentsConsolidate) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.RemoveIndexPaths) > 0 {
		for _, s := range m.RemoveIndexPaths {
			l = len(s)
			n += 1 + l + sovPhysicalpb(uint64(l))
		}
	}
	if len(m.AddIndexPaths) > 0 {
		for _, s := range m.AddIndexPaths {
			l = len(s)
			n += 1 + l + sovPhysicalpb(uint64(l))
		}
	}
...
func (this *Node_TableOfContentsConsolidate) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Node_TableOfContentsConsolidate{`,
		`TableOfContentsConsolidate:` + strings.Replace(fmt.Sprintf("%v", this.TableOfContentsConsolidate), "TableOfContentsConsolidate", "TableOfContentsConsolidate", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *TableOfContentsConsolidate) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&TableOfContentsConsolidate{`,
		`Tenant:` + fmt.Sprintf("%v", this.Tenant) + `,`,
		`TocWindowStart:` + fmt.Sprintf("%v", this.TocWindowStart) + `,`,
		`RemoveIndexPaths:` + fmt.Sprintf("%v", this.RemoveIndexPaths) + `,`,
		`AddIndexPaths:` + fmt.Sprintf("%v", this.AddIndexPaths) + `,`,
...
func (m *Node) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TableOfContentsConsolidate", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &TableOfContentsConsolidate{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Kind = &Node_TableOfContentsConsolidate{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPhysicalpb(dAtA[iNdEx:])
...
func (m *TableOfContentsConsolidate) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TableOfContentsConsolidate: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TableOfContentsConsolidate: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RemoveIndexPaths", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RemoveIndexPaths = append(m.RemoveIndexPaths, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field AddIndexPaths", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.AddIndexPaths = append(m.AddIndexPaths, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
