...
const (
	...
	VARIADIC_OP_PARSE_LABELFMT VariadicOp = 3
	VARIADIC_OP_PARSE_LINEFMT  VariadicOp = 4
)
...
var VariadicOp_name = map[int32]string{
	...
	3: "VARIADIC_OP_PARSE_LABELFMT",
	4: "VARIADIC_OP_PARSE_LINEFMT",
}
...
var VariadicOp_value = map[string]int32{
	...
	"VARIADIC_OP_PARSE_LABELFMT": 3,
	"VARIADIC_OP_PARSE_LINEFMT":  4,
}
...
var fileDescriptor_6f4cc9c3840d3467 = []byte{
	...
	,
}
