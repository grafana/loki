...
func castFn(operation physical.UnaryOp) UnaryFunction {
...
func getConversionFunction(operation physical.UnaryOp) conversionFn {
	switch operation {
	case physical.UNARY_OP_CAST_BYTES:
		return convertBytes
	case physical.UNARY_OP_CAST_DURATION:
