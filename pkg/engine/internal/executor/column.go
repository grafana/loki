...
func NewScalar(value physical.LiteralExpression, rows int) arrow.Array {
	...
	case *physical.LiteralExpression_IntegerLiteral, *physical.LiteralExpression_DurationLiteral, *physical.LiteralExpression_BytesLiteral:
...
func NewCoalesce(columns []*columnWithType) arrow.Array {
	...
	slices.SortFunc(columns, func(a, b *columnWithType) int {
		return physical.ColumnTypePrecedence(a.ct) - physical.ColumnTypePrecedence(b.ct)
	})
