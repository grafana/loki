...
type Config struct {
	...
	// and two inlined structs claiming the same key make the YAML decoder
	// fail while building struct info, before it reads any config. Every
	// field below is reachable through -logline-store.* and
