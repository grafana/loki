...
func (t *Loki) setupModuleManager() error {
	...
	mm.RegisterModule(LoglineStore, t.initLoglineStore, modules.UserInvisibleModule)
	...
	deps := map[string][]string{
		...
		Querier:                      {Store, Ring, Server, IngesterQuerier, PatternRingClient, Overrides, Analytics, CacheGenerationLoader, QuerySchedulerRing, UIRing, LoglineStore},
		QueryFrontendTripperware:     {Server, Overrides, TenantConfigs},
		LoglineStore:                 {},
		LoglineTripperware:           {QueryFrontendTripperware, LoglineStore},
		QueryFrontend:                {QueryFrontendTripperware, LoglineTripperware, Analytics, CacheGenerationLoader, QuerySchedulerRing, UIRing},
