...
func TestDistributor_PushIngestLimits(t *testing.T) {
	tests := []struct {
		...
		expectedErr: "rpc error: code = Code(400) desc = request exceeded limits: max streams exceeded",
	}, {
		...
		expectedErr: "rpc error: code = Code(400) desc = request exceeded limits: rate limit exceeded",
	}, {
