...
type Config struct {
	...
	MaxDataObjAge       time.Duration         `yaml:"max_dataobj_age"`
...
func (cfg *Config) RegisterFlagsWithPrefix(prefix string, f *flag.FlagSet) {
	...
	f.DurationVar(&cfg.MaxDataObjAge, prefix+"max-dataobj-age", time.Hour, "The maximum amount of time to wait in seconds before flushing an object that has reached max age. Defaults to 1 hour.")
}
