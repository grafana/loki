...
func (b *Builder) AppendStream(stream streams.Stream) (int64, error) {
	...
	// This is because the streams section interface is used for Log Lines, not individual streams.
	// TODO: We lose Row count information here because it is generated by total calls to Record.
...
func (b *Builder) Flush(output *bytes.Buffer) (FlushStats, error) {
	...
	b.Reset()
	// TODO: Do we need flush stats for this object? Probably not? Oh no, we probably do.
