...
type Config struct {
	...
	UsePostingsSections bool   `yaml:"use_postings_sections" experimental:"true"`
}
...
func (c *Config) RegisterFlags(f *flag.FlagSet) {
	...
	f.BoolVar(&c.UsePostingsSections, prefix+"use-postings-sections", false, "Experimental: When enabled, reads from new-format postings sections in index objects instead of the streams sections. Defaults to false.")
}
