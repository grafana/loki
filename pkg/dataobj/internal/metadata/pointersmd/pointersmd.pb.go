...
const (
	...
	COLUMN_TYPE_UNCOMPRESSED_SIZE ColumnType = 8
	// COLUMN_TYPE_COLUMN_NAME is the name of a column this object is storing indexes about
	COLUMN_TYPE_COLUMN_NAME ColumnType = 9
	// COLUMN_TYPE_VALUES_BLOOM_FILTER is the raw bytes of a bloom filter for values stored in relevant column & section.
	COLUMN_TYPE_VALUES_BLOOM_FILTER ColumnType = 10
)
...
var ColumnType_name = map[int32]string{
	...
	3:  "COLUMN_TYPE_STREAM_ID",
	4:  "COLUMN_TYPE_STREAM_ID_REF",
	5:  "COLUMN_TYPE_MIN_TIMESTAMP",
	6:  "COLUMN_TYPE_MAX_TIMESTAMP",
	7:  "COLUMN_TYPE_ROWS",
	8:  "COLUMN_TYPE_UNCOMPRESSED_SIZE",
	9:  "COLUMN_TYPE_COLUMN_NAME",
	10: "COLUMN_TYPE_VALUES_BLOOM_FILTER",
}
...
var ColumnType_value = map[string]int32{
	...
	"COLUMN_TYPE_STREAM_ID":           3,
	"COLUMN_TYPE_STREAM_ID_REF":       4,
	"COLUMN_TYPE_MIN_TIMESTAMP":       5,
	"COLUMN_TYPE_MAX_TIMESTAMP":       6,
	"COLUMN_TYPE_ROWS":                7,
	"COLUMN_TYPE_UNCOMPRESSED_SIZE":   8,
	"COLUMN_TYPE_COLUMN_NAME":         9,
	"COLUMN_TYPE_VALUES_BLOOM_FILTER": 10,
}
...
var fileDescriptor_807d51c83b4cb61f = []byte{
	...
	,
}
