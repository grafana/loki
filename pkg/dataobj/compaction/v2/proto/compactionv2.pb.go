...
type TaskSpec struct {
	...
	SortOnly    bool        `protobuf:"varint,4,opt,name=sort_only,json=sortOnly,proto3" json:"sort_only"`
	StreamOrder StreamOrder `protobuf:"varint,5,opt,name=stream_order,json=streamOrder,proto3,enum=proto.StreamOrder" json:"stream_order"`
	ShardCount  uint32      `protobuf:"varint,6,opt,name=shard_count,json=shardCount,proto3" json:"shard_count"`
}
...
func (m *TaskSpec) GetSortOnly() bool {
	if m != nil {
		return m.SortOnly
	}
	return false
...
func (m *TaskSpec) GetStreamOrder() StreamOrder {
	if m != nil {
...
func (m *TaskSpec) GetShardCount() uint32 {
	if m != nil {
		return m.ShardCount
	}
	return 0
...
func init() {
	proto.RegisterEnum("proto.StreamOrder", StreamOrder_name, StreamOrder_value)
...
var fileDescriptor_7f32d9e22d0d4ec3 = []byte{
	...
	,
}
...
func (m *SectionRef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.UncompressedSize != 0 {
		i = encodeVarintCompactionv2(dAtA, i, uint64(m.UncompressedSize))
		i--
		dAtA[i] = 0x38
	}
	if m.MaxTimestamp != 0 {
...
func (m *TaskSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.ShardCount != 0 {
		i = encodeVarintCompactionv2(dAtA, i, uint64(m.ShardCount))
		i--
		dAtA[i] = 0x30
	}
	if m.StreamOrder != 0 {
		i = encodeVarintCompactionv2(dAtA, i, uint64(m.StreamOrder))
		i--
		dAtA[i] = 0x28
	}
	if m.SortOnly {
	...
	if len(m.SortSchema) > 0 {
		for iNdEx := len(m.SortSchema) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintCompactionv2(dAtA, i, uint64(len(m.SortSchema[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
...
func (m *SectionRef) Size() (n int) {
	...
	if m.UncompressedSize != 0 {
		n += 1 + sovCompactionv2(uint64(m.UncompressedSize))
	}
	return n
}
...
func (m *TaskSpec) Size() (n int) {
	...
	if m.StreamOrder != 0 {
		n += 1 + sovCompactionv2(uint64(m.StreamOrder))
	}
	if m.ShardCount != 0 {
		n += 1 + sovCompactionv2(uint64(m.ShardCount))
	}
	return n
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SectionIndex |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
