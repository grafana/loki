...
type Stream struct {
	StreamID int64  `protobuf:"varint,1,opt,name=StreamID,proto3" json:"stream_id"`
...
func (m *Stream) GetStreamID() int64 {
	if m != nil {
		return m.StreamID
	}
	return 0
...
var fileDescriptor_e8066c7cd7ae7d12 = []byte{
	...
	,
}
...
func (m *Stream) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.StreamID != 0 {
		i = encodeVarintCompaction(dAtA, i, uint64(m.StreamID))
		i--
		dAtA[i] = 0x8
	}
...
func (m *Stream) Size() (n int) {
	...
	_ = l
	if m.StreamID != 0 {
		n += 1 + sovCompaction(uint64(m.StreamID))
	}
	l = len(m.Index)
	if l > 0 {
