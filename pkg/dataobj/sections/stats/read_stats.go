...
type (
	// Stats provides statistics about a stats section.
	Stats struct {
...
// ReadStats returns statistics about the stats section. ReadStats returns an
// error if the stats section couldn't be inspected or if the provided ctx is
// canceled.
