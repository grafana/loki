...
func TestBuilder_LabelPostingRoundTrip(t *testing.T) {
	...
	b.ObserveLabelPosting(LabelObservation{ObjectPath: "/tenant/abc/obj1", ShardFactor: 16, SectionIndex: 0, ColumnName: "env", LabelValue: "value1", StreamID: 3, Timestamp: ts, UncompressedSize: 4096})
	b.ObserveLabelPosting(LabelObservation{ObjectPath: "/tenant/abc/obj1", ShardFactor: 16, SectionIndex: 0, ColumnName: "env", LabelValue: "value1", StreamID: 7, Timestamp: ts, UncompressedSize: 0})
	b.ObserveLabelPosting(LabelObservation{ObjectPath: "/tenant/abc/obj1", ShardFactor: 16, SectionIndex: 0, ColumnName: "env", LabelValue: "value1", StreamID: 15, Timestamp: ts, UncompressedSize: 0})
...
func TestBuilder_BloomPostingRoundTrip(t *testing.T) {
	...
	err := b.ObserveBloomPosting(BloomObservation{ObjectPath: "/tenant/abc/obj2", ShardFactor: 16, SectionIndex: 1, ColumnName: "service_name", Value: "my-service", StreamID: 0, Timestamp: ts, UncompressedSize: 8192})
	require.NoError(t, err)
	err = b.ObserveBloomPosting(BloomObservation{ObjectPath: "/tenant/abc/obj2", ShardFactor: 16, SectionIndex: 1, ColumnName: "service_name", Value: "my-service", StreamID: 2, Timestamp: ts, UncompressedSize: 0})
	require.NoError(t, err)
	err = b.ObserveBloomPosting(BloomObservation{ObjectPath: "/tenant/abc/obj2", ShardFactor: 16, SectionIndex: 1, ColumnName: "service_name", Value: "my-service", StreamID: 8, Timestamp: ts, UncompressedSize: 0})
	require.NoError(t, err)
