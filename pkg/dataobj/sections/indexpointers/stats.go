...
func ReadStats(ctx context.Context, section *Section) (Stats, error) {
	...
	for i, col := range cols {
		...
		switch {
		case col.Type == indexpointersmd.COLUMN_TYPE_MIN_TIMESTAMP && col.Info.Statistics != nil:
		...
		case col.Type == indexpointersmd.COLUMN_TYPE_MAX_TIMESTAMP && col.Info.Statistics != nil:
			var ts dataset.Value
