...
// InitLogger initialises the global gokit logger (logutil.Logger) and overrides the
// default logger for the server.
func InitLogger(cfg *server.Config, reg prometheus.Registerer) {
	l := NewPrometheusLogger(cfg.LogLevel, cfg.LogFormat, reg, "")

	// when use logutil.Logger, skip 3 stack frames.
...
func NewPrometheusLogger(l logging.Level, format fmt.Stringer, reg prometheus.Registerer, metricsNamespace string) log.Logger {
