...
type Summary struct {
	...
	// Total bytes processed. Includes metadata.
	...
	TotalMetadataBytesProcessed int64 `protobuf:"varint,12,opt,name=totalMetadataBytesProcessed,proto3" json:"totalMetadataBytesProcessed"`
}
...
func (m *Summary) GetTotalMetadataBytesProcessed() int64 {
	if m != nil {
		return m.TotalMetadataBytesProcessed
	}
	return 0
}
...
type Chunk struct {
	// Total bytes processed but was already in memory (found in the headchunk). Includes metadata.
	...
	// Total bytes decompressed and processed from chunks. Includes metadata.
	...
	HeadChunkMetadataBytes int64 `protobuf:"varint,11,opt,name=headChunkMetadataBytes,proto3" json:"headChunkMetadataBytes"`
	// Total bytes of entries metadata decompressed and processed from chunks.
	DecompressedMetadataBytes int64 `protobuf:"varint,12,opt,name=decompressedMetadataBytes,proto3" json:"decompressedMetadataBytes"`
}
...
func (m *Chunk) GetHeadChunkMetadataBytes() int64 {
	if m != nil {
		return m.HeadChunkMetadataBytes
	}
	return 0
}

func (m *Chunk) GetDecompressedMetadataBytes() int64 {
	if m != nil {
		return m.DecompressedMetadataBytes
	}
	return 0
}
...
var fileDescriptor_6cdfe5d2aea33ebb = []byte{
	...
	,
}
...
func (this *Summary) Equal(that interface{}) bool {
	...
	if this.TotalMetadataBytesProcessed != that1.TotalMetadataBytesProcessed {
		return false
	}
	return true
}
...
func (this *Chunk) Equal(that interface{}) bool {
	...
	if this.HeadChunkMetadataBytes != that1.HeadChunkMetadataBytes {
		return false
	}
	if this.DecompressedMetadataBytes != that1.DecompressedMetadataBytes {
		return false
	}
	return true
}
...
func (this *Summary) GoString() string {
	...
	s = append(s, "TotalMetadataBytesProcessed: "+fmt.Sprintf("%#v", this.TotalMetadataBytesProcessed)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *Chunk) GoString() string {
	...
	s = append(s, "HeadChunkMetadataBytes: "+fmt.Sprintf("%#v", this.HeadChunkMetadataBytes)+",\n")
	s = append(s, "DecompressedMetadataBytes: "+fmt.Sprintf("%#v", this.DecompressedMetadataBytes)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Summary) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.TotalMetadataBytesProcessed != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.TotalMetadataBytesProcessed))
		i--
		dAtA[i] = 0x60
	}
...
func (m *Chunk) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.DecompressedMetadataBytes != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.DecompressedMetadataBytes))
		i--
		dAtA[i] = 0x60
	}
	if m.HeadChunkMetadataBytes != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.HeadChunkMetadataBytes))
		i--
		dAtA[i] = 0x58
	}
...
func (m *Summary) Size() (n int) {
	...
	if m.TotalMetadataBytesProcessed != 0 {
		n += 1 + sovStats(uint64(m.TotalMetadataBytesProcessed))
	}
	return n
}
...
func (m *Chunk) Size() (n int) {
	...
	if m.HeadChunkMetadataBytes != 0 {
		n += 1 + sovStats(uint64(m.HeadChunkMetadataBytes))
	}
	if m.DecompressedMetadataBytes != 0 {
		n += 1 + sovStats(uint64(m.DecompressedMetadataBytes))
	}
	return n
}
...
func (this *Summary) String() string {
	...
	s := strings.Join([]string{`&Summary{`,
		...
		`TotalMetadataBytesProcessed:` + fmt.Sprintf("%v", this.TotalMetadataBytesProcessed) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *Chunk) String() string {
	...
	s := strings.Join([]string{`&Chunk{`,
		...
		`HeadChunkMetadataBytes:` + fmt.Sprintf("%v", this.HeadChunkMetadataBytes) + `,`,
		`DecompressedMetadataBytes:` + fmt.Sprintf("%v", this.DecompressedMetadataBytes) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Summary) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalMetadataBytesProcessed", wireType)
			}
			m.TotalMetadataBytesProcessed = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalMetadataBytesProcessed |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Chunk) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HeadChunkMetadataBytes", wireType)
			}
			m.HeadChunkMetadataBytes = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.HeadChunkMetadataBytes |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DecompressedMetadataBytes", wireType)
			}
			m.DecompressedMetadataBytes = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DecompressedMetadataBytes |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
