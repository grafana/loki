...
type Result struct {
	...
	// shardedStreams is temporary instrumentation to estimate how much longer a
	// query would take if stream sharding were disabled. Each entry is a logical
	// stream (labels with __stream_shard__ removed). Populated per subquery on the
	// querier and merged at the frontend.
	ShardedStreams []ShardedStream `protobuf:"bytes,6,rep,name=shardedStreams,proto3" json:"shardedStreams"`
}
...
func (m *Result) GetShardedStreams() []ShardedStream {
	if m != nil {
		return m.ShardedStreams
	}
	return nil
}

// ShardedStream carries per-logical-stream shard timings for the stream-sharding
// query-cost analysis. On a single subquery sumDurationNanos == maxDurationNanos.
// After merging across a parent query's subqueries: sumDurationNanos is T_s (the
// unsharded read time), maxDurationNanos is M_s (the worst single-subquery share,
// already on the critical path), and shards is the total shard count.
type ShardedStream struct {
	Stream           string `protobuf:"bytes,1,opt,name=stream,proto3" json:"stream"`
	SumDurationNanos int64  `protobuf:"varint,2,opt,name=sumDurationNanos,proto3" json:"sumDurationNanos"`
	MaxDurationNanos int64  `protobuf:"varint,3,opt,name=maxDurationNanos,proto3" json:"maxDurationNanos"`
	Shards           int64  `protobuf:"varint,4,opt,name=shards,proto3" json:"shards"`
}

func (m *ShardedStream) Reset()      { *m = ShardedStream{} }
func (*ShardedStream) ProtoMessage() {}
func (*ShardedStream) Descriptor() ([]byte, []int) {
	return fileDescriptor_6cdfe5d2aea33ebb, []int{1}
}
func (m *ShardedStream) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ShardedStream) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ShardedStream.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ShardedStream) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ShardedStream.Merge(m, src)
}
func (m *ShardedStream) XXX_Size() int {
	return m.Size()
}
func (m *ShardedStream) XXX_DiscardUnknown() {
	xxx_messageInfo_ShardedStream.DiscardUnknown(m)
}

var xxx_messageInfo_ShardedStream proto.InternalMessageInfo

func (m *ShardedStream) GetStream() string {
	if m != nil {
		return m.Stream
	}
	return ""
...
func (m *ShardedStream) GetSumDurationNanos() int64 {
	if m != nil {
		return m.SumDurationNanos
	}
	return 0
}

func (m *ShardedStream) GetMaxDurationNanos() int64 {
	if m != nil {
		return m.MaxDurationNanos
	}
	return 0
}

func (m *ShardedStream) GetShards() int64 {
	if m != nil {
		return m.Shards
	}
	return 0
...
func (*Cache) Descriptor() ([]byte, []int) {
	return fileDescriptor_6cdfe5d2aea33ebb, []int{10}
}
...
func init() {
	...
	proto.RegisterType((*ShardedStream)(nil), "stats.ShardedStream")
...
var fileDescriptor_6cdfe5d2aea33ebb = []byte{
	...
	,
}
...
func (this *Result) Equal(that interface{}) bool {
	...
	if len(this.ShardedStreams) != len(that1.ShardedStreams) {
		return false
	}
	for i := range this.ShardedStreams {
		if !this.ShardedStreams[i].Equal(&that1.ShardedStreams[i]) {
			return false
		}
	}
	return true
}
func (this *ShardedStream) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*ShardedStream)
	if !ok {
		that2, ok := that.(ShardedStream)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.SumDurationNanos != that1.SumDurationNanos {
		return false
	}
	if this.MaxDurationNanos != that1.MaxDurationNanos {
		return false
	}
...
func (this *Result) GoString() string {
	...
	if this.ShardedStreams != nil {
		vs := make([]*ShardedStream, len(this.ShardedStreams))
		for i := range vs {
			vs[i] = &this.ShardedStreams[i]
		}
		s = append(s, "ShardedStreams: "+fmt.Sprintf("%#v", vs)+",\n")
	}
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *ShardedStream) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 8)
	s = append(s, "&stats.ShardedStream{")
	s = append(s, "Stream: "+fmt.Sprintf("%#v", this.Stream)+",\n")
	s = append(s, "SumDurationNanos: "+fmt.Sprintf("%#v", this.SumDurationNanos)+",\n")
	s = append(s, "MaxDurationNanos: "+fmt.Sprintf("%#v", this.MaxDurationNanos)+",\n")
...
func (m *Result) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.ShardedStreams) > 0 {
		for iNdEx := len(m.ShardedStreams) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ShardedStreams[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *ShardedStream) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ShardedStream) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ShardedStream) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.MaxDurationNanos != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.MaxDurationNanos))
		i--
		dAtA[i] = 0x18
	}
	if m.SumDurationNanos != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.SumDurationNanos))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Stream) > 0 {
		...
		i = encodeVarintStats(dAtA, i, uint64(len(m.Stream)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Result) Size() (n int) {
	...
	n += 1 + l + sovStats(uint64(l))
	if len(m.ShardedStreams) > 0 {
		for _, e := range m.ShardedStreams {
			l = e.Size()
			n += 1 + l + sovStats(uint64(l))
		}
	}
...
func (m *ShardedStream) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.SumDurationNanos != 0 {
		n += 1 + sovStats(uint64(m.SumDurationNanos))
	}
	if m.MaxDurationNanos != 0 {
		n += 1 + sovStats(uint64(m.MaxDurationNanos))
	}
	if m.Shards != 0 {
...
func (this *Result) String() string {
	...
	repeatedStringForShardedStreams := "[]ShardedStream{"
	for _, f := range this.ShardedStreams {
		repeatedStringForShardedStreams += strings.Replace(strings.Replace(f.String(), "ShardedStream", "ShardedStream", 1), `&`, ``, 1) + ","
	}
	repeatedStringForShardedStreams += "}"
	s := strings.Join([]string{`&Result{`,
		...
		`ShardedStreams:` + repeatedStringForShardedStreams + `,`,
		`}`,
	}, "")
	return s
}
func (this *ShardedStream) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ShardedStream{`,
		`Stream:` + fmt.Sprintf("%v", this.Stream) + `,`,
		`SumDurationNanos:` + fmt.Sprintf("%v", this.SumDurationNanos) + `,`,
		`MaxDurationNanos:` + fmt.Sprintf("%v", this.MaxDurationNanos) + `,`,
...
func (m *Result) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ShardedStreams", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ShardedStreams = append(m.ShardedStreams, ShardedStream{})
			if err := m.ShardedStreams[len(m.ShardedStreams)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *ShardedStream) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ShardedStream: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ShardedStream: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SumDurationNanos", wireType)
			}
			m.SumDurationNanos = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SumDurationNanos |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxDurationNanos", wireType)
			}
			m.MaxDurationNanos = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxDurationNanos |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
