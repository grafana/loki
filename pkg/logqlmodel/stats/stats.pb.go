...
type Dataobj struct {
	...
	SectionsScanned    int64 `protobuf:"varint,13,opt,name=sectionsScanned,proto3" json:"sectionsScanned"`
	PagesSkipped       int64 `protobuf:"varint,14,opt,name=pagesSkipped,proto3" json:"pagesSkipped"`
}
...
func (m *Dataobj) GetSectionsScanned() int64 {
	if m != nil {
		return m.SectionsScanned
	}
	return 0
}

func (m *Dataobj) GetPagesSkipped() int64 {
	if m != nil {
		return m.PagesSkipped
	}
	return 0
}
...
var fileDescriptor_6cdfe5d2aea33ebb = []byte{
	...
	,
}
...
func (this *Dataobj) Equal(that interface{}) bool {
	...
	if this.SectionsScanned != that1.SectionsScanned {
		return false
	}
	if this.PagesSkipped != that1.PagesSkipped {
		return false
	}
	return true
}
...
func (this *Dataobj) GoString() string {
	...
	s = append(s, "SectionsScanned: "+fmt.Sprintf("%#v", this.SectionsScanned)+",\n")
	s = append(s, "PagesSkipped: "+fmt.Sprintf("%#v", this.PagesSkipped)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Dataobj) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.PagesSkipped != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.PagesSkipped))
		i--
		dAtA[i] = 0x70
	}
	if m.SectionsScanned != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.SectionsScanned))
		i--
		dAtA[i] = 0x68
	}
...
func (m *Dataobj) Size() (n int) {
	...
	if m.SectionsScanned != 0 {
		n += 1 + sovStats(uint64(m.SectionsScanned))
	}
	if m.PagesSkipped != 0 {
		n += 1 + sovStats(uint64(m.PagesSkipped))
	}
	return n
}
...
func (this *Dataobj) String() string {
	...
	s := strings.Join([]string{`&Dataobj{`,
		...
		`SectionsScanned:` + fmt.Sprintf("%v", this.SectionsScanned) + `,`,
		`PagesSkipped:` + fmt.Sprintf("%v", this.PagesSkipped) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Dataobj) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SectionsScanned", wireType)
			}
			m.SectionsScanned = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SectionsScanned |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PagesSkipped", wireType)
			}
			m.PagesSkipped = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PagesSkipped |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
