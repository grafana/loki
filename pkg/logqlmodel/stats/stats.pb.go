...
type Summary struct {
	...
	// Number of range-aggregation sub-evaluations executed in stream-first (per-stream) sample order.
	StreamFirstSubqueries int64 `protobuf:"varint,14,opt,name=streamFirstSubqueries,proto3" json:"streamFirstSubqueries,omitempty"`
	// Number of range-aggregation sub-evaluations executed in timestamp-first sample order.
	TimestampFirstSubqueries int64 `protobuf:"varint,15,opt,name=timestampFirstSubqueries,proto3" json:"timestampFirstSubqueries,omitempty"`
}
...
func (m *Summary) GetStreamFirstSubqueries() int64 {
	if m != nil {
		return m.StreamFirstSubqueries
	}
	return 0
}

func (m *Summary) GetTimestampFirstSubqueries() int64 {
	if m != nil {
		return m.TimestampFirstSubqueries
	}
	return 0
}
...
type Store struct {
	...
	// Total number of chunks that failed to be fetched or decoded for the query,
	// counted even when propagateChunkFetchErrors tolerated the failure instead
	// of failing the query outright.
	ChunkFetchFailures int64 `protobuf:"varint,15,opt,name=chunkFetchFailures,proto3" json:"chunkFetchFailures"`
}
...
func (m *Store) GetChunkFetchFailures() int64 {
	if m != nil {
		return m.ChunkFetchFailures
	}
	return 0
}
...
type Dataobj struct {
	...
	// Longest time spent resolving data-object sections for a single subquery, in nanoseconds. Results
	// merge it as a max across subqueries, not a sum.
	SectionsResolutionMaxTime int64 `protobuf:"varint,15,opt,name=sectionsResolutionMaxTime,proto3" json:"sectionsResolutionMaxTime"`
}
...
func (m *Dataobj) GetSectionsResolutionMaxTime() int64 {
	if m != nil {
		return m.SectionsResolutionMaxTime
	}
	return 0
}
...
var fileDescriptor_6cdfe5d2aea33ebb = []byte{
	...
	,
}
...
func (this *Summary) Equal(that interface{}) bool {
	...
	if this.StreamFirstSubqueries != that1.StreamFirstSubqueries {
		return false
	}
	if this.TimestampFirstSubqueries != that1.TimestampFirstSubqueries {
		return false
	}
	return true
}
...
func (this *Store) Equal(that interface{}) bool {
	...
	if this.ChunkFetchFailures != that1.ChunkFetchFailures {
		return false
	}
	return true
}
func (this *Dataobj) Equal(that interface{}) bool {
	...
	if this.SectionsResolutionMaxTime != that1.SectionsResolutionMaxTime {
		return false
	}
	return true
}
...
func (this *Summary) GoString() string {
	...
	s = append(s, "StreamFirstSubqueries: "+fmt.Sprintf("%#v", this.StreamFirstSubqueries)+",\n")
	s = append(s, "TimestampFirstSubqueries: "+fmt.Sprintf("%#v", this.TimestampFirstSubqueries)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (this *Store) GoString() string {
	...
	s = append(s, "ChunkFetchFailures: "+fmt.Sprintf("%#v", this.ChunkFetchFailures)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *Dataobj) GoString() string {
	...
	s = append(s, "SectionsResolutionMaxTime: "+fmt.Sprintf("%#v", this.SectionsResolutionMaxTime)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Summary) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.TimestampFirstSubqueries != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.TimestampFirstSubqueries))
		i--
		dAtA[i] = 0x78
	}
	if m.StreamFirstSubqueries != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.StreamFirstSubqueries))
		i--
		dAtA[i] = 0x70
	}
...
func (m *Store) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ChunkFetchFailures != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.ChunkFetchFailures))
		i--
		dAtA[i] = 0x78
	}
...
func (m *Dataobj) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.SectionsResolutionMaxTime != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.SectionsResolutionMaxTime))
		i--
		dAtA[i] = 0x78
	}
...
func (m *Summary) Size() (n int) {
	...
	if m.StreamFirstSubqueries != 0 {
		n += 1 + sovStats(uint64(m.StreamFirstSubqueries))
	}
	if m.TimestampFirstSubqueries != 0 {
		n += 1 + sovStats(uint64(m.TimestampFirstSubqueries))
	}
	return n
}
...
func (m *Store) Size() (n int) {
	...
	if m.ChunkFetchFailures != 0 {
		n += 1 + sovStats(uint64(m.ChunkFetchFailures))
	}
	return n
}
...
func (m *Dataobj) Size() (n int) {
	...
	if m.SectionsResolutionMaxTime != 0 {
		n += 1 + sovStats(uint64(m.SectionsResolutionMaxTime))
	}
	return n
}
...
func (this *Summary) String() string {
	...
	s := strings.Join([]string{`&Summary{`,
		...
		`StreamFirstSubqueries:` + fmt.Sprintf("%v", this.StreamFirstSubqueries) + `,`,
		`TimestampFirstSubqueries:` + fmt.Sprintf("%v", this.TimestampFirstSubqueries) + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *Store) String() string {
	...
	s := strings.Join([]string{`&Store{`,
		...
		`ChunkFetchFailures:` + fmt.Sprintf("%v", this.ChunkFetchFailures) + `,`,
		`}`,
	}, "")
	return s
}
func (this *Dataobj) String() string {
	...
	s := strings.Join([]string{`&Dataobj{`,
		...
		`SectionsResolutionMaxTime:` + fmt.Sprintf("%v", this.SectionsResolutionMaxTime) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Summary) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StreamFirstSubqueries", wireType)
			}
			m.StreamFirstSubqueries = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.StreamFirstSubqueries |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 15:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TimestampFirstSubqueries", wireType)
			}
			m.TimestampFirstSubqueries = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TimestampFirstSubqueries |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Store) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ChunkFetchFailures", wireType)
			}
			m.ChunkFetchFailures = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ChunkFetchFailures |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Dataobj) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 15:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SectionsResolutionMaxTime", wireType)
			}
			m.SectionsResolutionMaxTime = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SectionsResolutionMaxTime |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
