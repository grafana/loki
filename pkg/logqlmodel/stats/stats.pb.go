...
type Chunk struct {
	...
	// Total bytes found in duplicates while processing.
	DuplicateBytes int64 `protobuf:"varint,10,opt,name=duplicateBytes,proto3" json:"duplicateBytes"`
}
...
func (m *Chunk) GetDuplicateBytes() int64 {
	if m != nil {
		return m.DuplicateBytes
	}
	return 0
}
...
var fileDescriptor_6cdfe5d2aea33ebb = []byte{
	...
	,
}
...
func (this *Chunk) Equal(that interface{}) bool {
	...
	if this.DuplicateBytes != that1.DuplicateBytes {
		return false
	}
	return true
}
...
func (this *Chunk) GoString() string {
	...
	s = append(s, "DuplicateBytes: "+fmt.Sprintf("%#v", this.DuplicateBytes)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
...
func (m *Chunk) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.DuplicateBytes != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.DuplicateBytes))
		i--
		dAtA[i] = 0x50
	}
...
func (m *Chunk) Size() (n int) {
	...
	if m.DuplicateBytes != 0 {
		n += 1 + sovStats(uint64(m.DuplicateBytes))
	}
	return n
}
...
func (this *Chunk) String() string {
	...
	s := strings.Join([]string{`&Chunk{`,
		...
		`DuplicateBytes:` + fmt.Sprintf("%v", this.DuplicateBytes) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *Chunk) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DuplicateBytes", wireType)
			}
			m.DuplicateBytes = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DuplicateBytes |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
