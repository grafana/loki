...
type Cache struct {
	...
	BytesTransferred int64 `protobuf:"varint,4,opt,name=bytesTransferred,proto3" json:"bytesTransferred"`
	Requests         int32 `protobuf:"varint,5,opt,name=requests,proto3" json:"requests"`
}
...
func (m *Cache) GetBytesTransferred() int64 {
	if m != nil {
...
var fileDescriptor_6cdfe5d2aea33ebb = []byte{
	...
	,
}
...
func (this *Cache) Equal(that interface{}) bool {
	...
	if this.BytesTransferred != that1.BytesTransferred {
		return false
	}
...
func (m *Cache) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.BytesTransferred != 0 {
		i = encodeVarintStats(dAtA, i, uint64(m.BytesTransferred))
		i--
		dAtA[i] = 0x20
	}
...
func (m *Cache) Size() (n int) {
	...
	if m.BytesTransferred != 0 {
		n += 1 + sovStats(uint64(m.BytesTransferred))
	}
	if m.Requests != 0 {
...
func (this *Cache) String() string {
	...
	s := strings.Join([]string{`&Cache{`,
		...
		`BytesTransferred:` + fmt.Sprintf("%v", this.BytesTransferred) + `,`,
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BytesTransferred |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
