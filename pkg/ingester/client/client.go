...
func (cfg *Config) RegisterFlags(f *flag.FlagSet) {
	...
	f.DurationVar(&cfg.PoolConfig.HealthCheckGracePeriod, "ingester.client.healthcheck-grace-period", 2*time.Minute, "Grace period to wait before removing an unhealthy client from the pool.")
