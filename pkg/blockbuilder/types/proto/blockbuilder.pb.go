...
type CompleteJobRequest struct {
	...
	LastConsumedOffset int64  `protobuf:"varint,3,opt,name=LastConsumedOffset,proto3" json:"LastConsumedOffset,omitempty"`
}
...
func (m *CompleteJobRequest) GetLastConsumedOffset() int64 {
	if m != nil {
...
var fileDescriptor_04968622516f7b79 = []byte{
	...
	,
}
...
func (this *CompleteJobRequest) Equal(that interface{}) bool {
	...
	if this.LastConsumedOffset != that1.LastConsumedOffset {
		return false
	}
	return true
}
...
type BlockBuilderServiceClient interface {
	...
	GetJob(ctx context.Context, in *GetJobRequest, opts ...grpc.CallOption) (BlockBuilderService_GetJobClient, error)
...
func (c *blockBuilderServiceClient) GetJob(ctx context.Context, in *GetJobRequest, opts ...grpc.CallOption) (BlockBuilderService_GetJobClient, error) {
	stream, err := c.cc.NewStream(ctx, &_BlockBuilderService_serviceDesc.Streams[0], "/blockbuilder.types.BlockBuilderService/GetJob", opts...)
	if err != nil {
		return nil, err
	}
	x := &blockBuilderServiceGetJobClient{stream}
...
type BlockBuilderService_GetJobClient interface {
	Recv() (*GetJobResponse, error)
	grpc.ClientStream
}

type blockBuilderServiceGetJobClient struct {
	grpc.ClientStream
}

func (x *blockBuilderServiceGetJobClient) Recv() (*GetJobResponse, error) {
	m := new(GetJobResponse)
...
type BlockBuilderServiceServer interface {
	// GetJob requests a new job from the scheduler
	GetJob(*GetJobRequest, BlockBuilderService_GetJobServer) error
	// CompleteJob notifies the scheduler that a job has been completed
...
func (*UnimplementedBlockBuilderServiceServer) GetJob(req *GetJobRequest, srv BlockBuilderService_GetJobServer) error {
	return status.Errorf(codes.Unimplemented, "method GetJob not implemented")
}
...
func _BlockBuilderService_GetJob_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetJobRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(BlockBuilderServiceServer).GetJob(m, &blockBuilderServiceGetJobServer{stream})
}

type BlockBuilderService_GetJobServer interface {
	Send(*GetJobResponse) error
	grpc.ServerStream
}

type blockBuilderServiceGetJobServer struct {
	grpc.ServerStream
}

func (x *blockBuilderServiceGetJobServer) Send(m *GetJobResponse) error {
...
func (m *CompleteJobRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.LastConsumedOffset != 0 {
		i = encodeVarintBlockbuilder(dAtA, i, uint64(m.LastConsumedOffset))
		i--
		dAtA[i] = 0x18
	}
	if m.Job != nil {
...
func (m *CompleteJobRequest) Size() (n int) {
	...
	if m.LastConsumedOffset != 0 {
		n += 1 + sovBlockbuilder(uint64(m.LastConsumedOffset))
	}
	return n
}
...
func (this *CompleteJobRequest) String() string {
	...
	s := strings.Join([]string{`&CompleteJobRequest{`,
		`BuilderId:` + fmt.Sprintf("%v", this.BuilderId) + `,`,
		`Job:` + strings.Replace(this.Job.String(), "Job", "Job", 1) + `,`,
		`LastConsumedOffset:` + fmt.Sprintf("%v", this.LastConsumedOffset) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *CompleteJobRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LastConsumedOffset", wireType)
			}
			m.LastConsumedOffset = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowBlockbuilder
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LastConsumedOffset |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
