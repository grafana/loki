...
type TopK struct {
	...
	Results     []*TopK_Result  `protobuf:"bytes,2,rep,name=results,proto3" json:"results,omitempty"`
...
func (m *TopK) GetResults() []*TopK_Result {
	if m != nil {
		return m.Results
	}
	return nil
...
type TopK_Result struct {
	Key  string       `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	List []*TopK_Pair `protobuf:"bytes,2,rep,name=list,proto3" json:"list,omitempty"`
}

func (m *TopK_Result) Reset()      { *m = TopK_Result{} }
func (*TopK_Result) ProtoMessage() {}
func (*TopK_Result) Descriptor() ([]byte, []int) {
	return fileDescriptor_7f9fd40e59b87ff3, []int{1, 1}
}
func (m *TopK_Result) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TopK_Result) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TopK_Result.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TopK_Result) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TopK_Result.Merge(m, src)
}
func (m *TopK_Result) XXX_Size() int {
	return m.Size()
}
func (m *TopK_Result) XXX_DiscardUnknown() {
	xxx_messageInfo_TopK_Result.DiscardUnknown(m)
}

var xxx_messageInfo_TopK_Result proto.InternalMessageInfo

func (m *TopK_Result) GetKey() string {
	if m != nil {
		return m.Key
	}
	return ""
...
func (m *TopK_Result) GetList() []*TopK_Pair {
	if m != nil {
		return m.List
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*TopK_Result)(nil), "logproto.TopK.Result")
...
var fileDescriptor_7f9fd40e59b87ff3 = []byte{
	...
	,
}
...
func (this *TopK_Result) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*TopK_Result)
	if !ok {
		that2, ok := that.(TopK_Result)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *TopK_Result) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&logproto.TopK_Result{")
...
func (m *CountMinSketch) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Counters) > 0 {
		for iNdEx := len(m.Counters) - 1; iNdEx >= 0; iNdEx-- {
			f1 := math.Float64bits(float64(m.Counters[iNdEx]))
			i -= 8
...
func (m *TopK_Result) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TopK_Result) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TopK_Result) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Key) > 0 {
		i -= len(m.Key)
		copy(dAtA[i:], m.Key)
		i = encodeVarintSketch(dAtA, i, uint64(len(m.Key)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (this *TopK) String() string {
	...
	repeatedStringForResults := "[]*TopK_Result{"
	for _, f := range this.Results {
		repeatedStringForResults += strings.Replace(fmt.Sprintf("%v", f), "TopK_Result", "TopK_Result", 1) + ","
	}
...
func (this *TopK_Result) String() string {
	if this == nil {
		return "nil"
	}
	...
	s := strings.Join([]string{`&TopK_Result{`,
...
func (m *TopK) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Results = append(m.Results, &TopK_Result{})
...
func (m *TopK_Result) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
