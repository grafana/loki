...
type VariantsQueryRequest struct {
	Selector  string                                                 `protobuf:"bytes,1,opt,name=selector,proto3" json:"selector,omitempty"`
	...
	Direction Direction                                              `protobuf:"varint,6,opt,name=direction,proto3,enum=logproto.Direction" json:"direction,omitempty"`
	Shards    []string                                               `protobuf:"bytes,7,rep,name=shards,proto3" json:"shards,omitempty"`
	Deletes   []*Delete                                              `protobuf:"bytes,8,rep,name=deletes,proto3" json:"deletes,omitempty"`
	Plan      *github_com_grafana_loki_v3_pkg_querier_plan.QueryPlan `protobuf:"bytes,9,opt,name=plan,proto3,customtype=github.com/grafana/loki/v3/pkg/querier/plan.QueryPlan" json:"plan,omitempty"`
	// If populated, these represent the chunk references that the querier should
...
func (m *VariantsQueryRequest) Reset()      { *m = VariantsQueryRequest{} }
func (*VariantsQueryRequest) ProtoMessage() {}
func (*VariantsQueryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_c28a5f14f1f4c79a, []int{54}
}
func (m *VariantsQueryRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VariantsQueryRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VariantsQueryRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VariantsQueryRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VariantsQueryRequest.Merge(m, src)
}
func (m *VariantsQueryRequest) XXX_Size() int {
	return m.Size()
}
func (m *VariantsQueryRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_VariantsQueryRequest.DiscardUnknown(m)
}

var xxx_messageInfo_VariantsQueryRequest proto.InternalMessageInfo

func (m *VariantsQueryRequest) GetSelector() string {
	if m != nil {
		return m.Selector
	}
	return ""
...
func (m *VariantsQueryRequest) GetVariants() []string {
	if m != nil {
		return m.Variants
	}
	return nil
...
func (m *VariantsQueryRequest) GetLimit() uint32 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func (m *VariantsQueryRequest) GetStart() time.Time {
	if m != nil {
		return m.Start
	}
	return time.Time{}
...
func (m *VariantsQueryRequest) GetEnd() time.Time {
	if m != nil {
		return m.End
	}
	return time.Time{}
...
func (m *VariantsQueryRequest) GetDirection() Direction {
	if m != nil {
		return m.Direction
	}
	return FORWARD
...
func (m *VariantsQueryRequest) GetShards() []string {
	if m != nil {
		return m.Shards
	}
	return nil
...
func (m *VariantsQueryRequest) GetDeletes() []*Delete {
	if m != nil {
		return m.Deletes
	}
	return nil
...
func (m *VariantsQueryRequest) GetStoreChunks() *ChunkRefGroup {
	if m != nil {
		return m.StoreChunks
	}
	return nil
...
type VariantsQueryResponse struct {
	Variants []*Variants    `protobuf:"bytes,1,rep,name=variants,proto3" json:"variants,omitempty"`
	Stats    stats.Ingester `protobuf:"bytes,3,opt,name=stats,proto3" json:"stats"`
	Warnings []string       `protobuf:"bytes,4,rep,name=warnings,proto3" json:"warnings,omitempty"`
}

func (m *VariantsQueryResponse) Reset()      { *m = VariantsQueryResponse{} }
func (*VariantsQueryResponse) ProtoMessage() {}
func (*VariantsQueryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_c28a5f14f1f4c79a, []int{55}
}
func (m *VariantsQueryResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VariantsQueryResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_VariantsQueryResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *VariantsQueryResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VariantsQueryResponse.Merge(m, src)
}
func (m *VariantsQueryResponse) XXX_Size() int {
	return m.Size()
}
func (m *VariantsQueryResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_VariantsQueryResponse.DiscardUnknown(m)
}

var xxx_messageInfo_VariantsQueryResponse proto.InternalMessageInfo

func (m *VariantsQueryResponse) GetVariants() []*Variants {
	if m != nil {
		return m.Variants
	}
	return nil
...
func (m *VariantsQueryResponse) GetStats() stats.Ingester {
	if m != nil {
		return m.Stats
	}
	return stats.Ingester{}
...
func (m *VariantsQueryResponse) GetWarnings() []string {
	if m != nil {
		return m.Warnings
	}
	return nil
...
type Variants struct {
	Streams []github_com_grafana_loki_pkg_push.Stream `protobuf:"bytes,1,rep,name=streams,proto3,customtype=github.com/grafana/loki/pkg/push.Stream" json:"streams,omitempty"`
	Series  []Series                                  `protobuf:"bytes,2,rep,name=series,proto3,customtype=Series" json:"series,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*VariantsQueryRequest)(nil), "logproto.VariantsQueryRequest")
	proto.RegisterType((*VariantsQueryResponse)(nil), "logproto.VariantsQueryResponse")
	proto.RegisterType((*Variants)(nil), "logproto.Variants")
}
...
var fileDescriptor_c28a5f14f1f4c79a = []byte{
	...
	,
}
...
func (this *VariantsQueryRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*VariantsQueryRequest)
	if !ok {
		that2, ok := that.(VariantsQueryRequest)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	for i := range this.Variants {
		if this.Variants[i] != that1.Variants[i] {
			return false
		}
	}
	if this.Limit != that1.Limit {
...
func (this *VariantsQueryResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*VariantsQueryResponse)
	if !ok {
		that2, ok := that.(VariantsQueryResponse)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *Variants) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*Variants)
	if !ok {
		that2, ok := that.(Variants)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *VariantsQueryRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 14)
	s = append(s, "&logproto.VariantsQueryRequest{")
	s = append(s, "Selector: "+fmt.Sprintf("%#v", this.Selector)+",\n")
...
func (this *VariantsQueryResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&logproto.VariantsQueryResponse{")
	if this.Variants != nil {
		s = append(s, "Variants: "+fmt.Sprintf("%#v", this.Variants)+",\n")
	}
	s = append(s, "Stats: "+strings.Replace(this.Stats.GoString(), `&`, ``, 1)+",\n")
	s = append(s, "Warnings: "+fmt.Sprintf("%#v", this.Warnings)+",\n")
...
func (this *Variants) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 6)
	s = append(s, "&logproto.Variants{")
	s = append(s, "Streams: "+fmt.Sprintf("%#v", this.Streams)+",\n")
	s = append(s, "Series: "+fmt.Sprintf("%#v", this.Series)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
...
type QuerierClient interface {
	...
	QueryVariants(ctx context.Context, in *VariantsQueryRequest, opts ...grpc.CallOption) (Querier_QueryVariantsClient, error)
}
...
func (c *querierClient) QueryVariants(ctx context.Context, in *VariantsQueryRequest, opts ...grpc.CallOption) (Querier_QueryVariantsClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Querier_serviceDesc.Streams[3], "/logproto.Querier/QueryVariants", opts...)
	if err != nil {
		return nil, err
	}
	x := &querierQueryVariantsClient{stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
type Querier_QueryVariantsClient interface {
	Recv() (*VariantsQueryResponse, error)
	grpc.ClientStream
}

type querierQueryVariantsClient struct {
	grpc.ClientStream
}

func (x *querierQueryVariantsClient) Recv() (*VariantsQueryResponse, error) {
	m := new(VariantsQueryResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type QuerierServer interface {
	...
	QueryVariants(*VariantsQueryRequest, Querier_QueryVariantsServer) error
}
...
func (*UnimplementedQuerierServer) QueryVariants(req *VariantsQueryRequest, srv Querier_QueryVariantsServer) error {
	return status.Errorf(codes.Unimplemented, "method QueryVariants not implemented")
}
...
func _Querier_QueryVariants_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(VariantsQueryRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(QuerierServer).QueryVariants(m, &querierQueryVariantsServer{stream})
}

type Querier_QueryVariantsServer interface {
	Send(*VariantsQueryResponse) error
	grpc.ServerStream
}

type querierQueryVariantsServer struct {
	grpc.ServerStream
}

func (x *querierQueryVariantsServer) Send(m *VariantsQueryResponse) error {
	return x.ServerStream.SendMsg(m)
}
...
var _Querier_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "QueryVariants",
			Handler:       _Querier_QueryVariants_Handler,
			ServerStreams: true,
		},
	},
...
func (m *VariantsQueryRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VariantsQueryRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VariantsQueryRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Variants) > 0 {
		for iNdEx := len(m.Variants) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.Variants[iNdEx])
			copy(dAtA[i:], m.Variants[iNdEx])
			i = encodeVarintLogproto(dAtA, i, uint64(len(m.Variants[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *VariantsQueryResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *VariantsQueryResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *VariantsQueryResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Variants) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Variants) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Variants) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *VariantsQueryRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *VariantsQueryResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *VariantsQueryRequest) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForDeletes := "[]*Delete{"
	...
	repeatedStringForDeletes += "}"
	s := strings.Join([]string{`&VariantsQueryRequest{`,
		`Selector:` + fmt.Sprintf("%v", this.Selector) + `,`,
...
func (this *VariantsQueryResponse) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForVariants := "[]*Variants{"
	for _, f := range this.Variants {
		repeatedStringForVariants += strings.Replace(f.String(), "Variants", "Variants", 1) + ","
	}
	repeatedStringForVariants += "}"
	s := strings.Join([]string{`&VariantsQueryResponse{`,
		`Variants:` + repeatedStringForVariants + `,`,
		`Stats:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.Stats), "Ingester", "stats.Ingester", 1), `&`, ``, 1) + `,`,
		`Warnings:` + fmt.Sprintf("%v", this.Warnings) + `,`,
		`}`,
	}, "")
...
func (this *Variants) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&Variants{`,
		`Streams:` + fmt.Sprintf("%v", this.Streams) + `,`,
		`Series:` + fmt.Sprintf("%v", this.Series) + `,`,
		`}`,
	}, "")
...
func (m *VariantsQueryRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VariantsQueryRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VariantsQueryRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Variants = append(m.Variants, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Limit", wireType)
...
func (m *VariantsQueryResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VariantsQueryResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VariantsQueryResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *Variants) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: Variants: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: Variants: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
