...
type QueryPlanRequest struct {
	...
	End       time.Time `protobuf:"bytes,4,opt,name=end,proto3,stdtime" json:"end"`
	Direction Direction `protobuf:"varint,5,opt,name=direction,proto3,enum=logproto.Direction" json:"direction,omitempty"`
	Buckets   uint32    `protobuf:"varint,6,opt,name=buckets,proto3" json:"buckets,omitempty"`
...
func (m *QueryPlanRequest) GetQuery() string {
	if m != nil {
		return m.Query
	}
	return ""
...
func (m *QueryPlanRequest) GetLimit() uint32 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func (m *QueryPlanRequest) GetStart() time.Time {
	if m != nil {
		return m.Start
	}
	return time.Time{}
...
func (m *QueryPlanRequest) GetEnd() time.Time {
	if m != nil {
		return m.End
	}
	return time.Time{}
...
func (m *QueryPlanRequest) GetDirection() Direction {
	if m != nil {
		return m.Direction
	}
	return FORWARD
...
func (m *QueryPlanRequest) GetBuckets() uint32 {
	if m != nil {
		return m.Buckets
	}
	return 0
...
func (m *QueryPlanRequest) GetStrategy() string {
	if m != nil {
		return m.Strategy
	}
	return ""
...
type QueryPlanResponse struct {
	Results       []*SubQueryResult `protobuf:"bytes,1,rep,name=results,proto3" json:"results,omitempty"`
	MergeStrategy MergeStrategy     `protobuf:"varint,2,opt,name=mergeStrategy,proto3,enum=logproto.MergeStrategy" json:"mergeStrategy,omitempty"`
...
func (m *QueryPlanResponse) GetResults() []*SubQueryResult {
	if m != nil {
		return m.Results
	}
	return nil
...
func (m *QueryPlanResponse) GetMergeStrategy() MergeStrategy {
	if m != nil {
...
func (m *QueryPlanResponse) GetPath() string {
	if m != nil {
		return m.Path
	}
	return ""
...
func (m *SubQueryResult) Reset()      { *m = SubQueryResult{} }
func (*SubQueryResult) ProtoMessage() {}
func (*SubQueryResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_c28a5f14f1f4c79a, []int{56}
}
func (m *SubQueryResult) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SubQueryResult) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SubQueryResult.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SubQueryResult) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SubQueryResult.Merge(m, src)
}
func (m *SubQueryResult) XXX_Size() int {
	return m.Size()
}
func (m *SubQueryResult) XXX_DiscardUnknown() {
	xxx_messageInfo_SubQueryResult.DiscardUnknown(m)
}

var xxx_messageInfo_SubQueryResult proto.InternalMessageInfo

func (m *SubQueryResult) GetId() string {
	if m != nil {
		return m.Id
	}
	return ""
...
func (m *SubQueryResult) GetStart() time.Time {
	if m != nil {
		return m.Start
	}
	return time.Time{}
...
func (m *SubQueryResult) GetEnd() time.Time {
	if m != nil {
		return m.End
	}
	return time.Time{}
...
func (m *SubQueryResult) GetQuery() string {
	if m != nil {
		return m.Query
	}
	return ""
...
func (m *SubQueryResult) GetLimit() uint32 {
	if m != nil {
		return m.Limit
	}
	return 0
...
func (m *SubQueryResult) GetVolume() uint64 {
	if m != nil {
		return m.Volume
	}
	return 0
...
func init() {
	...
	proto.RegisterEnum("logproto.MergeStrategy", MergeStrategy_name, MergeStrategy_value)
	...
	proto.RegisterType((*QueryPlanRequest)(nil), "logproto.QueryPlanRequest")
	proto.RegisterType((*QueryPlanResponse)(nil), "logproto.QueryPlanResponse")
	proto.RegisterType((*SubQueryResult)(nil), "logproto.SubQueryResult")
}
...
var fileDescriptor_c28a5f14f1f4c79a = []byte{
	...
	,
}
...
func (x MergeStrategy) String() string {
	s, ok := MergeStrategy_name[int32(x)]
	if ok {
		return s
	}
	return strconv.Itoa(int(x))
...
func (this *QueryPlanRequest) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*QueryPlanRequest)
	if !ok {
		that2, ok := that.(QueryPlanRequest)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *QueryPlanResponse) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*QueryPlanResponse)
	if !ok {
		that2, ok := that.(QueryPlanResponse)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.MergeStrategy != that1.MergeStrategy {
		return false
	}
...
func (this *SubQueryResult) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*SubQueryResult)
	if !ok {
		that2, ok := that.(SubQueryResult)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *QueryPlanRequest) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 11)
	s = append(s, "&logproto.QueryPlanRequest{")
	s = append(s, "Query: "+fmt.Sprintf("%#v", this.Query)+",\n")
	s = append(s, "Limit: "+fmt.Sprintf("%#v", this.Limit)+",\n")
	s = append(s, "Start: "+fmt.Sprintf("%#v", this.Start)+",\n")
	s = append(s, "End: "+fmt.Sprintf("%#v", this.End)+",\n")
...
func (this *QueryPlanResponse) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 7)
	s = append(s, "&logproto.QueryPlanResponse{")
	if this.Results != nil {
...
func (this *SubQueryResult) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 10)
	s = append(s, "&logproto.SubQueryResult{")
...
func (m *QueryPlanRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Strategy) > 0 {
		...
		i = encodeVarintLogproto(dAtA, i, uint64(len(m.Strategy)))
		i--
		dAtA[i] = 0x3a
	}
	if m.Buckets != 0 {
		i = encodeVarintLogproto(dAtA, i, uint64(m.Buckets))
		i--
		dAtA[i] = 0x30
	}
	if m.Direction != 0 {
...
func (m *QueryPlanResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MergeStrategy != 0 {
		i = encodeVarintLogproto(dAtA, i, uint64(m.MergeStrategy))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Results) > 0 {
...
func (m *SubQueryResult) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SubQueryResult) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SubQueryResult) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryPlanRequest) Size() (n int) {
	...
	if m.Buckets != 0 {
		n += 1 + sovLogproto(uint64(m.Buckets))
	}
	l = len(m.Strategy)
	if l > 0 {
		n += 1 + l + sovLogproto(uint64(l))
...
func (m *QueryPlanResponse) Size() (n int) {
	...
	if m.MergeStrategy != 0 {
		n += 1 + sovLogproto(uint64(m.MergeStrategy))
	}
	l = len(m.Path)
	if l > 0 {
		n += 1 + l + sovLogproto(uint64(l))
...
func (m *SubQueryResult) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *QueryPlanRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&QueryPlanRequest{`,
		`Query:` + fmt.Sprintf("%v", this.Query) + `,`,
		`Limit:` + fmt.Sprintf("%v", this.Limit) + `,`,
		`Start:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.Start), "Timestamp", "types.Timestamp", 1), `&`, ``, 1) + `,`,
		`End:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.End), "Timestamp", "types.Timestamp", 1), `&`, ``, 1) + `,`,
...
func (this *QueryPlanResponse) String() string {
	if this == nil {
		return "nil"
	}
	repeatedStringForResults := "[]*SubQueryResult{"
	for _, f := range this.Results {
		repeatedStringForResults += strings.Replace(f.String(), "SubQueryResult", "SubQueryResult", 1) + ","
	}
	repeatedStringForResults += "}"
	s := strings.Join([]string{`&QueryPlanResponse{`,
...
func (this *SubQueryResult) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&SubQueryResult{`,
...
func (m *QueryPlanResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Results = append(m.Results, &SubQueryResult{})
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MergeStrategy |= MergeStrategy(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *SubQueryResult) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SubQueryResult: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SubQueryResult: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
