...
// SampleOrder selects the ordering of samples returned by a QuerySample request.
type SampleOrder int32

const (
	// SAMPLE_ORDER_BY_TIMESTAMP orders samples globally by timestamp. It is the zero value and the
	// default ordering.
...
type SampleQueryRequest struct {
	...
	// use to fetch the data, plus any other chunks reported by ingesters.
	StoreChunks *ChunkRefGroup `protobuf:"bytes,10,opt,name=storeChunks,proto3" json:"storeChunks"`
	// order selects how the returned samples are ordered. Its zero value keeps the historical
	// global-timestamp ordering, so old clients are unaffected.
...
var fileDescriptor_c28a5f14f1f4c79a = []byte{
	...
	,
}
