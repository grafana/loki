...
type HintRequest struct {
	...
	Tenant      string                                  `protobuf:"bytes,4,opt,name=tenant,proto3" json:"tenant,omitempty"`
	Indexes     []Meta                                  `protobuf:"bytes,5,rep,name=indexes,proto3" json:"indexes"`
	NgramLength int64                                   `protobuf:"varint,6,opt,name=ngram_length,json=ngramLength,proto3" json:"ngram_length,omitempty"`
}
...
func (m *HintRequest) GetTenant() string {
	if m != nil {
		return m.Tenant
	}
	return ""
...
func (m *HintRequest) GetIndexes() []Meta {
	if m != nil {
		return m.Indexes
	}
	return nil
...
func (m *HintRequest) GetNgramLength() int64 {
	if m != nil {
...
// Meta is the wire form of store.Meta for hint jobs.
type Meta struct {
	...
	MinLogTs         time.Time     `protobuf:"bytes,5,opt,name=min_log_ts,json=minLogTs,proto3,stdtime" json:"min_log_ts"`
	MaxLogTs         time.Time     `protobuf:"bytes,6,opt,name=max_log_ts,json=maxLogTs,proto3,stdtime" json:"max_log_ts"`
	MinRecordTs      time.Time     `protobuf:"bytes,7,opt,name=min_record_ts,json=minRecordTs,proto3,stdtime" json:"min_record_ts"`
	MaxRecordTs      time.Time     `protobuf:"bytes,8,opt,name=max_record_ts,json=maxRecordTs,proto3,stdtime" json:"max_record_ts"`
	CompactedFrom    []string      `protobuf:"bytes,9,rep,name=compacted_from,json=compactedFrom,proto3" json:"compacted_from,omitempty"`
	CreatedAt        time.Time     `protobuf:"bytes,10,opt,name=created_at,json=createdAt,proto3,stdtime" json:"created_at"`
	IndexHeader      *HeaderInfo   `protobuf:"bytes,11,opt,name=index_header,json=indexHeader,proto3" json:"index_header,omitempty"`
	ShardCount       int64         `protobuf:"varint,12,opt,name=shard_count,json=shardCount,proto3" json:"shard_count,omitempty"`
	ShardAlgorithm   string        `protobuf:"bytes,13,opt,name=shard_algorithm,json=shardAlgorithm,proto3" json:"shard_algorithm,omitempty"`
	ShardValue       int64         `protobuf:"varint,14,opt,name=shard_value,json=shardValue,proto3" json:"shard_value,omitempty"`
	DocumentInterval time.Duration `protobuf:"bytes,15,opt,name=document_interval,json=documentInterval,proto3,stdduration" json:"document_interval"`
...
func (m *Meta) GetStorageID() string {
	if m != nil {
		return m.StorageID
	}
	return ""
...
func (m *Meta) GetMinLogTs() time.Time {
	if m != nil {
		return m.MinLogTs
	}
	return time.Time{}
...
func (m *Meta) GetMaxLogTs() time.Time {
	if m != nil {
		return m.MaxLogTs
	}
	return time.Time{}
...
func (m *Meta) GetMinRecordTs() time.Time {
	if m != nil {
		return m.MinRecordTs
	}
	return time.Time{}
}

func (m *Meta) GetMaxRecordTs() time.Time {
	if m != nil {
		return m.MaxRecordTs
	}
	return time.Time{}
}

func (m *Meta) GetCompactedFrom() []string {
	if m != nil {
...
func (m *Meta) GetIndexHeader() *HeaderInfo {
	if m != nil {
...
func (m *Meta) GetShardCount() int64 {
	if m != nil {
		return m.ShardCount
	}
	return 0
...
func (m *Meta) GetShardAlgorithm() string {
	if m != nil {
...
func (m *Meta) GetShardValue() int64 {
	if m != nil {
		return m.ShardValue
	}
	return 0
...
func (m *Meta) GetDocumentInterval() time.Duration {
	if m != nil {
		return m.DocumentInterval
	}
	return 0
}

func (m *Meta) GetSizeBytes() int64 {
	if m != nil {
		return m.SizeBytes
	}
	return 0
...
type HeaderInfo struct {
	...
	TermBlockCount       uint32 `protobuf:"varint,4,opt,name=term_block_count,json=termBlockCount,proto3" json:"term_block_count,omitempty"`
	PostingsBlockCount   uint32 `protobuf:"varint,5,opt,name=postings_block_count,json=postingsBlockCount,proto3" json:"postings_block_count,omitempty"`
	PostingsCompression  uint32 `protobuf:"varint,6,opt,name=postings_compression,json=postingsCompression,proto3" json:"postings_compression,omitempty"`
	TermCount            uint64 `protobuf:"varint,7,opt,name=term_count,json=termCount,proto3" json:"term_count,omitempty"`
	PostingsDataSize     uint64 `protobuf:"varint,8,opt,name=postings_data_size,json=postingsDataSize,proto3" json:"postings_data_size,omitempty"`
	TermDataSize         uint64 `protobuf:"varint,9,opt,name=term_data_size,json=termDataSize,proto3" json:"term_data_size,omitempty"`
	DocMetadataSize      uint64 `protobuf:"varint,10,opt,name=doc_metadata_size,json=docMetadataSize,proto3" json:"doc_metadata_size,omitempty"`
	TermBlockDirSize     uint64 `protobuf:"varint,11,opt,name=term_block_dir_size,json=termBlockDirSize,proto3" json:"term_block_dir_size,omitempty"`
	PostingsBlockDirSize uint64 `protobuf:"varint,12,opt,name=postings_block_dir_size,json=postingsBlockDirSize,proto3" json:"postings_block_dir_size,omitempty"`
}
...
type HintQueryStats struct {
	...
	ObjectStorageRequests     int64         `protobuf:"varint,5,opt,name=object_storage_requests,json=objectStorageRequests,proto3" json:"object_storage_requests,omitempty"`
	TotalIOWait               time.Duration `protobuf:"bytes,6,opt,name=total_io_wait,json=totalIoWait,proto3,stdduration" json:"total_io_wait"`
	TotalIOBytes              int64         `protobuf:"varint,7,opt,name=total_io_bytes,json=totalIoBytes,proto3" json:"total_io_bytes,omitempty"`
	PeakConcurrency           int32         `protobuf:"varint,8,opt,name=peak_concurrency,json=peakConcurrency,proto3" json:"peak_concurrency,omitempty"`
	EffectiveConcurrency      float64       `protobuf:"fixed64,9,opt,name=effective_concurrency,json=effectiveConcurrency,proto3" json:"effective_concurrency,omitempty"`
	PrefetchCalls             int32         `protobuf:"varint,10,opt,name=prefetch_calls,json=prefetchCalls,proto3" json:"prefetch_calls,omitempty"`
	PrefetchTimeouts          int32         `protobuf:"varint,11,opt,name=prefetch_timeouts,json=prefetchTimeouts,proto3" json:"prefetch_timeouts,omitempty"`
	IndexQueriesTotal         int64         `protobuf:"varint,12,opt,name=index_queries_total,json=indexQueriesTotal,proto3" json:"index_queries_total,omitempty"`
	IndexQueriesTermMiss      int64         `protobuf:"varint,13,opt,name=index_queries_term_miss,json=indexQueriesTermMiss,proto3" json:"index_queries_term_miss,omitempty"`
	IndexQueriesEmptyAnd      int64         `protobuf:"varint,14,opt,name=index_queries_empty_and,json=indexQueriesEmptyAnd,proto3" json:"index_queries_empty_and,omitempty"`
	IndexQueriesPositive      int64         `protobuf:"varint,15,opt,name=index_queries_positive,json=indexQueriesPositive,proto3" json:"index_queries_positive,omitempty"`
	TotalTermBatchesProcessed int64         `protobuf:"varint,16,opt,name=total_term_batches_processed,json=totalTermBatchesProcessed,proto3" json:"total_term_batches_processed,omitempty"`
	HintCacheResult           string        `protobuf:"bytes,17,opt,name=hint_cache_result,json=hintCacheResult,proto3" json:"hint_cache_result,omitempty"`
	HintCacheDaysFetched      int64         `protobuf:"varint,18,opt,name=hint_cache_days_fetched,json=hintCacheDaysFetched,proto3" json:"hint_cache_days_fetched,omitempty"`
	HintCacheDaysHit          int64         `protobuf:"varint,19,opt,name=hint_cache_days_hit,json=hintCacheDaysHit,proto3" json:"hint_cache_days_hit,omitempty"`
}
...
func init() {
	...
	proto.RegisterType((*Meta)(nil), "logproto.Meta")
...
var fileDescriptor_c28a5f14f1f4c79a = []byte{
	...
	,
}
...
func (this *Meta) Equal(that interface{}) bool {
	...
	if this.StorageID != that1.StorageID {
		return false
	}
	if this.Hash != that1.Hash {
		return false
	...
	if !this.MinRecordTs.Equal(that1.MinRecordTs) {
		return false
	}
	if !this.MaxRecordTs.Equal(that1.MaxRecordTs) {
		return false
	}
	if len(this.CompactedFrom) != len(that1.CompactedFrom) {
		return false
	}
	for i := range this.CompactedFrom {
		if this.CompactedFrom[i] != that1.CompactedFrom[i] {
			return false
		}
	}
	...
	if this.DocumentInterval != that1.DocumentInterval {
		return false
	}
...
func (this *Meta) GoString() string {
	...
	s := make([]string, 0, 20)
	s = append(s, "&logproto.Meta{")
	s = append(s, "Date: "+fmt.Sprintf("%#v", this.Date)+",\n")
	s = append(s, "StorageID: "+fmt.Sprintf("%#v", this.StorageID)+",\n")
	s = append(s, "Hash: "+fmt.Sprintf("%#v", this.Hash)+",\n")
	s = append(s, "Version: "+fmt.Sprintf("%#v", this.Version)+",\n")
	s = append(s, "MinLogTs: "+fmt.Sprintf("%#v", this.MinLogTs)+",\n")
	s = append(s, "MaxLogTs: "+fmt.Sprintf("%#v", this.MaxLogTs)+",\n")
	s = append(s, "MinRecordTs: "+fmt.Sprintf("%#v", this.MinRecordTs)+",\n")
	s = append(s, "MaxRecordTs: "+fmt.Sprintf("%#v", this.MaxRecordTs)+",\n")
	s = append(s, "CompactedFrom: "+fmt.Sprintf("%#v", this.CompactedFrom)+",\n")
	...
	s = append(s, "DocumentInterval: "+fmt.Sprintf("%#v", this.DocumentInterval)+",\n")
...
func (m *Meta) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n25, err25 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.DocumentInterval, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.DocumentInterval):])
	if err25 != nil {
		return 0, err25
	}
	i -= n25
	...
	if len(m.CompactedFrom) > 0 {
		for iNdEx := len(m.CompactedFrom) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.CompactedFrom[iNdEx])
			copy(dAtA[i:], m.CompactedFrom[iNdEx])
			i = encodeVarintLogproto(dAtA, i, uint64(len(m.CompactedFrom[iNdEx])))
			i--
			dAtA[i] = 0x4a
		}
	}
	n28, err28 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.MaxRecordTs, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.MaxRecordTs):])
	if err28 != nil {
		return 0, err28
	}
	i -= n28
	...
	i--
	dAtA[i] = 0x42
	n29, err29 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.MinRecordTs, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.MinRecordTs):])
	if err29 != nil {
		return 0, err29
	}
	i -= n29
	...
	i--
	dAtA[i] = 0x3a
	n30, err30 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.MaxLogTs, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.MaxLogTs):])
	if err30 != nil {
		return 0, err30
	}
	i -= n30
	...
	i--
	dAtA[i] = 0x32
	n31, err31 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.MinLogTs, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.MinLogTs):])
	if err31 != nil {
		return 0, err31
	}
	i -= n31
	...
	if len(m.Hash) > 0 {
		i -= len(m.Hash)
		copy(dAtA[i:], m.Hash)
		i = encodeVarintLogproto(dAtA, i, uint64(len(m.Hash)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.StorageID) > 0 {
		...
		i = encodeVarintLogproto(dAtA, i, uint64(len(m.StorageID)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Date) > 0 {
		i -= len(m.Date)
		copy(dAtA[i:], m.Date)
		i = encodeVarintLogproto(dAtA, i, uint64(len(m.Date)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *HintQueryStats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n34, err34 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.TotalIOWait, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.TotalIOWait):])
	if err34 != nil {
		return 0, err34
	}
	i -= n34
...
func (m *DetectedFieldsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n37, err37 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.End, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.End):])
	if err37 != nil {
		return 0, err37
	}
	i -= n37
	i = encodeVarintLogproto(dAtA, i, uint64(n37))
	i--
	dAtA[i] = 0x12
	...
	i -= n38
	i = encodeVarintLogproto(dAtA, i, uint64(n38))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
...
func (m *DetectedLabelsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n39, err39 := github_com_gogo_protobuf_types.StdTimeMarshalTo(m.End, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdTime(m.End):])
	if err39 != nil {
		return 0, err39
	}
	i -= n39
	i = encodeVarintLogproto(dAtA, i, uint64(n39))
	i--
	dAtA[i] = 0x12
	...
	i -= n40
	i = encodeVarintLogproto(dAtA, i, uint64(n40))
	i--
	dAtA[i] = 0xa
	return len(dAtA) - i, nil
}
...
func (m *Meta) Size() (n int) {
	...
	n += 1 + l + sovLogproto(uint64(l))
	l = github_com_gogo_protobuf_types.SizeOfStdTime(m.MinRecordTs)
	n += 1 + l + sovLogproto(uint64(l))
	l = github_com_gogo_protobuf_types.SizeOfStdTime(m.MaxRecordTs)
	n += 1 + l + sovLogproto(uint64(l))
	if len(m.CompactedFrom) > 0 {
		for _, s := range m.CompactedFrom {
			l = len(s)
			n += 1 + l + sovLogproto(uint64(l))
		}
	}
	...
	l = github_com_gogo_protobuf_types.SizeOfStdDuration(m.DocumentInterval)
	n += 1 + l + sovLogproto(uint64(l))
	if m.SizeBytes != 0 {
		n += 2 + sovLogproto(uint64(m.SizeBytes))
	}
	return n
}
...
func (m *HintQueryStats) Size() (n int) {
	...
	if m.IndexQueriesEmptyAnd != 0 {
		n += 1 + sovLogproto(uint64(m.IndexQueriesEmptyAnd))
	}
	if m.IndexQueriesPositive != 0 {
		n += 1 + sovLogproto(uint64(m.IndexQueriesPositive))
	}
	if m.TotalTermBatchesProcessed != 0 {
...
func (this *HintRequest) String() string {
	...
	repeatedStringForIndexes := "[]Meta{"
	for _, f := range this.Indexes {
		repeatedStringForIndexes += strings.Replace(strings.Replace(f.String(), "Meta", "Meta", 1), `&`, ``, 1) + ","
	}
...
func (this *Meta) String() string {
	...
	s := strings.Join([]string{`&Meta{`,
		...
		`StorageID:` + fmt.Sprintf("%v", this.StorageID) + `,`,
		`Hash:` + fmt.Sprintf("%v", this.Hash) + `,`,
		...
		`MinRecordTs:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.MinRecordTs), "Timestamp", "types.Timestamp", 1), `&`, ``, 1) + `,`,
		`MaxRecordTs:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.MaxRecordTs), "Timestamp", "types.Timestamp", 1), `&`, ``, 1) + `,`,
		`CompactedFrom:` + fmt.Sprintf("%v", this.CompactedFrom) + `,`,
		...
		`DocumentInterval:` + strings.Replace(strings.Replace(fmt.Sprintf("%v", this.DocumentInterval), "Duration", "types.Duration", 1), `&`, ``, 1) + `,`,
...
func (m *HintRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.Indexes = append(m.Indexes, Meta{})
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NgramLength |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Meta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinRecordTs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := github_com_gogo_protobuf_types.StdTimeUnmarshal(&m.MinRecordTs, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxRecordTs", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := github_com_gogo_protobuf_types.StdTimeUnmarshal(&m.MaxRecordTs, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CompactedFrom", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.CompactedFrom = append(m.CompactedFrom, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
		...
		case 15:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DocumentInterval", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := github_com_gogo_protobuf_types.StdDurationUnmarshal(&m.DocumentInterval, dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 16:
