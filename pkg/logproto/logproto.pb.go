...
type HintRequest struct {
	...
	Tenant      string                                  `protobuf:"bytes,4,opt,name=tenant,proto3" json:"tenant,omitempty"`
	Indexes     []IndexRef                              `protobuf:"bytes,5,rep,name=indexes,proto3" json:"indexes"`
...
func (m *HintRequest) GetIndexes() []IndexRef {
	if m != nil {
		return m.Indexes
	}
	return nil
...
type IndexRef struct {
	...
	MinLogTs       github_com_prometheus_common_model.Time `protobuf:"varint,5,opt,name=min_log_ts,json=minLogTs,proto3,customtype=github.com/prometheus/common/model.Time" json:"min_log_ts"`
	MaxLogTs       github_com_prometheus_common_model.Time `protobuf:"varint,6,opt,name=max_log_ts,json=maxLogTs,proto3,customtype=github.com/prometheus/common/model.Time" json:"max_log_ts"`
	ShardCount     int64                                   `protobuf:"varint,8,opt,name=shard_count,json=shardCount,proto3" json:"shard_count,omitempty"`
	ShardAlgorithm string                                  `protobuf:"bytes,9,opt,name=shard_algorithm,json=shardAlgorithm,proto3" json:"shard_algorithm,omitempty"`
	ShardValue     int64                                   `protobuf:"varint,10,opt,name=shard_value,json=shardValue,proto3" json:"shard_value,omitempty"`
}

func (m *IndexRef) Reset()      { *m = IndexRef{} }
func (*IndexRef) ProtoMessage() {}
func (*IndexRef) Descriptor() ([]byte, []int) {
	return fileDescriptor_c28a5f14f1f4c79a, []int{42}
}
func (m *IndexRef) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IndexRef) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_IndexRef.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *IndexRef) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IndexRef.Merge(m, src)
}
func (m *IndexRef) XXX_Size() int {
	return m.Size()
}
func (m *IndexRef) XXX_DiscardUnknown() {
	xxx_messageInfo_IndexRef.DiscardUnknown(m)
}

var xxx_messageInfo_IndexRef proto.InternalMessageInfo

func (m *IndexRef) GetDate() string {
	if m != nil {
		return m.Date
	}
	return ""
...
func (m *IndexRef) GetStorageID() string {
	if m != nil {
		return m.StorageID
	}
	return ""
...
func (m *IndexRef) GetVersion() string {
	if m != nil {
		return m.Version
	}
	return ""
...
func (m *IndexRef) GetSizeBytes() int64 {
	if m != nil {
		return m.SizeBytes
	}
	return 0
...
func (m *IndexRef) GetShardCount() int64 {
	if m != nil {
		return m.ShardCount
	}
	return 0
...
func (m *IndexRef) GetShardAlgorithm() string {
	if m != nil {
...
func (m *IndexRef) GetShardValue() int64 {
	if m != nil {
		return m.ShardValue
	}
	return 0
...
type HintQueryStats struct {
	TermDictReads             int64         `protobuf:"varint,1,opt,name=term_dict_reads,json=termDictReads,proto3" json:"term_dict_reads,omitempty"`
	BitmapReads               int64         `protobuf:"varint,2,opt,name=bitmap_reads,json=bitmapReads,proto3" json:"bitmap_reads,omitempty"`
	ObjectStorageRequests     int64         `protobuf:"varint,3,opt,name=object_storage_requests,json=objectStorageRequests,proto3" json:"object_storage_requests,omitempty"`
	TotalIOWait               time.Duration `protobuf:"bytes,4,opt,name=total_io_wait,json=totalIoWait,proto3,stdduration" json:"total_io_wait"`
	TotalIOBytes              int64         `protobuf:"varint,5,opt,name=total_io_bytes,json=totalIoBytes,proto3" json:"total_io_bytes,omitempty"`
	PeakConcurrency           int32         `protobuf:"varint,6,opt,name=peak_concurrency,json=peakConcurrency,proto3" json:"peak_concurrency,omitempty"`
	EffectiveConcurrency      float64       `protobuf:"fixed64,7,opt,name=effective_concurrency,json=effectiveConcurrency,proto3" json:"effective_concurrency,omitempty"`
	PrefetchCalls             int32         `protobuf:"varint,8,opt,name=prefetch_calls,json=prefetchCalls,proto3" json:"prefetch_calls,omitempty"`
	PrefetchTimeouts          int32         `protobuf:"varint,9,opt,name=prefetch_timeouts,json=prefetchTimeouts,proto3" json:"prefetch_timeouts,omitempty"`
	IndexQueriesTotal         int64         `protobuf:"varint,10,opt,name=index_queries_total,json=indexQueriesTotal,proto3" json:"index_queries_total,omitempty"`
	IndexQueriesTermMiss      int64         `protobuf:"varint,11,opt,name=index_queries_term_miss,json=indexQueriesTermMiss,proto3" json:"index_queries_term_miss,omitempty"`
	IndexQueriesEmptyAnd      int64         `protobuf:"varint,12,opt,name=index_queries_empty_and,json=indexQueriesEmptyAnd,proto3" json:"index_queries_empty_and,omitempty"`
	IndexQueriesPositive      int64         `protobuf:"varint,13,opt,name=index_queries_positive,json=indexQueriesPositive,proto3" json:"index_queries_positive,omitempty"`
	TotalTermBatchesProcessed int64         `protobuf:"varint,14,opt,name=total_term_batches_processed,json=totalTermBatchesProcessed,proto3" json:"total_term_batches_processed,omitempty"`
	HintCacheResult           string        `protobuf:"bytes,15,opt,name=hint_cache_result,json=hintCacheResult,proto3" json:"hint_cache_result,omitempty"`
	HintCacheDaysFetched      int64         `protobuf:"varint,16,opt,name=hint_cache_days_fetched,json=hintCacheDaysFetched,proto3" json:"hint_cache_days_fetched,omitempty"`
	HintCacheDaysHit          int64         `protobuf:"varint,17,opt,name=hint_cache_days_hit,json=hintCacheDaysHit,proto3" json:"hint_cache_days_hit,omitempty"`
}
...
var fileDescriptor_c28a5f14f1f4c79a = []byte{
	...
	,
}
...
func (this *IndexRef) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*IndexRef)
	if !ok {
		that2, ok := that.(IndexRef)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *HintRequest) GoString() string {
	...
	s = append(s, "Tenant: "+fmt.Sprintf("%#v", this.Tenant)+",\n")
	if this.Indexes != nil {
		vs := make([]IndexRef, len(this.Indexes))
		for i := range vs {
			vs[i] = this.Indexes[i]
		}
...
func (this *IndexRef) GoString() string {
	if this == nil {
		return "nil"
	}
	s := make([]string, 0, 13)
	s = append(s, "&logproto.IndexRef{")
...
func (m *IndexRef) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *IndexRef) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IndexRef) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.MaxLogTs != 0 {
		i = encodeVarintLogproto(dAtA, i, uint64(m.MaxLogTs))
		i--
		dAtA[i] = 0x30
	}
	if m.MinLogTs != 0 {
		i = encodeVarintLogproto(dAtA, i, uint64(m.MinLogTs))
		i--
		dAtA[i] = 0x28
	}
	if m.SizeBytes != 0 {
...
func (m *HintQueryStats) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	n27, err27 := github_com_gogo_protobuf_types.StdDurationMarshalTo(m.TotalIOWait, dAtA[i-github_com_gogo_protobuf_types.SizeOfStdDuration(m.TotalIOWait):])
	if err27 != nil {
		return 0, err27
	}
	i -= n27
...
func (m *IndexRef) Size() (n int) {
	...
	if m.MinLogTs != 0 {
		n += 1 + sovLogproto(uint64(m.MinLogTs))
	}
	if m.MaxLogTs != 0 {
		n += 1 + sovLogproto(uint64(m.MaxLogTs))
	}
	if m.ShardCount != 0 {
...
func (m *HintQueryStats) Size() (n int) {
	...
	if m.TotalTermBatchesProcessed != 0 {
		n += 1 + sovLogproto(uint64(m.TotalTermBatchesProcessed))
	}
...
func (this *HintRequest) String() string {
	...
	repeatedStringForIndexes := "[]IndexRef{"
	for _, f := range this.Indexes {
		repeatedStringForIndexes += strings.Replace(strings.Replace(f.String(), "IndexRef", "IndexRef", 1), `&`, ``, 1) + ","
	}
...
func (this *IndexRef) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&IndexRef{`,
		`Date:` + fmt.Sprintf("%v", this.Date) + `,`,
		`StorageID:` + fmt.Sprintf("%v", this.StorageID) + `,`,
		`Version:` + fmt.Sprintf("%v", this.Version) + `,`,
		`SizeBytes:` + fmt.Sprintf("%v", this.SizeBytes) + `,`,
		`MinLogTs:` + fmt.Sprintf("%v", this.MinLogTs) + `,`,
		`MaxLogTs:` + fmt.Sprintf("%v", this.MaxLogTs) + `,`,
...
func (m *HintRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.Indexes = append(m.Indexes, IndexRef{})
...
func (m *IndexRef) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IndexRef: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IndexRef: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinLogTs |= github_com_prometheus_common_model.Time(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxLogTs |= github_com_prometheus_common_model.Time(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
