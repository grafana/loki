...
type Stream struct {
	...
	Label   []github_com_cortexproject_cortex_pkg_ingester_client.LabelAdapter `protobuf:"bytes,3,rep,name=label,proto3,customtype=github.com/cortexproject/cortex/pkg/ingester/client.LabelAdapter" json:"metric"`
}
...
var fileDescriptor_c28a5f14f1f4c79a = []byte{
	...
	,
}
...
func (m *Stream) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Label = append(m.Label, github_com_cortexproject_cortex_pkg_ingester_client.LabelAdapter{})
