...
import (
	...
	analyze "github.com/grafana/loki/pkg/logqlmodel/analyze"
...
type QueryResponse struct {
	...
	Analyze *analyze.RemoteContext                    `protobuf:"bytes,3,opt,name=analyze,proto3" json:"analyze,omitempty"`
}
...
func (m *QueryResponse) GetAnalyze() *analyze.RemoteContext {
	if m != nil {
		return m.Analyze
	}
	return nil
...
var fileDescriptor_c28a5f14f1f4c79a = []byte{
	...
	,
}
...
func (this *QueryResponse) Equal(that interface{}) bool {
	...
	if !this.Analyze.Equal(that1.Analyze) {
		return false
	}
	return true
}
...
func (m *QueryResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Analyze != nil {
		{
			size, err := m.Analyze.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (this *QueryResponse) String() string {
	...
	s := strings.Join([]string{`&QueryResponse{`,
		...
		`Analyze:` + strings.Replace(fmt.Sprintf("%v", this.Analyze), "RemoteContext", "analyze.RemoteContext", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *QueryResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.Analyze == nil {
				m.Analyze = &analyze.RemoteContext{}
			}
			if err := m.Analyze.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
