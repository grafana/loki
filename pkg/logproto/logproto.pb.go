...
func (Direction) EnumDescriptor() ([]byte, []int) { return fileDescriptorLogproto, []int{0} }
...
func (*PushRequest) Descriptor() ([]byte, []int) { return fileDescriptorLogproto, []int{0} }
...
func (*PushResponse) Descriptor() ([]byte, []int) { return fileDescriptorLogproto, []int{1} }
...
func (*QueryRequest) Descriptor() ([]byte, []int) { return fileDescriptorLogproto, []int{2} }
...
func (*QueryResponse) Descriptor() ([]byte, []int) { return fileDescriptorLogproto, []int{3} }
...
func (*LabelRequest) Descriptor() ([]byte, []int) { return fileDescriptorLogproto, []int{4} }
...
func (*LabelResponse) Descriptor() ([]byte, []int) { return fileDescriptorLogproto, []int{5} }
...
func (*Stream) Descriptor() ([]byte, []int) { return fileDescriptorLogproto, []int{6} }
...
func (*Entry) Descriptor() ([]byte, []int) { return fileDescriptorLogproto, []int{7} }
...
func (c *pusherClient) Push(ctx context.Context, in *PushRequest, opts ...grpc.CallOption) (*PushResponse, error) {
	...
	err := grpc.Invoke(ctx, "/logproto.Pusher/Push", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pusherClient) Check(ctx context.Context, in *grpc_health_v1.HealthCheckRequest, opts ...grpc.CallOption) (*grpc_health_v1.HealthCheckResponse, error) {
	out := new(grpc_health_v1.HealthCheckResponse)
	err := grpc.Invoke(ctx, "/logproto.Pusher/Check", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Pusher_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(grpc_health_v1.HealthCheckRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PusherServer).Check(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/logproto.Pusher/Check",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PusherServer).Check(ctx, req.(*grpc_health_v1.HealthCheckRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func (c *querierClient) Query(ctx context.Context, in *QueryRequest, opts ...grpc.CallOption) (Querier_QueryClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_Querier_serviceDesc.Streams[0], c.cc, "/logproto.Querier/Query", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *querierClient) Label(ctx context.Context, in *LabelRequest, opts ...grpc.CallOption) (*LabelResponse, error) {
	...
	err := grpc.Invoke(ctx, "/logproto.Querier/Label", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (m *QueryRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x1a
	i++
	i = encodeVarintLogproto(dAtA, i, uint64(types.SizeOfStdTime(m.Start)))
	n1, err := types.StdTimeMarshalTo(m.Start, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n1
	dAtA[i] = 0x22
	i++
	i = encodeVarintLogproto(dAtA, i, uint64(types.SizeOfStdTime(m.End)))
	n2, err := types.StdTimeMarshalTo(m.End, dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n2
...
func (this *QueryRequest) String() string {
	...
	s := strings.Join([]string{`&QueryRequest{`,
		...
		`Start:` + strings.Replace(strings.Replace(this.Start.String(), "Timestamp", "google_protobuf.Timestamp", 1), `&`, ``, 1) + `,`,
		`End:` + strings.Replace(strings.Replace(this.End.String(), "Timestamp", "google_protobuf.Timestamp", 1), `&`, ``, 1) + `,`,
...
func (this *Entry) String() string {
	...
	s := strings.Join([]string{`&Entry{`,
		`Timestamp:` + strings.Replace(strings.Replace(this.Timestamp.String(), "Timestamp", "google_protobuf.Timestamp", 1), `&`, ``, 1) + `,`,
...
func init() { proto.RegisterFile("logproto.proto", fileDescriptorLogproto) }

var fileDescriptorLogproto = []byte{
	// 617 bytes of a gzipped FileDescriptorProto
	,
}
