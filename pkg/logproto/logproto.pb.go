...
func (Direction) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_logproto_adef8c83a5cec564, []int{0}
}
...
func (*PushResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_logproto_adef8c83a5cec564, []int{1}
}
...
func (*QueryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_logproto_adef8c83a5cec564, []int{2}
}
...
func (*QueryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_logproto_adef8c83a5cec564, []int{3}
}
...
func (*LabelRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_logproto_adef8c83a5cec564, []int{4}
}
...
func (*LabelResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_logproto_adef8c83a5cec564, []int{5}
}
...
func (*Stream) Descriptor() ([]byte, []int) {
	return fileDescriptor_logproto_adef8c83a5cec564, []int{6}
}
...
func (*Entry) Descriptor() ([]byte, []int) {
	return fileDescriptor_logproto_adef8c83a5cec564, []int{7}
}
...
func (c *pusherClient) Check(ctx context.Context, in *grpc_health_v1.HealthCheckRequest, opts ...grpc.CallOption) (*grpc_health_v1.HealthCheckResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/logproto.Pusher/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func init() { proto.RegisterFile("logproto.proto", fileDescriptor_logproto_adef8c83a5cec564) }

var fileDescriptor_logproto_adef8c83a5cec564 = []byte{
