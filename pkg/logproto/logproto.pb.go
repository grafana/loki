...
type PushRequest struct {
	...
	IdempotentKey string   `protobuf:"bytes,2,opt,name=idempotentKey,proto3" json:"idempotentKey,omitempty"`
}
...
func (m *PushRequest) GetIdempotentKey() string {
	if m != nil {
...
var fileDescriptor_c28a5f14f1f4c79a = []byte{
	...
	,
}
...
func (this *PushRequest) Equal(that interface{}) bool {
	...
	if this.IdempotentKey != that1.IdempotentKey {
		return false
	}
	return true
}
...
func (this *PushRequest) GoString() string {
	...
	s = append(s, "IdempotentKey: "+fmt.Sprintf("%#v", this.IdempotentKey)+",\n")
	s = append(s, "}")
...
func (m *PushRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.IdempotentKey) > 0 {
		i -= len(m.IdempotentKey)
		copy(dAtA[i:], m.IdempotentKey)
		i = encodeVarintLogproto(dAtA, i, uint64(len(m.IdempotentKey)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Streams) > 0 {
...
func (this *PushRequest) String() string {
	...
	s := strings.Join([]string{`&PushRequest{`,
		...
		`IdempotentKey:` + fmt.Sprintf("%v", this.IdempotentKey) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *PushRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IdempotentKey", wireType)
			}
			...
			m.IdempotentKey = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
