...
func (r *SeriesRequest) WithStartEnd(s, e time.Time) definitions.Request {
	clone := *r
	clone.Start = s
	clone.End = e
	return &clone
...
func (r *SeriesRequest) WithQuery(_ string) definitions.Request {
	clone := *r
	return &clone
}

func (r *SeriesRequest) GetQuery() string {
	return ""
}

func (r *SeriesRequest) GetStep() int64 {
	return 0
}

func (r *SeriesRequest) LogToSpan(sp opentracing.Span) {
	sp.LogFields(
		otlog.String("matchers", strings.Join(r.GetGroups(), ",")),
...
func (*SeriesRequest) GetCachingOptions() (res definitions.CachingOptions) { return }

func (*SeriesRequest) GetHeaders() []*definitions.PrometheusResponseHeader {
	return nil
}
