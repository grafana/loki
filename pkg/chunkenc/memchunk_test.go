...
func (nomatchPipeline) Process(ts int64, line []byte, nonIndexedLabels ...labels.Label) ([]byte, log.LabelsResult, bool) {
	return line, nil, false
}
func (nomatchPipeline) ProcessString(ts int64, line string, nonIndexedLabels ...labels.Label) (string, log.LabelsResult, bool) {
	return line, nil, false
}
