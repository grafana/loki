...
func (nomatchPipeline) Process(ts int64, line []byte) ([]byte, log.LabelsResult, bool) {
	return line, nil, false
}
func (nomatchPipeline) ProcessString(ts int64, line string) (string, log.LabelsResult, bool) {
	return line, nil, false
}
