...
func (nomatchPipeline) Process(ts int64, line []byte) ([]byte, log.LabelsResult, int64, bool) {
	return line, nil, ts, false
}
func (nomatchPipeline) ProcessString(ts int64, line string) (string, log.LabelsResult, int64, bool) {
	return line, nil, ts, false
}
