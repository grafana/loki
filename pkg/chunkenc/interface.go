...
type Chunk interface {
	...
	SampleIterator(ctx context.Context, from, through time.Time, extractor log.StreamSampleExtractor, queryMetricsOnly bool) iter.SampleIterator
...
type Block interface {
	...
	SampleIterator(ctx context.Context, extractor log.StreamSampleExtractor, queryMetricsOnly bool) iter.SampleIterator
}
