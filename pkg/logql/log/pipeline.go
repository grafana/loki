...
type StreamPipeline interface {
	...
	Process(ts int64, line []byte) (resultLine []byte, resultLabels LabelsResult, ok bool)
	ProcessString(ts int64, line string) (resultLine string, resultLabels LabelsResult, ok bool)
}
