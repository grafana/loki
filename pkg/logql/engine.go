...
type EngineOpts struct {
	...
	// MergePrefetchConcurrency controls the number of inputs that are prefetched simultaneously by any Merge node.
	MergePrefetchConcurrency int `yaml:"merge_prefetch_concurrency" category:"experimental"`
