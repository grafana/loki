...
func (q *query) evalSample(ctx context.Context, expr syntax.SampleExpr) (promql_parser.Value, error) {
	...
	sort.Sort(result)
	fmt.Printf("Engine Final Result %v\n", result)
...
// 	next, ts, vec := stepEvaluator.(*histogramEvaluator).Next()
// 	if stepEvaluator.Error() != nil {
// 		return nil, stepEvaluator.Error()
// 	}
...
// 	// series := make([]promql.Series, 0, len(seriesIndex))
// 	// seriesIndex2 := map[uint64]*promql.Series{}
// 	// for _, s := range seriesIndex {
// 	// 	sCopy := s.Metric.Copy()
// 	// 	for _, point := range s.Points {
// 	// 		for _, v := range point.V {
// 	// 			sCopy = s.Metric.Copy()
// 	// 			sCopy = append(sCopy, labels.Label{Name: "le", Value: strconv.FormatFloat(v.UpperBound, 'f', -1, 64)})
// 	// 			hashIndex2 := sCopy.Hash()
// 	// 			series2, ok := seriesIndex2[hashIndex2]
// 	// 			if !ok {
// 	// 				series2 = &promql.Series{
// 	// 					Metric: sCopy,
// 	// 					Points: make([]promql.Point, 0, stepCount),
// 	// 				}
// 	// 				seriesIndex2[hashIndex2] = series2
// 	// 			}
// 	// 			series2.Points = append(series2.Points, promql.Point{
// 	// 				T: point.T,
// 	// 				V: v.Count,
// 	// 			})
// 	// 		}
