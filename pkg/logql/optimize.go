...
func optimizeSampleExpr(expr syntax.SampleExpr) (syntax.SampleExpr, error) {
	...
	expr.Walk(func(e syntax.Expr) bool {
		switch e.(type) {
		case *ConcatSampleExpr, DownstreamSampleExpr, *QuantileSketchEvalExpr, *QuantileSketchMergeExpr, *MergeFirstOverTimeExpr, *MergeLastOverTimeExpr, *CountDistinctEvalExpr, *CountDistinctMergeExpr, *CountMinSketchEvalExpr:
			skip = true
		}
		return true
	})
