...
import (
	...
	clientSyntax "github.com/grafana/loki/v3/client/pkg/logql/syntax"
)
...
// This function delegates to the client module implementation.
func ParseLabels(lbs string) (labels.Labels, error) {
	return clientSyntax.ParseLabels(lbs)
}
