...
type DepthFirstTraversal struct {
	VisitBinOpFn                  func(v *DepthFirstTraversal, e *BinOpExpr)
	VisitDecolorizeFn             func(v *DepthFirstTraversal, e *DecolorizeExpr)
	VisitDropLabelsFn             func(v *DepthFirstTraversal, e *DropLabelsExpr)
	VisitJSONExpressionParserFn   func(v *DepthFirstTraversal, e *JSONExpressionParser)
	VisitKeepLabelFn              func(v *DepthFirstTraversal, e *KeepLabelsExpr)
	VisitLabelFilterFn            func(v *DepthFirstTraversal, e *LabelFilterExpr)
	VisitLabelFmtFn               func(v *DepthFirstTraversal, e *LabelFmtExpr)
	VisitLabelParserFn            func(v *DepthFirstTraversal, e *LabelParserExpr)
	VisitLabelReplaceFn           func(v *DepthFirstTraversal, e *LabelReplaceExpr)
	VisitLineFilterFn             func(v *DepthFirstTraversal, e *LineFilterExpr)
	VisitLineFmtFn                func(v *DepthFirstTraversal, e *LineFmtExpr)
	VisitLiteralFn                func(v *DepthFirstTraversal, e *LiteralExpr)
	VisitLogRangeFn               func(v *DepthFirstTraversal, e *LogRange)
	VisitLogfmtExpressionParserFn func(v *DepthFirstTraversal, e *LogfmtExpressionParser)
	...
	VisitPipelineFn               func(v *DepthFirstTraversal, e *PipelineExpr)
	VisitRangeAggregationFn       func(v *DepthFirstTraversal, e *RangeAggregationExpr)
	VisitVectorFn                 func(v *DepthFirstTraversal, e *VectorExpr)
	VisitVectorAggregationFn      func(v *DepthFirstTraversal, e *VectorAggregationExpr)
}
