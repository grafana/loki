...
// TODO: file an issue with an obfuscated query that reproduces this.
func Test_ParseSampleExpr_IssueTBA(t *testing.T) {
	badQuery := `((sum(count_over_time({foo="bar"} |~ "" [6h])) / sum(count_over_time({foo="bar"} |~ ""[6h]))) * 100)`

	_, err := ParseSampleExpr(badQuery)
	require.NoError(t, err)
}
