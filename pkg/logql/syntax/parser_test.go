...
func Test_parseExprWithoutInputCheck(t *testing.T) {
	_, err := ParseSampleExpr(largeQuery)
	require.Error(t, err)
	assert.ErrorContains(t, err, "input size too long")

	_, err = ParseSampleExprWithoutInputCheck(largeQuery)
	require.NoError(t, err)
}

const largeQuery = `
sum(rate({cluster="foobar-cluster", namespace="foobar"} |= "error parsing explore query from context " | logfmt | msg=~"(?-s:.)*?error parsing explore query from context (?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i: URL )(?i:HTTP)(?i:S)?(?i:://)[\\--\\.0-9A-Za-zſK]+?(?i:\\.)[A-Za-zſK][A-Za-zſK](?:[A-Za-zſK][A-Za-zſK]?)?((?i:/)[\\--\\.0-9A-Za-zſK]+)*?(?i:\\?FOOBAR=)[0-9]+?(?i:&LEFT=%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)[0-9]+?(?i:%)[0-9]+?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:-FOO%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:-COM-API%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:-FOOBAR%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)[0-9]+?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:-%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)[0-9]+?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:_FORMAT%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)((?i:/)?([\\-0-9A-Z_a-zſK]+))+?(?i:\\.)[0-9A-Z_a-zſK][0-9A-Z_a-zſK](?:[0-9A-Z_a-zſK][0-9A-Z_a-zſK]?)?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)((?i:/)?([\\-0-9A-Z_a-zſK]+))+?(?i:\\.)[0-9A-Z_a-zſK][0-9A-Z_a-zſK](?:[0-9A-Z_a-zſK][0-9A-Z_a-zſK]?)?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)[0-9]+?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)[0-9]+?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:-)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:: PARSE SOMETHING EXPRESSION \\{NAMESPACE=\"FOO-COM\", CONTAINER=\"WEBAPI_SERVER\"\\} \\|= \"/PROVISIONED-PLUGINS\" != \"\\\\\"AUTH\\\\\":\\\\\"FOOBAR-\" != \"FOOBAR\" \\| JSON \\| LINE_FORMAT \"\\{\\{\\.MSG\\}\\} \\{\\{\\.AUTH\\}\\}\": )[0-9]+?(?i::)[0-9]+?(?i:: PARSE ERROR: UNEXPECTED CHARACTER: '\\|')(?-s:.)*?"[30m]))
`
