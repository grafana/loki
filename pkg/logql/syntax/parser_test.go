...
func Test_parseExprWithoutInputCheck(t *testing.T) {
	_, err := ParseExpr(largeQuery)
	require.Error(t, err)
	assert.ErrorContains(t, err, "input size too long")

	_, err = parseExprWithoutInputCheck(largeQuery)
	require.NoError(t, err)
}

const largeQuery = `
sum(rate({cluster="ops-us-east-0", namespace="incident"} |= "error parsing explore query from context " | logfmt | msg=~"(?-s:.)*?error parsing explore query from context (?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i: URL )(?i:HTTP)(?i:S)?(?i:://)[\\--\\.0-9A-Za-zſK]+?(?i:\\.)[A-Za-zſK][A-Za-zſK](?:[A-Za-zſK][A-Za-zſK]?)?((?i:/)[\\--\\.0-9A-Za-zſK]+)*?(?i:\\?ORGID=)[0-9]+?(?i:&LEFT=%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)[0-9]+?(?i:%)[0-9]+?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:-COM%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:-COM-API%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:-PLUGINS%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)[0-9]+?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:-%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)[0-9]+?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:_FORMAT%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)((?i:/)?([\\-0-9A-Z_a-zſK]+))+?(?i:\\.)[0-9A-Z_a-zſK][0-9A-Z_a-zſK](?:[0-9A-Z_a-zſK][0-9A-Z_a-zſK]?)?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)((?i:/)?([\\-0-9A-Z_a-zſK]+))+?(?i:\\.)[0-9A-Z_a-zſK][0-9A-Z_a-zſK](?:[0-9A-Z_a-zſK][0-9A-Z_a-zſK]?)?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)[0-9]+?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)[0-9]+?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:-)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:,%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i::%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)[0-9]+?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:%)(?:[0-9]+?[A-Za-zſK]|[A-Za-zſK]+?[0-9])[0-9A-Za-zſK]*?(?i:: PARSE PROMETHEUS EXPRESSION \\{NAMESPACE=\"GRAFANA-COM\", CONTAINER=\"GRAFANA-COM-API\"\\} \\|= \"/PROVISIONED-PLUGINS\" != \"\\\\\"AUTH\\\\\":\\\\\"RAINTANK-\" != \"BEEKBANKS\" \\| JSON \\| LINE_FORMAT \"\\{\\{\\.MSG\\}\\} \\{\\{\\.AUTH\\}\\}\": )[0-9]+?(?i::)[0-9]+?(?i:: PARSE ERROR: UNEXPECTED CHARACTER: '\\|')(?-s:.)*?"[30m]))
`
