...
func TestLex(t *testing.T) {
	for _, tc := range []struct {
		...
		{`{foo="bar"}|logfmt --strict"`, []int{OPEN_BRACE, IDENTIFIER, EQ, STRING, CLOSE_BRACE, PIPE, LOGFMT, STRICT}},
		...
		{`{foo="bar"}|logfmt --strict|=ip("b")`, []int{OPEN_BRACE, IDENTIFIER, EQ, STRING, CLOSE_BRACE, PIPE, LOGFMT, STRICT, PIPE_EXACT, IP, OPEN_PARENTHESIS, STRING, CLOSE_PARENTHESIS}},
		{`ip`, []int{IDENTIFIER}},
		{`rate`, []int{IDENTIFIER}},
		...
		{`{foo="bar"} | logfmt --strict code"`, []int{OPEN_BRACE, IDENTIFIER, EQ, STRING, CLOSE_BRACE, PIPE, LOGFMT, STRICT, IDENTIFIER}},
		{`{foo="bar"} | logfmt --strict code="response.code", IPAddress="host"`, []int{OPEN_BRACE, IDENTIFIER, EQ, STRING, CLOSE_BRACE, PIPE, LOGFMT, STRICT, IDENTIFIER, EQ, STRING, COMMA, IDENTIFIER, EQ, STRING}},
