...
type Summary struct {
	...
	ExecTimeNano int64 `protobuf:"varint,5,opt,name=execTimeNano,proto3" json:"execTimeNano"`
}
...
func (m *Summary) GetBytesProcessedPerSeconds() int64 {
	if m != nil {
		return m.BytesProcessedPerSeconds
	}
	return 0
}

func (m *Summary) GetLinesProcessedPerSeconds() int64 {
	if m != nil {
...
func (m *Summary) GetExecTimeNano() int64 {
	if m != nil {
		return m.ExecTimeNano
	}
	return 0
}
...
type Store struct {
	...
	TotalDownloadedChunks int64 `protobuf:"varint,2,opt,name=totalDownloadedChunks,proto3" json:"totalDownloadedChunks"`
	// Time spent fetching chunks in nanoseconds.
	TimeDownloadingChunksNano int64 `protobuf:"varint,3,opt,name=timeDownloadingChunksNano,proto3" json:"timeDownloadingChunksNano"`
...
func (m *Store) GetTotalDownloadedChunks() int64 {
	if m != nil {
		return m.TotalDownloadedChunks
	}
	return 0
}

func (m *Store) GetTimeDownloadingChunksNano() int64 {
	if m != nil {
		return m.TimeDownloadingChunksNano
	}
	return 0
}
...
var fileDescriptor_770b8387e5696475 = []byte{
	...
	,
}
...
func (this *Summary) Equal(that interface{}) bool {
	...
	if this.BytesProcessedPerSeconds != that1.BytesProcessedPerSeconds {
		return false
	}
	if this.LinesProcessedPerSeconds != that1.LinesProcessedPerSeconds {
		return false
	}
	...
	if this.ExecTimeNano != that1.ExecTimeNano {
		return false
	}
	return true
}
func (this *Store) Equal(that interface{}) bool {
	...
	if this.TotalDownloadedChunks != that1.TotalDownloadedChunks {
		return false
	}
	if this.TimeDownloadingChunksNano != that1.TimeDownloadingChunksNano {
		return false
	}
...
func (this *Summary) GoString() string {
	...
	s = append(s, "BytesProcessedPerSeconds: "+fmt.Sprintf("%#v", this.BytesProcessedPerSeconds)+",\n")
	...
	s = append(s, "ExecTimeNano: "+fmt.Sprintf("%#v", this.ExecTimeNano)+",\n")
	s = append(s, "}")
	return strings.Join(s, "")
}
func (this *Store) GoString() string {
	...
	s = append(s, "TotalDownloadedChunks: "+fmt.Sprintf("%#v", this.TotalDownloadedChunks)+",\n")
	s = append(s, "TimeDownloadingChunksNano: "+fmt.Sprintf("%#v", this.TimeDownloadingChunksNano)+",\n")
...
func (m *Summary) Size() (n int) {
	...
	_ = l
	if m.BytesProcessedPerSeconds != 0 {
		n += 1 + sovStats(uint64(m.BytesProcessedPerSeconds))
	}
	if m.LinesProcessedPerSeconds != 0 {
		n += 1 + sovStats(uint64(m.LinesProcessedPerSeconds))
	}
	if m.TotalBytesProcessed != 0 {
	...
	if m.ExecTimeNano != 0 {
		n += 1 + sovStats(uint64(m.ExecTimeNano))
	}
	return n
}
...
func (m *Store) Size() (n int) {
	...
	if m.TotalDownloadedChunks != 0 {
		n += 1 + sovStats(uint64(m.TotalDownloadedChunks))
	}
	if m.TimeDownloadingChunksNano != 0 {
		n += 1 + sovStats(uint64(m.TimeDownloadingChunksNano))
	}
	if m.HeadChunkBytes != 0 {
...
func (this *Store) String() string {
	...
	s := strings.Join([]string{`&Store{`,
		...
		`TotalDownloadedChunks:` + fmt.Sprintf("%v", this.TotalDownloadedChunks) + `,`,
		`TimeDownloadingChunksNano:` + fmt.Sprintf("%v", this.TimeDownloadingChunksNano) + `,`,
...
func (m *Summary) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BytesProcessedPerSeconds", wireType)
			}
			m.BytesProcessedPerSeconds = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BytesProcessedPerSeconds |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LinesProcessedPerSeconds", wireType)
			}
			m.LinesProcessedPerSeconds = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LinesProcessedPerSeconds |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExecTimeNano", wireType)
			}
			m.ExecTimeNano = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ExecTimeNano |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Store) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalDownloadedChunks", wireType)
			}
			m.TotalDownloadedChunks = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalDownloadedChunks |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TimeDownloadingChunksNano", wireType)
			}
			m.TimeDownloadingChunksNano = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowStats
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TimeDownloadingChunksNano |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
