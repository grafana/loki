...
func (ev *DefaultEvaluator) NewStepEvaluator(
	...
	case *syntax.LabelAggregationExpr:
		...
		return newCountDistinctStepEvaluator(iter.NewPeekingSampleIterator(it), q, e.Left.Interval, e.Left.Offset, false)
	case *syntax.CountDistinctSketchExpr:
		...
		return newCountDistinctStepEvaluator(iter.NewPeekingSampleIterator(it), q, e.Left.Interval, e.Left.Offset, true)
