...
loki_prometheus_last_evaluation_samples{rule_group="group_one",user="user1"} 1000
loki_prometheus_last_evaluation_samples{rule_group="group_one",user="user2"} 10000
loki_prometheus_last_evaluation_samples{rule_group="group_one",user="user3"} 100000
loki_prometheus_last_evaluation_samples{rule_group="group_two",user="user1"} 1000
loki_prometheus_last_evaluation_samples{rule_group="group_two",user="user2"} 10000
loki_prometheus_last_evaluation_samples{rule_group="group_two",user="user3"} 100000
...
loki_prometheus_rule_evaluation_failures_total{rule_group="group_one",user="user1"} 1
loki_prometheus_rule_evaluation_failures_total{rule_group="group_one",user="user2"} 10
loki_prometheus_rule_evaluation_failures_total{rule_group="group_one",user="user3"} 100
loki_prometheus_rule_evaluation_failures_total{rule_group="group_two",user="user1"} 1
loki_prometheus_rule_evaluation_failures_total{rule_group="group_two",user="user2"} 10
loki_prometheus_rule_evaluation_failures_total{rule_group="group_two",user="user3"} 100
...
loki_prometheus_rule_evaluations_total{rule_group="group_one",user="user1"} 1
loki_prometheus_rule_evaluations_total{rule_group="group_one",user="user2"} 10
loki_prometheus_rule_evaluations_total{rule_group="group_one",user="user3"} 100
loki_prometheus_rule_evaluations_total{rule_group="group_two",user="user1"} 1
loki_prometheus_rule_evaluations_total{rule_group="group_two",user="user2"} 10
loki_prometheus_rule_evaluations_total{rule_group="group_two",user="user3"} 100
...
loki_prometheus_rule_group_iterations_missed_total{rule_group="group_one",user="user1"} 1
loki_prometheus_rule_group_iterations_missed_total{rule_group="group_one",user="user2"} 10
loki_prometheus_rule_group_iterations_missed_total{rule_group="group_one",user="user3"} 100
loki_prometheus_rule_group_iterations_missed_total{rule_group="group_two",user="user1"} 1
loki_prometheus_rule_group_iterations_missed_total{rule_group="group_two",user="user2"} 10
loki_prometheus_rule_group_iterations_missed_total{rule_group="group_two",user="user3"} 100
...
loki_prometheus_rule_group_iterations_total{rule_group="group_one",user="user1"} 1
loki_prometheus_rule_group_iterations_total{rule_group="group_one",user="user2"} 10
loki_prometheus_rule_group_iterations_total{rule_group="group_one",user="user3"} 100
loki_prometheus_rule_group_iterations_total{rule_group="group_two",user="user1"} 1
loki_prometheus_rule_group_iterations_total{rule_group="group_two",user="user2"} 10
loki_prometheus_rule_group_iterations_total{rule_group="group_two",user="user3"} 100
...
loki_prometheus_rule_group_last_duration_seconds{rule_group="group_one",user="user1"} 1000
loki_prometheus_rule_group_last_duration_seconds{rule_group="group_one",user="user2"} 10000
loki_prometheus_rule_group_last_duration_seconds{rule_group="group_one",user="user3"} 100000
loki_prometheus_rule_group_last_duration_seconds{rule_group="group_two",user="user1"} 1000
loki_prometheus_rule_group_last_duration_seconds{rule_group="group_two",user="user2"} 10000
loki_prometheus_rule_group_last_duration_seconds{rule_group="group_two",user="user3"} 100000
...
loki_prometheus_rule_group_last_evaluation_timestamp_seconds{rule_group="group_one",user="user1"} 1000
loki_prometheus_rule_group_last_evaluation_timestamp_seconds{rule_group="group_one",user="user2"} 10000
loki_prometheus_rule_group_last_evaluation_timestamp_seconds{rule_group="group_one",user="user3"} 100000
loki_prometheus_rule_group_last_evaluation_timestamp_seconds{rule_group="group_two",user="user1"} 1000
loki_prometheus_rule_group_last_evaluation_timestamp_seconds{rule_group="group_two",user="user2"} 10000
loki_prometheus_rule_group_last_evaluation_timestamp_seconds{rule_group="group_two",user="user3"} 100000
# HELP loki_prometheus_rule_group_rules The number of rules.
# TYPE loki_prometheus_rule_group_rules gauge
loki_prometheus_rule_group_rules{rule_group="group_one",user="user1"} 1000
loki_prometheus_rule_group_rules{rule_group="group_one",user="user2"} 10000
loki_prometheus_rule_group_rules{rule_group="group_one",user="user3"} 100000
loki_prometheus_rule_group_rules{rule_group="group_two",user="user1"} 1000
loki_prometheus_rule_group_rules{rule_group="group_two",user="user2"} 10000
loki_prometheus_rule_group_rules{rule_group="group_two",user="user3"} 100000
`))
