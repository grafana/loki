...
// runtime, so RuleGroupDesc.Options is declared google.protobuf.Any on the
// wire but carries this adapter in Go. Wire format is identical. Mirrors
// resultscache.AnyAdapter.
type AnyAdapter types.Any

// Any returns the gogo representation. A zero adapter yields nil, matching
// the previous *types.Any element shape where absent meant nil.
